...
page_title: "terrible_azure_azcollection_azure_rm_monitoractiongroups_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_monitoractiongroups_info (Resource)
...
- `name` (String) The name of the action group you're trying to get details about.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `resource_group` (String) The name of the resource group in which the action group is (if you use name) The name of the resource group where you want to list Action Groups (if you don't use name)
...
- `actiongroups` (String) List of Action Groups Can be empty if listing Action Groups
