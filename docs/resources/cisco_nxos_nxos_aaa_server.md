...
page_title: "terrible_cisco_nxos_nxos_aaa_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_aaa_server (Resource)
...
- `directed_request` (String) Enables direct authentication requests to AAA server or keyword 'default' Device default is disabled.
- `encrypt_type` (String) The state of encryption applied to the entered global key. O clear text, 7 encrypted. Type-6 encryption is not supported.
