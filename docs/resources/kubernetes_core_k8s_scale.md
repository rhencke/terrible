...
page_title: "terrible_kubernetes_core_k8s_scale Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_kubernetes_core_k8s_scale (Resource)
...
- `continue_on_error` (Boolean) Whether to continue on errors when multiple resources are defined.
...
- `result` (String) If a change was made, will return the patched object, otherwise returns the existing object.
