...
page_title: "terrible_cisco_dnac_qos_policy_setting Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_qos_policy_setting (Resource)
...
- `deployByDefaultOnWiredDevices` (Boolean) Flag to indicate whether QoS policy should be deployed automatically on wired network device when it is provisioned. This would be only applicable for cases where the network device is assigned to a site where a QoS policy has been configured.
