...
page_title: "terrible_cisco_dnac_event_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_count_info (Resource)
...
- `eventId` (String) EventId query parameter. The registered EventId should be provided.
