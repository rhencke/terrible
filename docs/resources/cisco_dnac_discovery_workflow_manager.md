...
page_title: "terrible_cisco_dnac_discovery_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_discovery_workflow_manager (Resource)
...
- `config` (String) List of details of device being managed.
...
- `response_3` (String) A string with the response returned by the Cisco Catalyst Center Python SDK
