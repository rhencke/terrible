...
page_title: "terrible_cisco_dnac_users_external_authentication Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_users_external_authentication (Resource)
...
- `enable` (Boolean) Enable/disable External Authentication.
