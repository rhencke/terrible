...
page_title: "terrible_dellemc_enterprise_sonic_sonic_roce Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_roce (Resource)
...
- `config` (String) RoCE QoS configuration
...
- `after` (String) The configuration from module invocation.
- `after(generated)` (String) The generated (simulated) configuration expected from module invocation.
