...
page_title: "terrible_check_point_mgmt_cp_mgmt_install_lsm_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_install_lsm_settings (Resource)
...
- `cp_mgmt_install_lsm_settings` (String) The checkpoint install-lsm-settings output.
