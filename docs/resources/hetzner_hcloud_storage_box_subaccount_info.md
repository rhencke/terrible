...
page_title: "terrible_hetzner_hcloud_storage_box_subaccount_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_storage_box_subaccount_info (Resource)
...
- `label_selector` (String) Label selector to filter the Storage Box Subaccounts to get.
- `name` (String) Name of the Storage Box Subaccount to get.
...
- `hcloud_storage_box_subaccount_info` (String) List of Storage Box Subaccounts.
