...
page_title: "terrible_cisco_dnac_security_service_insertions Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_service_insertions (Resource)
...
- `virtualNetworks` (String) Security Service Insertions's virtualNetworks.
