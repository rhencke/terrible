...
page_title: "terrible_hetzner_hcloud_zone_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_zone_info (Resource)
...
- `label_selector` (String) Label selector to filter the Zones you want to get.
- `name` (String) Name of the Zone you want to get.
...
- `hcloud_zone_info` (String) Zone infos as list.
