...
page_title: "terrible_dellemc_enterprise_sonic_sonic_bgp_communities Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_bgp_communities (Resource)
...
- `config` (String) A list of 'bgp_communities' configurations.
...
- `commands` (String) The set of commands that are pushed to the remote device.
