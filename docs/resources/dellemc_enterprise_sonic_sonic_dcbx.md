...
page_title: "terrible_dellemc_enterprise_sonic_sonic_dcbx Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_dcbx (Resource)
...
- `config` (String) The set of DCBx attribute configurations
...
- `after` (String) The resulting configuration from module invocation.
- `after(generated)` (String) The generated (simulated) configuration from module invocation.
