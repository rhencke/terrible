...
page_title: "terrible_theforeman_foreman_host_collection Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_host_collection (Resource)
...
- `name` (String) Name of the host collection
