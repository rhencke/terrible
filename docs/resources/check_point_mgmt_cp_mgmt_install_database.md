...
page_title: "terrible_check_point_mgmt_cp_mgmt_install_database Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_install_database (Resource)
...
- `targets` (String) Check Point host(s) with one or more Management Software Blades enabled. The targets can be identified by their name or unique identifier.
...
- `cp_mgmt_install_database` (String) The checkpoint install-database output.
