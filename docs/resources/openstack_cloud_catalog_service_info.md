...
page_title: "terrible_openstack_cloud_catalog_service_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_catalog_service_info (Resource)
...
- `name` (String) Name or ID of the service.
...
- `services` (String) List of dictionaries the services.
