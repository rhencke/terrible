...
page_title: "terrible_dellemc_enterprise_sonic_sonic_ecmp_load_share Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_ecmp_load_share (Resource)
...
- `config` (String) IP ECMP load share mode configuration.
