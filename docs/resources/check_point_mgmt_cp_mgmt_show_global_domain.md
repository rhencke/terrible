...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_global_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_global_domain (Resource)
...
- `cp_mgmt_show_global_domain` (String) The checkpoint show-global-domain output.
