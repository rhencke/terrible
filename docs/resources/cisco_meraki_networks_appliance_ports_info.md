...
page_title: "terrible_cisco_meraki_networks_appliance_ports_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_ports_info (Resource)
...
- `networkId` (String) Information module for Networks Appliance Ports Info. NetworkId path parameter. Network ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `portId` (String) Information module for Networks Appliance Ports Info. PortId path parameter. Port ID.
