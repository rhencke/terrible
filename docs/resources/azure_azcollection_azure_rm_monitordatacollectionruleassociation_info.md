...
page_title: "terrible_azure_azcollection_azure_rm_monitordatacollectionruleassociation_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_monitordatacollectionruleassociation_info (Resource)
...
- `association_name` (String) The name of the association. The name is case insensitive.
...
- `data_collection_endpoint_name` (String) The name of the data collection endpoint. The name is case insensitive.
- `data_collection_rule_name` (String) The name of the data collection rule. The name is case insensitive.
...
- `resource_group` (String) The name of the resource group in which the data collection rule association is (if you use name)
...
- `datacollectionruleassociations` (String) List of data collection rule association. Can be empty if listing data collection rule association.
