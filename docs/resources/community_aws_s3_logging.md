...
page_title: "terrible_community_aws_s3_logging Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_s3_logging (Resource)
...
- `state` (String) Enable or disable logging.
- `tags` (String) Run only tasks with these Ansible tags (list of strings).
- `target_bucket` (String) The bucket to log to. Required when state=present.
- `target_prefix` (String) The prefix that should be prepended to the generated log files written to the target_bucket.
