...
page_title: "terrible_check_point_mgmt_cp_mgmt_verify_management_license Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_verify_management_license (Resource)
...
- `cp_mgmt_verify_management_license` (String) The checkpoint verify-management-license output.
