...
page_title: "terrible_cisco_meraki_networks_appliance_connectivity_monitoring_destinations_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_connectivity_monitoring_destinations_info (Resource)
...
- `networkId` (String) Information module for Networks Appliance Connectivitymonitoringdestinations Info. NetworkId path parameter. Network ID.
