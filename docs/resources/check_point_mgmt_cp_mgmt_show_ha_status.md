...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_ha_status Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_ha_status (Resource)
...
- `cp_mgmt_show_ha_status` (String) The checkpoint show-ha-status output.
