...
page_title: "terrible_community_general_keycloak_realm_keys_metadata_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_keycloak_realm_keys_metadata_info (Resource)
...
- `realm` (String) They Keycloak realm to fetch keys metadata.
...
- `keys_metadata` (String) Representation of the realm keys metadata (see https://www.keycloak.org/docs-api/latest/rest-api/index.html#KeysMetadataRepresentation).
