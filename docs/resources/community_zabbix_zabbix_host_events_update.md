...
page_title: "terrible_community_zabbix_zabbix_host_events_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_host_events_update (Resource)
...
- `params` (String) Parameters to update event(s) with. Parameters as defined at https://www.zabbix.com/documentation/current/en/manual/api/reference/event/acknowledge Additionally supported parameters are below
