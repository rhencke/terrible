...
page_title: "terrible_check_point_mgmt_cp_mgmt_approve_session Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_approve_session (Resource)
...
- `cp_mgmt_approve_session` (String) The checkpoint approve-session output.
