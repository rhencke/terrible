...
page_title: "terrible_netbox_netbox_netbox_power_panel Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_power_panel (Resource)
...
- `data` (String) Defines the power panel configuration
...
- `power_panel` (String) Serialized object as created or already existent within NetBox
