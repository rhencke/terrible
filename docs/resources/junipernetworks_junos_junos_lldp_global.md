...
page_title: "terrible_junipernetworks_junos_junos_lldp_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_lldp_global (Resource)
...
- `config` (String) The list of link layer discovery protocol attribute configurations
