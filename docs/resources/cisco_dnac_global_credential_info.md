...
page_title: "terrible_cisco_dnac_global_credential_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_global_credential_info (Resource)
...
- `sortBy` (String) SortBy query parameter. Field to sort the results by. Sorts by 'instanceId' if no value is provided.
