...
page_title: "terrible_community_general_scaleway_server_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_scaleway_server_info (Resource)
...
- `scaleway_server_info` (String) Response from Scaleway API. For more details please refer to: https://developers.scaleway.com/en/products/instance/api/.
