...
page_title: "terrible_cisco_meraki_networks_appliance_traffic_shaping Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_traffic_shaping (Resource)
...
- `globalBandwidthLimits` (String) Global per-client bandwidth limit.
