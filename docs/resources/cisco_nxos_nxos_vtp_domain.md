...
page_title: "terrible_cisco_nxos_nxos_vtp_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_vtp_domain (Resource)
...
- `end_state` (String) k/v pairs of vtp domain after module execution
- `existing` (String) k/v pairs of existing vtp domain
