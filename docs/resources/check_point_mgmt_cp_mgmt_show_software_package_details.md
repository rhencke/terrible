...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_software_package_details Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_software_package_details (Resource)
...
- `cp_mgmt_show_software_package_details` (String) The checkpoint show-software-package-details output.
