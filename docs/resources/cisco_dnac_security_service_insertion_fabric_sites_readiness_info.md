...
page_title: "terrible_cisco_dnac_security_service_insertion_fabric_sites_readiness_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_service_insertion_fabric_sites_readiness_info (Resource)
...
- `sortBy` (String) SortBy query parameter. Sort results by the fabric site name.
