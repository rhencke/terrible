...
page_title: "terrible_cisco_dnac_device_replacement_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_device_replacement_count_info (Resource)
...
- `replacementStatus` (String) ReplacementStatus query parameter. Device Replacement status listREADY-FOR-REPLACEMENT, REPLACEMENT-IN- PROGRESS, REPLACEMENT-SCHEDULED, REPLACED, ERROR.
