...
page_title: "terrible_community_windows_win_scoop_bucket Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_windows_win_scoop_bucket (Resource)
...
- `name` (String) Name of the Scoop bucket.
...
- `state` (String) State of the Scoop bucket. When `absent`, will ensure the package is not installed. When `present`, will ensure the package is installed.
...
- `rc` (Number) The result code of the scoop action
- `stdout` (String) The raw output from the scoop action
