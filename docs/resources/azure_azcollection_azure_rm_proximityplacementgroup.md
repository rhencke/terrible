...
page_title: "terrible_azure_azcollection_azure_rm_proximityplacementgroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_proximityplacementgroup (Resource)
...
- `state` (String) Assert the state of the placement group. Use `present` to create or update and `absent` to delete.
