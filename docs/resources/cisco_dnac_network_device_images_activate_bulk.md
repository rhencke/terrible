...
page_title: "terrible_cisco_dnac_network_device_images_activate_bulk Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_images_activate_bulk (Resource)
...
- `payload` (String) Network Device Images Activate Bulk's payload.
