...
page_title: "terrible_community_proxmox_proxmox_ipam_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_proxmox_proxmox_ipam_info (Resource)
...
- `ipam` (String) Limit results to a single IPAM.
...
- `vmid` (Number) Get IP of a VM under IPAM.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `ipams` (String) List of all IPAMs and IPs under them.
- `ips` (String) Filter by vmid
