...
page_title: "terrible_check_point_mgmt_cp_mgmt_securemote_dns_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_securemote_dns_server (Resource)
...
- `domains` (String) The DNS domains that the remote clients can access.
...
- `host` (String) DNS server for remote clients in the Remote access community. Identified by name or UID.
...
- `cp_mgmt_securemote_dns_server` (String) The checkpoint object created or updated.
