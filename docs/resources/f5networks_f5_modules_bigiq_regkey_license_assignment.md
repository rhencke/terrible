...
page_title: "terrible_f5networks_f5_modules_bigiq_regkey_license_assignment Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigiq_regkey_license_assignment (Resource)
...
- `state` (String) When `present`, ensures the device is assigned the specified license. When `absent`, ensures the license is revoked from the remote device and freed on the BIG-IQ.
