...
page_title: "terrible_cisco_intersight_intersight_ssh_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_ssh_policy_info (Resource)
...
- `name` (String) The name of the SSH Policy to gather information from.
- `organization` (String) The name of the organization the SSH Policy belongs to.
