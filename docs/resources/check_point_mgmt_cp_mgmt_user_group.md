...
page_title: "terrible_check_point_mgmt_cp_mgmt_user_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_user_group (Resource)
...
- `members` (String) Collection of User Group objects identified by the name or UID.
...
- `cp_mgmt_user_group` (String) The checkpoint object created or updated.
