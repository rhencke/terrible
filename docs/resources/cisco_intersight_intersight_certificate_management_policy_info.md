...
page_title: "terrible_cisco_intersight_intersight_certificate_management_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_certificate_management_policy_info (Resource)
...
- `name` (String) The name of the Certificate Management Policy to gather information from.
- `organization` (String) The name of the organization the Certificate Management Policy belongs to.
