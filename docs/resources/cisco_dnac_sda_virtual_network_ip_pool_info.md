...
page_title: "terrible_cisco_dnac_sda_virtual_network_ip_pool_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_virtual_network_ip_pool_info (Resource)
...
- `ipPoolName` (String) IpPoolName query parameter. IpPoolName. Note Use vlanName as a value for this parameter if same ip pool is assigned to multiple virtual networks (e.g.. IpPoolName=vlan1021).
