...
page_title: "terrible_cisco_meraki_organizations_adaptive_policy_acls Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_adaptive_policy_acls (Resource)
...
- `rules` (String) An ordered array of the adaptive policy ACL rules.
