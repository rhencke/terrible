...
page_title: "terrible_cisco_dnac_backups Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_backups (Resource)
...
- `scope` (String) The backup scope states whether the backup is with assurance or without assurance data.
