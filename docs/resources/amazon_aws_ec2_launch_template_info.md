...
page_title: "terrible_amazon_aws_ec2_launch_template_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_launch_template_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeLaunchTemplates.html for possible filters. Filter names and values are case sensitive.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `launch_template_ids` (String) The IDs of the launch templates.
...
- `launch_templates` (String) A list of launch templates.
