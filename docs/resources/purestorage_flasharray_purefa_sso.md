...
page_title: "terrible_purestorage_flasharray_purefa_sso Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_sso (Resource)
...
- `state` (String) Enable or disable the array Signle Sign-On from Pure1 Manage
