...
page_title: "terrible_cisco_dnac_flexible_report_content_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_flexible_report_content_info (Resource)
...
- `executionId` (String) ExecutionId path parameter. Id of execution.
...
- `reportId` (String) ReportId path parameter. Id of the report.
