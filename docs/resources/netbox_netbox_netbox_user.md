...
page_title: "terrible_netbox_netbox_netbox_user Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_user (Resource)
...
- `data` (String) Defines the user configuration
...
- `user` (String) Serialized object as created or already existent within NetBox
