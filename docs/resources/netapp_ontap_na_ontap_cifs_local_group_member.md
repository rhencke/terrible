...
page_title: "terrible_netapp_ontap_na_ontap_cifs_local_group_member Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_cifs_local_group_member (Resource)
...
- `group` (String) Specifies name of the CIFS local group
- `host_id` (String) ID of the `terrible_host` to run this task against
- `member` (String) Specifies the name of the member
