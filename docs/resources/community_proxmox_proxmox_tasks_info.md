...
page_title: "terrible_community_proxmox_proxmox_tasks_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_proxmox_proxmox_tasks_info (Resource)
...
- `node` (String) Node where to get tasks.
...
- `source` (String) Source of tasks to be considered.
- `tags` (String) Run only tasks with these Ansible tags (list of strings).
- `task` (String) Return specific task.
...
- `proxmox_tasks` (String) List of tasks.
