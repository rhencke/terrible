...
page_title: "terrible_netapp_ontap_na_ontap_cli_timeout Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_cli_timeout (Resource)
...
- `state` (String) Modify timeout value, only present is supported.
