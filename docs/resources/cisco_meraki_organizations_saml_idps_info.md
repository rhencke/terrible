...
page_title: "terrible_cisco_meraki_organizations_saml_idps_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_saml_idps_info (Resource)
...
- `idpId` (String) Information module for Organizations Saml Idps Info. IdpId path parameter. Idp ID.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `organizationId` (String) Information module for Organizations Saml Idps Info. OrganizationId path parameter. Organization ID.
