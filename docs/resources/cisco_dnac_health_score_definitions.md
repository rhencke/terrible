...
page_title: "terrible_cisco_dnac_health_score_definitions Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_health_score_definitions (Resource)
...
- `includeForOverallHealth` (Boolean) Include For Overall Health.
...
- `synchronizeToIssueThreshold` (Boolean) Synchronize To Issue Threshold.
- `tags` (String) Run only tasks with these Ansible tags (list of strings).
- `thresholdValue` (Number) Thresehold Value.
