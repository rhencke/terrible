...
page_title: "terrible_fortinet_fortimanager_fmgr_export_playbooks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_fortinet_fortimanager_fmgr_export_playbooks (Resource)
...
- `export_playbooks` (String) Export playbooks for selectors.
