...
page_title: "terrible_openstack_cloud_baremetal_port_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_baremetal_port_info (Resource)
...
- `name` (String) Name or ID of the Bare Metal port.
- `node` (String) Name or ID of a Bare Metal node.
...
- `ports` (String) Bare Metal port list.
