...
page_title: "terrible_containers_podman_podman_import Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_import (Resource)
...
- `image` (String) info from loaded image
