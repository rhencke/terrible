...
page_title: "terrible_theforeman_foreman_domain_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_domain_info (Resource)
...
- `domain` (String) Details about the found domain
- `domains` (String) List of all found domains and their details
