...
page_title: "terrible_community_general_btrfs_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_btrfs_info (Resource)
...
- `filesystems` (String) Summaries of the current state for all btrfs filesystems found on the target host.
