...
page_title: "terrible_cisco_dnac_network_devices_top_nanalytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_devices_top_nanalytics (Resource)
...
- `aggregateAttributes` (String) Network Devices Top Nanalytics's aggregateAttributes.
...
- `filters` (String) Network Devices Top Nanalytics's filters.
- `groupBy` (String) Group By.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Network Devices Top Nanalytics's page.
