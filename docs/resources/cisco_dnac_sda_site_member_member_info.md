...
page_title: "terrible_cisco_dnac_sda_site_member_member_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_site_member_member_info (Resource)
...
- `memberType` (String) MemberType query parameter. Member type (This API only supports the 'networkdevice' type).
