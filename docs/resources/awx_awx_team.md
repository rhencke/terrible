...
page_title: "terrible_awx_awx_team Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_team (Resource)
...
- `name` (String) Name to use for the team.
- `organization` (String) Organization name, ID, or named URL the team should be made a member of.
