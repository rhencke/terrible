...
page_title: "terrible_cisco_dnac_sites_time_zone_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sites_time_zone_settings (Resource)
...
- `timeZone` (String) Sites Time Zone Settings's timeZone.
