...
page_title: "terrible_netbox_netbox_netbox_power_outlet_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_power_outlet_template (Resource)
...
- `data` (String) Defines the power outlet configuration
...
- `power_outlet_template` (String) Serialized object as created or already existent within NetBox
