...
page_title: "terrible_cisco_dnac_network_applications_summary_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_applications_summary_analytics (Resource)
...
- `aggregateAttributes` (String) Network Applications Summary Analytics's aggregateAttributes.
...
- `filters` (String) Network Applications Summary Analytics's filters.
- `headers` (String) Additional headers.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Network Applications Summary Analytics's page.
