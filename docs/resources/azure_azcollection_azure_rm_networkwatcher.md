...
page_title: "terrible_azure_azcollection_azure_rm_networkwatcher Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_networkwatcher (Resource)
...
- `name` (String) The name of the network watcher.
...
- `state` (String) State of the Network Watcher. Use `present` to create or update and `absent` to delete.
