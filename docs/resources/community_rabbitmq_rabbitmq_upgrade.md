...
page_title: "terrible_community_rabbitmq_rabbitmq_upgrade Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_rabbitmq_rabbitmq_upgrade (Resource)
...
- `action` (String) Specify action to be executed.
...
- `node` (String) Erlang node name of the target rabbit node.
