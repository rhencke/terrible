...
page_title: "terrible_azure_azcollection_azure_rm_storageshare_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_storageshare_info (Resource)
...
- `state` (String) Facts about the current state of the storage file share
