...
page_title: "terrible_community_hashi_vault_vault_database_connection_read Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_database_connection_read (Resource)
...
- `connection_name` (String) The connection name to be read.
...
- `data` (String) The `data` field of the R`raw` result. This can also be accessed via R`raw.data`.
