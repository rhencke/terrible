...
page_title: "terrible_cisco_meraki_networks_switch_stacks_routing_static_routes_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_stacks_routing_static_routes_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Stacks Routing Staticroutes Info. NetworkId path parameter. Network ID.
...
- `staticRouteId` (String) Information module for Networks Switch Stacks Routing Staticroutes Info. StaticRouteId path parameter. Static route ID.
- `switchStackId` (String) Information module for Networks Switch Stacks Routing Staticroutes Info. SwitchStackId path parameter. Switch stack ID.
