...
page_title: "terrible_ibm_storage_virtualize_ibm_sv_switch_replication_direction Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ibm_storage_virtualize_ibm_sv_switch_replication_direction (Resource)
...
- `mode` (String) Specifies the replication mode of the volume group.
- `name` (String) Specifies the name of the volume group.
