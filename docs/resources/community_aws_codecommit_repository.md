...
page_title: "terrible_community_aws_codecommit_repository Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_codecommit_repository (Resource)
...
- `state` (String) Specifies the state of repository.
...
- `repository_metadata` (String) Information about the repository.
- `response_metadata` (String) Information about the response.
