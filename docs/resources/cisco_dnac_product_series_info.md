...
page_title: "terrible_cisco_dnac_product_series_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_product_series_info (Resource)
...
- `name` (String) Name query parameter. Product series name. Supports partial case-insensitive search. A minimum of 3 characters is required for the search.
