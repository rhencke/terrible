...
page_title: "terrible_check_point_mgmt_cp_mgmt_delete_central_license Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_delete_central_license (Resource)
...
- `signature` (String) The license's signature to be deleted.
...
- `cp_mgmt_delete_central_license` (String) The checkpoint delete-central-license output.
