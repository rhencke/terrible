...
page_title: "terrible_google_cloud_gcp_kms_key_ring Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_kms_key_ring (Resource)
...
- `location` (String) The location for the KeyRing. A full list of valid locations can be found by running `gcloud kms locations list`.
