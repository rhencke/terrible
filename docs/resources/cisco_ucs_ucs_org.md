...
page_title: "terrible_cisco_ucs_ucs_org Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ucs_ucs_org (Resource)
...
- `description` (String) A user-defined description of the organization. Enter up to 256 characters. You can use any characters or spaces except the following: ` (accent mark),  (backslash), ^ (carat), " (double quote), = (equal sign), > (greater than), < (less than), or ' (single quote).
...
- `org_name` (String) The name of the organization. Enter up to 16 characters. You can use any characters or spaces except the following: ` (accent mark),  (backslash), ^ (carat), " (double quote), = (equal sign), > (greater than), < (less than), or ' (single quote).
