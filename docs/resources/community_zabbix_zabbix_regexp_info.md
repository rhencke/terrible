...
page_title: "terrible_community_zabbix_zabbix_regexp_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_regexp_info (Resource)
...
- `regexp` (String) A Zabbix regular expression which is converted value to be used in community.zabbix.zabbix_regexp module.
