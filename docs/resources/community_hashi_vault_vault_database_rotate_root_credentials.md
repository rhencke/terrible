...
page_title: "terrible_community_hashi_vault_vault_database_rotate_root_credentials Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_database_rotate_root_credentials (Resource)
...
- `connection_name` (String) The connection name where the root credential rotation should be triggered.
