...
page_title: "terrible_vmware_vmware_rest_appliance_ntp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_ntp (Resource)
...
- `servers` (String) List of host names or ip addresses of ntp servers. This parameter is mandatory.
...
- `value` (String) Test the NTP configuration
