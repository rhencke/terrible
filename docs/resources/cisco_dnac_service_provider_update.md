...
page_title: "terrible_cisco_dnac_service_provider_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_service_provider_update (Resource)
...
- `settings` (String) Service Provider Update's settings.
