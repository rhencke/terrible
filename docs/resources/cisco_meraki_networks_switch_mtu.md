...
page_title: "terrible_cisco_meraki_networks_switch_mtu Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_mtu (Resource)
...
- `defaultMtuSize` (Number) MTU size for the entire network. Default value is 9578.
...
- `overrides` (String) Override MTU size for individual switches or switch templates. An empty array will clear overrides.
