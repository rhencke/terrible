...
page_title: "terrible_cisco_meraki_organizations_appliance_uplinks_statuses_overview_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_appliance_uplinks_statuses_overview_info (Resource)
...
- `networkIds` (String) Information module for Organizations Appliance Uplinks Statuses Overview Info. NetworkIds query parameter. A list of network IDs. The returned devices will be filtered to only include these networks.
- `organizationId` (String) Information module for Organizations Appliance Uplinks Statuses Overview Info. OrganizationId path parameter. Organization ID.
