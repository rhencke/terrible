...
page_title: "terrible_vyos_vyos_vyos_prefix_lists Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_prefix_lists (Resource)
...
- `config` (String) A list of prefix-list options
