...
page_title: "terrible_cisco_meraki_organizations Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations (Resource)
...
- `api` (String) API-specific settings.
...
- `management` (String) Information about the organization's management system.
