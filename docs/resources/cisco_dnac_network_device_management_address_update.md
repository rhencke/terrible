...
page_title: "terrible_cisco_dnac_network_device_management_address_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_management_address_update (Resource)
...
- `newIP` (String) New IP Address of the device to be Updated.
