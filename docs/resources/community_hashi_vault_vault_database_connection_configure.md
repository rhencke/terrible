...
page_title: "terrible_community_hashi_vault_vault_database_connection_configure Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_database_connection_configure (Resource)
...
- `connection_password` (String) Password to connect to the database
- `connection_url` (String) Connection URL to the database
- `connection_username` (String) Username to connect to the database
- `host_id` (String) ID of the `terrible_host` to run this task against
- `plugin_name` (String) Plugin name used to connect to the database
