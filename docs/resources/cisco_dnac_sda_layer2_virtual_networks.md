...
page_title: "terrible_cisco_dnac_sda_layer2_virtual_networks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_layer2_virtual_networks (Resource)
...
- `payload` (String) Sda Layer2 Virtual Networks's payload.
