...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabschedule_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabschedule_info (Resource)
...
- `schedules` (String) A list of dictionaries containing facts for Schedule.
