...
page_title: "terrible_cisco_meraki_devices_switch_ports_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_switch_ports_info (Resource)
...
- `portId` (String) Information module for Devices Switch Ports Info. PortId path parameter. Port ID.
- `serial` (String) Information module for Devices Switch Ports Info. Serial path parameter.
