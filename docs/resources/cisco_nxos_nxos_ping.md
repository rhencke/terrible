...
page_title: "terrible_cisco_nxos_nxos_ping Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_ping (Resource)
...
- `dest` (String) IP address or hostname (resolvable by switch) of remote node.
...
- `size` (Number) Size of packets to send.
