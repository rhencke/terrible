...
page_title: "terrible_check_point_mgmt_cp_mgmt_renew_scaled_sharing_server_certificate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_renew_scaled_sharing_server_certificate (Resource)
...
- `name` (String) Gateway or cluster name.
...
- `cp_mgmt_renew_scaled_sharing_server_certificate` (String) The checkpoint renew-scaled-sharing-server-certificate output.
