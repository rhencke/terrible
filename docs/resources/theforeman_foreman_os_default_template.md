...
page_title: "terrible_theforeman_foreman_os_default_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_os_default_template (Resource)
...
- `template_kind` (String) name of the template kind
