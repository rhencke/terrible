...
page_title: "terrible_cisco_dnac_configuration_template_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_configuration_template_create (Resource)
...
- `containingTemplates` (String) Configuration Template Create's containingTemplates.
...
- `deviceTypes` (String) Configuration Template Create's deviceTypes.
...
- `rollbackTemplateParams` (String) Configuration Template Create's rollbackTemplateParams.
...
- `templateParams` (String) Configuration Template Create's templateParams.
- `timeout` (Number) Override the default execution timeout (seconds). Defaults to 300.
- `triggers` (String) Arbitrary map of values; any change triggers task re-execution
- `validationErrors` (String) Configuration Template Create's validationErrors.
