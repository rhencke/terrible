...
page_title: "terrible_cisco_mso_mso_schema_template_external_epg_contract Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_external_epg_contract (Resource)
...
- `external_epg` (String) The name of the EPG to manage.
...
- `contract` (String) A contract associated to this EPG.
