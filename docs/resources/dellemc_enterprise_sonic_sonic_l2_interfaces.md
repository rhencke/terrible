...
page_title: "terrible_dellemc_enterprise_sonic_sonic_l2_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_l2_interfaces (Resource)
...
- `config` (String) A list of Layer 2 interface configurations.
