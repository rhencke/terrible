...
page_title: "terrible_vmware_vmware_rest_appliance_localaccounts_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_localaccounts_info (Resource)
...
- `value` (String) List the local accounts
