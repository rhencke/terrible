...
page_title: "terrible_awx_awx_import Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_import (Resource)
...
- `assets` (String) The assets to import. This can be the output of the export module or loaded from a file
