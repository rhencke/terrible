...
page_title: "terrible_check_point_mgmt_cp_mgmt_compliance_scan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_compliance_scan (Resource)
...
- `cp_mgmt_compliance_scan` (String) The checkpoint compliance-scan output.
