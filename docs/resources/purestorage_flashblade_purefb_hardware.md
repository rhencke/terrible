...
page_title: "terrible_purestorage_flashblade_purefb_hardware Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_hardware (Resource)
...
- `name` (String) Name of hardware component
...
- `enabled` (Boolean) State of the component identification LED
...
- `ports` (Number) If the component specificed is a connector, the number of configured ports in the connector
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `speed` (Number) If the component specified is a connector, set the configured speed of each lane in the connector in gigabits-per-second
