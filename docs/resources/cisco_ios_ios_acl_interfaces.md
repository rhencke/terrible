...
page_title: "terrible_cisco_ios_ios_acl_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_acl_interfaces (Resource)
...
- `config` (String) A dictionary of ACL interfaces options
