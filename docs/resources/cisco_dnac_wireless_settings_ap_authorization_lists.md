...
page_title: "terrible_cisco_dnac_wireless_settings_ap_authorization_lists Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_ap_authorization_lists (Resource)
...
- `localAuthorization` (String) Wireless Settings Ap Authorization Lists's localAuthorization.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `remoteAuthorization` (String) Wireless Settings Ap Authorization Lists's remoteAuthorization.
