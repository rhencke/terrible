...
page_title: "terrible_check_point_mgmt_cp_mgmt_verify_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_verify_policy (Resource)
...
- `policy_package` (String) Policy package identified by the name or UID.
...
- `cp_mgmt_verify_policy` (String) The checkpoint verify-policy output.
