...
page_title: "terrible_cisco_meraki_networks_floor_plans_auto_locate_jobs_recalculate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_floor_plans_auto_locate_jobs_recalculate (Resource)
...
- `devices` (String) The list of devices to update anchor positions for.
...
- `jobId` (String) JobId path parameter. Job ID.
