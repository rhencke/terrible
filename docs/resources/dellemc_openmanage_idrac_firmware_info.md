...
page_title: "terrible_dellemc_openmanage_idrac_firmware_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_idrac_firmware_info (Resource)
...
- `firmware_info` (String) Details of the firmware.
- `id` (String) Unique task resource ID
- `msg` (String) Fetching the firmware inventory details.
