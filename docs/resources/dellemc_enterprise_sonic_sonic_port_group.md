...
page_title: "terrible_dellemc_enterprise_sonic_sonic_port_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_port_group (Resource)
...
- `config` (String) A list of port group configurations.
