...
page_title: "terrible_cisco_dnac_projects_project_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_projects_project_id (Resource)
...
- `projectId` (String) ProjectId path parameter. The id of the project to update, retrieveable from `GET /dna/intent/api/v1/projects`.
