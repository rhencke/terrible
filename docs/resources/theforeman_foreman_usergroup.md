...
page_title: "terrible_theforeman_foreman_usergroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_usergroup (Resource)
...
- `admin` (Boolean) Whether or not the users in this group are administrators
...
- `roles` (String) List of roles assigned to the group
...
- `usergroups` (String) List of other groups assigned to the group
