...
page_title: "terrible_community_aws_ec2_customer_gateway_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_ec2_customer_gateway_info (Resource)
...
- `customer_gateway_ids` (String) Get details of a specific customer gateways using customer gateway ID/IDs. This value should be provided as a list.
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeCustomerGateways.html for possible filters.
...
- `customer_gateways` (String) List of one or more customer gateways.
