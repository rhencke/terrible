...
page_title: "terrible_netbox_netbox_netbox_region Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_region (Resource)
...
- `data` (String) Defines the region configuration
...
- `region` (String) Serialized object as created or already existent within NetBox
