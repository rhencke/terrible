...
page_title: "terrible_netbox_netbox_netbox_console_port_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_console_port_template (Resource)
...
- `data` (String) Defines the console port template configuration
...
- `console_port_template` (String) Serialized object as created or already existent within NetBox
