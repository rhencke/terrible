...
page_title: "terrible_azure_azcollection_azure_rm_mysqlconfiguration Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mysqlconfiguration (Resource)
...
- `state` (String) Assert the state of the MySQL configuration. Use `present` to update setting, or `absent` to reset to default value.
