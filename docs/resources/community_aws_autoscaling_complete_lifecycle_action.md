...
page_title: "terrible_community_aws_autoscaling_complete_lifecycle_action Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_autoscaling_complete_lifecycle_action (Resource)
...
- `asg_name` (String) The name of the Auto Scaling Group which the instance belongs to.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `instance_id` (String) The ID of the instance.
- `lifecycle_action_result` (String) The action for the lifecycle hook to take.
- `lifecycle_hook_name` (String) The name of the lifecycle hook to complete.
