...
page_title: "terrible_purestorage_flashblade_purefb_virtualhost Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_virtualhost (Resource)
...
- `name` (String) Name of the Object Store Virtual Host A hostname or domain by which the array can be addressed for virtual hosted-style S3 requests.
...
- `state` (String) Define whether the Object Store Virtual Host should be added or deleted
