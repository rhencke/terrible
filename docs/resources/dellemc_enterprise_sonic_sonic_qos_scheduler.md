...
page_title: "terrible_dellemc_enterprise_sonic_sonic_qos_scheduler Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_qos_scheduler (Resource)
...
- `config` (String) QoS scheduler configuration
