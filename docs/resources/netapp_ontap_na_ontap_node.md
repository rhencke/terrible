...
page_title: "terrible_netapp_ontap_na_ontap_node Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_node (Resource)
...
- `asset_tag` (String) The asset tag for the node, not supported by REST
...
- `from_name` (String) The name of the node to be renamed.  If *name* already exists, no action will be performed.
