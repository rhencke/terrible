...
page_title: "terrible_netbox_netbox_netbox_rack_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_rack_group (Resource)
...
- `data` (String) Defines the rack group configuration
...
- `rack_group` (String) Serialized object as created or already existent within NetBox
