...
page_title: "terrible_infoblox_nios_modules_nios_srv_record Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_srv_record (Resource)
...
- `port` (Number) Configures the port (0-65535) of this SRV record.
...
- `weight` (Number) Configures the weight (0-65535) for this SRV record.
