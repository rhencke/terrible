...
page_title: "terrible_azure_azcollection_azure_rm_route_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_route_info (Resource)
...
- `routes` (String) A list of dict results where the key is the name of the Route and the values are the facts for that Route.
