...
page_title: "terrible_cisco_nxos_nxos_vrf_address_family Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_vrf_address_family (Resource)
...
- `config` (String) A list of device configurations for VRF address family.
