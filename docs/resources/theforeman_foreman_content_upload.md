...
page_title: "terrible_theforeman_foreman_content_upload Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_content_upload (Resource)
...
- `repository` (String) Repository to upload file in to
- `src` (String) File (on the remote/target machine) to upload
