...
page_title: "terrible_cisco_meraki_organizations_openapi_spec_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_openapi_spec_info (Resource)
...
- `organizationId` (String) Information module for Organizations Openapispec Info. OrganizationId path parameter. Organization ID.
...
- `version` (Number) Information module for Organizations Openapispec Info. Version query parameter. OpenAPI Specification version to return. Default is 2.
