...
page_title: "terrible_cisco_nxos_nxos_udld_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_udld_interface (Resource)
...
- `interface` (String) FULL name of the interface, i.e. Ethernet1/1-
- `mode` (String) Manages UDLD mode for an interface.
