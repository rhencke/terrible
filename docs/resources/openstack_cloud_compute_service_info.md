...
page_title: "terrible_openstack_cloud_compute_service_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_compute_service_info (Resource)
...
- `compute_services` (String) List of dictionaries describing Compute (Nova) services.
