...
page_title: "terrible_cisco_dnac_swim_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_swim_workflow_manager (Resource)
...
- `config` (String) List of details of SWIM image being managed
...
- `response` (String) A dictionary with activation details as returned by the Catalyst Center Python SDK
