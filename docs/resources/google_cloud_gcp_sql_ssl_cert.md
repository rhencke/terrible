...
page_title: "terrible_google_cloud_gcp_sql_ssl_cert Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_sql_ssl_cert (Resource)
...
- `sha1_fingerprint` (String) The SHA-1 of the certificate.
...
- `privateKey` (String) The private key associated with the certificate.
- `sha1Fingerprint` (String) The SHA-1 of the certificate.
