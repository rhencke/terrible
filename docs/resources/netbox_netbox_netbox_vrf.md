...
page_title: "terrible_netbox_netbox_netbox_vrf Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_vrf (Resource)
...
- `data` (String) Defines the vrf configuration
...
- `vrf` (String) Serialized object as created or already existent within NetBox
