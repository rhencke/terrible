...
page_title: "terrible_cisco_meraki_networks_vlan_profiles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_vlan_profiles (Resource)
...
- `vlanGroups` (String) An array of VLAN groups.
- `vlanNames` (String) An array of named VLANs.
