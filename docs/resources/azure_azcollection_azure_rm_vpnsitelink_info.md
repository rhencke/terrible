...
page_title: "terrible_azure_azcollection_azure_rm_vpnsitelink_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_vpnsitelink_info (Resource)
...
- `vpn_site_name` (String) The name of the Vpn Site.
...
- `vpn_site_links` (String) A list of dict results where the key is the name of the VpnSiteLink and the values are the facts for that VpnSiteLink.
