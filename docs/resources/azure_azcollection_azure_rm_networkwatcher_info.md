...
page_title: "terrible_azure_azcollection_azure_rm_networkwatcher_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_networkwatcher_info (Resource)
...
- `network_watchers` (String) The facts of the network watcher.
