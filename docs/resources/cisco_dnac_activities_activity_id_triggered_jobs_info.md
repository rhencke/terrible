...
page_title: "terrible_cisco_dnac_activities_activity_id_triggered_jobs_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_activities_activity_id_triggered_jobs_info (Resource)
...
- `activityId` (String) ActivityId path parameter. The id of the activity.
