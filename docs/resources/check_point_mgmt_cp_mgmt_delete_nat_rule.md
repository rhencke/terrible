...
page_title: "terrible_check_point_mgmt_cp_mgmt_delete_nat_rule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_delete_nat_rule (Resource)
...
- `cp_mgmt_delete_nat_rule` (String) The checkpoint delete-nat-rule output.
