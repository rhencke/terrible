...
page_title: "terrible_purestorage_flashblade_purefb_admin Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_admin (Resource)
...
- `min_password` (Number) Minimum user password length Range between 1 and 100
