...
page_title: "terrible_inspur_ispim_edit_fru Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_inspur_ispim_edit_fru (Resource)
...
- `attribute` (String) Attribute,CP is Chassis Part Number,CS is Chassis Serial,PM is Product Manufacturer, PPN is Product Part Number,PS is Product Serial,PN is Product Name,PV is Product Version, PAT is Product Asset Tag,BM is Board Mfg,BPN is Board Product Name,BS is Board Serial, BP is Board Part Number.
