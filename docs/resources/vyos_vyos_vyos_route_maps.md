...
page_title: "terrible_vyos_vyos_vyos_route_maps Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_route_maps (Resource)
...
- `config` (String) A list of route-map configuration.
