...
page_title: "terrible_cisco_meraki_devices_camera_sense_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_sense_info (Resource)
...
- `serial` (String) Information module for Devices Camera Sense Info. Serial path parameter.
