...
page_title: "terrible_netapp_storagegrid_na_sg_grid_ssh_security Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_ssh_security (Resource)
...
- `allow_external_access` (Boolean) Whether external SSH access to the grid is allowed.
...
- `state` (String) The ssh security should be present.
...
- `resp` (String) Returns information about the StorageGRID ssh security.
