...
page_title: "terrible_cisco_dnac_dns_services_top_nanalytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_dns_services_top_nanalytics (Resource)
...
- `aggregateAttributes` (String) Dns Services Top Nanalytics's aggregateAttributes.
...
- `filters` (String) Dns Services Top Nanalytics's filters.
...
- `page` (String) Dns Services Top Nanalytics's page.
