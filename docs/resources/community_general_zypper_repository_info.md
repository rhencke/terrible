...
page_title: "terrible_community_general_zypper_repository_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_zypper_repository_info (Resource)
...
- `repodatalist` (String) A list of repository descriptions like it is returned by the command `zypper repos`.
