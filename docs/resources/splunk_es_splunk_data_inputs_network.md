...
page_title: "terrible_splunk_es_splunk_data_inputs_network Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_splunk_es_splunk_data_inputs_network (Resource)
...
- `config` (String) Manage and preview protocol input data.
