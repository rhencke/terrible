...
page_title: "terrible_amazon_aws_rds_cluster_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_rds_cluster_info (Resource)
...
- `db_cluster_identifier` (String) The user-supplied DB cluster identifier. If this parameter is specified, information from only the specific DB cluster is returned.
...
- `filters` (String) A filter that specifies one or more DB clusters to describe. See https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeDBClusters.html.
...
- `clusters` (String) List of RDS clusters.
