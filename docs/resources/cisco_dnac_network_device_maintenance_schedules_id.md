...
page_title: "terrible_cisco_dnac_network_device_maintenance_schedules_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_maintenance_schedules_id (Resource)
...
- `maintenanceSchedule` (String) Network Device Maintenance Schedules Id's maintenanceSchedule.
- `networkDeviceIds` (String) List of network device ids. This field is applicable only during creation of schedules; for updates, it is read-only.
