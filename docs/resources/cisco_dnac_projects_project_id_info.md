...
page_title: "terrible_cisco_dnac_projects_project_id_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_projects_project_id_info (Resource)
...
- `projectId` (String) ProjectId path parameter. The id of the project to get, retrieveable from `GET /dna/intent/api/v1/projects`.
