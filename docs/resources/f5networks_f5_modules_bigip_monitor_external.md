...
page_title: "terrible_f5networks_f5_modules_bigip_monitor_external Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigip_monitor_external (Resource)
...
- `interval` (Number) The interval specifying how frequently the monitor instance of this template will run. If this parameter is not provided when creating a new monitor, the default value will be 5. This value **must** be less than the `timeout` value.
...
- `parent` (String) The parent template of this monitor template. Once this value has been set, it cannot be changed. By default, this value is the `external` parent on the `Common` partition.
...
- `variables` (String) Specifies any variables the script requires. Note that double quotes in values will be suppressed.
