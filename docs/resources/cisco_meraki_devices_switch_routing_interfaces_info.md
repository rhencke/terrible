...
page_title: "terrible_cisco_meraki_devices_switch_routing_interfaces_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_switch_routing_interfaces_info (Resource)
...
- `interfaceId` (String) Information module for Devices Switch Routing Interfaces Info. InterfaceId path parameter. Interface ID.
- `mode` (String) Information module for Devices Switch Routing Interfaces Info. Mode query parameter. Optional parameter to filter L3 interfaces by mode.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `protocol` (String) Information module for Devices Switch Routing Interfaces Info. Protocol query parameter. Optional parameter to filter L3 interfaces by protocol.
- `serial` (String) Information module for Devices Switch Routing Interfaces Info. Serial path parameter.
