...
page_title: "terrible_netbox_netbox_netbox_export_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_export_template (Resource)
...
- `data` (String) Defines the custom field
...
- `custom_link` (String) Serialized object as created/existent/updated/deleted within NetBox
