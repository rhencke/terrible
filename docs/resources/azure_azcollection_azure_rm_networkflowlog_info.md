...
page_title: "terrible_azure_azcollection_azure_rm_networkflowlog_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_networkflowlog_info (Resource)
...
- `network_watcher_name` (String) Name of the network watcher.
...
- `name` (String) Name of the network flow logs.
...
- `flow_logs` (String) The facts of the network flow logs.
