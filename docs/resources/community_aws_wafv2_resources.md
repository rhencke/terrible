...
page_title: "terrible_community_aws_wafv2_resources Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_wafv2_resources (Resource)
...
- `arn` (String) AWS resources (ALB, API Gateway or AppSync GraphQL API) ARN
...
- `resource_arns` (String) Current resources where the wafv2 is applied on
