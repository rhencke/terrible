...
page_title: "terrible_cisco_meraki_organizations_saml_roles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_saml_roles (Resource)
...
- `networks` (String) The list of networks that the SAML administrator has privileges on.
