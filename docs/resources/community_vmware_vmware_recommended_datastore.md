...
page_title: "terrible_community_vmware_vmware_recommended_datastore Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_recommended_datastore (Resource)
...
- `datastore_cluster` (String) Name of the datastore cluster.
...
- `recommended_datastore` (String) metadata about the recommended datastore
