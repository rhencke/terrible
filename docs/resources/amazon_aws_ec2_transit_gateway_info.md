...
page_title: "terrible_amazon_aws_ec2_transit_gateway_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_transit_gateway_info (Resource)
...
- `filters` (String) A dictionary of filters to apply to the query. Each key-value pair represents a filter key and its corresponding value. For a complete list of available filters, refer to the AWS documentation https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeTransitGateways.html.
...
- `transit_gateway_ids` (String) A list of Transit Gateway IDs for which to gather information.
...
- `transit_gateways` (String) Transit gateways that match the provided filters. Each element consists of a dict with all the information related to that transit gateway.
