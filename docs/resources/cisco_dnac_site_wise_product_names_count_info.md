...
page_title: "terrible_cisco_dnac_site_wise_product_names_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_wise_product_names_count_info (Resource)
...
- `productName` (String) ProductName query parameter. Filter with network device product name. Supports partial case-insensitive search. A minimum of 3 characters are required for search.
- `siteId` (String) SiteId query parameter. Site identifier to get the list of all available products under the site. The default value is global site id. See https //developer.cisco.com/docs/dna-center/get-site/ for siteId.
