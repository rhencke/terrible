...
page_title: "terrible_netapp_storagegrid_na_sg_org_container Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_org_container (Resource)
...
- `consistency` (String) The consistency control affects the availability of objects for client requests.
...
- `policy` (String) Configure bucket policy.
