...
page_title: "terrible_community_general_manageiq_tags_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_manageiq_tags_info (Resource)
...
- `resource_name` (String) The name of the resource at which tags are controlled. Must be specified if `resource_id` is not set. Both options are mutually exclusive.
