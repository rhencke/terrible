...
page_title: "terrible_azure_azcollection_azure_rm_postgresqlserver_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqlserver_info (Resource)
...
- `servers` (String) A list of dictionaries containing facts for PostgreSQL servers.
