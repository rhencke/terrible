...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabpolicy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabpolicy_info (Resource)
...
- `policies` (String) A list of dictionaries containing facts for Policy.
