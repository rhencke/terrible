...
page_title: "terrible_cisco_meraki_devices_camera_analytics_live_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_analytics_live_info (Resource)
...
- `serial` (String) Information module for Devices Camera Analytics Live Info. Serial path parameter.
