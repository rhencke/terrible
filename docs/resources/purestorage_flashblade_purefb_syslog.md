...
page_title: "terrible_purestorage_flashblade_purefb_syslog Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_syslog (Resource)
...
- `name` (String) Unique identifier for the syslog server address
...
- `services` (String) Syslog service type(s)
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Create update, delete or test syslog servers configuration
