...
page_title: "terrible_community_general_oneview_datacenter_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_oneview_datacenter_info (Resource)
...
- `options` (String) Retrieve additional information. Options available: `visualContent`.
...
- `datacenter_visual_content` (String) Has information about the Data Center Visual Content.
- `datacenters` (String) Has all the OneView information about the Data Centers.
