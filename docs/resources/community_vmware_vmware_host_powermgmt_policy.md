...
page_title: "terrible_community_vmware_vmware_host_powermgmt_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_powermgmt_policy (Resource)
...
- `policy` (String) Set the Power Management Policy of the host system.
...
- `result` (String) metadata about host system's Power Management Policy
