...
page_title: "terrible_containers_podman_podman_login_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_login_info (Resource)
...
- `registry` (String) Registry server.
...
- `login` (String) Logged in user for a registry
