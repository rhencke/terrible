...
page_title: "terrible_cisco_dnac_device_reboot_apreboot Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_device_reboot_apreboot (Resource)
...
- `apMacAddresses` (String) The ethernet MAC address of the access point.
