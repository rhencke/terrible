...
page_title: "terrible_cisco_dnac_wireless_settings_ap_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_ap_profiles_info (Resource)
...
- `apProfileName` (String) ApProfileName query parameter. Employ this query parameter to obtain the details of the apProfiles corresponding to the provided apProfileName.
