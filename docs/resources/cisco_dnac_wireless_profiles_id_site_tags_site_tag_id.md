...
page_title: "terrible_cisco_dnac_wireless_profiles_id_site_tags_site_tag_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_profiles_id_site_tags_site_tag_id (Resource)
...
- `apProfileName` (String) Ap Profile Name.
...
- `flexProfileName` (String) Flex Profile Name.
...
- `siteTagId` (String) SiteTagId path parameter. Site Tag Id.
- `siteTagName` (String) Use English letters, numbers, special characters except <, /, '.*', ? and leading/trailing space.
