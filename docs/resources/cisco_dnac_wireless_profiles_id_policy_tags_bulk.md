...
page_title: "terrible_cisco_dnac_wireless_profiles_id_policy_tags_bulk Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_profiles_id_policy_tags_bulk (Resource)
...
- `items` (String) Wireless Profiles Id Policy Tags Bulk's items.
