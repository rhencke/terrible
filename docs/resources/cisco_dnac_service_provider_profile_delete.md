...
page_title: "terrible_cisco_dnac_service_provider_profile_delete Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_service_provider_profile_delete (Resource)
...
- `spProfileName` (String) SpProfileName path parameter. Sp profile name.
