...
page_title: "terrible_cisco_meraki_networks_switch_stp_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_stp_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Stp Info. NetworkId path parameter. Network ID.
