...
page_title: "terrible_azure_azcollection_azure_rm_cdnprofile_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_cdnprofile_info (Resource)
...
- `resource_group` (String) The resource group to search for the desired CDN profile.
...
- `cdnprofiles` (String) List of CDN profiles.
