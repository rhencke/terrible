...
page_title: "terrible_cisco_nxos_nxos_zone_zoneset Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_zone_zoneset (Resource)
...
- `zone_zoneset_details` (String) List of zone/zoneset details to be added or removed
