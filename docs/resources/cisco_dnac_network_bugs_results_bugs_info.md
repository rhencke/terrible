...
page_title: "terrible_cisco_dnac_network_bugs_results_bugs_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_bugs_results_bugs_info (Resource)
...
- `deviceCount` (Number) DeviceCount query parameter. Return network bugs with deviceCount greater than this deviceCount.
