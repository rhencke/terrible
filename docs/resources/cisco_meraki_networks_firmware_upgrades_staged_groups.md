...
page_title: "terrible_cisco_meraki_networks_firmware_upgrades_staged_groups Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_firmware_upgrades_staged_groups (Resource)
...
- `assignedDevices` (String) The devices and Switch Stacks assigned to the Group.
