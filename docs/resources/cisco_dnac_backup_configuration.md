...
page_title: "terrible_cisco_dnac_backup_configuration Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_backup_configuration (Resource)
...
- `dataRetention` (Number) Date retention policy of the backup.
- `delegate_to_id` (String) ID of another terrible_host to delegate execution to.
- `encryptionPassphrase` (String) Password to encrypt the backup information.
...
- `mountPath` (String) Backup storage mount path.
