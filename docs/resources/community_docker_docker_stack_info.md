...
page_title: "terrible_community_docker_docker_stack_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_docker_docker_stack_info (Resource)
...
- `results` (String) List of dictionaries containing the list of stacks on the target node.
