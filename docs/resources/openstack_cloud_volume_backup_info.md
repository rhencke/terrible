...
page_title: "terrible_openstack_cloud_volume_backup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_volume_backup_info (Resource)
...
- `volume_backups` (String) List of dictionaries describing volume backups.
