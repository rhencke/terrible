...
page_title: "terrible_amazon_aws_autoscaling_instance_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_autoscaling_instance_info (Resource)
...
- `group_name` (String) Name of the AutoScaling Group to manage. `group_name` and `instance_ids` are mutually exclusive.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `instance_ids` (String) The IDs of the EC2 instances. `group_name` and `instance_ids` are mutually exclusive.
