...
page_title: "terrible_cisco_meraki_devices_cellular_gateway_port_forwarding_rules_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_cellular_gateway_port_forwarding_rules_info (Resource)
...
- `serial` (String) Information module for Devices Cellulargateway Portforwardingrules Info. Serial path parameter.
