...
page_title: "terrible_community_general_redis_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_redis_info (Resource)
...
- `cluster` (Boolean) Get informations about cluster status as R`cluster`.
...
- `info` (String) The default set of server information sections https://redis.io/commands/info.
