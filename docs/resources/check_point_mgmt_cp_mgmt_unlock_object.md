...
page_title: "terrible_check_point_mgmt_cp_mgmt_unlock_object Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_unlock_object (Resource)
...
- `layer` (String) Object layer, need to specify the layer if the object is rule/section and uid is not supplied.
...
- `cp_mgmt_unlock_object` (String) The checkpoint unlock-object output.
