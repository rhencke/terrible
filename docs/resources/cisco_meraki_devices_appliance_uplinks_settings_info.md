...
page_title: "terrible_cisco_meraki_devices_appliance_uplinks_settings_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_appliance_uplinks_settings_info (Resource)
...
- `serial` (String) Information module for Devices Appliance Uplinks Settings Info. Serial path parameter.
