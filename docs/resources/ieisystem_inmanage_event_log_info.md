...
page_title: "terrible_ieisystem_inmanage_event_log_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_event_log_info (Resource)
...
- `event_file` (String) Store logs to a file.
