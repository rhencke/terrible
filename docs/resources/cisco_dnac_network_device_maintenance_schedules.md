...
page_title: "terrible_cisco_dnac_network_device_maintenance_schedules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_maintenance_schedules (Resource)
...
- `maintenanceSchedule` (String) Network Device Maintenance Schedules's maintenanceSchedule.
