...
page_title: "terrible_theforeman_foreman_host_errata_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_host_errata_info (Resource)
...
- `host` (String) Name of the host to fetch errata for.
...
- `host_errata` (String) List of all found errata for the host and their details
