...
page_title: "terrible_cisco_meraki_networks_sm_devices_device_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sm_devices_device_profiles_info (Resource)
...
- `deviceId` (String) Information module for Networks Sm Devices Deviceprofiles Info. DeviceId path parameter. Device ID.
...
- `networkId` (String) Information module for Networks Sm Devices Deviceprofiles Info. NetworkId path parameter. Network ID.
