...
page_title: "terrible_cisco_dnac_license_setting Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_license_setting (Resource)
...
- `autoRegistrationVirtualAccountId` (String) Virtual account id.
- `changed_when` (String) Jinja2 expression that overrides when the task is considered changed (e.g. 'false').
- `defaultSmartAccountId` (String) Default smart account id.
