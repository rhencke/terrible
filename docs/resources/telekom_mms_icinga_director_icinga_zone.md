...
page_title: "terrible_telekom_mms_icinga_director_icinga_zone Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_telekom_mms_icinga_director_icinga_zone (Resource)
...
- `is_global` (Boolean) Whether configuration files for this zone should be synced to all endpoints.
