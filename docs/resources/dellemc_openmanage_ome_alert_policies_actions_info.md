...
page_title: "terrible_dellemc_openmanage_ome_alert_policies_actions_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_alert_policies_actions_info (Resource)
...
- `actions` (String) Returns the alert policies action information collected from the Device.
...
- `msg` (String) Status of the alert policies actions fetch operation.
