...
page_title: "terrible_vyos_vyos_vyos_firewall_rules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_firewall_rules (Resource)
...
- `config` (String) A dictionary of Firewall rule-set options.
