...
page_title: "terrible_netbox_netbox_netbox_fhrp_group_assignment Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_fhrp_group_assignment (Resource)
...
- `data` (String) Defines the FHRP group assignment configuration
...
- `fhrp_group` (String) Serialized object as created or already existent within NetBox
