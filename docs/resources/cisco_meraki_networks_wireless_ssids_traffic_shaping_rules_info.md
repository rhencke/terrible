...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_traffic_shaping_rules_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_traffic_shaping_rules_info (Resource)
...
- `networkId` (String) Information module for Networks Wireless Ssids Trafficshaping Rules Info. NetworkId path parameter. Network ID.
- `number` (String) Information module for Networks Wireless Ssids Trafficshaping Rules Info. Number path parameter.
