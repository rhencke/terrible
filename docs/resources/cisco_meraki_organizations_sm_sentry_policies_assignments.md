...
page_title: "terrible_cisco_meraki_organizations_sm_sentry_policies_assignments Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_sm_sentry_policies_assignments (Resource)
...
- `items` (String) Sentry Group Policies for the Organization keyed by Network Id.
