...
page_title: "terrible_cisco_meraki_organizations_camera_permissions_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_camera_permissions_info (Resource)
...
- `organizationId` (String) Information module for Organizations Camera Permissions Info. OrganizationId path parameter. Organization ID.
- `permissionScopeId` (String) Information module for Organizations Camera Permissions Info. PermissionScopeId path parameter. Permission scope ID.
