...
page_title: "terrible_azure_azcollection_azure_rm_serviceendpointpolicy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_serviceendpointpolicy (Resource)
...
- `name` (String) The name of the service endpoint policy name.
...
- `state` (String) Set to `present` to create or update the service endpoint policy. Set to `absent` to remove the service endpoint policy.
...
- `serviceendpointpolicypolicy` (String) The fact of the service endpoint policys in a service end point policy.
