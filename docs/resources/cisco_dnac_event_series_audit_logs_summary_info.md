...
page_title: "terrible_cisco_dnac_event_series_audit_logs_summary_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_series_audit_logs_summary_info (Resource)
...
- `isParentOnly` (Boolean) IsParentOnly query parameter. Parameter to filter parent only audit-logs.
...
- `parentInstanceId` (String) ParentInstanceId query parameter. Parent Audit Log record's instanceID.
