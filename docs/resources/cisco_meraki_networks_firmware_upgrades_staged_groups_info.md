...
page_title: "terrible_cisco_meraki_networks_firmware_upgrades_staged_groups_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_firmware_upgrades_staged_groups_info (Resource)
...
- `groupId` (String) Information module for Networks Firmwareupgrades Staged Groups Info. GroupId path parameter. Group ID.
- `headers` (String) Additional headers.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `networkId` (String) Information module for Networks Firmwareupgrades Staged Groups Info. NetworkId path parameter. Network ID.
