...
page_title: "terrible_netbox_netbox_netbox_ip_address Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_ip_address (Resource)
...
- `data` (String) Defines the IP address configuration
...
- `state` (String) Use `present`, `new` or `absent` for adding, force adding or removing.
...
- `ip_address` (String) Serialized object as created or already existent within NetBox
