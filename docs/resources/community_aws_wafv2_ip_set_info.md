...
page_title: "terrible_community_aws_wafv2_ip_set_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_wafv2_ip_set_info (Resource)
...
- `addresses` (String) Current addresses of the ip set
...
- `ip_address_version` (String) IP version of the ip set
