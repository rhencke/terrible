...
page_title: "terrible_theforeman_foreman_wait_for_task Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_wait_for_task (Resource)
...
- `task` (String) Task id to wait for.
