...
page_title: "terrible_community_sap_libs_sap_control_exec Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_sap_libs_sap_control_exec (Resource)
...
- `port` (Number) The port number of the sapstartsrv. If provided, the module will use always use http connection instead of local socket.
