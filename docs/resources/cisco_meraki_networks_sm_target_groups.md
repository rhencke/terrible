...
page_title: "terrible_cisco_meraki_networks_sm_target_groups Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sm_target_groups (Resource)
...
- `targetGroupId` (String) TargetGroupId path parameter. Target group ID.
