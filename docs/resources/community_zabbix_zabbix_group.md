...
page_title: "terrible_community_zabbix_zabbix_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_group (Resource)
...
- `host_groups` (String) List of host groups to create or delete.
...
- `propagate` (String) List of settings will be propagated. This module propagates permissions and/or tag_filters after creating missing host groups. This parameter is for Zabbix >= 7.0.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Create or delete host group.
