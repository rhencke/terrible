...
page_title: "terrible_community_vmware_vmware_datacenter Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_datacenter (Resource)
...
- `datacenter_name` (String) The name of the datacenter the cluster will be created in.
...
- `state` (String) If the datacenter should be present or absent.
