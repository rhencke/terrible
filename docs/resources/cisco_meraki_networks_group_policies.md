...
page_title: "terrible_cisco_meraki_networks_group_policies Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_group_policies (Resource)
...
- `bandwidth` (String) The bandwidth settings for clients bound to your group policy.
- `bonjourForwarding` (String) The Bonjour settings for your group policy. Only valid if your network has a wireless configuration.
- `changed_when` (String) Jinja2 expression that overrides when the task is considered changed (e.g. 'false').
- `contentFiltering` (String) The content filtering settings for your group policy.
...
- `firewallAndTrafficShaping` (String) The firewall and traffic shaping rules and settings for your policy.
