...
page_title: "terrible_cisco_iosxr_iosxr_bgp_templates Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_bgp_templates (Resource)
...
- `config` (String) BGP template configurations.
