...
page_title: "terrible_cisco_meraki_meraki_mr_l3_firewall Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_meraki_mr_l3_firewall (Resource)
...
- `allow_lan_access` (Boolean) Sets whether devices can talk to other devices on the same LAN.
