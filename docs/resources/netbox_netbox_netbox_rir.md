...
page_title: "terrible_netbox_netbox_netbox_rir Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_rir (Resource)
...
- `data` (String) Defines the RIR configuration
...
- `rir` (String) Serialized object as created or already existent within NetBox
