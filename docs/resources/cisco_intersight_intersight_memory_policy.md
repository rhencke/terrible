...
page_title: "terrible_cisco_intersight_intersight_memory_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_memory_policy (Resource)
...
- `name` (String) The name assigned to the Memory policy. The name must be between 1 and 62 alphanumeric characters, allowing special characters :-_.
...
- `description` (String) The user-defined description of the Memory policy. Description can contain letters(a-z, A-Z), numbers(0-9), hyphen(-), period(.), colon(:), or an underscore(_).
- `enable_dimm_blocklisting` (Boolean) Enable or disable DIMM blocklisting.
