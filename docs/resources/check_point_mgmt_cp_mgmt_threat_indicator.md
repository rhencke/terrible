...
page_title: "terrible_check_point_mgmt_cp_mgmt_threat_indicator Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_threat_indicator (Resource)
...
- `action` (String) The indicator's action.
...
- `observables` (String) The indicator's observables.
...
- `profile_overrides` (String) Profiles in which to override the indicator's default action.
...
- `cp_mgmt_threat_indicator` (String) The checkpoint object created or updated.
