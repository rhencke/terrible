...
page_title: "terrible_cisco_dnac_inventory_intent Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_inventory_intent (Resource)
...
- `config` (String) List of devices with credentails to perform Add/Update/Delete/Resync operation
