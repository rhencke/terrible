...
page_title: "terrible_community_proxmox_proxmox_cluster_join_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_proxmox_proxmox_cluster_join_info (Resource)
...
- `cluster_join` (String) List of Proxmox VE nodes including the join information within the cluster.
