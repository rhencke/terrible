...
page_title: "terrible_azure_azcollection_azure_rm_virtualhubconnection_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualhubconnection_info (Resource)
...
- `virtual_hub_name` (String) The resource name of the VirtualHub.
...
- `virtual_hub_connection` (String) A list of dict results for the virtual hub connection info.
