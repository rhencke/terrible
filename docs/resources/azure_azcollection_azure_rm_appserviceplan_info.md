...
page_title: "terrible_azure_azcollection_azure_rm_appserviceplan_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_appserviceplan_info (Resource)
...
- `appserviceplans` (String) List of app service plans.
