...
page_title: "terrible_cisco_dnac_security_advisories_results_trend_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_advisories_results_trend_count_info (Resource)
...
- `scanTime` (Number) ScanTime query parameter. Return advisories trend with scanTime greater than this scanTime.
