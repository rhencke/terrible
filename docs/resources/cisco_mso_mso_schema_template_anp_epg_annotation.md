...
page_title: "terrible_cisco_mso_mso_schema_template_anp_epg_annotation Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_anp_epg_annotation (Resource)
...
- `anp` (String) The name of the Application Network Profile (ANP).
...
- `annotation_key` (String) The key of the Annotation object.
- `annotation_value` (String) The value of the Annotation object.
