...
page_title: "terrible_cisco_intersight_intersight_ipmi_over_lan_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_ipmi_over_lan_policy_info (Resource)
...
- `name` (String) The name of the IPMI over LAN Policy to gather information from.
- `organization` (String) The name of the organization the IPMI over LAN Policy belongs to.
