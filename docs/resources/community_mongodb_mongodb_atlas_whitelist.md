...
page_title: "terrible_community_mongodb_mongodb_atlas_whitelist Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_mongodb_mongodb_atlas_whitelist (Resource)
...
- `cidr_block` (String) Whitelist entry in Classless Inter-Domain Routing (CIDR) notation.
...
- `comment` (String) Optional Comment associated with the whitelist entry.
