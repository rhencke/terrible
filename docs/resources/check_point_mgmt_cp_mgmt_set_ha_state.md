...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_ha_state Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_ha_state (Resource)
...
- `new_state` (String) Domain server new state.
...
- `cp_mgmt_set_ha_state` (String) The checkpoint set-ha-state output.
