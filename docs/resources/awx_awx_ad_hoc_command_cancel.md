...
page_title: "terrible_awx_awx_ad_hoc_command_cancel Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_ad_hoc_command_cancel (Resource)
...
- `command_id` (Number) ID of the command to cancel
...
- `fail_if_not_running` (Boolean) Fail loudly if the *command_id* can not be canceled
...
- `interval` (Number) The interval in seconds, to request an update from .
