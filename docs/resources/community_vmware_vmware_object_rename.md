...
page_title: "terrible_community_vmware_vmware_object_rename Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_object_rename (Resource)
...
- `new_name` (String) New name for VMware object.
- `object_type` (String) Type of object to work with. Valid options are Cluster, ClusterComputeResource, Datacenter, Datastore, Folder, ResourcePool, VM or VirtualMachine.
...
- `rename_status` (String) metadata about VMware object rename operation
