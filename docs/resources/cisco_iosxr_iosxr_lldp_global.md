...
page_title: "terrible_cisco_iosxr_iosxr_lldp_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_lldp_global (Resource)
...
- `config` (String) The provided global LLDP configuration.
