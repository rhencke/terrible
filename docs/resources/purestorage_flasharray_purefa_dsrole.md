...
page_title: "terrible_purestorage_flasharray_purefa_dsrole Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_dsrole (Resource)
...
- `name` (String) Name of role If not providied, will be assinged to the same as *role*
