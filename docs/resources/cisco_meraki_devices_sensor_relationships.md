...
page_title: "terrible_cisco_meraki_devices_sensor_relationships Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_sensor_relationships (Resource)
...
- `livestream` (String) A role defined between an MT sensor and an MV camera that adds the camera's livestream to the sensor's details page. Snapshots from the camera will also appear in alert notifications that the sensor triggers.
