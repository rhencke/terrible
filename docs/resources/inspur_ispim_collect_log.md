...
page_title: "terrible_inspur_ispim_collect_log Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_inspur_ispim_collect_log (Resource)
...
- `file_url` (String) File download path or path with filename , e.g. filepath/filename.tar.
