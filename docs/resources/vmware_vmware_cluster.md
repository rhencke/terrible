...
page_title: "terrible_vmware_vmware_cluster Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_cluster (Resource)
...
- `state` (String) Create `present` or remove `absent` a VMware vSphere cluster.
