...
page_title: "terrible_amazon_aws_rds_instance_param_group_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_rds_instance_param_group_info (Resource)
...
- `db_parameter_group_name` (String) The name of a specific DB parameter group to return details for.
...
- `db_instance_parameter_groups` (String) List of RDS instance parameter groups.
