...
page_title: "terrible_junipernetworks_junos_junos_lacp_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_lacp_interfaces (Resource)
...
- `config` (String) The list of dictionaries of LACP interfaces options.
