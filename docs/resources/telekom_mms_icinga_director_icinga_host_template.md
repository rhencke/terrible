...
page_title: "terrible_telekom_mms_icinga_director_icinga_host_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_telekom_mms_icinga_director_icinga_host_template (Resource)
...
- `imports` (String) Choose a host-template.
