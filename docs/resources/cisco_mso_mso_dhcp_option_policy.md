...
page_title: "terrible_cisco_mso_mso_dhcp_option_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_dhcp_option_policy (Resource)
...
- `description` (String) Description of the DHCP Option Policy
- `dhcp_option_policy` (String) Name of the DHCP Option Policy
...
- `tenant` (String) Tenant where the DHCP Option Policy is located.
