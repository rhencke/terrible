...
page_title: "terrible_community_general_uptimerobot Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_uptimerobot (Resource)
...
- `apikey` (String) Uptime Robot API key.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `monitorid` (String) ID of the monitor to check.
- `state` (String) Define whether or not the monitor should be running or paused.
