...
page_title: "terrible_cisco_dnac_system_issue_definitions_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_system_issue_definitions_id (Resource)
...
- `issueEnabled` (Boolean) Issue Enabled.
...
- `synchronizeToHealthThreshold` (Boolean) Synchronize To Health Threshold.
