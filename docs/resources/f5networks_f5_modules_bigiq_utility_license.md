...
page_title: "terrible_f5networks_f5_modules_bigiq_utility_license Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigiq_utility_license (Resource)
...
- `license_key` (String) The license key to install and activate.
...
- `state` (String) The state of the utility license on the system. When `present`, guarantees the license exists. When `absent`, removes the license from the system.
