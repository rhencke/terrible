...
page_title: "terrible_cisco_meraki_networks_cellular_gateway_connectivity_monitoring_destinations Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_cellular_gateway_connectivity_monitoring_destinations (Resource)
...
- `destinations` (String) The list of connectivity monitoring destinations.
