...
page_title: "terrible_cisco_dnac_intent_network_devices_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_intent_network_devices_query_count (Resource)
...
- `filter` (String) Intent Network Devices Query Count's filter.
