...
page_title: "terrible_azure_azcollection_azure_rm_eventgrid_topic_subscription Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_eventgrid_topic_subscription (Resource)
...
- `state` (String) State of the Eventgrid Topic Event Subscription. Use `present` to create or update and `absent` to delete.
