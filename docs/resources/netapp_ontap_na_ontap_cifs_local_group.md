...
page_title: "terrible_netapp_ontap_na_ontap_cifs_local_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_cifs_local_group (Resource)
...
- `name` (String) Specifies name of the CIFS local group
- `vserver` (String) Specifies the vserver that owns the CIFS local group
...
- `from_name` (String) Specifies the existing cifs local group name. This option is used to rename cifs local group.
...
- `state` (String) Whether the specified member should be part of the CIFS local group
