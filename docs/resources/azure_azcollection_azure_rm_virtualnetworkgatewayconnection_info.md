...
page_title: "terrible_azure_azcollection_azure_rm_virtualnetworkgatewayconnection_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualnetworkgatewayconnection_info (Resource)
...
- `name` (String) The name of the virtual network gateway connection.
...
- `state` (String) Current state of the Azure Virtual Network Gateway Connection resource.
