...
page_title: "terrible_azure_azcollection_azure_rm_aksupgrade_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_aksupgrade_info (Resource)
...
- `resource_group` (String) Name of a resource group where the managed Azure Container Services (AKS) exists.
...
- `azure_aks_upgrades` (String) Supported AKS instance versions for upgrade by agent pools and control plane.
