...
page_title: "terrible_cisco_mso_mso_schema_site_vrf_region_cidr Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_site_vrf_region_cidr (Resource)
...
- `cidr` (String) The name of the region CIDR to manage.
...
- `primary` (Boolean) Whether this is the primary CIDR.
