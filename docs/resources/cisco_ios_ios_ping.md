...
page_title: "terrible_cisco_ios_ios_ping Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_ping (Resource)
...
- `afi` (String) Define echo type ip or ipv6.
...
- `size` (Number) Size of the packet to send.
