...
page_title: "terrible_netapp_ontap_na_ontap_storage_failover Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_storage_failover (Resource)
...
- `node_name` (String) Specifies the node name to enable or disable storage failover.
...
- `state` (String) Whether storage failover should be enabled (present) or disabled (absent).
