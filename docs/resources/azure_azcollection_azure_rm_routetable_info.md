...
page_title: "terrible_azure_azcollection_azure_rm_routetable_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_routetable_info (Resource)
...
- `disable_bgp_route_propagation` (Boolean) Whether the routes learned by BGP on that route table disabled.
- `id` (String) Unique task resource ID
- `routes` (String) Current routes of the route table.
