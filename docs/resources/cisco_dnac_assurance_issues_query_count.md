...
page_title: "terrible_cisco_dnac_assurance_issues_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_assurance_issues_query_count (Resource)
...
- `filters` (String) Assurance Issues Query Count's filters.
