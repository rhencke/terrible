...
page_title: "terrible_community_aws_api_gateway_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_api_gateway_info (Resource)
...
- `ids` (String) The list of the string identifiers of the associated RestApis.
...
- `rest_apis` (String) A list of API gateway.
