...
page_title: "terrible_purestorage_flasharray_purefa_default_protection Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_default_protection (Resource)
...
- `name` (String) The name of the protection group to assign or remove as default for the scope. If *scope* is *pod* only the short-name for the pod protection group is needed. See examples
...
- `scope` (String) The scope of the default protection group
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Define whether to add or delete the protection group to the default list
