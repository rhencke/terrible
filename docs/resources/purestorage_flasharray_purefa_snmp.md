...
page_title: "terrible_purestorage_flasharray_purefa_snmp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_snmp (Resource)
...
- `state` (String) Create, delete or testSNMP manager
