...
page_title: "terrible_cisco_meraki_networks_mqtt_brokers Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_mqtt_brokers (Resource)
...
- `authentication` (String) Authentication settings of the MQTT broker.
...
- `security` (String) Security settings of the MQTT broker.
