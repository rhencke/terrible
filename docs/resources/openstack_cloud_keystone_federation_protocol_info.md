...
page_title: "terrible_openstack_cloud_keystone_federation_protocol_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_keystone_federation_protocol_info (Resource)
...
- `idp` (String) ID or name of the identity provider this protocol is associated with.
...
- `name` (String) ID or name of the federation protocol.
...
- `protocols` (String) List of federation protocol dictionaries.
