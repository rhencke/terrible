...
page_title: "terrible_netapp_storagegrid_na_sg_grid_recovery_package Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_recovery_package (Resource)
...
- `passphrase` (String) the password used during maintenance procedures to make changes to the grid topology.
...
- `state` (String) Whether the recovery package should be present or absent.
...
- `resp` (String) Returns information about the StorageGRID recovery package.
