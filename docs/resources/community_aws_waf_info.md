...
page_title: "terrible_community_aws_waf_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_waf_info (Resource)
...
- `waf_regional` (Boolean) Whether to use the `waf-regional` module.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `wafs` (String) The WAFs that match the passed arguments.
