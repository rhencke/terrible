...
page_title: "terrible_netapp_ontap_na_ontap_ldap Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_ldap (Resource)
...
- `name` (String) The name of LDAP client configuration
- `vserver` (String) vserver/svm configured to use LDAP
...
- `skip_config_validation` (String) Skip LDAP validation
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Whether the LDAP is present or not.
