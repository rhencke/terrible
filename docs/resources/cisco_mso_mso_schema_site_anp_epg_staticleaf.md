...
page_title: "terrible_cisco_mso_mso_schema_site_anp_epg_staticleaf Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_site_anp_epg_staticleaf (Resource)
...
- `leaf` (String) The path of the static leaf.
- `pod` (String) The pod of the static leaf.
...
- `vlan` (Number) The VLAN id of the static leaf.
