...
page_title: "terrible_check_point_mgmt_cp_mgmt_reset_sic Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_reset_sic (Resource)
...
- `cp_mgmt_reset_sic` (String) The checkpoint reset-sic output.
