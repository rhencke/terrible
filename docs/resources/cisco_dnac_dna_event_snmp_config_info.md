...
page_title: "terrible_cisco_dnac_dna_event_snmp_config_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_dna_event_snmp_config_info (Resource)
...
- `configId` (String) ConfigId query parameter. List of SNMP configurations.
