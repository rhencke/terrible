...
page_title: "terrible_cisco_dnac_activities_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_activities_count_info (Resource)
...
- `description` (String) Description query parameter. The description provided when creating the activity.
...
- `recurring` (Boolean) Recurring query parameter. Denotes whether an activity is recurring or not.
...
- `status` (String) Status query parameter. Status of the activity.
...
- `type` (String) Type query parameter. Type of the activity.
