...
page_title: "terrible_cisco_meraki_networks_floor_plans_auto_locate_jobs_batch Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_floor_plans_auto_locate_jobs_batch (Resource)
...
- `jobs` (String) The list of auto locate jobs to be scheduled. Up to 100 jobs can be provided in a request.
