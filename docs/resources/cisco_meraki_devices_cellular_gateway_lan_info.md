...
page_title: "terrible_cisco_meraki_devices_cellular_gateway_lan_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_cellular_gateway_lan_info (Resource)
...
- `serial` (String) Information module for Devices Cellulargateway Lan Info. Serial path parameter.
