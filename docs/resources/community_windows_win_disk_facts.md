...
page_title: "terrible_community_windows_win_disk_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_windows_win_disk_facts (Resource)
...
- `filter` (String) Allows to filter returned facts by type of disk information. If volumes are selected partitions will be returned as well.
...
- `ansible_facts` (String) Dictionary containing all the detailed information about the disks of the target.
