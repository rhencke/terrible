...
page_title: "terrible_azure_azcollection_azure_rm_capacityreservationgroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_capacityreservationgroup_info (Resource)
...
- `name` (String) Name of the capacity reservation group.
...
- `capacity_reservation_group` (String) Current state of the Capacity Reservation Group.
