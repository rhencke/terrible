...
page_title: "terrible_check_point_mgmt_cp_mgmt_idp_administrator_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_idp_administrator_group (Resource)
...
- `group_id` (String) Group ID or Name should be set base on the source attribute of 'groups' in the Saml Assertion.
...
- `permissions_profile` (String) Administrator permissions profile. Permissions profile should not be provided when multi-domain-profile is set to "Multi-Domain Super User" or "Domain Super User".
...
- `cp_mgmt_idp_administrator_group` (String) The checkpoint object created or updated.
