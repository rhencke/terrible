...
page_title: "terrible_cisco_dnac_sda_multicast_virtual_networks_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_multicast_virtual_networks_info (Resource)
...
- `fabricId` (String) FabricId query parameter. ID of the fabric site where multicast is configured.
...
- `virtualNetworkName` (String) VirtualNetworkName query parameter. Name of the virtual network associated to the multicast configuration.
