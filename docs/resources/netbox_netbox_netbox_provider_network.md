...
page_title: "terrible_netbox_netbox_netbox_provider_network Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_provider_network (Resource)
...
- `data` (String) Defines the provider network configuration
...
- `provider_network` (String) Serialized object as created or already existent within NetBox
