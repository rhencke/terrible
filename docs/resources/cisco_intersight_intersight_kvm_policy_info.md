...
page_title: "terrible_cisco_intersight_intersight_kvm_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_kvm_policy_info (Resource)
...
- `name` (String) The name of the KVM Policy to gather information from.
- `organization` (String) The name of the organization the KVM Policy belongs to.
