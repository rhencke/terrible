...
page_title: "terrible_cisco_meraki_networks_sm_devices_security_centers_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sm_devices_security_centers_info (Resource)
...
- `deviceId` (String) Information module for Networks Sm Devices Securitycenters Info. DeviceId path parameter. Device ID.
...
- `networkId` (String) Information module for Networks Sm Devices Securitycenters Info. NetworkId path parameter. Network ID.
