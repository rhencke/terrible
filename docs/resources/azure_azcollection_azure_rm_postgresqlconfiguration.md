...
page_title: "terrible_azure_azcollection_azure_rm_postgresqlconfiguration Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqlconfiguration (Resource)
...
- `state` (String) Assert the state of the PostgreSQL setting. Use `present` to update setting, or `absent` to reset to default value.
