...
page_title: "terrible_cisco_meraki_devices_live_tools_mac_table_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_live_tools_mac_table_info (Resource)
...
- `macTableId` (String) Information module for Devices Live Tools Mac Table Info. MacTableId path parameter. Mac table ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `serial` (String) Information module for Devices Live Tools Mac Table Info. Serial path parameter.
