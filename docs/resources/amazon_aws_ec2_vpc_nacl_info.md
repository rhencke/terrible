...
page_title: "terrible_amazon_aws_ec2_vpc_nacl_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_nacl_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeNetworkAcls.html for possible filters. Filter names and values are case sensitive.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `nacl_ids` (String) A list of Network ACL IDs to retrieve information about.
...
- `nacls` (String) Returns an array of complex objects as described below.
