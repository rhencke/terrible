...
page_title: "terrible_community_hashi_vault_vault_list Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_list (Resource)
...
- `path` (String) Vault path to be listed.
...
- `data` (String) The raw result of the list against the given path.
