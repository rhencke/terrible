...
page_title: "terrible_junipernetworks_junos_junos_ospfv3 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_ospfv3 (Resource)
...
- `config` (String) A list of OSPFv3 process configuration.
