...
page_title: "terrible_community_hashi_vault_vault_database_static_role_get_credentials Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_database_static_role_get_credentials (Resource)
...
- `role_name` (String) The role name from which the credentials should be retrieved.
