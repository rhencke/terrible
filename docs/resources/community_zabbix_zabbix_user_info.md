...
page_title: "terrible_community_zabbix_zabbix_user_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_user_info (Resource)
...
- `username` (String) User name. sername is the unique identifier used and cannot be updated using this module.
