...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_cp_password_requirements Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_cp_password_requirements (Resource)
...
- `min_password_length` (Number) Minimum Check Point password length. Valid values are between 4 and 99.
...
- `cp_mgmt_set_cp_password_requirements` (String) The checkpoint set-cp-password-requirements output.
