...
page_title: "terrible_netbox_netbox_netbox_console_port Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_console_port (Resource)
...
- `data` (String) Defines the console port configuration
...
- `console_port` (String) Serialized object as created or already existent within NetBox
