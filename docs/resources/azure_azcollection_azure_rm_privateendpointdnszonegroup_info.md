...
page_title: "terrible_azure_azcollection_azure_rm_privateendpointdnszonegroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_privateendpointdnszonegroup_info (Resource)
...
- `name` (String) Limit results to a single private endpoint DNS zone group.
...
- `groups` (String) List of private endpoint zone groups.
