...
page_title: "terrible_cisco_meraki_networks_sm_devices_cellular_usage_history_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sm_devices_cellular_usage_history_info (Resource)
...
- `deviceId` (String) Information module for Networks Sm Devices Cellularusagehistory Info. DeviceId path parameter. Device ID.
...
- `networkId` (String) Information module for Networks Sm Devices Cellularusagehistory Info. NetworkId path parameter. Network ID.
