...
page_title: "terrible_cisco_mso_ndo_route_map_policy_route_control Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_route_map_policy_route_control (Resource)
...
- `description` (String) The description of the Route Map Policy for Route Control.
...
- `match_type` (String) The match type of the Route Map Policy for Route Control. Defaults to `routing_policy_only` when unset during creation.
- `name` (String) The name of the Route Map Policy for Route Control.
...
- `uuid` (String) The UUID of the Route Map Policy for Route Control. This parameter is required when the `name` needs to be updated.
