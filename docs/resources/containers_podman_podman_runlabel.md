...
page_title: "terrible_containers_podman_podman_runlabel Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_runlabel (Resource)
...
- `image` (String) Image to get the label from.
- `label` (String) Label to run.
