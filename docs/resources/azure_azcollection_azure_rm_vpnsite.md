...
page_title: "terrible_azure_azcollection_azure_rm_vpnsite Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_vpnsite (Resource)
...
- `device_properties` (String) The device properties.
...
- `is_security_site` (Boolean) IsSecuritySite flag.
- `location` (String) The location of the VpnSite
- `o365_policy` (String) Office365 Policy.
...
- `state` (String) Assert the state of the VpnSite. Use `present` to create or update an VpnSite and `absent` to delete it.
...
- `virtual_wan` (String) The VirtualWAN to which the vpnSite belongs.
- `vpn_site_links` (String) List of all vpn site links.
