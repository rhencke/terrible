...
page_title: "terrible_azure_azcollection_azure_rm_sqlfirewallrule_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_sqlfirewallrule_info (Resource)
...
- `resource_group` (String) The name of the resource group that contains the server.
...
- `rules` (String) A list of dict results containing the facts for matching SQL firewall rules.
