...
page_title: "terrible_cisco_dnac_wireless_controllers_wireless_mobility_groups_mobility_reset Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_controllers_wireless_mobility_groups_mobility_reset (Resource)
...
- `networkDeviceId` (String) Network device Id of Cisco wireless controller. Obtain the network device ID value by using the API call GET - /dna/intent/api/v1/network-device/ip-address/${ipAddress}.
