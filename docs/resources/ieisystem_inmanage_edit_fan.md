...
page_title: "terrible_ieisystem_inmanage_edit_fan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_fan (Resource)
...
- `fan_speed` (Number) Fan speed (duty ratio), range in 1 - 100.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `mode` (String) Control mode, Manual or Automatic , Manual must be used with fans_peed.
