...
page_title: "terrible_cisco_dnac_sensor_test_template_duplicate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sensor_test_template_duplicate (Resource)
...
- `newTemplateName` (String) Destination test template name.
...
- `templateName` (String) Source test template name.
