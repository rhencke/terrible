...
page_title: "terrible_cisco_meraki_devices_camera_video_settings_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_video_settings_info (Resource)
...
- `serial` (String) Information module for Devices Camera Video Settings Info. Serial path parameter.
