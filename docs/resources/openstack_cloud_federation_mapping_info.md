...
page_title: "terrible_openstack_cloud_federation_mapping_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_federation_mapping_info (Resource)
...
- `name` (String) ID or name of the federation mapping.
...
- `mappings` (String) List of federation mapping dictionaries.
