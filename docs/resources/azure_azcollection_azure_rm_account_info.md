...
page_title: "terrible_azure_azcollection_azure_rm_account_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_account_info (Resource)
...
- `account_info` (String) Facts for current logged in user, equivalent to `az account show`.
