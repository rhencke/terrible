...
page_title: "terrible_community_vmware_vmware_vcenter_settings_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_vcenter_settings_info (Resource)
...
- `properties` (String) Specify the properties to retrieve. Example:    properties: [       "config.workflow.port"    ] Only valid when `schema=vsphere`.
...
- `vcenter_config_info` (String) dict of vCenter settings
