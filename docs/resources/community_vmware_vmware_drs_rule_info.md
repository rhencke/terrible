...
page_title: "terrible_community_vmware_vmware_drs_rule_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_drs_rule_info (Resource)
...
- `drs_rule_info` (String) metadata about DRS rule from given cluster / datacenter
