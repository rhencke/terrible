...
page_title: "terrible_community_aws_wafv2_rule_group_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_wafv2_rule_group_info (Resource)
...
- `capacity` (Number) Current capacity of the rule group
...
- `rules` (String) Current rules of the rule group
