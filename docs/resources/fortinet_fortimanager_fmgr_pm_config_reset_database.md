...
page_title: "terrible_fortinet_fortimanager_fmgr_pm_config_reset_database Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_fortinet_fortimanager_fmgr_pm_config_reset_database (Resource)
...
- `pm_config_reset_database` (String) The top level parameters set.
