...
page_title: "terrible_cisco_meraki_networks_traffic_analysis Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_traffic_analysis (Resource)
...
- `customPieChartItems` (String) The list of items that make up the custom pie chart for traffic reporting.
