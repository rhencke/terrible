...
page_title: "terrible_vmware_vmware_rest_appliance_health_mem_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_health_mem_info (Resource)
...
- `value` (String) Get the system mem status
