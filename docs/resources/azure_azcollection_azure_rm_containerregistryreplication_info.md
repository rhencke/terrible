...
page_title: "terrible_azure_azcollection_azure_rm_containerregistryreplication_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_containerregistryreplication_info (Resource)
...
- `replications` (String) A list of dict results where the key is the name of the Replication and the values are the facts for that Replication.
