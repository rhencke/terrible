...
page_title: "terrible_community_zabbix_zabbix_group_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_group_info (Resource)
...
- `all_hostgroups` (Boolean) return info about all hostgroups.
...
- `hostgroup_name` (String) Name of the hostgroup in Zabbix. hostgroup is the unique identifier used and cannot be updated using this module.
...
- `host_groups` (String) List of Zabbix groups.
