...
page_title: "terrible_theforeman_foreman_smart_proxy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_smart_proxy (Resource)
...
- `name` (String) Name of the Smart Proxy
- `url` (String) URL of the Smart Proxy
...
- `download_policy` (String) The download policy for the Smart Proxy Only available for Katello installations. The download policy `background` is deprecated and not available since Katello 4.3. The download policy `streamed` is available since Katello 4.5.
...
- `lifecycle_environments` (String) Lifecycle Environments synced to the Smart Proxy. Only available for Katello installations.
