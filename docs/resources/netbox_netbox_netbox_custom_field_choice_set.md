...
page_title: "terrible_netbox_netbox_netbox_custom_field_choice_set Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_custom_field_choice_set (Resource)
...
- `data` (String) Defines the choice set
...
- `custom_field_choice_set` (String) Serialized object as created/existent/updated/deleted within NetBox
