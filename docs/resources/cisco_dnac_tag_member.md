...
page_title: "terrible_cisco_dnac_tag_member Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_tag_member (Resource)
...
- `memberType` (String) Tag Member's memberType.
- `payload` (String) Map of member type and member ids.
