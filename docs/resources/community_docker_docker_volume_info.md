...
page_title: "terrible_community_docker_docker_volume_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_docker_docker_volume_info (Resource)
...
- `name` (String) Name of the volume to inspect.
...
- `exists` (Boolean) Returns whether the volume exists.
- `id` (String) Unique task resource ID
- `volume` (String) Volume inspection results for the affected volume. Will be `none` if volume does not exist.
