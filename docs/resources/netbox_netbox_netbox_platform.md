...
page_title: "terrible_netbox_netbox_netbox_platform Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_platform (Resource)
...
- `data` (String) Defines the platform configuration
...
- `platform` (String) Serialized object as created or already existent within NetBox
