...
page_title: "terrible_theforeman_foreman_compute_resource Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_compute_resource (Resource)
...
- `name` (String) compute resource name
...
- `provider` (String) Compute resource provider. Required if *state=present_with_defaults*.
- `provider_params` (String) Parameter specific to compute resource provider. Required if *state=present_with_defaults*.
