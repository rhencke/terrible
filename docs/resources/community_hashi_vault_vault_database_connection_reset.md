...
page_title: "terrible_community_hashi_vault_vault_database_connection_reset Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_database_connection_reset (Resource)
...
- `connection_name` (String) The connection name to be resetted.
