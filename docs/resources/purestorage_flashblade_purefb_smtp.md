...
page_title: "terrible_purestorage_flashblade_purefb_smtp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_smtp (Resource)
...
- `domain` (String) Domain name for alert messages
...
- `encryption` (String) Enforces an encryption mode when sending alert email messages. Use "" to clear.
