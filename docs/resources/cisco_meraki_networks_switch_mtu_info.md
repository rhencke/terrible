...
page_title: "terrible_cisco_meraki_networks_switch_mtu_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_mtu_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Mtu Info. NetworkId path parameter. Network ID.
