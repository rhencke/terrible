...
page_title: "terrible_ovirt_ovirt_ovirt_snapshot_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ovirt_ovirt_ovirt_snapshot_info (Resource)
...
- `vm` (String) Name of the VM with snapshot.
...
- `follow` (String) List of linked entities, which should be fetched along with the main entity. This parameter replaces usage of `fetch_nested` and `nested_attributes`. All follow parameters can be found at following url: https://ovirt.github.io/ovirt-engine-api-model/master/#types/snapshot/links_summary
...
- `snapshot_id` (String) Id of the snapshot we want to retrieve information about.
...
- `ovirt_snapshots` (String) List of dictionaries describing the snapshot. Snapshot attributes are mapped to dictionary keys, all snapshot attributes can be found at following url: http://ovirt.github.io/ovirt-engine-api-model/master/#types/snapshot.
