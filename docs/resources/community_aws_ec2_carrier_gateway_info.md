...
page_title: "terrible_community_aws_ec2_carrier_gateway_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_ec2_carrier_gateway_info (Resource)
...
- `carrier_gateway_ids` (String) Get details of specific Carrier Gateway ID.
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeCarrierGateways.html for possible filters.
...
- `carrier_gateways` (String) The carrier gateways for the account.
