...
page_title: "terrible_cisco_intersight_intersight_device_connector_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_device_connector_policy_info (Resource)
...
- `name` (String) The name of the Device Connector Policy to gather information from.
- `organization` (String) The name of the organization the Device Connector Policy belongs to.
