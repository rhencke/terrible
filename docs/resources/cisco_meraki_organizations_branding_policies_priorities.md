...
page_title: "terrible_cisco_meraki_organizations_branding_policies_priorities Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_branding_policies_priorities (Resource)
...
- `brandingPolicyIds` (String) An ordered list of branding policy IDs that determines the priority order of how to apply the policies.
