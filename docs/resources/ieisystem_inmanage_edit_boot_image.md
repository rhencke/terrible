...
page_title: "terrible_ieisystem_inmanage_edit_boot_image Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_boot_image (Resource)
...
- `image` (Number) BMC boot image. 0-Higher firmware version; 1-Image 1; 2-Image 2; 3-Lower firmware version; 4-Latest updated firmware; 5-Not latest updated firmware.
