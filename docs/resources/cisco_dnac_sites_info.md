...
page_title: "terrible_cisco_dnac_sites_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sites_info (Resource)
...
- `_unitsOfMeasure` (String) _unitsOfMeasure query parameter. Floor units of measure.
...
- `nameHierarchy` (String) NameHierarchy query parameter. Site name hierarchy.
