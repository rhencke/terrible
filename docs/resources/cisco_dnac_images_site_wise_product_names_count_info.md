...
page_title: "terrible_cisco_dnac_images_site_wise_product_names_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_images_site_wise_product_names_count_info (Resource)
...
- `imageId` (String) ImageId path parameter. Software image identifier. Refer `/dna/intent/api/v/images` API for obtaining `imageId`.
