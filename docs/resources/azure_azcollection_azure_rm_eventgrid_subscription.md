...
page_title: "terrible_azure_azcollection_azure_rm_eventgrid_subscription Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_eventgrid_subscription (Resource)
...
- `source_resource_id` (String) Name of a resource id where the subscription exists or will be created.
...
- `state` (String) State of the Eventgrid Event Subscription. Use `present` to create or update and `absent` to delete.
