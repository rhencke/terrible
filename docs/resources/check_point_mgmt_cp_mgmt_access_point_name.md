...
page_title: "terrible_check_point_mgmt_cp_mgmt_access_point_name Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_access_point_name (Resource)
...
- `block_traffic_other_end_user_domains` (Boolean) Block MS to MS traffic between this and other APN end user domains.
- `block_traffic_this_end_user_domain` (Boolean) Block MS to MS traffic within this end user domain.
...
- `enforce_end_user_domain` (Boolean) Enable enforce end user domain.
...
- `cp_mgmt_access_point_name` (String) The checkpoint object created or updated.
