...
page_title: "terrible_openstack_cloud_identity_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_identity_role (Resource)
...
- `role` (String) Dictionary describing the identity role.
