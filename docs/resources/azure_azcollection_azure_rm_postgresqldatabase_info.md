...
page_title: "terrible_azure_azcollection_azure_rm_postgresqldatabase_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqldatabase_info (Resource)
...
- `databases` (String) A list of dict results where the key is the name of the PostgreSQL Database and the values are the facts for that PostgreSQL Database.
