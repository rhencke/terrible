...
page_title: "terrible_cisco_nxos_nxos_vrf_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_vrf_global (Resource)
...
- `config` (String) A list containing device configurations for VRF.
