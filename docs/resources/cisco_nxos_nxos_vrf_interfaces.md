...
page_title: "terrible_cisco_nxos_nxos_vrf_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_vrf_interfaces (Resource)
...
- `config` (String) A list of interface VRF configurations.
