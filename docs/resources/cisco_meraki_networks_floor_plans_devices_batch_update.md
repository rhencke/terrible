...
page_title: "terrible_cisco_meraki_networks_floor_plans_devices_batch_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_floor_plans_devices_batch_update (Resource)
...
- `assignments` (String) List of floorplan assignments to update. Up to 100 floor plan assignments can be provided in a request.
