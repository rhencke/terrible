...
page_title: "terrible_cisco_dnac_network_applications_id_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_applications_id_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Network Applications Id Trend Analytics's aggregateAttributes.
...
- `filters` (String) Network Applications Id Trend Analytics's filters.
- `headers` (String) Additional headers.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Network Applications Id Trend Analytics's page.
