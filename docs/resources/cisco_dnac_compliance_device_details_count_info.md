...
page_title: "terrible_cisco_dnac_compliance_device_details_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_compliance_device_details_count_info (Resource)
...
- `complianceStatus` (String) ComplianceStatus query parameter. Specify "Compliance status(es)" separated by commas. The Compliance status can be 'COMPLIANT', 'NON_COMPLIANT', 'IN_PROGRESS', 'NOT_AVAILABLE', 'NOT_APPLICABLE', 'ERROR'.
