...
page_title: "terrible_check_point_mgmt_cp_mgmt_lsm_gateway Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_lsm_gateway (Resource)
...
- `device_id` (String) Device ID. Available from R81.20 management version.
- `dynamic_objects` (String) Dynamic Objects. Available from R81.20 management version.
...
- `provisioning_settings` (String) Provisioning settings.
- `provisioning_state` (String) Provisioning state. By default the state is 'manual'- enable provisioning but not attach to profile. If 'using-profile' state is provided a provisioning profile must be provided in provisioning-settings.
- `security_profile` (String) LSM profile.
- `sic` (String) Secure Internal Communication.
...
- `topology` (String) Topology. Available from R81.20 management version.
...
- `cp_mgmt_lsm_gateway` (String) The checkpoint object created or updated.
