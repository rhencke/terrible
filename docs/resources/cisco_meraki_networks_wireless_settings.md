...
page_title: "terrible_cisco_meraki_networks_wireless_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_settings (Resource)
...
- `namedVlans` (String) Named VLAN settings for wireless networks.
