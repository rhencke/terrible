...
page_title: "terrible_azure_azcollection_azure_rm_dnszone_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_dnszone_info (Resource)
...
- `azure_dnszones` (String) List of zone dicts.
- `changed` (Boolean) Whether the task reported a change
- `dnszones` (String) List of zone dicts, which share the same layout as azure_rm_dnszone module parameter.
