...
page_title: "terrible_netbox_netbox_netbox_user_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_user_group (Resource)
...
- `data` (String) Defines the user group configuration
...
- `user_group` (String) Serialized object as created or already existent within NetBox
