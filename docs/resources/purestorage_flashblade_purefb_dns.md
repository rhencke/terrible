...
page_title: "terrible_purestorage_flashblade_purefb_dns Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_dns (Resource)
...
- `domain` (String) Domain suffix to be appended when performing DNS lookups.
...
- `service` (String) The service utilizing the DNS configuration. Only aplicable when creating a new DNS configuration.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `source` (String) A virtual network interface (vip) The network interfaces must have a *service* value of *data*
