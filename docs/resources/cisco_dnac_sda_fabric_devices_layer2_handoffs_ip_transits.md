...
page_title: "terrible_cisco_dnac_sda_fabric_devices_layer2_handoffs_ip_transits Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_devices_layer2_handoffs_ip_transits (Resource)
...
- `payload` (String) Sda Fabric Devices Layer2 Handoffs Ip Transits's payload.
