...
page_title: "terrible_community_zabbix_zabbix_templategroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_templategroup (Resource)
...
- `template_groups` (String) List of template groups to create or delete.
...
- `propagate` (String) List of settings will be propagated. This module propagates permissions after creating missing template groups. This parameter is for Zabbix >= 7.0.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Create or delete template group.
