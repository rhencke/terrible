...
page_title: "terrible_community_docker_docker_compose_v2_exec Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_docker_docker_compose_v2_exec (Resource)
...
- `index` (Number) The index of the container to run the command in if the service has multiple replicas.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `privileged` (Boolean) Whether to give extended privileges to the process.
