...
page_title: "terrible_cisco_meraki_devices_live_tools_ping_device_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_live_tools_ping_device_info (Resource)
...
- `serial` (String) Information module for Devices Livetools Pingdevice Info. Serial path parameter.
