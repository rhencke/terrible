...
page_title: "terrible_cisco_dnac_dns_services_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_dns_services_query_count (Resource)
...
- `filters` (String) Dns Services Query Count's filters.
