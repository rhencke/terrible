...
page_title: "terrible_check_point_mgmt_cp_mgmt_syslog_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_syslog_server (Resource)
...
- `host` (String) Host server object identified by the name or UID.
...
- `server_version` (String) RFC version.
...
- `cp_mgmt_syslog_server` (String) The checkpoint object created or updated.
