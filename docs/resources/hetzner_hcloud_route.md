...
page_title: "terrible_hetzner_hcloud_route Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_route (Resource)
...
- `destination` (String) Destination network or host of this route.
- `gateway` (String) Gateway for the route.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `network` (String) Name or ID of the Hetzner Cloud Network.
...
- `hcloud_route` (String) One Route of a Network
