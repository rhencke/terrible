...
page_title: "terrible_azure_azcollection_azure_rm_virtualnetworkpeering_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualnetworkpeering_info (Resource)
...
- `virtual_network` (String) Name or resource ID of a virtual network.
...
- `vnetpeerings` (String) A list of Virtual Network Peering facts.
