...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_api_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_api_settings (Resource)
...
- `accepted_api_calls_from` (String) Clients allowed to connect to the API Server.
...
- `cp_mgmt_set_api_settings` (String) The checkpoint set-api-settings output.
