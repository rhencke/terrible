...
page_title: "terrible_cisco_dnac_event_webhook_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_webhook_info (Resource)
...
- `webhookIds` (String) WebhookIds query parameter. List of webhook configurations.
