...
page_title: "terrible_azure_azcollection_azure_rm_ipgroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_ipgroup_info (Resource)
...
- `ipgroups` (String) Gets a list of IP groups.
