...
page_title: "terrible_cisco_meraki_networks_syslog_servers Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_syslog_servers (Resource)
...
- `servers` (String) A list of the syslog servers for this network.
