...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_https_section Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_https_section (Resource)
...
- `cp_mgmt_show_https_section` (String) The checkpoint show-https-section output.
