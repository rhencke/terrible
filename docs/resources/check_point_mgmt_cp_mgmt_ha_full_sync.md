...
page_title: "terrible_check_point_mgmt_cp_mgmt_ha_full_sync Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_ha_full_sync (Resource)
...
- `name` (String) Peer name (Multi Domain Server, Domain Server or Security Management Server).
...
- `cp_mgmt_ha_full_sync` (String) The checkpoint ha-full-sync output.
