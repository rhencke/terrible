...
page_title: "terrible_azure_azcollection_azure_rm_containerregistrytag_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_containerregistrytag_info (Resource)
...
- `name` (String) Filter results by tags with a desired name.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `repository_name` (String) Filter results for repository within the registry. If omitted, all repositories will be retrieved.
...
- `repositories` (String) A list of dictionaries containing facts for repositories.
