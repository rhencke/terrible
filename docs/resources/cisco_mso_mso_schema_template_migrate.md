...
page_title: "terrible_cisco_mso_mso_schema_template_migrate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_migrate (Resource)
...
- `target_schema` (String) The name of the target_schema.
- `target_template` (String) The name of the target_template.
...
- `bds` (String) The name of the BDs to migrate.
...
- `epgs` (String) The name of the EPGs and the ANP it is in to migrate.
...
- `state` (String) Use `present` for adding.
