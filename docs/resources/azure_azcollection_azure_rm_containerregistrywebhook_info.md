...
page_title: "terrible_azure_azcollection_azure_rm_containerregistrywebhook_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_containerregistrywebhook_info (Resource)
...
- `webhooks` (String) A list of dict results where the key is the name of the Webhook and the values are the facts for that Webhook.
