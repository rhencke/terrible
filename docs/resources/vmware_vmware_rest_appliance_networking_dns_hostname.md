...
page_title: "terrible_vmware_vmware_rest_appliance_networking_dns_hostname Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_networking_dns_hostname (Resource)
...
- `name` (String) FQDN. This parameter is mandatory.
...
- `value` (String) Test the hostname configuration
