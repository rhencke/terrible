...
page_title: "terrible_netapp_ontap_na_ontap_cifs_local_user_set_password Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_cifs_local_user_set_password (Resource)
...
- `user_name` (String) The name of the local CIFS user to set the password for.
- `user_password` (String) The password to set for the local CIFS user.
