...
page_title: "terrible_cisco_meraki_organizations_early_access_features_opt_ins Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_early_access_features_opt_ins (Resource)
...
- `limitScopeToNetworks` (String) A list of network IDs to apply the opt-in to.
- `optInId` (String) OptInId path parameter. Opt in ID.
