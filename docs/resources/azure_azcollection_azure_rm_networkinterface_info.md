...
page_title: "terrible_azure_azcollection_azure_rm_networkinterface_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_networkinterface_info (Resource)
...
- `networkinterfaces` (String) List of network interface dicts. Each dict contains parameters can be passed to `azure.azcollection.azure_rm_networkinterface` module.
