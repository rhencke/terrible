...
page_title: "terrible_azure_azcollection_azure_rm_privatednszonelink_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_privatednszonelink_info (Resource)
...
- `virtualnetworklinks` (String) Gets a list of virtual network links dict in a Private DNS zone.
