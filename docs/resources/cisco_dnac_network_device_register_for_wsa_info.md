...
page_title: "terrible_cisco_dnac_network_device_register_for_wsa_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_register_for_wsa_info (Resource)
...
- `serialNumber` (String) SerialNumber query parameter. Serial number of the device.
