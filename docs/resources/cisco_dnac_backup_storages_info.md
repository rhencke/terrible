...
page_title: "terrible_cisco_dnac_backup_storages_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_backup_storages_info (Resource)
...
- `storageType` (String) StorageType query parameter. The `storageType` of the backup storage to be retrieved.
