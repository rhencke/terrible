...
page_title: "terrible_cisco_intersight_intersight_ethernet_adapter_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_ethernet_adapter_policy_info (Resource)
...
- `name` (String) The name of the Ethernet Adapter Policy to gather information from.
- `organization` (String) The name of the organization the Ethernet Adapter Policy belongs to. Use 'default' for the default organization.
