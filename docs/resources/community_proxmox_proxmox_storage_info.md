...
page_title: "terrible_community_proxmox_proxmox_storage_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_proxmox_proxmox_storage_info (Resource)
...
- `storage` (String) Only return information on a specific storage.
...
- `proxmox_storages` (String) List of storage pools.
