...
page_title: "terrible_community_zabbix_zabbix_hostmacro Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_hostmacro (Resource)
...
- `macro_name` (String) Name of the host macro in zabbix native format `{$MACRO}` or simple format `MACRO`.
...
- `macro_type` (String) Type of the host macro. text (default)
