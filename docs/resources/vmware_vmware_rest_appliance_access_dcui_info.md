...
page_title: "terrible_vmware_vmware_rest_appliance_access_dcui_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_access_dcui_info (Resource)
...
- `value` (Number) Check if the Direct Console User Interface is enabled
