...
page_title: "terrible_dellemc_openmanage_ome_network_vlan_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_network_vlan_info (Resource)
...
- `msg` (String) Detailed information of the network VLAN(s).
