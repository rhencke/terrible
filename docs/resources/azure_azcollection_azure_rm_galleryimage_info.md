...
page_title: "terrible_azure_azcollection_azure_rm_galleryimage_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_galleryimage_info (Resource)
...
- `gallery_name` (String) The name of the shared image gallery from which the image definitions are to be retrieved.
...
- `images` (String) A list of dict results where the key is the name of the image and the values are the info for that image.
