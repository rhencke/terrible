...
page_title: "terrible_azure_azcollection_azure_rm_postgresqlflexiblefirewallrule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqlflexiblefirewallrule (Resource)
...
- `name` (String) The name of the PostgreSQL flexible firewall rule.
...
- `end_ip_address` (String) The end IP address of the PostgreSQL flexible firewall rule. Must be IPv4 format.
...
- `start_ip_address` (String) The start IP address of the PostgreSQL flexible firewall rule. Must be IPv4 format.
- `state` (String) Assert the state of the PostgreSQL flexible firewall rule. Use `present` to create or update a PostgreSQL flexible firewall rule and `absent` to delete it.
...
- `rules` (String) A list of dictionaries containing facts for PostgreSQL Flexible Firewall Rule.
