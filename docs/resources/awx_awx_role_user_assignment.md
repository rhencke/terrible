...
page_title: "terrible_awx_awx_role_user_assignment Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_role_user_assignment (Resource)
...
- `role_definition` (String) The name or id of the role definition to assign to the user.
...
- `user` (String) The name or id of the user to assign to the object.
- `user_ansible_id` (Number) Resource id of the user who will receive permissions from this assignment. Alternative to user field.
