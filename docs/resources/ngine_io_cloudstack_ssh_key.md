...
page_title: "terrible_ngine_io_cloudstack_ssh_key Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ngine_io_cloudstack_ssh_key (Resource)
...
- `name` (String) Name of public key.
...
- `state` (String) State of the public key.
...
- `private_key` (String) Private key of generated SSH keypair.
