...
page_title: "terrible_community_general_oneview_network_set_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_oneview_network_set_info (Resource)
...
- `options` (String) List with options to gather information about Network Set. Option allowed: `withoutEthernet`. The option `withoutEthernet` retrieves the list of network_sets excluding Ethernet networks.
...
- `network_sets` (String) Has all the OneView information about the Network Sets.
