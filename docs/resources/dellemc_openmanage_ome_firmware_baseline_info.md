...
page_title: "terrible_dellemc_openmanage_ome_firmware_baseline_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_firmware_baseline_info (Resource)
...
- `baseline_info` (String) Details of the baselines.
- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `msg` (String) Overall baseline information.
