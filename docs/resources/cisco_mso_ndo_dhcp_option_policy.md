...
page_title: "terrible_cisco_mso_ndo_dhcp_option_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_dhcp_option_policy (Resource)
...
- `description` (String) The description of the DHCP Option Policy.
...
- `option_policy` (String) The name of the DHCP Option Policy.
- `option_policy_uuid` (String) The uuid of the DHCP Option Policy. This parameter is required when the `option_policy` needs to be updated.
- `options` (String) A list of options attached to the DHCP Option Policy. The list of configured options must contain at least one option. When the list of options is null the update will not change existing option configuration.
