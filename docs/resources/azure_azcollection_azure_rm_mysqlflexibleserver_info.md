...
page_title: "terrible_azure_azcollection_azure_rm_mysqlflexibleserver_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mysqlflexibleserver_info (Resource)
...
- `servers` (String) A list of dictionaries containing facts for MySQL servers.
