...
page_title: "terrible_cisco_meraki_networks_sensor_alerts_profiles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sensor_alerts_profiles (Resource)
...
- `conditions` (String) List of conditions that will cause the profile to send an alert.
...
- `recipients` (String) List of recipients that will receive the alert.
- `schedule` (String) The sensor schedule to use with the alert profile.
- `serials` (String) List of device serials assigned to this sensor alert profile.
