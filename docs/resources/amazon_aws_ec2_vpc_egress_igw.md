...
page_title: "terrible_amazon_aws_ec2_vpc_egress_igw Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_egress_igw (Resource)
...
- `vpc_id` (String) The VPC ID for the VPC that this Egress Only Internet Gateway should be attached.
...
- `state` (String) Create or delete the EIGW.
...
- `gateway_id` (String) The ID of the Egress Only Internet Gateway or Null.
