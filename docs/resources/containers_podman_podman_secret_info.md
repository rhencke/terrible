...
page_title: "terrible_containers_podman_podman_secret_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_secret_info (Resource)
...
- `showsecret` (Boolean) Show secret data value
...
- `secrets` (String) Facts from all or specified secrets
