...
page_title: "terrible_cisco_nxos_nxos_logging_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_logging_global (Resource)
...
- `config` (String) A dictionary of logging configuration.
