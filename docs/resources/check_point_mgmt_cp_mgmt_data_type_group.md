...
page_title: "terrible_check_point_mgmt_cp_mgmt_data_type_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_data_type_group (Resource)
...
- `file_content` (String) List of Data Types, identified by name or UID. At least one must be matched.
- `file_type` (String) List of data-types-file-attributes objects. Identified by name or UID.
...
- `cp_mgmt_data_type_group` (String) The checkpoint object created or updated.
