...
page_title: "terrible_theforeman_foreman_subnet_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_subnet_info (Resource)
...
- `subnet` (String) Details about the found subnet
- `subnets` (String) List of all found subnets and their details
