...
page_title: "terrible_ngine_io_cloudstack_configuration_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ngine_io_cloudstack_configuration_info (Resource)
...
- `name` (String) Name of the configuration. If not specified, information about all configurations is gathered.
...
- `configurations` (String) A list of matching configurations.
