...
page_title: "terrible_junipernetworks_junos_junos_ospfv2 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_ospfv2 (Resource)
...
- `config` (String) A list of OSPFv2 process configuration.
