...
page_title: "terrible_telekom_mms_icinga_director_icinga_servicegroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_telekom_mms_icinga_director_icinga_servicegroup (Resource)
...
- `object_name` (String) Name for the Icinga servicegroup.
