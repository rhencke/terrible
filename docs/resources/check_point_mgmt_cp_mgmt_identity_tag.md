...
page_title: "terrible_check_point_mgmt_cp_mgmt_identity_tag Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_identity_tag (Resource)
...
- `external_identifier` (String) External identifier. For example, Cisco ISE security group tag.
...
- `cp_mgmt_identity_tag` (String) The checkpoint object created or updated.
