...
page_title: "terrible_community_general_gitlab_branch Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_gitlab_branch (Resource)
...
- `branch` (String) The name of the branch that needs to be created.
...
- `state` (String) Create or delete branch.
