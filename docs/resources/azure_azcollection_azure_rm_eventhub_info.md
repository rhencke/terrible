...
page_title: "terrible_azure_azcollection_azure_rm_eventhub_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_eventhub_info (Resource)
...
- `state` (String) Current state of the Event Hub namesapce or Event Hub.
