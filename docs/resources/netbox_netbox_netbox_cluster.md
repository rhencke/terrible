...
page_title: "terrible_netbox_netbox_netbox_cluster Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_cluster (Resource)
...
- `data` (String) Defines the cluster configuration
...
- `cluster` (String) Serialized object as created or already existent within NetBox
