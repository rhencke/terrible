...
page_title: "terrible_cisco_dnac_events_and_notifications_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_events_and_notifications_workflow_manager (Resource)
...
- `config` (String) List containing the subscription configuration for events, notification on site through one or more channels.
