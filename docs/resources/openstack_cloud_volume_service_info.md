...
page_title: "terrible_openstack_cloud_volume_service_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_volume_service_info (Resource)
...
- `volume_services` (String) List of dictionaries describing Volume (Cinder) services.
