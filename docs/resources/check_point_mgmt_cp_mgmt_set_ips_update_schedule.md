...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_ips_update_schedule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_ips_update_schedule (Resource)
...
- `enabled` (Boolean) Enable/Disable IPS Update Schedule.
...
- `cp_mgmt_set_ips_update_schedule` (String) The checkpoint set-ips-update-schedule output.
