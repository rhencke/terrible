...
page_title: "terrible_cisco_meraki_devices_wireless_bluetooth_settings_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_wireless_bluetooth_settings_info (Resource)
...
- `serial` (String) Information module for Devices Wireless Bluetooth Settings Info. Serial path parameter.
