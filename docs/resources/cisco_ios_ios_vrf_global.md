...
page_title: "terrible_cisco_ios_ios_vrf_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_vrf_global (Resource)
...
- `config` (String) A dictionary containing device configurations for VRF, including a list of VRF definitions.
