...
page_title: "terrible_theforeman_foreman_compute_attribute Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_compute_attribute (Resource)
...
- `compute_profile` (String) Name of compute profile
- `compute_resource` (String) Name of compute resource
...
- `vm_attrs` (String) Hash containing the data of vm_attrs
