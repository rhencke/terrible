...
page_title: "terrible_azure_azcollection_azure_rm_gallery_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_gallery_info (Resource)
...
- `galleries` (String) A list of dict results where the key is the name of the gallery and the values are the info for that gallery.
