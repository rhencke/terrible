...
page_title: "terrible_azure_azcollection_azure_rm_storageaccountmanagementpolicy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_storageaccountmanagementpolicy (Resource)
...
- `rules` (String) The Storage Account ManagementPolicies Rules.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) State of the storage account managed policy. Use `present` add or update the policy rule. Use `absent` to delete all policy rules.
