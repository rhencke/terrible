...
page_title: "terrible_community_vmware_vmware_local_role_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_local_role_info (Resource)
...
- `local_role_info` (String) A list of dict about role information present on ESXi host
