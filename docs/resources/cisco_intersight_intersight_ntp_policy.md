...
page_title: "terrible_cisco_intersight_intersight_ntp_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_ntp_policy (Resource)
...
- `enable` (Boolean) Enable or disable NTP.
...
- `ntp_servers` (String) List of NTP servers configured on the endpoint.
