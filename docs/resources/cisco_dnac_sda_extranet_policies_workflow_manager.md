...
page_title: "terrible_cisco_dnac_sda_extranet_policies_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_extranet_policies_workflow_manager (Resource)
...
- `config` (String) List of Extranet Policy Details for Creating, Updating, or Deleting Operations.
