...
page_title: "terrible_lowlydba_sqlserver_login_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_lowlydba_sqlserver_login_role (Resource)
...
- `login` (String) Name of the login.
- `server_role` (String) The server role for the login to be modified.
...
- `data` (String) Output from the `Remove-DbaServerRoleMember`, (Get-DbaServerRoleMember), or `Add-DbaServerRoleMember` functions.
