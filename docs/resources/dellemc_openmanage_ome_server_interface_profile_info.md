...
page_title: "terrible_dellemc_openmanage_ome_server_interface_profile_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_server_interface_profile_info (Resource)
...
- `device_id` (String) The ID of the device. *device_id* is mutually exclusive with *device_service_tag*.
- `device_service_tag` (String) The service tag of the device. *device_service_tag* is mutually exclusive with *device_id*.
...
- `msg` (String) Overall status of the server interface profile information.
- `server_profiles` (String) Returns the information of collected server interface profile information.
