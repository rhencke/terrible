...
page_title: "terrible_amazon_aws_backup_plan_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_backup_plan_info (Resource)
...
- `backup_plan_names` (String) Specifies a list of plan names.
...
- `backup_plans` (String) List of backup plan objects. List elements are dict with the information about backup plan.
