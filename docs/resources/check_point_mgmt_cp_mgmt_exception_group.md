...
page_title: "terrible_check_point_mgmt_cp_mgmt_exception_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_exception_group (Resource)
...
- `applied_profile` (String) The threat profile to apply this group to in the case of apply-on threat-rules-with-specific-profile. Available from R80.10 management version.
- `applied_threat_rules` (String) The threat rules to apply this group on in the case of apply-on manually-select-threat-rules. Available from R80.10 management version.
- `apply_on` (String) An exception group can be set to apply on all threat rules, all threat rules which have a specific profile, or those rules manually chosen by the user. Available from R80.10 management version.
...
- `cp_mgmt_exception_group` (String) The checkpoint object created or updated.
