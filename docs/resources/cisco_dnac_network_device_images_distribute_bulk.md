...
page_title: "terrible_cisco_dnac_network_device_images_distribute_bulk Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_images_distribute_bulk (Resource)
...
- `payload` (String) Network Device Images Distribute Bulk's payload.
