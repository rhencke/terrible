...
page_title: "terrible_arista_eos_eos_vrf_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_arista_eos_eos_vrf_global (Resource)
...
- `config` (String) A list of dictionaries containing device configurations for VRF definitions.
