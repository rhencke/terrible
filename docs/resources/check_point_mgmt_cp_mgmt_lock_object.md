...
page_title: "terrible_check_point_mgmt_cp_mgmt_lock_object Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_lock_object (Resource)
...
- `cp_mgmt_lock_object` (String) The checkpoint lock-object output.
