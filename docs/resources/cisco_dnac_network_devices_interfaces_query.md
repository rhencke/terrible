...
page_title: "terrible_cisco_dnac_network_devices_interfaces_query Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_devices_interfaces_query (Resource)
...
- `deviceId` (String) DeviceId path parameter. Network Device Id.
...
- `query` (String) Network Devices Interfaces Query's query.
