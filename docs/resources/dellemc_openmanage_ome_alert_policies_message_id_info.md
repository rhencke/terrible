...
page_title: "terrible_dellemc_openmanage_ome_alert_policies_message_id_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_alert_policies_message_id_info (Resource)
...
- `message_ids` (String) Details of the message ids.
- `msg` (String) Status of the alert policies message ids fetch operation.
