...
page_title: "terrible_kaytus_ksmanage_edit_network_bond Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_kaytus_ksmanage_edit_network_bond (Resource)
...
- `auto_config` (String) Enable this option to configure the interfaces in service configuration automatically.
