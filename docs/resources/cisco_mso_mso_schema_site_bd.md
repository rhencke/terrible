...
page_title: "terrible_cisco_mso_mso_schema_site_bd Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_site_bd (Resource)
...
- `host_route` (Boolean) Whether host-based routing is enabled.
