...
page_title: "terrible_cisco_meraki_networks_wireless_alternate_management_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_alternate_management_interface (Resource)
...
- `protocols` (String) Can be one or more of the following values 'radius', 'snmp', 'syslog' or 'ldap'.
...
- `vlanId` (Number) Alternate management interface VLAN, must be between 1 and 4094.
