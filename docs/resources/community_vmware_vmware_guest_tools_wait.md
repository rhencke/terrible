...
page_title: "terrible_community_vmware_vmware_guest_tools_wait Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_guest_tools_wait (Resource)
...
- `datacenter` (String) Name of the datacenter. The datacenter to search for a virtual machine.
...
- `name_match` (String) If multiple VMs match the name, use the first or last found.
