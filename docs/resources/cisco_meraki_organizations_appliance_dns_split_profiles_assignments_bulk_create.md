...
page_title: "terrible_cisco_meraki_organizations_appliance_dns_split_profiles_assignments_bulk_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_appliance_dns_split_profiles_assignments_bulk_create (Resource)
...
- `items` (String) List containing the network ID and Profile ID.
