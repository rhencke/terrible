...
page_title: "terrible_openstack_cloud_project Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_project (Resource)
...
- `name` (String) Name for the project. This attribute cannot be updated.
...
- `domain` (String) Domain name or id to create the project in if the cloud supports domains.
- `environment` (String) Environment variables set for the task (dict of name→value).
- `extra_specs` (String) Additional properties to be associated with this project.
...
- `is_enabled` (Boolean) Whether this project is enabled or not.
...
- `project` (String) Dictionary describing the project.
