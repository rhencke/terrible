...
page_title: "terrible_netapp_storagegrid_na_sg_grid_domain_name Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_domain_name (Resource)
...
- `domain_name` (String) List of domain names to be configured.
...
- `state` (String) The endpoint domain name should be present.
...
- `resp` (String) Returns information about the StorageGRID domain name.
