...
page_title: "terrible_netbox_netbox_netbox_mac_address Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_mac_address (Resource)
...
- `data` (String) Defines the MAC address configuration
...
- `mac_address` (String) Serialized object as created or already existent within NetBox
