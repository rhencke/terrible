...
page_title: "terrible_vmware_vmware_rest_appliance_update_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_update_info (Resource)
...
- `value` (String) Check if the system is up to date
