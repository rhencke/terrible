...
page_title: "terrible_cisco_meraki_organizations_appliance_security_intrusion Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_appliance_security_intrusion (Resource)
...
- `allowedRules` (String) Sets a list of specific SNORT signatures to allow.
