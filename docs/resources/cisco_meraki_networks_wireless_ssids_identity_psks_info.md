...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_identity_psks_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_identity_psks_info (Resource)
...
- `identityPskId` (String) Information module for Networks Wireless Ssids Identitypsks Info. IdentityPskId path parameter. Identity psk ID.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `networkId` (String) Information module for Networks Wireless Ssids Identitypsks Info. NetworkId path parameter. Network ID.
- `number` (String) Information module for Networks Wireless Ssids Identitypsks Info. Number path parameter.
