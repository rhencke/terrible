...
page_title: "terrible_community_general_keycloak_clientsecret_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_keycloak_clientsecret_info (Resource)
...
- `clientsecret_info` (String) Representation of the client secret.
- `id` (String) Unique task resource ID
- `msg` (String) Textual description of whether we succeeded or failed.
