...
page_title: "terrible_community_proxmox_proxmox_group_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_proxmox_proxmox_group_info (Resource)
...
- `group` (String) Restrict results to a specific group.
...
- `proxmox_groups` (String) List of groups.
