...
page_title: "terrible_netapp_cloudmanager_na_cloudmanager_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_cloudmanager_na_cloudmanager_info (Resource)
...
- `gather_subsets` (String) When supplied, this argument will restrict the information collected to a given subset. Possible values for this argument include working_environments_info aggregates_info accounts_info account_info agents_info active_agents_info
...
- `info` (String) a dictionary of collected subsets each subset if in JSON format
