...
page_title: "terrible_fortinet_fortimanager_fmgr_devprof_import Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_fortinet_fortimanager_fmgr_devprof_import (Resource)
...
- `devprof_import` (String) The top level parameters set.
