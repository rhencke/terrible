...
page_title: "terrible_amazon_aws_ec2_vpc_endpoint_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_endpoint_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcEndpoints.html for possible filters.
...
- `vpc_endpoint_ids` (String) The IDs of specific endpoints to retrieve the details of.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `vpc_endpoints` (String) A list of matching endpoints.
