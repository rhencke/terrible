...
page_title: "terrible_cisco_dnac_authentication_import_certificate_p12 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_authentication_import_certificate_p12 (Resource)
...
- `listOfUsers` (String) ListOfUsers query parameter. Specify whether the certificate will be used for controller ("server"), disaster recovery ("ipsec") or both ("server, ipsec"). If no value is provided, the default value taken will be "server".
- `p12FilePath` (String) P12 file absolute path.
- `p12Password` (String) P12Password query parameter. The password for PKCS12 certificate bundle.
- `pkPassword` (String) PkPassword query parameter. Password for encrypted private key.
