...
page_title: "terrible_community_hashi_vault_vault_read Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_read (Resource)
...
- `path` (String) Vault path to be read.
...
- `data` (String) The raw result of the read against the given path.
