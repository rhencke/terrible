...
page_title: "terrible_google_cloud_gcp_iam_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_iam_role (Resource)
...
- `included_permissions` (String) Names of permissions this role grants when bound in an IAM policy.
...
- `includedPermissions` (String) Names of permissions this role grants when bound in an IAM policy.
