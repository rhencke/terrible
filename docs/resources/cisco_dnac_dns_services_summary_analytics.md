...
page_title: "terrible_cisco_dnac_dns_services_summary_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_dns_services_summary_analytics (Resource)
...
- `aggregateAttributes` (String) Dns Services Summary Analytics's aggregateAttributes.
...
- `filters` (String) Dns Services Summary Analytics's filters.
...
- `page` (String) Dns Services Summary Analytics's page.
