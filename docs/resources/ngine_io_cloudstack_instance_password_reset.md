...
page_title: "terrible_ngine_io_cloudstack_instance_password_reset Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ngine_io_cloudstack_instance_password_reset (Resource)
...
- `vm` (String) Name of the virtual machine to reset the password on.
- `zone` (String) Name of the zone in which the instance is deployed.
...
- `password` (String) The new default password.
