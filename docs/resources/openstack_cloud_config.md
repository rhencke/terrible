...
page_title: "terrible_openstack_cloud_config Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_config (Resource)
...
- `clouds` (String) List of clouds to limit the return list to. When *clouds* is not defined, then data is returned for all configured clouds.
