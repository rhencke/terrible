...
page_title: "terrible_netbox_netbox_netbox_console_server_port Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_console_server_port (Resource)
...
- `data` (String) Defines the console server port configuration
...
- `console_server_port` (String) Serialized object as created or already existent within NetBox
