...
page_title: "terrible_cisco_dnac_business_sda_hostonboarding_ssid_ippool_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_business_sda_hostonboarding_ssid_ippool_info (Resource)
...
- `siteNameHierarchy` (String) SiteNameHierarchy query parameter. Site Name Heirarchy.
...
- `vlanName` (String) VlanName query parameter. VLAN Name.
