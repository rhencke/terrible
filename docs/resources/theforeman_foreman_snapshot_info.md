...
page_title: "terrible_theforeman_foreman_snapshot_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_snapshot_info (Resource)
...
- `snapshot` (String) Details about the first found snapshot with searched name
- `snapshots` (String) List of all snapshots and their details for a host
