...
page_title: "terrible_cisco_dnac_health_score_definitions_bulk_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_health_score_definitions_bulk_update (Resource)
...
- `payload` (String) Health Score Definitions Bulk Update's payload.
