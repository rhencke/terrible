...
page_title: "terrible_check_point_mgmt_cp_mgmt_task_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_task_facts (Resource)
...
- `order` (String) Sorts results by the given field. By default the results are sorted in the descending order by the task's last update date. This parameter is relevant only for getting few objects.
...
- `task_id` (String) Unique identifier of one or more tasks.
