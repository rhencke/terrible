...
page_title: "terrible_community_vmware_vmware_guest_vgpu_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_guest_vgpu_info (Resource)
...
- `vgpu_info` (String) metadata about the virtual machine's vGPU profiles
