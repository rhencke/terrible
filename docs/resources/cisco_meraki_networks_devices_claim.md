...
page_title: "terrible_cisco_meraki_networks_devices_claim Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_devices_claim (Resource)
...
- `detailsByDevice` (String) Optional details for claimed devices (currently only used for Catalyst devices).
