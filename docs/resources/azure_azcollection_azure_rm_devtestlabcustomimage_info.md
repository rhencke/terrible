...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabcustomimage_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabcustomimage_info (Resource)
...
- `custom_images` (String) A list of dictionaries containing facts for Custom Image.
