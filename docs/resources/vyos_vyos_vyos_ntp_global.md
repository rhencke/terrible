...
page_title: "terrible_vyos_vyos_vyos_ntp_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_ntp_global (Resource)
...
- `config` (String) List of configurations for ntp module
