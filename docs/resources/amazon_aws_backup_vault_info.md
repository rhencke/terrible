...
page_title: "terrible_amazon_aws_backup_vault_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_backup_vault_info (Resource)
...
- `backup_vault_names` (String) Specifies a list of vault names. If an empty list is specified, information for the backup vaults in the current region is returned.
...
- `backup_vaults` (String) List of backup vault objects. Each element consists of a dict with all the information related to that backup vault.
