...
page_title: "terrible_cisco_nxos_nxos_rollback Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_rollback (Resource)
...
- `filename` (String) The filename of the checkpoint/rollback file.
- `id` (String) Unique task resource ID
- `status` (String) Which operation took place and whether it was successful.
