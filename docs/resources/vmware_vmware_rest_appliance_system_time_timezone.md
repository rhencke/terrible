...
page_title: "terrible_vmware_vmware_rest_appliance_system_time_timezone Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_system_time_timezone (Resource)
...
- `name` (String) Time zone name. This parameter is mandatory.
...
- `value` (String) Use the UTC timezone
