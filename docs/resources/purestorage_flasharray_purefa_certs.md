...
page_title: "terrible_purestorage_flasharray_purefa_certs Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_certs (Resource)
...
- `certificate` (String) Required for *import* A valid signed certicate in PEM format (Base64 encoded) Includes the "-----BEGIN CERTIFICATE-----" and "-----END CERTIFICATE-----" lines
