...
page_title: "terrible_cisco_meraki_organizations_devices_packet_capture_schedules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_devices_packet_capture_schedules (Resource)
...
- `scheduleId` (String) ScheduleId path parameter. Schedule ID.
