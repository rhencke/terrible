...
page_title: "terrible_community_windows_win_psscript_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_windows_win_psscript_info (Resource)
...
- `name` (String) The name of the script. Supports any wildcard pattern supported by `Get-InstalledScript`. If omitted then all scripts will returned.
...
- `scripts` (String) A list of installed scripts (or an empty list is there are none).
