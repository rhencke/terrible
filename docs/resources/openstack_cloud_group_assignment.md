...
page_title: "terrible_openstack_cloud_group_assignment Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_group_assignment (Resource)
...
- `group` (String) Name or ID for the group.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `user` (String) Name or ID for the user.
...
- `state` (String) Should the user be present or absent in the group.
