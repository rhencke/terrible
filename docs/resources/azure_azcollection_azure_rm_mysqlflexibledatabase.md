...
page_title: "terrible_azure_azcollection_azure_rm_mysqlflexibledatabase Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mysqlflexibledatabase (Resource)
...
- `server_name` (String) The name of the flexible server.
...
- `state` (String) Assert the state of the MySQL Flexible Database. Use `present` to createe a database and `absent` to delete it.
