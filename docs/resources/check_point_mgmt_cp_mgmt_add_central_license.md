...
page_title: "terrible_check_point_mgmt_cp_mgmt_add_central_license Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_add_central_license (Resource)
...
- `license` (String) The license string received from the User Center - without 'cplic put'.
...
- `cp_mgmt_add_central_license` (String) The checkpoint add-central-license output.
