...
page_title: "terrible_theforeman_foreman_content_view_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_content_view_info (Resource)
...
- `content_view` (String) Details about the found content_view
- `content_views` (String) List of all found content_views and their details
