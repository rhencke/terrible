...
page_title: "terrible_infinidat_infinibox_infini_map Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infinidat_infinibox_infini_map (Resource)
...
- `state` (String) Creates mapping when present or removes when absent, or provides details of a mapping when stat.
