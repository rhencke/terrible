...
page_title: "terrible_cisco_meraki_networks_sm_target_groups_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sm_target_groups_info (Resource)
...
- `networkId` (String) Information module for Networks Sm Targetgroups Info. NetworkId path parameter. Network ID.
...
- `targetGroupId` (String) Information module for Networks Sm Targetgroups Info. TargetGroupId path parameter. Target group ID.
- `timeout` (Number) Override the default execution timeout (seconds). Defaults to 300.
- `triggers` (String) Arbitrary map of values; any change triggers task re-execution
- `withDetails` (Boolean) Information module for Networks Sm Targetgroups Info. WithDetails query parameter. Boolean indicating if the the ids of the devices or users scoped by the target group should be included in the response.
