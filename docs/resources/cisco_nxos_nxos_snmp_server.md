...
page_title: "terrible_cisco_nxos_nxos_snmp_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_snmp_server (Resource)
...
- `config` (String) A dict of SNMP server configuration
