...
page_title: "terrible_cisco_meraki_networks_wireless_air_marshal_rules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_air_marshal_rules (Resource)
...
- `match` (String) Object describing the rule specification.
...
- `ruleId` (String) RuleId path parameter. Rule ID.
