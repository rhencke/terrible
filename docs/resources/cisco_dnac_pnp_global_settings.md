...
page_title: "terrible_cisco_dnac_pnp_global_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_pnp_global_settings (Resource)
...
- `defaultProfile` (String) Pnp Global Settings's defaultProfile.
...
- `savaMappingList` (String) Pnp Global Settings's savaMappingList.
