...
page_title: "terrible_vyos_vyos_vyos_static_routes Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_static_routes (Resource)
...
- `config` (String) A provided static route configuration.
