...
page_title: "terrible_check_point_mgmt_cp_mgmt_add_nat_rule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_add_nat_rule (Resource)
...
- `cp_mgmt_add_nat_rule` (String) The checkpoint add-nat-rule output.
