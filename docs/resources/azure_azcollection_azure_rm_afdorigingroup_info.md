...
page_title: "terrible_azure_azcollection_azure_rm_afdorigingroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_afdorigingroup_info (Resource)
...
- `name` (String) Limit results to a specific AFD OriginGroup.
...
- `afdorigingroups` (String) List of AFD OriginGroups.
