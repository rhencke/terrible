...
page_title: "terrible_community_hrobot_reset_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hrobot_reset_info (Resource)
...
- `server_number` (Number) The server number of the server to query its resetter.
...
- `reset` (String) Information on the server's resetter.
