...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_cloud_licenses_usage Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_cloud_licenses_usage (Resource)
...
- `cp_mgmt_show_cloud_licenses_usage` (String) The checkpoint show-cloud-licenses-usage output.
