...
page_title: "terrible_add_host Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_add_host (Resource)
...
- `name` (String) The hostname/ip of the host to add to the inventory, can include a colon and a port number.
...
- `groups` (String) The groups to add the hostname to.
