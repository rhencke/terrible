...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_last_published_session Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_last_published_session (Resource)
...
- `cp_mgmt_show_last_published_session` (String) The checkpoint show-last-published-session output.
