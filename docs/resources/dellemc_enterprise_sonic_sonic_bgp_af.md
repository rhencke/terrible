...
page_title: "terrible_dellemc_enterprise_sonic_sonic_bgp_af Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_bgp_af (Resource)
...
- `config` (String) Specifies the BGP_AF related configuration.
...
- `state` (String) Specifies the operation to be performed on the BGP_AF process configured on the device. In case of merged, the input configuration is merged with the existing BGP_AF configuration on the device. In case of deleted, the existing BGP_AF configuration is removed from the device. In case of replaced, the existing BGP_AF of specified BGP AS will be replaced with provided configuration. In case of overridden, the existing BGP_AF configuration will be overridden with the provided configuration.
