...
page_title: "terrible_grafana_grafana_datasource Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_grafana_grafana_datasource (Resource)
...
- `dataSource` (String) JSON source code for the Data source.
- `grafana_api_key` (String) Grafana API Key to authenticate with Grafana Cloud.
...
- `state` (String) State for the Grafana Datasource.
...
- `output` (String) Dict object containing Data source information.
