...
page_title: "terrible_cisco_dnac_wireless_settings_power_profiles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_power_profiles (Resource)
...
- `profileName` (String) Name of the Power Profile. Max allowed characters is 128.
- `rules` (String) Wireless Settings Power Profiles's rules.
