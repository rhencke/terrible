...
page_title: "terrible_community_hashi_vault_vault_write Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_write (Resource)
...
- `path` (String) Vault path to be written to.
...
- `data` (String) A dictionary to be serialized to JSON and then sent as the request body. If the dictionary contains keys named `path` or `wrap_ttl`, the call will fail with `hvac<1.2`.
