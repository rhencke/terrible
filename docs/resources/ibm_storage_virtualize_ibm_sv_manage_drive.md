...
page_title: "terrible_ibm_storage_virtualize_ibm_sv_manage_drive Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ibm_storage_virtualize_ibm_sv_manage_drive (Resource)
...
- `drive_id` (Number) Specifies the drive id.
...
- `drive_state` (String) Specifies the desired usability state of the drive.
...
- `task` (String) Specifies a task to be performed on drive.
