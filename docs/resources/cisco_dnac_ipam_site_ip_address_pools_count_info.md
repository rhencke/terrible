...
page_title: "terrible_cisco_dnac_ipam_site_ip_address_pools_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_ipam_site_ip_address_pools_count_info (Resource)
...
- `siteId` (String) SiteId query parameter. The `id` of the site for which to retrieve IP address subpools. Only subpools whose `siteId` matches will be counted.
