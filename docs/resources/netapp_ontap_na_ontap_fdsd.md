...
page_title: "terrible_netapp_ontap_na_ontap_fdsd Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_fdsd (Resource)
...
- `name` (String) Specifies the name of the security descriptor.
- `vserver` (String) Specifies the vserver.
...
- `state` (String) Whether the specified security descriptor should exist or not.
