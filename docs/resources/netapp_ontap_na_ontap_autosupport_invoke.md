...
page_title: "terrible_netapp_ontap_na_ontap_autosupport_invoke Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_autosupport_invoke (Resource)
...
- `autosupport_message` (String) Text sent in the subject line of the AutoSupport message. message is deprecated and will be removed to avoid a conflict with an Ansible internal variable.
...
- `type` (String) Type of AutoSupport Collection to Issue.
