...
page_title: "terrible_cisco_intersight_intersight_boot_order_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_boot_order_policy_info (Resource)
...
- `name` (String) The name of the Boot Order Policy to gather information from.
- `organization` (String) The name of the organization the Boot Order Policy belongs to.
