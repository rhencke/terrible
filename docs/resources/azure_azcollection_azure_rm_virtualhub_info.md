...
page_title: "terrible_azure_azcollection_azure_rm_virtualhub_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualhub_info (Resource)
...
- `virtual_hubs` (String) A list of dict results where the key is the name of the VirtualHub and the values are the facts for that VirtualHub.
