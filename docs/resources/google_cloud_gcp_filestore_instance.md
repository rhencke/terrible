...
page_title: "terrible_google_cloud_gcp_filestore_instance Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_filestore_instance (Resource)
...
- `file_shares` (String) File system shares on the instance. For this version, only a single file share is supported.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `name` (String) The resource name of the instance.
- `networks` (String) VPC networks to which the instance is connected. For this version, only a single network is supported.
- `tier` (String) The service tier of the instance. Some valid choices include: "TIER_UNSPECIFIED", "STANDARD", "PREMIUM", "BASIC_HDD", "BASIC_SSD", "HIGH_SCALE_SSD"
- `zone` (String) The name of the Filestore zone of the instance.
...
- `createTime` (String) Creation timestamp in RFC3339 text format.
- `etag` (String) Server-specified ETag for the instance resource to prevent simultaneous updates from overwriting each other.
- `fileShares` (String) File system shares on the instance. For this version, only a single file share is supported.
