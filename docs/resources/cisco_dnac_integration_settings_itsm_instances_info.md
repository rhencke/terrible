...
page_title: "terrible_cisco_dnac_integration_settings_itsm_instances_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_integration_settings_itsm_instances_info (Resource)
...
- `sortBy` (String) SortBy query parameter. The field name used to sort the records.
