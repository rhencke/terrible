...
page_title: "terrible_vmware_vmware_rest_appliance_access_ssh_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_access_ssh_info (Resource)
...
- `value` (Number) Check is the SSH access is enabled
