...
page_title: "terrible_cisco_meraki_organizations_wireless_location_scanning_receivers Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_wireless_location_scanning_receivers (Resource)
...
- `network` (String) Add scanning API receiver for network.
...
- `radio` (String) Add scanning API Radio.
- `receiverId` (String) ReceiverId path parameter. Receiver ID.
