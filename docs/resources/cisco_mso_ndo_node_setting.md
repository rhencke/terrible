...
page_title: "terrible_cisco_mso_ndo_node_setting Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_node_setting (Resource)
...
- `description` (String) The description of the Fabric Policy Node Settings.
...
- `name` (String) The name of the Fabric Policy Node Settings.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `ptp` (String) The Precision Time Protocol (PTP) of the Fabric Policy Node Settings.
...
- `synce` (String) The Synchronous Ethernet (SyncE) Interface Policy of the Fabric Policy Node Settings.
...
- `uuid` (String) The UUID of the Fabric Policy Node Settings. This parameter is required when the `name` needs to be updated.
