...
page_title: "terrible_azure_azcollection_azure_rm_iothubconsumergroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_iothubconsumergroup (Resource)
...
- `event_hub` (String) Event hub endpoint name.
