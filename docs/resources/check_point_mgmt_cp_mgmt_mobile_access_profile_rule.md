...
page_title: "terrible_check_point_mgmt_cp_mgmt_mobile_access_profile_rule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_mobile_access_profile_rule (Resource)
...
- `mobile_profile` (String) Profile configuration for User groups - identified by the name or UID.
...
- `user_groups` (String) User groups that will be configured with the profile object - identified by the name or UID.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `cp_mgmt_mobile_access_profile_rule` (String) The checkpoint object created or updated.
