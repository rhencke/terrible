...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_logs Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_logs (Resource)
...
- `ignore_warnings` (Boolean) Ignore warnings if exist.
- `new_query` (String) Running a new query.
...
- `cp_mgmt_show_logs` (String) The checkpoint show-logs output.
