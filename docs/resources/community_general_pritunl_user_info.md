...
page_title: "terrible_community_general_pritunl_user_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_pritunl_user_info (Resource)
...
- `users` (String) List of Pritunl users.
