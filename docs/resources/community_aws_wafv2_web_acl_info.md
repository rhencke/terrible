...
page_title: "terrible_community_aws_wafv2_web_acl_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_wafv2_web_acl_info (Resource)
...
- `scope` (String) Scope of wafv2 web acl.
...
- `rules` (String) Current rules of the web acl
