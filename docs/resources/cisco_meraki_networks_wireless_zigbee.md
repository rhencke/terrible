...
page_title: "terrible_cisco_meraki_networks_wireless_zigbee Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_zigbee (Resource)
...
- `defaults` (String) Default Settings for Zigbee Devices.
...
- `iotController` (String) Zigbee's IoT controller details.
- `lockManagement` (String) Login Credentials of on-premises lock management.
