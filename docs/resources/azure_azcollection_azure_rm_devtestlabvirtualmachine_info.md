...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabvirtualmachine_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabvirtualmachine_info (Resource)
...
- `virtualmachines` (String) A list of dictionaries containing facts for DevTest Lab Virtual Machine.
