...
page_title: "terrible_check_point_mgmt_cp_mgmt_service_sctp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_service_sctp (Resource)
...
- `source_port` (String) Source port number. To specify a port range add a hyphen between the lowest and the highest port numbers, for example 44-45.
...
- `cp_mgmt_service_sctp` (String) The checkpoint object created or updated.
