...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_l3_firewall_rules_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_l3_firewall_rules_info (Resource)
...
- `networkId` (String) Information module for Networks Appliance Firewall L3Firewallrules Info. NetworkId path parameter. Network ID.
