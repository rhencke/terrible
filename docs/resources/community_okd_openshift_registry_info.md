...
page_title: "terrible_community_okd_openshift_registry_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_okd_openshift_registry_info (Resource)
...
- `check` (Boolean) Attempt to contact the integrated registry using local client.
...
- `internal_hostname` (String) The internal registry hostname.
- `public_hostname` (String) The public registry hostname.
