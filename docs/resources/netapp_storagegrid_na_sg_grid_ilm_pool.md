...
page_title: "terrible_netapp_storagegrid_na_sg_grid_ilm_pool Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_ilm_pool (Resource)
...
- `name` (String) The name of the storage pool Must be unique

### Optional

- `archives` (String) A list of the sites that use the Archive Nodes storage grade
...
- `disks` (String) A list of the sites and storage grades in the storage pool
...
- `state` (String) Whether the specified pool should be created or deleted.
...
- `resp` (String) Returns information about the StorageGRID ILM pool.
