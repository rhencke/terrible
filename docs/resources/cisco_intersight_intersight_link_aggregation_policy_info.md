...
page_title: "terrible_cisco_intersight_intersight_link_aggregation_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_link_aggregation_policy_info (Resource)
...
- `name` (String) The name of the Link Aggregation Policy to gather information from.
- `organization` (String) The name of the organization the Link Aggregation Policy belongs to.
