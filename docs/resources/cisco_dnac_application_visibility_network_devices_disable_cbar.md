...
page_title: "terrible_cisco_dnac_application_visibility_network_devices_disable_cbar Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_application_visibility_network_devices_disable_cbar (Resource)
...
- `networkDeviceIds` (String) List of network device ids where CBAR has to be disabled.
