...
page_title: "terrible_cisco_dnac_sites_device_credentials_apply Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sites_device_credentials_apply (Resource)
...
- `deviceCredentialId` (String) It must be cli/snmpV2Read/snmpV2Write/snmpV3 Id.
