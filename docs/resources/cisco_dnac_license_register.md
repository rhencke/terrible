...
page_title: "terrible_cisco_dnac_license_register Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_license_register (Resource)
...
- `smartAccountId` (String) The ID of the Smart Account to which the system is registered.
...
- `virtualAccountId` (String) The ID of the Virtual Account to which the system is registered.
