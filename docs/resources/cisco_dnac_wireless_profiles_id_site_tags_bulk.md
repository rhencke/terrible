...
page_title: "terrible_cisco_dnac_wireless_profiles_id_site_tags_bulk Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_profiles_id_site_tags_bulk (Resource)
...
- `items` (String) Wireless Profiles Id Site Tags Bulk's items.
