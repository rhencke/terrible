...
page_title: "terrible_check_point_mgmt_cp_mgmt_threat_layer Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_threat_layer (Resource)
...
- `add_default_rule` (Boolean) Indicates whether to include a default rule in the new layer. Available from R80.10 management version.
...
- `cp_mgmt_threat_layer` (String) The checkpoint object created or updated.
