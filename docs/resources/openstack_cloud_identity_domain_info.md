...
page_title: "terrible_openstack_cloud_identity_domain_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_identity_domain_info (Resource)
...
- `filters` (String) A dictionary of meta data to use for filtering. Elements of this dictionary may be additional dictionaries.
...
- `domains` (String) List of dictionaries describing OpenStack domains
