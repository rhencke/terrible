...
page_title: "terrible_cisco_meraki_organizations_admins_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_admins_info (Resource)
...
- `networkIds` (String) Information module for Organizations Admins Info. NetworkIds query parameter. Optional parameter to filter the result set by the included set of network IDs.
- `organizationId` (String) Information module for Organizations Admins Info. OrganizationId path parameter. Organization ID.
