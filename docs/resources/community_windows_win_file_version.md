...
page_title: "terrible_community_windows_win_file_version Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_windows_win_file_version (Resource)
...
- `path` (String) File to get version. Always provide absolute path.
...
- `win_file_version` (String) dictionary containing all the version data
