...
page_title: "terrible_theforeman_foreman_content_export_library Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_content_export_library (Resource)
...
- `fail_on_missing_content` (Boolean) Fails if any of the repositories belonging to this organization are unexportable.
