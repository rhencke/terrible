...
page_title: "terrible_netapp_ontap_na_ontap_snmp_traphosts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_snmp_traphosts (Resource)
...
- `host` (String) Fully qualified domain name (FQDN), IPv4 address or IPv6 address of SNMP traphost.
...
- `state` (String) Whether the specified SNMP traphost should exist or not.
