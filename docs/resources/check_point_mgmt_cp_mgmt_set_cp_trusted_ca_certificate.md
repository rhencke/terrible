...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_cp_trusted_ca_certificate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_cp_trusted_ca_certificate (Resource)
...
- `status` (String) Indicates whether the trusted CP CA certificate is enabled/disabled.
...
- `cp_mgmt_set_cp_trusted_ca_certificate` (String) The checkpoint set-cp-trusted-ca-certificate output.
