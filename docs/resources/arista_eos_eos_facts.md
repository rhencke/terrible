...
page_title: "terrible_arista_eos_eos_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_arista_eos_eos_facts (Resource)
...
- `ansible_net_fqdn` (String) The fully qualified domain name of the device
...
- `ansible_net_neighbors` (String) The list of LLDP neighbors from the remote device
