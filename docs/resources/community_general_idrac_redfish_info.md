...
page_title: "terrible_community_general_idrac_redfish_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_idrac_redfish_info (Resource)
...
- `command` (String) List of commands to execute on iDRAC. `GetManagerAttributes` returns the list of dicts containing iDRAC, LifecycleController and System attributes.
...
- `msg` (String) Different results depending on task.
