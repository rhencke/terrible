...
page_title: "terrible_cisco_meraki_devices_camera_custom_analytics_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_custom_analytics_info (Resource)
...
- `serial` (String) Information module for Devices Camera Customanalytics Info. Serial path parameter.
