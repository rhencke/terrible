...
page_title: "terrible_cisco_ios_ios_service Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_service (Resource)
...
- `config` (String) A dictionary of service configuration
...
- `state` (String) The state the configuration should be left in. The module have declaratively similar behavior for replaced and overridden state. Refer to examples for more details.
