...
page_title: "terrible_infinidat_infinibox_infini_fibre_channel_switch Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infinidat_infinibox_infini_fibre_channel_switch (Resource)
...
- `switch_name` (String) Current name of an existing fibre channel switch.
...
- `new_switch_name` (String) New name for an existing fibre channel switch.
...
- `state` (String) Rename an FC switch name, when using state rename. States present and absent are not implemented. State stat shows the existing FC switch details.
