...
page_title: "terrible_cisco_meraki_networks_floor_plans_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_floor_plans_info (Resource)
...
- `floorPlanId` (String) Information module for Networks Floorplans Info. FloorPlanId path parameter. Floor plan ID.
- `headers` (String) Additional headers.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `networkId` (String) Information module for Networks Floorplans Info. NetworkId path parameter. Network ID.
