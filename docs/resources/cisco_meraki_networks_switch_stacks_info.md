...
page_title: "terrible_cisco_meraki_networks_switch_stacks_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_stacks_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Stacks Info. NetworkId path parameter. Network ID.
...
- `switchStackId` (String) Information module for Networks Switch Stacks Info. SwitchStackId path parameter. Switch stack ID.
