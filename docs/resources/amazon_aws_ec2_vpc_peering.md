...
page_title: "terrible_amazon_aws_ec2_vpc_peering Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_peering (Resource)
...
- `state` (String) Create, delete, accept, reject a peering connection.
...
- `wait` (Boolean) Wait for peering state changes to complete.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `vpc_peering_connection` (String) The details of the VPC peering connection.
