...
page_title: "terrible_netbox_netbox_netbox_rack_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_rack_role (Resource)
...
- `data` (String) Defines the rack role configuration
...
- `rack_role` (String) Serialized object as created or already existent within NetBox
