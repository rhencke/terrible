...
page_title: "terrible_netapp_ontap_na_ontap_ntp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_ntp (Resource)
...
- `server_name` (String) The name of the NTP server to manage.
...
- `key_id` (Number) The symmetric authentication key ID being used for this time server.
...
- `state` (String) Whether the specified NTP server should exist or not.
...
- `version` (String) give version for NTP server
