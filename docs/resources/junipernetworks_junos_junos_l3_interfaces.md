...
page_title: "terrible_junipernetworks_junos_junos_l3_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_l3_interfaces (Resource)
...
- `config` (String) A dictionary of Layer 3 interface options
