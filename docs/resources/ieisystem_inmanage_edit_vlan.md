...
page_title: "terrible_ieisystem_inmanage_edit_vlan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_vlan (Resource)
...
- `vlan_id` (Number) The Identification for VLAN configuration(2-4094).
- `vlan_priority` (Number) The priority for VLAN configuration(1-7).
- `vlan_status` (String) Enable or disable vlan.
