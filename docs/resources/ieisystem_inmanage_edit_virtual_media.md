...
page_title: "terrible_ieisystem_inmanage_edit_virtual_media Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_virtual_media (Resource)
...
- `remote_media_support` (String) To enable or disable Remote Media support, check or uncheck the checkbox respectively.
