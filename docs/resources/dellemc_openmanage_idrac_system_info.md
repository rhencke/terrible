...
page_title: "terrible_dellemc_openmanage_idrac_system_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_idrac_system_info (Resource)
...
- `msg` (String) Overall system inventory information status.
- `system_info` (String) Details of the PowerEdge Server System Inventory.
