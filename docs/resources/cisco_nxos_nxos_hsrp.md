...
page_title: "terrible_cisco_nxos_nxos_hsrp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_hsrp (Resource)
...
- `group` (String) HSRP group number.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `interface` (String) Full name of interface that is being managed for HSRP.
...
- `preempt` (String) Enable/Disable preempt.
