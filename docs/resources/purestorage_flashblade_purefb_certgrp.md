...
page_title: "terrible_purestorage_flashblade_purefb_certgrp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_certgrp (Resource)
...
- `certificates` (String) List of certifcates to add to a policy on creation
...
- `state` (String) Create or delete certifcate group
