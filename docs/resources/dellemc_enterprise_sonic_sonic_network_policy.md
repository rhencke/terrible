...
page_title: "terrible_dellemc_enterprise_sonic_sonic_network_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_network_policy (Resource)
...
- `config` (String) List of network policy configurations
