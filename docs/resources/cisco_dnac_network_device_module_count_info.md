...
page_title: "terrible_cisco_dnac_network_device_module_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_module_count_info (Resource)
...
- `nameList` (String) NameList query parameter.
- `operationalStateCodeList` (String) OperationalStateCodeList query parameter.
- `partNumberList` (String) PartNumberList query parameter.
...
- `vendorEquipmentTypeList` (String) VendorEquipmentTypeList query parameter.
