...
page_title: "terrible_cisco_dnac_sda_extranet_policies Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_extranet_policies (Resource)
...
- `extranetPolicyName` (String) ExtranetPolicyName query parameter. Name of the extranet policy.
...
- `payload` (String) Sda Extranet Policies's payload.
