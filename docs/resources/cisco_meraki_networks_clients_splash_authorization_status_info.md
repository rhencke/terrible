...
page_title: "terrible_cisco_meraki_networks_clients_splash_authorization_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_clients_splash_authorization_status_info (Resource)
...
- `clientId` (String) Information module for Networks Clients Splashauthorizationstatus Info. ClientId path parameter. Client ID.
...
- `networkId` (String) Information module for Networks Clients Splashauthorizationstatus Info. NetworkId path parameter. Network ID.
