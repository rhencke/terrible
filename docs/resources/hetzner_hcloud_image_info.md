...
page_title: "terrible_hetzner_hcloud_image_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_image_info (Resource)
...
- `architecture` (String) The architecture for the images you want to get.
...
- `label_selector` (String) The label selector for the images you want to get.
...
- `type` (String) The type for the images you want to get.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `hcloud_image_info` (String) The image infos as list
