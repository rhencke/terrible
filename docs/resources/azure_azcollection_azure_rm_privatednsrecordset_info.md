...
page_title: "terrible_azure_azcollection_azure_rm_privatednsrecordset_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_privatednsrecordset_info (Resource)
...
- `dnsrecordsets` (String) Gets a list of recordsets dict in a Private DNS zone.
