...
page_title: "terrible_azure_azcollection_azure_rm_securitygroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_securitygroup_info (Resource)
...
- `securitygroups` (String) List containing security group dicts.
