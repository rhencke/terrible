...
page_title: "terrible_cisco_mso_mso_schema_validate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_validate (Resource)
...
- `state` (String) Use `query` to validate deploying the schema.
