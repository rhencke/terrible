...
page_title: "terrible_netapp_eseries_santricity_netapp_e_snapshot_images Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_eseries_santricity_netapp_e_snapshot_images (Resource)
...
- `snapshot_group` (String) The name of the snapshot group in which you want to create a snapshot image.
- `ssid` (String) Storage system identifier
- `state` (String) Whether a new snapshot image should be created or oldest be deleted.
...
- `image_id` (String) ID of snapshot image
- `msg` (String) State of operation
