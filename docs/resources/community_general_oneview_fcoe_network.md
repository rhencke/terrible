...
page_title: "terrible_community_general_oneview_fcoe_network Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_oneview_fcoe_network (Resource)
...
- `data` (String) List with FCoE Network properties.
...
- `state` (String) Indicates the desired state for the FCoE Network resource. `present` ensures data properties are compliant with OneView. `absent` removes the resource from OneView, if it exists.
...
- `fcoe_network` (String) Has the facts about the OneView FCoE Networks.
