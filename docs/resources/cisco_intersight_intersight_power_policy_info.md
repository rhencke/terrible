...
page_title: "terrible_cisco_intersight_intersight_power_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_power_policy_info (Resource)
...
- `name` (String) The name of the Power Policy to gather information from.
- `organization` (String) The name of the organization the Power Policy belongs to.
