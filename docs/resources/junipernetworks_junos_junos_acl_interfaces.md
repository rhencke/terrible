...
page_title: "terrible_junipernetworks_junos_junos_acl_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_acl_interfaces (Resource)
...
- `config` (String) A dictionary of ACL options for interfaces.
