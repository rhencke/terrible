...
page_title: "terrible_vmware_vmware_esxi_connection Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_esxi_connection (Resource)
...
- `state` (String) Sets the connection status of the host in vCenter
...
- `host` (String) Identifying information about the managed host
