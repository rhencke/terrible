...
page_title: "terrible_ansible_windows_win_service_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ansible_windows_win_service_info (Resource)
...
- `exists` (Boolean) Whether any services were found based on the criteria specified.
- `id` (String) Unique task resource ID
- `services` (String) A list of service(s) that were found based on the criteria. Will be an empty list if no services were found.
