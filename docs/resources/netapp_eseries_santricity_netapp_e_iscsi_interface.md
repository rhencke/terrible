...
page_title: "terrible_netapp_eseries_santricity_netapp_e_iscsi_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_eseries_santricity_netapp_e_iscsi_interface (Resource)
...
- `name` (Number) The channel of the port to modify the configuration of. The list of choices is not necessarily comprehensive. It depends on the number of ports that are available in the system. The numerical value represents the number of the channel (typically from left to right on the HIC), beginning with a value of 1.
