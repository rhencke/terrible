...
page_title: "terrible_netapp_ontap_na_ontap_fpolicy_status Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_fpolicy_status (Resource)
...
- `vserver` (String) Name of the vserver to enable fPolicy on.
...
- `sequence_number` (Number) Policy Sequence Number.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Whether the fPolicy policy is enabled or disabled.
