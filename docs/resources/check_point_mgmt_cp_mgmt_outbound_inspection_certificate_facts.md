...
page_title: "terrible_check_point_mgmt_cp_mgmt_outbound_inspection_certificate_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_outbound_inspection_certificate_facts (Resource)
...
- `details_level` (String) The level of detail for some of the fields in the response can vary from showing only the UID value of the object to a fully detailed representation of the object. Available from R82 management version.
