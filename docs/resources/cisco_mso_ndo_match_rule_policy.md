...
page_title: "terrible_cisco_mso_ndo_match_rule_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_match_rule_policy (Resource)
...
- `description` (String) The description of the Match Rule Policy.
...
- `name` (String) The name of the Match Rule Policy.
...
- `uuid` (String) The UUID of the Match Rule Policy. This parameter is required when the `name` needs to be updated.
