...
page_title: "terrible_theforeman_foreman_repository_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_repository_info (Resource)
...
- `repositories` (String) List of all found repositories and their details
- `repository` (String) Details about the found repository
