...
page_title: "terrible_community_vmware_vmware_host_ssl_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_ssl_info (Resource)
...
- `host_ssl_info` (String) dict with hostname as key and dict with SSL thumbprint related info
