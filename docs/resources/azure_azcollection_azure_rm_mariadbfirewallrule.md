...
page_title: "terrible_azure_azcollection_azure_rm_mariadbfirewallrule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mariadbfirewallrule (Resource)
...
- `name` (String) The name of the MariaDB firewall rule.
...
- `end_ip_address` (String) The end IP address of the MariaDB firewall rule. Must be IPv4 format.
...
- `start_ip_address` (String) The start IP address of the MariaDB firewall rule. Must be IPv4 format.
- `state` (String) Assert the state of the MariaDB firewall rule. Use `present` to create or update a rule and `absent` to ensure it is not present.
