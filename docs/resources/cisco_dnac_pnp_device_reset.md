...
page_title: "terrible_cisco_dnac_pnp_device_reset Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_pnp_device_reset (Resource)
...
- `deviceResetList` (String) Pnp Device Reset's deviceResetList.
...
- `projectId` (String) Pnp Device Reset's projectId.
...
- `workflowId` (String) Pnp Device Reset's workflowId.
