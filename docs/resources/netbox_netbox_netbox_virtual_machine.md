...
page_title: "terrible_netbox_netbox_netbox_virtual_machine Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_virtual_machine (Resource)
...
- `data` (String) Defines the virtual machine configuration
...
- `virtual_machine` (String) Serialized object as created or already existent within NetBox
