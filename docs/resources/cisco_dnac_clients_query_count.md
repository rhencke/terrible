...
page_title: "terrible_cisco_dnac_clients_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_clients_query_count (Resource)
...
- `filters` (String) Clients Query Count's filters.
