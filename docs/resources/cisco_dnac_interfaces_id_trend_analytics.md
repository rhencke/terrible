...
page_title: "terrible_cisco_dnac_interfaces_id_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_interfaces_id_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Interfaces Id Trend Analytics's aggregateAttributes.
...
- `filters` (String) Interfaces Id Trend Analytics's filters.
...
- `timestampOrder` (String) Timestamp Order.
