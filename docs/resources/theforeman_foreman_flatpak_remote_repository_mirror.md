...
page_title: "terrible_theforeman_foreman_flatpak_remote_repository_mirror Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_flatpak_remote_repository_mirror (Resource)
...
- `flatpak_remote` (String) Flatpak remote
- `flatpak_remote_repository` (String) Flatpak remote repository
- `host_id` (String) ID of the `terrible_host` to run this task against
- `product` (String) Product to mirror the remote repository to
