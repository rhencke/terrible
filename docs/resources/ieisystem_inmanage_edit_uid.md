...
page_title: "terrible_ieisystem_inmanage_edit_uid Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_uid (Resource)
...
- `led` (String) Turn on or turn off the led.
...
- `time` (Number) Set led blink time(second).
