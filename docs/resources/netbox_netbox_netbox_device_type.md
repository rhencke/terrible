...
page_title: "terrible_netbox_netbox_netbox_device_type Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_device_type (Resource)
...
- `data` (String) Defines the device type configuration
...
- `device_type` (String) Serialized object as created or already existent within NetBox
