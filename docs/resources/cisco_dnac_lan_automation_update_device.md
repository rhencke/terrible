...
page_title: "terrible_cisco_dnac_lan_automation_update_device Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_lan_automation_update_device (Resource)
...
- `hostnameUpdateDevices` (String) Lan Automation Update Device's hostnameUpdateDevices.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `linkUpdate` (String) Lan Automation Update Device's linkUpdate.
- `loopbackUpdateDeviceList` (String) Lan Automation Update Device's loopbackUpdateDeviceList.
