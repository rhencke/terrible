...
page_title: "terrible_cisco_dnac_sda_multicast_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_multicast_info (Resource)
...
- `siteNameHierarchy` (String) SiteNameHierarchy query parameter. Fabric site name hierarchy.
