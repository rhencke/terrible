...
page_title: "terrible_cisco_nxos_nxos_vtp_password Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_vtp_password (Resource)
...
- `end_state` (String) k/v pairs of vtp after module execution
- `existing` (String) k/v pairs of existing vtp
