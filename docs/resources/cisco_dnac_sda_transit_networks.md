...
page_title: "terrible_cisco_dnac_sda_transit_networks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_transit_networks (Resource)
...
- `payload` (String) Sda Transit Networks's payload.
