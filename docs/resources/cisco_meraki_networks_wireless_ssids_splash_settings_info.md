...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_splash_settings_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_splash_settings_info (Resource)
...
- `networkId` (String) Information module for Networks Wireless Ssids Splash Settings Info. NetworkId path parameter. Network ID.
- `number` (String) Information module for Networks Wireless Ssids Splash Settings Info. Number path parameter.
