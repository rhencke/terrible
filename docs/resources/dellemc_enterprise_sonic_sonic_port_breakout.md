...
page_title: "terrible_dellemc_enterprise_sonic_sonic_port_breakout Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_port_breakout (Resource)
...
- `config` (String) Specifies the port breakout related configuration.
