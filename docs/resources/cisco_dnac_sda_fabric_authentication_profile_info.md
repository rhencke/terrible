...
page_title: "terrible_cisco_dnac_sda_fabric_authentication_profile_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_authentication_profile_info (Resource)
...
- `authenticateTemplateName` (String) AuthenticateTemplateName query parameter.
