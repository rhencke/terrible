...
page_title: "terrible_vmware_vmware_rest_appliance_health_system_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_health_system_info (Resource)
...
- `value` (String) Get the system health status
