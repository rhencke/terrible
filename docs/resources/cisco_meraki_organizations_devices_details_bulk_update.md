...
page_title: "terrible_cisco_meraki_organizations_devices_details_bulk_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_devices_details_bulk_update (Resource)
...
- `details` (String) An array of details.
