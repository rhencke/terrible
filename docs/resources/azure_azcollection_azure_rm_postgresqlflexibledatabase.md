...
page_title: "terrible_azure_azcollection_azure_rm_postgresqlflexibledatabase Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqlflexibledatabase (Resource)
...
- `state` (String) Assert the state of the PostgreSQL Flexible database. Use `present` to create or update a database and `absent` to delete it.
...
- `database` (String) A list of dictionaries containing facts for PostgreSQL Flexible Database.
