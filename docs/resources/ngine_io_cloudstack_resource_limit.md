...
page_title: "terrible_ngine_io_cloudstack_resource_limit Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ngine_io_cloudstack_resource_limit (Resource)
...
- `limit` (Number) Maximum number of the resource. Default is unlimited `-1`.
...
- `recource_type` (String) Type of the resource
