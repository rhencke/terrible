...
page_title: "terrible_community_zabbix_zabbix_correlation Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_correlation (Resource)
...
- `name` (String) Name of this correlation
...
- `description` (String) Description of this correlation
...
- `operations` (String) A operations.
...
- `state` (String) State of the correlation.
- `status` (String) Status of the correlation.
