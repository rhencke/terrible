...
page_title: "terrible_cisco_meraki_organizations_camera_custom_analytics_artifacts_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_camera_custom_analytics_artifacts_info (Resource)
...
- `artifactId` (String) Information module for Organizations Camera Customanalytics Artifacts Info. ArtifactId path parameter. Artifact ID.
...
- `organizationId` (String) Information module for Organizations Camera Customanalytics Artifacts Info. OrganizationId path parameter. Organization ID.
