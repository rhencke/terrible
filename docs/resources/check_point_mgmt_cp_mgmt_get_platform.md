...
page_title: "terrible_check_point_mgmt_cp_mgmt_get_platform Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_get_platform (Resource)
...
- `cp_mgmt_get_platform` (String) The checkpoint get-platform output.
