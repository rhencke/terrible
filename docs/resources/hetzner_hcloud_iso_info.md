...
page_title: "terrible_hetzner_hcloud_iso_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_iso_info (Resource)
...
- `architecture` (String) Filter ISOs with compatible architecture.
...
- `include_architecture_wildcard` (Boolean) Include ISOs with wildcard architecture (architecture is null). Works only if architecture filter is specified.
...
- `hcloud_iso_info` (String) The ISO type infos as list
