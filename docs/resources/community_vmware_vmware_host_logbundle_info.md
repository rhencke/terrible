...
page_title: "terrible_community_vmware_vmware_host_logbundle_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_logbundle_info (Resource)
...
- `esxi_hostname` (String) Name of the host system to fetch the manifests for logbundle.
...
- `manifests` (String) list of dictionary of manifest information for logbundle
