...
page_title: "terrible_community_vmware_vsan_health_silent_checks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vsan_health_silent_checks (Resource)
...
- `cluster_name` (String) Name of the vSAN cluster.
...
- `checks` (String) The checks to silence.
...
- `state` (String) The state of the health checks. If set to `present`, all given health checks will be silenced. If set to `absent`, all given health checks will be removed from the list of silent checks.
