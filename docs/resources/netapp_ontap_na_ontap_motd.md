...
page_title: "terrible_netapp_ontap_na_ontap_motd Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_motd (Resource)
...
- `vserver` (String) The name of the SVM motd should be set for.
...
- `state` (String) If `state=present` sets MOTD given in *message* `state=absent` removes it.
