...
page_title: "terrible_cisco_meraki_devices_live_tools_wake_on_lan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_live_tools_wake_on_lan (Resource)
...
- `vlanId` (Number) The target's VLAN (1 to 4094).
