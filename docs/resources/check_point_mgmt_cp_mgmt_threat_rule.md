...
page_title: "terrible_check_point_mgmt_cp_mgmt_threat_rule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_threat_rule (Resource)
...
- `track_settings` (String) Threat rule track settings.
...
- `cp_mgmt_threat_rule` (String) The checkpoint object created or updated.
