...
page_title: "terrible_infoblox_nios_modules_nios_dtc_monitor_icmp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_dtc_monitor_icmp (Resource)
...
- `interval` (Number) Configures the interval for ICMP health check.
