...
page_title: "terrible_community_mongodb_mongodb_atlas_user Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_mongodb_mongodb_atlas_user (Resource)
...
- `roles` (String) Array of this user's roles and the databases / collections on which the roles apply. A role must include following elements
...
- `scopes` (String) List of clusters and Atlas Data Lakes that this user can access. Atlas grants database users access to all resources by default.
