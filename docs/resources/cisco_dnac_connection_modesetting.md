...
page_title: "terrible_cisco_dnac_connection_modesetting Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_connection_modesetting (Resource)
...
- `connectionMode` (String) The CSSM connection modes of Catalyst Center are DIRECT, ON_PREMISE and SMART_PROXY.
...
- `parameters` (String) Connection Mode Setting's parameters.
