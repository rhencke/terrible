...
page_title: "terrible_infoblox_nios_modules_nios_nsgroup_delegation Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_nsgroup_delegation (Resource)
...
- `delegate_to` (String) Specifies the list of name servers to be used
