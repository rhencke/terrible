...
page_title: "terrible_cisco_meraki_networks_appliance_prefixes_delegated_statics_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_prefixes_delegated_statics_info (Resource)
...
- `networkId` (String) Information module for Networks Appliance Prefixes Delegated Statics Info. NetworkId path parameter. Network ID.
...
- `staticDelegatedPrefixId` (String) Information module for Networks Appliance Prefixes Delegated Statics Info. StaticDelegatedPrefixId path parameter. Static delegated prefix ID.
