...
page_title: "terrible_cisco_nxos_nxos_hsrp_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_hsrp_interfaces (Resource)
...
- `config` (String) A dictionary of HSRP configuration options to add to interface
