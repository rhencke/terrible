...
page_title: "terrible_vmware_vmware_rest_appliance_access_dcui Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_access_dcui (Resource)
...
- `enabled` (Boolean) DCUI is enabled. This parameter is mandatory.
...
- `value` (String) Disable the Direct Console User Interface
