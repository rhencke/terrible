...
page_title: "terrible_cisco_meraki_organizations_cellular_gateway_esims_inventory_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_cellular_gateway_esims_inventory_info (Resource)
...
- `eids` (String) Information module for Organizations Cellular Gateway Esims Inventory Info. Eids query parameter. Optional parameter to filter the results by EID.
...
- `organizationId` (String) Information module for Organizations Cellular Gateway Esims Inventory Info. OrganizationId path parameter. Organization ID.
