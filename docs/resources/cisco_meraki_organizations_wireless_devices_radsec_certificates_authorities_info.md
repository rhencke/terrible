...
page_title: "terrible_cisco_meraki_organizations_wireless_devices_radsec_certificates_authorities_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_wireless_devices_radsec_certificates_authorities_info (Resource)
...
- `certificateAuthorityIds` (String) Information module for Organizations Wireless Devices Radsec Certificates Authorities Info. CertificateAuthorityIds query parameter. Optional parameter to filter CAs by one or more CA IDs. All returned CAs will have an ID that is an exact match.
...
- `organizationId` (String) Information module for Organizations Wireless Devices Radsec Certificates Authorities Info. OrganizationId path parameter. Organization ID.
