...
page_title: "terrible_cisco_dnac_pnp_workflow_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_pnp_workflow_info (Resource)
...
- `name` (String) Name query parameter. Workflow Name.
...
- `sort` (String) Sort query parameter. Comma seperated lost of fields to sort on.
...
- `type` (String) Type query parameter. Workflow Type.
