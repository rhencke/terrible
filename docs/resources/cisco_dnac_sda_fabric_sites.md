...
page_title: "terrible_cisco_dnac_sda_fabric_sites Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_sites (Resource)
...
- `payload` (String) Sda Fabric Sites's payload.
