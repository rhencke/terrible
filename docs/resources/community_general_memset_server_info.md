...
page_title: "terrible_community_general_memset_server_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_memset_server_info (Resource)
...
- `name` (String) The server product name (that is, `testyaa1`).
