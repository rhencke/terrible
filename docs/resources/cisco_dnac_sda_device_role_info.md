...
page_title: "terrible_cisco_dnac_sda_device_role_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_device_role_info (Resource)
...
- `deviceManagementIpAddress` (String) DeviceManagementIpAddress query parameter. Device Management IP Address.
