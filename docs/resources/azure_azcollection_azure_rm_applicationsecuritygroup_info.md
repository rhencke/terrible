...
page_title: "terrible_azure_azcollection_azure_rm_applicationsecuritygroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_applicationsecuritygroup_info (Resource)
...
- `applicationsecuritygroups` (String) List of application security groups.
