...
page_title: "terrible_cisco_meraki_devices_live_tools_multicast_routing_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_live_tools_multicast_routing_info (Resource)
...
- `multicastRoutingId` (String) Information module for Devices Live Tools Multicast Routing Info. MulticastRoutingId path parameter. Multicast routing ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `serial` (String) Information module for Devices Live Tools Multicast Routing Info. Serial path parameter.
