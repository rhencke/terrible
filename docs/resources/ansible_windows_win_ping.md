...
page_title: "terrible_ansible_windows_win_ping Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ansible_windows_win_ping (Resource)
...
- `data` (String) Alternate data to return instead of 'pong'. If this parameter is set to `crash`, the module will cause an exception.
