...
page_title: "terrible_netbox_netbox_netbox_aggregate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_aggregate (Resource)
...
- `data` (String) Defines the aggregate configuration
...
- `aggregate` (String) Serialized object as created or already existent within NetBox
