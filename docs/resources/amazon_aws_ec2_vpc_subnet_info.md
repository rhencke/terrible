...
page_title: "terrible_amazon_aws_ec2_vpc_subnet_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_subnet_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeSubnets.html for possible filters.
...
- `subnet_ids` (String) A list of subnet IDs to gather information for.
...
- `subnets` (String) Returns an array of complex objects as described below.
