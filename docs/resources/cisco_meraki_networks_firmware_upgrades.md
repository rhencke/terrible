...
page_title: "terrible_cisco_meraki_networks_firmware_upgrades Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_firmware_upgrades (Resource)
...
- `products` (String) Contains information about the network to update.
...
- `upgradeWindow` (String) Upgrade window for devices in network.
