...
page_title: "terrible_azure_azcollection_azure_rm_apimanagement_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_apimanagement_info (Resource)
...
- `expand_api_version_set` (Boolean) Include full ApiVersionSet resource in response
...
- `include_not_tagged_apis` (Boolean) Included not tagged APIs in the response.
...
- `api` (String) A list of dict results where the key is the name of the Api and the values are the facts for that Api.
