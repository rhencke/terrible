...
page_title: "terrible_cisco_intersight_intersight_fibre_channel_zone_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_fibre_channel_zone_policy_info (Resource)
...
- `name` (String) The exact name of the FC Zone Policy to retrieve information from. When specified, only the matching policy will be returned.
- `organization` (String) The name of the organization to filter FC Zone Policies by. Use 'default' for the default organization. When specified, only policies from this organization will be returned.
...
- `api_response` (String) The API response containing policy information including embedded FC target members. Returns a dictionary when querying a single policy. Returns a list when multiple policies are found.
