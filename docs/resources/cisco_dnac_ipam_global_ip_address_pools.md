...
page_title: "terrible_cisco_dnac_ipam_global_ip_address_pools Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_ipam_global_ip_address_pools (Resource)
...
- `addressSpace` (String) Ipam Global Ip Address Pools's addressSpace.
