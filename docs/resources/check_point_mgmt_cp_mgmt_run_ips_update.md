...
page_title: "terrible_check_point_mgmt_cp_mgmt_run_ips_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_run_ips_update (Resource)
...
- `cp_mgmt_run_ips_update` (String) The checkpoint run-ips-update output.
