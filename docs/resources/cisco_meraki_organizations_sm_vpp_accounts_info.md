...
page_title: "terrible_cisco_meraki_organizations_sm_vpp_accounts_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_sm_vpp_accounts_info (Resource)
...
- `organizationId` (String) Information module for Organizations Sm Vppaccounts Info. OrganizationId path parameter. Organization ID.
...
- `vppAccountId` (String) Information module for Organizations Sm Vppaccounts Info. VppAccountId path parameter. Vpp account ID.
