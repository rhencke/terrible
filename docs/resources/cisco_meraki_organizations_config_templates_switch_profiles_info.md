...
page_title: "terrible_cisco_meraki_organizations_config_templates_switch_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_config_templates_switch_profiles_info (Resource)
...
- `configTemplateId` (String) Information module for Organizations Configtemplates Switch Profiles Info. ConfigTemplateId path parameter. Config template ID.
...
- `organizationId` (String) Information module for Organizations Configtemplates Switch Profiles Info. OrganizationId path parameter. Organization ID.
