...
page_title: "terrible_azure_azcollection_azure_rm_hdinsightcluster_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_hdinsightcluster_info (Resource)
...
- `clusters` (String) A list of dictionaries containing facts for HDInsight Cluster.
