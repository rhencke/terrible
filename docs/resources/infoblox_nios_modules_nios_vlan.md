...
page_title: "terrible_infoblox_nios_modules_nios_vlan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_vlan (Resource)
...
- `name` (String) Specifies the vlan name to add or remove from the system.
...
- `parent` (String) Specifies the vlan parent to add or remove from the system. Can be either a `vlanview` or `vlanrange` name. Fetches the required _ref object automatically. If not specified defaults to vlan view `default`.
