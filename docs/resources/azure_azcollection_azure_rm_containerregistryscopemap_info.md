...
page_title: "terrible_azure_azcollection_azure_rm_containerregistryscopemap_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_containerregistryscopemap_info (Resource)
...
- `registry_scope_maps` (String) A list of dictionaries containing facts for scope map.
