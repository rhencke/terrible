...
page_title: "terrible_cisco_mso_mso_schema_template_l3out Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_l3out (Resource)
...
- `description` (String) The description of l3out is supported on versions of MSO that are 3.3 or greater.
...
- `l3out` (String) The name of the l3out to manage.
...
- `vrf` (String) The VRF associated to this L3out.
