...
page_title: "terrible_community_hashi_vault_vault_database_roles_list Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_database_roles_list (Resource)
...
- `roles` (String) The list of dynamic roles or en empty list. This can also be accessed via R`data.keys` or R`raw.data.keys`.
