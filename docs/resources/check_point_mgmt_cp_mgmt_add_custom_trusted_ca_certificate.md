...
page_title: "terrible_check_point_mgmt_cp_mgmt_add_custom_trusted_ca_certificate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_add_custom_trusted_ca_certificate (Resource)
...
- `base64_certificate` (String) Certificate file encoded in base64.<br/>Valid file formats, x509.
...
- `cp_mgmt_add_custom_trusted_ca_certificate` (String) The checkpoint add-custom-trusted-ca-certificate output.
