...
page_title: "terrible_cisco_dnac_wireless_access_points_factory_reset_request_provision Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_access_points_factory_reset_request_provision (Resource)
...
- `apMacAddresses` (String) List of Access Point's Ethernet MAC addresses, set maximum 100 ethernet MAC addresses per request.
...
- `keepStaticIPConfig` (Boolean) Set the value of keepStaticIPConfig to false, to clear all configurations from Access Points and set the value of keepStaticIPConfig to true, to clear all configurations from Access Points without clearing static IP configuration.
