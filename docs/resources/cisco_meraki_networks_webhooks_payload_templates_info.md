...
page_title: "terrible_cisco_meraki_networks_webhooks_payload_templates_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_webhooks_payload_templates_info (Resource)
...
- `networkId` (String) Information module for Networks Webhooks Payloadtemplates Info. NetworkId path parameter. Network ID.
- `payloadTemplateId` (String) Information module for Networks Webhooks Payloadtemplates Info. PayloadTemplateId path parameter. Payload template ID.
