...
page_title: "terrible_cisco_dnac_ipam_site_ip_address_pools_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_ipam_site_ip_address_pools_id (Resource)
...
- `ipV4AddressSpace` (String) Ipam Site Ip Address Pools Id's ipV4AddressSpace.
- `ipV6AddressSpace` (String) Ipam Site Ip Address Pools Id's ipV6AddressSpace.
