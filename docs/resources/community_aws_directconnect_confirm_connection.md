...
page_title: "terrible_community_aws_directconnect_confirm_connection Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_directconnect_confirm_connection (Resource)
...
- `connection_id` (String) The ID of the Direct Connect connection. One of *connection_id* or *name* must be specified.
...
- `name` (String) The name of the Direct Connect connection. One of *connection_id* or *name* must be specified.
