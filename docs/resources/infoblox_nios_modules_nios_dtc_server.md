...
page_title: "terrible_infoblox_nios_modules_nios_dtc_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_dtc_server (Resource)
...
- `host` (String) Configures the IP address (A response) or FQDN (CNAME response) of the server
- `host_id` (String) ID of the `terrible_host` to run this task against
- `name` (String) Specifies the DTC Server display name
