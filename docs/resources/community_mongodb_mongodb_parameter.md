...
page_title: "terrible_community_mongodb_mongodb_parameter Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_mongodb_mongodb_parameter (Resource)
...
- `param` (String) MongoDB administrative parameter to modify.
- `value` (String) MongoDB administrative parameter value to set.
...
- `param_type` (String) Define the type of parameter value.
...
- `after` (String) value after modification
- `before` (String) value before modification
