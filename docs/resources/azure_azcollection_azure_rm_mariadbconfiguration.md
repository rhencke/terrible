...
page_title: "terrible_azure_azcollection_azure_rm_mariadbconfiguration Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mariadbconfiguration (Resource)
...
- `state` (String) Assert the state of the MariaDB configuration. Use `present` to update setting, or `absent` to reset to default value.
