...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_ha_state Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_ha_state (Resource)
...
- `cp_mgmt_show_ha_state` (String) The checkpoint show-ha-state output.
