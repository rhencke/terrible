...
page_title: "terrible_cisco_dnac_interfaces_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_interfaces_query_count (Resource)
...
- `aggregateAttributes` (String) Interfaces Query Count's aggregateAttributes.
...
- `filters` (String) Interfaces Query Count's filters.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Interfaces Query Count's page.
