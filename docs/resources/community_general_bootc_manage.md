...
page_title: "terrible_community_general_bootc_manage Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_bootc_manage (Resource)
...
- `state` (String) Control whether to apply the latest image or switch the image. **Note:** This does not reboot the system. Please use `ansible.builtin.reboot` to reboot the system.
...
- `image` (String) The image to switch to. This is required when `state=switch`.
