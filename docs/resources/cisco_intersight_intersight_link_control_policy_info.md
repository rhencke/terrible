...
page_title: "terrible_cisco_intersight_intersight_link_control_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_link_control_policy_info (Resource)
...
- `name` (String) The name of the Link Control Policy to gather information from.
- `organization` (String) The name of the organization the Link Control Policy belongs to.
