...
page_title: "terrible_cisco_intersight_intersight_wwn_pool_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_wwn_pool_info (Resource)
...
- `name` (String) The name of the WWNN/WWPN Pool that will have information gathered from.
- `organization` (String) The name of the organization that will have information gathered from.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `pool_purpose` (String) The pool type WWNN or WWPN. WWNN and WWPN pools can have the same name. if none is passed all information regardless of pool purpose will be fetched.
