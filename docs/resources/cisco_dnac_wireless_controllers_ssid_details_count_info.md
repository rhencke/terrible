...
page_title: "terrible_cisco_dnac_wireless_controllers_ssid_details_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_controllers_ssid_details_count_info (Resource)
...
- `adminStatus` (Boolean) AdminStatus query parameter. Utilize this query parameter to obtain the number of SSIDs according to their administrative status. A 'true' value signifies that the admin status of the SSID is enabled, while a 'false' value indicates that the admin status of the SSID is disabled.
