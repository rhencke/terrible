...
page_title: "terrible_cisco_ios_ios_evpn_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_evpn_global (Resource)
...
- `config` (String) A dictionary of L2VPN Ethernet Virtual Private Network (EVPN) configuration
