...
page_title: "terrible_azure_azcollection_azure_rm_monitordatacollectionrules_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_monitordatacollectionrules_info (Resource)
...
- `name` (String) The name of the data collection rule you're trying to get details about.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `resource_group` (String) The name of the resource group in which the data collection rule is (if you use name) The name of the resource group where you want to list data collection rules (if you don't use name)
...
- `datacollectionrules` (String) List of data collection rules Can be empty if listing data collection rules
