...
page_title: "terrible_cisco_dnac_network_device_licenses_network_device_id_port_channels_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_licenses_network_device_id_port_channels_count_info (Resource)
...
- `name` (String) Name query parameter. Optional name of the port channel to filter by. This supports partial search. For example, searching for "Port" will match "Port-channel1", "Port-channel2", etc.
- `networkDeviceId` (String) NetworkDeviceId path parameter. Unique identifier for the network device.
