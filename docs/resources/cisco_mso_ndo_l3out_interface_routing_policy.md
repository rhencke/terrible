...
page_title: "terrible_cisco_mso_ndo_l3out_interface_routing_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_l3out_interface_routing_policy (Resource)
...
- `bfd_multi_hop_settings` (String) The Bidirectional Forwarding Detection (BFD) multi-hop configuration of the L3Out Interface Routing Policy.
- `bfd_settings` (String) The BFD Settings of the L3Out Interface Routing Policy.
...
- `description` (String) The description of the L3Out Interface Routing Policy.
...
- `name` (String) The name of the L3Out Interface Routing Policy.
- `ospf_interface_settings` (String) The Open Shortest Path First (OSPF) Interface Settings of the L3Out Interface Routing Policy.
...
- `uuid` (String) The UUID of the L3Out Interface Routing Policy. This parameter is required when the `name` needs to be updated.
