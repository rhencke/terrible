...
page_title: "terrible_cisco_dnac_field_notices_results_notices_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_field_notices_results_notices_info (Resource)
...
- `deviceCount` (Number) DeviceCount query parameter. Return field notices with deviceCount greater than this deviceCount.
