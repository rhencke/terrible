...
page_title: "terrible_community_general_pritunl_org_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_pritunl_org_info (Resource)
...
- `organization` (String) Name of the Pritunl organization to search for. If none provided, the module returns all Pritunl organizations.
...
- `organizations` (String) List of Pritunl organizations.
