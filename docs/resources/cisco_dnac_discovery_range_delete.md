...
page_title: "terrible_cisco_dnac_discovery_range_delete Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_discovery_range_delete (Resource)
...
- `recordsToDelete` (Number) RecordsToDelete path parameter. Number of records to delete from the starting index.
