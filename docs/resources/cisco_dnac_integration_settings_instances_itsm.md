...
page_title: "terrible_cisco_dnac_integration_settings_instances_itsm Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_integration_settings_instances_itsm (Resource)
...
- `data` (String) Integration Settings Instances Itsm's data.
...
- `dypName` (String) It can be ServiceNowConnection.
