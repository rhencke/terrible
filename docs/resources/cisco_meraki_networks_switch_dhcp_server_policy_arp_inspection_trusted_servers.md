...
page_title: "terrible_cisco_meraki_networks_switch_dhcp_server_policy_arp_inspection_trusted_servers Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_dhcp_server_policy_arp_inspection_trusted_servers (Resource)
...
- `ipv4` (String) The IPv4 attributes of the trusted server being added.
...
- `trustedServerId` (String) TrustedServerId path parameter. Trusted server ID.
