...
page_title: "terrible_cisco_dnac_site_kpi_summaries_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_kpi_summaries_query_count (Resource)
...
- `filters` (String) Site Kpi Summaries Query Count's filters.
