...
page_title: "terrible_fortinet_fortimanager_fmgr_dvm_cmd_add_devlist Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_fortinet_fortimanager_fmgr_dvm_cmd_add_devlist (Resource)
...
- `dvm_cmd_add_devlist` (String) The top level parameters set.
