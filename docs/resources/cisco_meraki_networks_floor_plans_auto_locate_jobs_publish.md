...
page_title: "terrible_cisco_meraki_networks_floor_plans_auto_locate_jobs_publish Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_floor_plans_auto_locate_jobs_publish (Resource)
...
- `devices` (String) The list of devices to publish positions for.
