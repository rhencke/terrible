...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_vpn Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_vpn (Resource)
...
- `concentrator` (String) The VPN concentrator settings for this SSID.
...
- `failover` (String) Secondary VPN concentrator settings. This is only used when two VPN concentrators are configured on the SSID.
...
- `splitTunnel` (String) The VPN split tunnel settings for this SSID.
