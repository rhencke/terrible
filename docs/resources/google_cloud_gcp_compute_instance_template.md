...
page_title: "terrible_google_cloud_gcp_compute_instance_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_compute_instance_template (Resource)
...
- `name` (String) Name of the resource. The name is 1-63 characters long and complies with RFC1035.
...
- `properties` (String) The instance properties for this instance template.
