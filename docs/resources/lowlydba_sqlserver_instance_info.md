...
page_title: "terrible_lowlydba_sqlserver_instance_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_lowlydba_sqlserver_instance_info (Resource)
...
- `data` (String) Instance level properties of the SQL Server instance.
