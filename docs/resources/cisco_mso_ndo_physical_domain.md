...
page_title: "terrible_cisco_mso_ndo_physical_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_physical_domain (Resource)
...
- `description` (String) The description of the Physical Domain.
...
- `physical_domain` (String) The name of the Physical Domain.
- `physical_domain_uuid` (String) The uuid of the Physical Domain. This parameter is required when the `physical_domain` needs to be updated.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `pool` (String) The name of the VLAN Pool. Providing an empty string will remove the pool from the Physical Domain.
