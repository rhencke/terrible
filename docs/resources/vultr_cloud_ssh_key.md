...
page_title: "terrible_vultr_cloud_ssh_key Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vultr_cloud_ssh_key (Resource)
...
- `state` (String) State of the ssh key.
...
- `vultr_ssh_key` (String) Response from Vultr API.
