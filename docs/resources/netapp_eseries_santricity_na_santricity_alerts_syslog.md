...
page_title: "terrible_netapp_eseries_santricity_na_santricity_alerts_syslog Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_eseries_santricity_na_santricity_alerts_syslog (Resource)
...
- `servers` (String) List of dictionaries where each dictionary contains a syslog server entry.
...
- `test` (Boolean) This forces a test syslog message to be sent to the stated syslog server. Test will only be issued when a change is made.
