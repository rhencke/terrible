...
page_title: "terrible_cisco_dnac_endpoint_analytics_endpoints_anc_policy_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_endpoint_analytics_endpoints_anc_policy_update (Resource)
...
- `ancPolicy` (String) ANC policy name.
...
- `granularAncPolicy` (String) Endpoint Analytics Endpoints Anc Policy Update's granularAncPolicy.
