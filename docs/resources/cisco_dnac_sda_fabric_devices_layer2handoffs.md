...
page_title: "terrible_cisco_dnac_sda_fabric_devices_layer2handoffs Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_devices_layer2handoffs (Resource)
...
- `payload` (String) Sda Fabric Devices Layer2handoffs's payload.
