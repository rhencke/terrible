...
page_title: "terrible_azure_azcollection_azure_rm_adserviceprincipal_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_adserviceprincipal_info (Resource)
...
- `object_id` (String) It's service principal's object ID.
...
- `service_principals` (String) A list of service principals in the tenant. If app_id or object_id is set, the maximum length of this list should be one.
