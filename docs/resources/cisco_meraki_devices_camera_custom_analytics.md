...
page_title: "terrible_cisco_meraki_devices_camera_custom_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_custom_analytics (Resource)
...
- `parameters` (String) Parameters for the custom analytics workload.
