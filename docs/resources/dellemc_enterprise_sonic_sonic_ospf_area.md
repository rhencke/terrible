...
page_title: "terrible_dellemc_enterprise_sonic_sonic_ospf_area Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_ospf_area (Resource)
...
- `config` (String) Specifies configuration for OSPFv2 areas
