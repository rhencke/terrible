...
page_title: "terrible_cisco_dnac_site_assign_credential Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_assign_credential (Resource)
...
- `httpRead` (String) Http Read.
- `httpWrite` (String) Http Write.
...
- `snmpV2ReadId` (String) Snmp V2 Read Id.
- `snmpV2WriteId` (String) Snmp V2 Write Id.
- `snmpV3Id` (String) Snmp V3 Id.
