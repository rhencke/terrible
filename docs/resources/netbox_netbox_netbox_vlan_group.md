...
page_title: "terrible_netbox_netbox_netbox_vlan_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_vlan_group (Resource)
...
- `data` (String) Defines the vlan group configuration
...
- `vlan_group` (String) Serialized object as created or already existent within NetBox
