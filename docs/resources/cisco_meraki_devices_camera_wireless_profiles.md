...
page_title: "terrible_cisco_meraki_devices_camera_wireless_profiles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_wireless_profiles (Resource)
...
- `ids` (String) The ids of the wireless profile to assign to the given camera.
