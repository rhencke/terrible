...
page_title: "terrible_cisco_meraki_organizations_wireless_zigbee_disenrollments_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_wireless_zigbee_disenrollments_info (Resource)
...
- `disenrollmentId` (String) Information module for Organizations Wireless Zigbee Disenrollments Info. DisenrollmentId path parameter. Disenrollment ID.
...
- `organizationId` (String) Information module for Organizations Wireless Zigbee Disenrollments Info. OrganizationId path parameter. Organization ID.
