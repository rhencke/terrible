...
page_title: "terrible_azure_azcollection_azure_rm_virtualmachinescalesetinstance_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualmachinescalesetinstance_info (Resource)
...
- `instances` (String) A list of dictionaries containing facts for Virtual Machine Scale Set VM.
