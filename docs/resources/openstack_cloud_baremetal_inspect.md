...
page_title: "terrible_openstack_cloud_baremetal_inspect Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_baremetal_inspect (Resource)
...
- `name` (String) Name or id of the node to inspect. Mutually exclusive with *mac*
...
- `node` (String) A dictionary describing the node after inspection
