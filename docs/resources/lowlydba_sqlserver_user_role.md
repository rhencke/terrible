...
page_title: "terrible_lowlydba_sqlserver_user_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_lowlydba_sqlserver_user_role (Resource)
...
- `role` (String) The database role for the user to be modified.
...
- `data` (String) Output from the `Remove-DbaDbRoleMember`, (Get-DbaDbRoleMember), or `Add-DbaDbRoleMember` functions.
