...
page_title: "terrible_openstack_cloud_volume_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_volume_info (Resource)
...
- `all_projects` (Boolean) Whether to return the volumes in all projects
...
- `details` (Boolean) Whether to provide additional information about volumes
...
- `volumes` (String) Volumes in project(s)
