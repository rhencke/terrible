...
page_title: "terrible_cisco_iosxr_iosxr_vrf_address_family Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_vrf_address_family (Resource)
...
- `config` (String) VRF address family configuration.
