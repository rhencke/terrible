...
page_title: "terrible_community_general_pacemaker_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_pacemaker_info (Resource)
...
- `cluster_info` (String) Cluster information such as the name, UUID, and nodes.
- `constraint_info` (String) All cluster resource constraints on the cluster.
- `id` (String) Unique task resource ID
- `property_info` (String) All properties present on the cluster.
- `resource_info` (String) All resources available on the cluster and their status.
- `stonith_info` (String) All STONITH information on the cluster.
- `version` (String) Pacemaker CLI version
