...
page_title: "terrible_azure_azcollection_azure_rm_roledefinition Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_roledefinition (Resource)
...
- `name` (String) Unique name of role definition.

### Optional

- `assignable_scopes` (String) List of assignable scopes of this definition.
...
- `permissions` (String) Set of role definition permissions. See https://docs.microsoft.com/en-us/azure/app-service/app-service-web-overview for more info.
...
- `state` (String) Assert the state of the role definition. Use `present` to create or update a role definition; use `absent` to delete it.
