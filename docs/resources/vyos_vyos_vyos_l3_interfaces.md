...
page_title: "terrible_vyos_vyos_vyos_l3_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_l3_interfaces (Resource)
...
- `config` (String) The provided L3 interfaces configuration.
