...
page_title: "terrible_cisco_dnac_product_names_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_product_names_info (Resource)
...
- `productNameOrdinal` (Number) ProductNameOrdinal path parameter. Product name ordinal is unique value for each network device product.
