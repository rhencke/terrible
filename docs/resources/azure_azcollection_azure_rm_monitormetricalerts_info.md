...
page_title: "terrible_azure_azcollection_azure_rm_monitormetricalerts_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_monitormetricalerts_info (Resource)
...
- `name` (String) The name of the metric alert you're trying to get details about.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `resource_group` (String) The name of the resource group in which the metric alert is (if you use name) The name of the resource group where you want to list metric alerts (if you don't use name)
...
- `metricalerts` (String) List of metric alerts Can be empty if listing metric alerts or metric alert does not exist
