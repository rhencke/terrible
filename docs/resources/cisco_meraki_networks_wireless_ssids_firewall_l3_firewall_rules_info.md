...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_firewall_l3_firewall_rules_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_firewall_l3_firewall_rules_info (Resource)
...
- `networkId` (String) Information module for Networks Wireless Ssids Firewall L3Firewallrules Info. NetworkId path parameter. Network ID.
- `number` (String) Information module for Networks Wireless Ssids Firewall L3Firewallrules Info. Number path parameter.
