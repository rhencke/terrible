...
page_title: "terrible_netapp_ontap_na_ontap_export_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_export_policy (Resource)
...
- `from_name` (String) The name of the export-policy to be renamed.
...
- `state` (String) Whether the specified export policy should exist or not.
