...
page_title: "terrible_dellemc_enterprise_sonic_sonic_l3_acls Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_l3_acls (Resource)
...
- `config` (String) Specifies Layer 3 ACL configurations.
