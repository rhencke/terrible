...
page_title: "terrible_community_dns_hosttech_dns_zone_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_dns_hosttech_dns_zone_info (Resource)
...
- `zone_info` (String) Extra information returned by the API.
- `zone_name` (Number) The name of the zone.
