...
page_title: "terrible_community_general_portinstall Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_portinstall (Resource)
...
- `use_packages` (Boolean) Use packages instead of ports whenever available.
