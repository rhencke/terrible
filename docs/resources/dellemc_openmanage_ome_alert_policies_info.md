...
page_title: "terrible_dellemc_openmanage_ome_alert_policies_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_alert_policies_info (Resource)
...
- `msg` (String) Status of the alert policies info fetch operation.
- `policies` (String) Retrieve information about all the OME alert policies.
