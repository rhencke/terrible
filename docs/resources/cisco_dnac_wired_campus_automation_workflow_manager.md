...
page_title: "terrible_cisco_dnac_wired_campus_automation_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wired_campus_automation_workflow_manager (Resource)
...
- `config` (String) List of wired campus automation configurations to be applied to network devices.
