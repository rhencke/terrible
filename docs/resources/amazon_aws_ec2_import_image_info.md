...
page_title: "terrible_amazon_aws_ec2_import_image_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_import_image_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeImportImageTasks.html for possible filters.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `import_task_ids` (String) The IDs of the import image tasks.
...
- `import_image` (String) A list of EC2 import tasks.
