...
page_title: "terrible_cisco_dnac_site_kpi_summaries_top_n_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_kpi_summaries_top_n_analytics (Resource)
...
- `filters` (String) Site Kpi Summaries Top N Analytics's filters.
