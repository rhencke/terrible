...
page_title: "terrible_amazon_aws_backup_tag Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_backup_tag (Resource)
...
- `resource` (String) The Amazon Resource Name (ARN) of the backup resource.
...
- `purge_tags` (Boolean) Whether unspecified tags should be removed from the resource. Note that when combined with `state=absent`, specified tag keys are not purged regardless of its current value.
