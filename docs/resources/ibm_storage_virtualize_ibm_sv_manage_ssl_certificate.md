...
page_title: "terrible_ibm_storage_virtualize_ibm_sv_manage_ssl_certificate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ibm_storage_virtualize_ibm_sv_manage_ssl_certificate (Resource)
...
- `certificate_type` (String) Specify the certificate type to be exported.
