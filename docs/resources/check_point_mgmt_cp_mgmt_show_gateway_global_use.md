...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_gateway_global_use Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_gateway_global_use (Resource)
...
- `cp_mgmt_show_gateway_global_use` (String) The checkpoint show-gateway-global-use output.
