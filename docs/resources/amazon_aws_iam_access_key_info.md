...
page_title: "terrible_amazon_aws_iam_access_key_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_iam_access_key_info (Resource)
...
- `user_name` (String) The name of the IAM User to which the keys belong.
