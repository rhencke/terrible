...
page_title: "terrible_theforeman_foreman_content_view_version_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_content_view_version_info (Resource)
...
- `content_view` (String) Content View to which the Version belongs
...
- `content_view_versions` (String) List of all found content_view_versions and their details
