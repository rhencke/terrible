...
page_title: "terrible_cisco_meraki_networks_alerts_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_alerts_settings (Resource)
...
- `alerts` (String) Alert-specific configuration for each type. Only alerts that pertain to the network can be updated.
...
- `defaultDestinations` (String) The network-wide destinations for all alerts on the network.
...
- `muting` (String) Mute alerts under certain conditions.
