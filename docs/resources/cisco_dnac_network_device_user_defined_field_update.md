...
page_title: "terrible_cisco_dnac_network_device_user_defined_field_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_user_defined_field_update (Resource)
...
- `deviceId` (String) DeviceId path parameter. UUID of device to which UDF has to be added.
...
- `payload` (String) Network Device User Defined Field Update's payload.
