...
page_title: "terrible_ovirt_ovirt_ovirt_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ovirt_ovirt_ovirt_role (Resource)
...
- `permits` (String) List of permits which role will have Permit 'login' is default and all roles will have it. List can contain name of permit.
...
- `state` (String) Should the role be present/absent.
...
- `ovirt_role` (String) List of dictionaries describing the Roles. Role attributes are mapped to dictionary keys, all Roles attributes can be found at following url: http://ovirt.github.io/ovirt-engine-api-model/master/#types/role.
