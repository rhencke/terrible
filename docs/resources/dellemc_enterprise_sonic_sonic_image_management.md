...
page_title: "terrible_dellemc_enterprise_sonic_sonic_image_management Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_image_management (Resource)
...
- `firmware` (String) Manage installation of Firmware updater
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `image` (String) Manage installation of Enterprise SONiC image.
- `patch` (String) Manage installation of software patch.
...
- `info` (String) Details returned by the specified get operation.
- `status` (String) Status of the operation performed.
