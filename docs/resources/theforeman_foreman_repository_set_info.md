...
page_title: "terrible_theforeman_foreman_repository_set_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_repository_set_info (Resource)
...
- `repository_set` (String) Details about the found Red Hat Repository.
- `repository_sets` (String) List of all found Red Hat Repositories and their details.
