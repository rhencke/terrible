...
page_title: "terrible_azure_azcollection_azure_rm_capacityreservationgroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_capacityreservationgroup (Resource)
...
- `name` (String) The name of the Capacity Reservation Group.
...
- `state` (String) State of the Capacity Reservation Group. Use `present` to create or update and `absent` to delete.
