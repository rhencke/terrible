...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_settings (Resource)
...
- `spoofingProtection` (String) Spoofing protection settings.
