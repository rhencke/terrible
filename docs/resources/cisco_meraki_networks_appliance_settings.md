...
page_title: "terrible_cisco_meraki_networks_appliance_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_settings (Resource)
...
- `dynamicDns` (String) Dynamic DNS settings for a network.
