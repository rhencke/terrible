...
page_title: "terrible_cisco_meraki_networks_appliance_traffic_shaping_vpn_exclusions Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_traffic_shaping_vpn_exclusions (Resource)
...
- `custom` (String) Custom VPN exclusion rules. Pass an empty array to clear existing rules.
...
- `majorApplications` (String) Major Application based VPN exclusion rules. Pass an empty array to clear existing rules.
