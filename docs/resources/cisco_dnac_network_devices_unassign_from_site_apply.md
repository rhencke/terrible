...
page_title: "terrible_cisco_dnac_network_devices_unassign_from_site_apply Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_devices_unassign_from_site_apply (Resource)
...
- `deviceIds` (String) Network device Ids, ranging from a minimum of 1 to a maximum of 100.
