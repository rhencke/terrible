...
page_title: "terrible_cisco_meraki_networks_wireless_alternate_management_interface_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_alternate_management_interface_info (Resource)
...
- `networkId` (String) Information module for Networks Wireless Alternatemanagementinterface Info. NetworkId path parameter. Network ID.
