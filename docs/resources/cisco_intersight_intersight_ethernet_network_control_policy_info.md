...
page_title: "terrible_cisco_intersight_intersight_ethernet_network_control_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_ethernet_network_control_policy_info (Resource)
...
- `name` (String) The name of the Ethernet Network Control Policy to gather information from.
- `organization` (String) The name of the organization the Ethernet Network Control Policy belongs to.
