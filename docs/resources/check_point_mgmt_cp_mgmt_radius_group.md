...
page_title: "terrible_check_point_mgmt_cp_mgmt_radius_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_radius_group (Resource)
...
- `members` (String) Collection of radius servers identified by the name or UID.
...
- `cp_mgmt_radius_group` (String) The checkpoint object created or updated.
