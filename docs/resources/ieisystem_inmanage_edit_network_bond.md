...
page_title: "terrible_ieisystem_inmanage_edit_network_bond Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_network_bond (Resource)
...
- `auto_config` (String) Enable this option to configure the interfaces in service configuration automatically. Only the M5 model supports this parameter.
- `bond` (String) Network bond status, If VLAN is enabled for slave interfaces, then Bonding cannot be enabled.
...
- `interface` (String) Interface name. The M6 model does not support *both*.
