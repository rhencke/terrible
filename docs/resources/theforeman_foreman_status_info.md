...
page_title: "terrible_theforeman_foreman_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_status_info (Resource)
...
- `ping` (String) Detailed service status.
- `status` (String) Basic status of the server.
