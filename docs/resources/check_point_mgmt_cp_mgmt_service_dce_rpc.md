...
page_title: "terrible_check_point_mgmt_cp_mgmt_service_dce_rpc Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_service_dce_rpc (Resource)
...
- `interface_uuid` (String) Network interface UUID.
...
- `cp_mgmt_service_dce_rpc` (String) The checkpoint object created or updated.
