...
page_title: "terrible_azure_azcollection_azure_rm_virtualmachineextension_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualmachineextension_info (Resource)
...
- `virtual_machine_name` (String) The name of the virtual machine containing the extension.
...
- `extensions` (String) A list of dictionaries containing facts for Virtual Machine Extension.
