...
page_title: "terrible_purestorage_flasharray_purefa_console Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_console (Resource)
...
- `state` (String) Define state of console lockout When set to *enable* the console port is locked from root login.
