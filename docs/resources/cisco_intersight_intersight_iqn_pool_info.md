...
page_title: "terrible_cisco_intersight_intersight_iqn_pool_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_iqn_pool_info (Resource)
...
- `name` (String) The name of the IQN Pool that will have information gathered from.
