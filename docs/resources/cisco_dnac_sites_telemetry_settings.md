...
page_title: "terrible_cisco_dnac_sites_telemetry_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sites_telemetry_settings (Resource)
...
- `applicationVisibility` (String) Sites Telemetry Settings's applicationVisibility.
...
- `snmpTraps` (String) Sites Telemetry Settings's snmpTraps.
- `syslogs` (String) Sites Telemetry Settings's syslogs.
...
- `wiredDataCollection` (String) Sites Telemetry Settings's wiredDataCollection.
- `wirelessTelemetry` (String) Sites Telemetry Settings's wirelessTelemetry.
