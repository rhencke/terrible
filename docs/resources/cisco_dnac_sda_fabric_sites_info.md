...
page_title: "terrible_cisco_dnac_sda_fabric_sites_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_sites_info (Resource)
...
- `siteId` (String) SiteId query parameter. ID of the network hierarchy associated with the fabric site.
