...
page_title: "terrible_azure_azcollection_azure_rm_postgresqlflexiblebackup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqlflexiblebackup_info (Resource)
...
- `backup_name` (String) The name of the post gresql backup.
...
- `backup` (String) A list of dictionaries containing facts for PostgreSQL Flexible Backup.
