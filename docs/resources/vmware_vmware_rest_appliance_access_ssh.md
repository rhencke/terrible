...
page_title: "terrible_vmware_vmware_rest_appliance_access_ssh Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_access_ssh (Resource)
...
- `enabled` (Boolean) SSH-based controlled CLI is enabled. This parameter is mandatory.
...
- `value` (Number) Ensure the SSH access ie enabled
