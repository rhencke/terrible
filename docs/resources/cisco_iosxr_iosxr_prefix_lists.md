...
page_title: "terrible_cisco_iosxr_iosxr_prefix_lists Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_prefix_lists (Resource)
...
- `config` (String) A list of prefix-lists configuration.
