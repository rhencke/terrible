...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_domain (Resource)
...
- `servers` (String) Domain servers. When this field is provided, 'set-domain' command is executed asynchronously.
...
- `cp_mgmt_domain` (String) The checkpoint set-domain output.
