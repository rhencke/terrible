...
page_title: "terrible_dellemc_openmanage_idrac_lifecycle_controller_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_idrac_lifecycle_controller_status_info (Resource)
...
- `lc_status_info` (String) Displays the status of the Lifecycle Controller on a Dell PowerEdge server.
- `msg` (String) Overall status of fetching lifecycle controller status.
