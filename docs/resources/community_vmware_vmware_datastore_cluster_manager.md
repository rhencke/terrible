...
page_title: "terrible_community_vmware_vmware_datastore_cluster_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_datastore_cluster_manager (Resource)
...
- `datastores` (String) A list of datastores to be manage.
...
- `state` (String) If set to `present`, datastores specified by `datastores` will be added to the given datastore cluster. If set to `absent`, datastores specified by `datastores` will be moved from the given datastore cluster to datstore folder of the parent datacenter.
...
- `datastore_cluster_info` (String) information about datastore cluster
