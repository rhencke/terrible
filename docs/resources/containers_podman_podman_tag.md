...
page_title: "terrible_containers_podman_podman_tag Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_tag (Resource)
...
- `image` (String) Image to tag.
- `target_names` (String) Additional names.
