...
page_title: "terrible_azure_azcollection_azure_rm_publicipprefix_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_publicipprefix_info (Resource)
...
- `publicipprefix` (String) List of public IP prefixes dicts.
