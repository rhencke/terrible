...
page_title: "terrible_cisco_meraki_networks_webhooks_webhook_tests_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_webhooks_webhook_tests_info (Resource)
...
- `networkId` (String) Information module for Networks Webhooks Webhooktests Info. NetworkId path parameter. Network ID.
...
- `webhookTestId` (String) Information module for Networks Webhooks Webhooktests Info. WebhookTestId path parameter. Webhook test ID.
