...
page_title: "terrible_community_general_cloud_init_data_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_cloud_init_data_facts (Resource)
...
- `cloud_init_data_facts` (String) Facts of result and status.
