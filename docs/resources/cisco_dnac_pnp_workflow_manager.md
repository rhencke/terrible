...
page_title: "terrible_cisco_dnac_pnp_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_pnp_workflow_manager (Resource)
...
- `config_verify` (Boolean) Set to True to verify the Cisco Catalyst Center config after applying the
playbook config.
