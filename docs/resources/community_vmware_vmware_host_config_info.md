...
page_title: "terrible_community_vmware_vmware_host_config_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_config_info (Resource)
...
- `hosts_info` (String) dict with hostname as key and dict with host config information
