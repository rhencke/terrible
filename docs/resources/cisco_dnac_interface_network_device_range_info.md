...
page_title: "terrible_cisco_dnac_interface_network_device_range_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_interface_network_device_range_info (Resource)
...
- `recordsToReturn` (Number) RecordsToReturn path parameter. Number of records to return.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `startIndex` (Number) StartIndex path parameter. Start index.
