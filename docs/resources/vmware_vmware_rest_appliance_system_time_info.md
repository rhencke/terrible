...
page_title: "terrible_vmware_vmware_rest_appliance_system_time_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_system_time_info (Resource)
...
- `value` (String) Get the current time
