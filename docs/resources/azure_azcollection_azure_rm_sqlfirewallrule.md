...
page_title: "terrible_azure_azcollection_azure_rm_sqlfirewallrule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_sqlfirewallrule (Resource)
...
- `end_ip_address` (String) The end IP address of the firewall rule. Must be IPv4 format. Must be greater than or equal to *start_ip_address*. Use value `0.0.0.0` to represent all Azure-internal IP addresses.
...
- `start_ip_address` (String) The start IP address of the firewall rule. Must be IPv4 format. Use value `0.0.0.0` to represent all Azure-internal IP addresses.
- `state` (String) State of the SQL Database. Use `present` to create or update an SQL Database and `absent` to delete it.
