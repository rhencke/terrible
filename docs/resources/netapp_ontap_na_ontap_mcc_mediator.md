...
page_title: "terrible_netapp_ontap_na_ontap_mcc_mediator Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_mcc_mediator (Resource)
...
- `mediator_address` (String) ip address of the mediator
- `mediator_password` (String) password of the mediator
- `mediator_user` (String) username of the mediator
...
- `state` (String) Whether MCCIP Mediator is present or not.
