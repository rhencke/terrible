...
page_title: "terrible_netbox_netbox_netbox_cluster_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_cluster_group (Resource)
...
- `data` (String) Defines the cluster group configuration
...
- `cluster_group` (String) Serialized object as created or already existent within NetBox
