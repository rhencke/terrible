...
page_title: "terrible_azure_azcollection_azure_rm_batchaccountpool_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_batchaccountpool_info (Resource)
...
- `batch_account_pool` (String) Contains information about an pool in a Batch account.
