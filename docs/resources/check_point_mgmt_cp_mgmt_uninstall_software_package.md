...
page_title: "terrible_check_point_mgmt_cp_mgmt_uninstall_software_package Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_uninstall_software_package (Resource)
...
- `cp_mgmt_uninstall_software_package` (String) The checkpoint uninstall-software-package output.
