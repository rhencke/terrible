...
page_title: "terrible_ibm_storage_virtualize_ibm_svctask_command Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ibm_storage_virtualize_ibm_svctask_command (Resource)
...
- `command` (String) A list containing svctask CLI commands to be executed on storage.
