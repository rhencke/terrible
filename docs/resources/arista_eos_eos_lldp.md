...
page_title: "terrible_arista_eos_eos_lldp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_arista_eos_eos_lldp (Resource)
...
- `state` (String) State of the LLDP configuration. If value is *present* lldp will be enabled else if it is *absent* it will be disabled.
