...
page_title: "terrible_cisco_dnac_site_kpi_summaries_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_kpi_summaries_trend_analytics (Resource)
...
- `filters` (String) Site Kpi Summaries Trend Analytics's filters.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Site Kpi Summaries Trend Analytics's page.
