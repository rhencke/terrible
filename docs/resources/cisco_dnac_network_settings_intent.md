...
page_title: "terrible_cisco_dnac_network_settings_intent Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_settings_intent (Resource)
...
- `response_1` (String) A dictionary or list with the response returned by the Cisco DNA Center Python SDK
- `response_2` (String) A dictionary or list with the response returned by the Cisco DNA Center Python SDK
- `response_3` (String) A dictionary or list with the response returned by the Cisco DNA Center Python SDK
