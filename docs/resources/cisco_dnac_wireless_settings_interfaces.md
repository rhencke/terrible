...
page_title: "terrible_cisco_dnac_wireless_settings_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_interfaces (Resource)
...
- `vlanId` (Number) VLAN ID range is 1-4094.
