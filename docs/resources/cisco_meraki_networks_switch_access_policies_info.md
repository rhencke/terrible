...
page_title: "terrible_cisco_meraki_networks_switch_access_policies_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_access_policies_info (Resource)
...
- `accessPolicyNumber` (String) Information module for Networks Switch Accesspolicies Info. AccessPolicyNumber path parameter. Access policy number.
...
- `networkId` (String) Information module for Networks Switch Accesspolicies Info. NetworkId path parameter. Network ID.
