...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_threat_advanced_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_threat_advanced_settings (Resource)
...
- `cp_mgmt_show_threat_advanced_settings` (String) The checkpoint show-threat-advanced-settings output.
