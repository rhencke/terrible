...
page_title: "terrible_cisco_ios_ios_ospf_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_ospf_interfaces (Resource)
...
- `config` (String) A dictionary of OSPF interfaces options.
