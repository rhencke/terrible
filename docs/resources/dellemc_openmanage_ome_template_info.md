...
page_title: "terrible_dellemc_openmanage_ome_template_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_template_info (Resource)
...
- `template_id` (Number) Unique Id of the template.
...
- `msg` (String) Overall template facts status.
- `template_info` (String) Details of the templates.
