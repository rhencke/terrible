...
page_title: "terrible_cisco_meraki_devices_wireless_electronic_shelf_label_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_wireless_electronic_shelf_label_info (Resource)
...
- `serial` (String) Information module for Devices Wireless Electronic Shelf Label Info. Serial path parameter.
