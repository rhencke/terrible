...
page_title: "terrible_vmware_vmware_rest_appliance_access_shell_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_access_shell_info (Resource)
...
- `value` (String) Check if the Shell is enabled
