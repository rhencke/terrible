...
page_title: "terrible_azure_azcollection_azure_rm_dedicatedhost_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_dedicatedhost_info (Resource)
...
- `name` (String) Name of the dedicate host.
...
- `dedicate_hosts` (String) Gets a list of dedicated host.
