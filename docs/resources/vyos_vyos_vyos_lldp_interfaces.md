...
page_title: "terrible_vyos_vyos_vyos_lldp_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_lldp_interfaces (Resource)
...
- `config` (String) A list of LLDP interfaces configurations.
