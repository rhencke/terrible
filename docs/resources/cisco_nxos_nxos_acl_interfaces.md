...
page_title: "terrible_cisco_nxos_nxos_acl_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_acl_interfaces (Resource)
...
- `config` (String) A list of interfaces to be configured with ACLs
