...
page_title: "terrible_cisco_meraki_networks_switch_stp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_stp (Resource)
...
- `stpBridgePriority` (String) STP bridge priority for switches/stacks or switch templates. An empty array will clear the STP bridge priority settings.
