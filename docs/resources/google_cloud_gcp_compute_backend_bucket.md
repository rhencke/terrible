...
page_title: "terrible_google_cloud_gcp_compute_backend_bucket Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_compute_backend_bucket (Resource)
...
- `cdn_policy` (String) Cloud CDN configuration for this Backend Bucket.
...
- `enable_cdn` (Boolean) If true, enable Cloud CDN for this BackendBucket.
...
- `cdnPolicy` (String) Cloud CDN configuration for this Backend Bucket.
