...
page_title: "terrible_cisco_meraki_networks_appliance_traffic_shaping_uplink_bandwidth_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_traffic_shaping_uplink_bandwidth_info (Resource)
...
- `networkId` (String) Information module for Networks Appliance Trafficshaping Uplinkbandwidth Info. NetworkId path parameter. Network ID.
