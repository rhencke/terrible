...
page_title: "terrible_cisco_dnac_user_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_user_info (Resource)
...
- `authSource` (String) AuthSource query parameter. The source that authenticates the user. The value of this query parameter can be set to "internal" or "external". If not provided, then all users will be returned in the response.
...
- `invokeSource` (String) InvokeSource query parameter. The source that invokes this API. The value of this query parameter must be set to "external".
