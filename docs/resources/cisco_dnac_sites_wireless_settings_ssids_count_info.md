...
page_title: "terrible_cisco_dnac_sites_wireless_settings_ssids_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sites_wireless_settings_ssids_count_info (Resource)
...
- `_inherited` (Boolean) _inherited query parameter. This query parameter indicates whether the current SSID count at the given 'siteId' is of the SSID(s) it is inheriting or count of non-inheriting SSID(s).
...
- `siteId` (String) SiteId path parameter. Site UUID.
