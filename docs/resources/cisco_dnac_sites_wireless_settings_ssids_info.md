...
page_title: "terrible_cisco_dnac_sites_wireless_settings_ssids_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sites_wireless_settings_ssids_info (Resource)
...
- `authType` (String) AuthType query parameter. Auth Type.
...
- `l3authType` (String) L3authType query parameter. L3 Auth Type.
...
- `wlanType` (String) WlanType query parameter. Wlan Type.
