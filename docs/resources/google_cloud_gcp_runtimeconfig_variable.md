...
page_title: "terrible_google_cloud_gcp_runtimeconfig_variable Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_runtimeconfig_variable (Resource)
...
- `config` (String) The name of the runtime config that this variable belongs to.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `name` (String) The name of the variable resource.
