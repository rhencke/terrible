...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_login_message Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_login_message (Resource)
...
- `warning` (Boolean) Add warning sign.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `cp_mgmt_set_login_message` (String) The checkpoint set-login-message output.
