...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_ips_update_schedule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_ips_update_schedule (Resource)
...
- `cp_mgmt_show_ips_update_schedule` (String) The checkpoint show-ips-update-schedule output.
