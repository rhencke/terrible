...
page_title: "terrible_community_aws_sns_topic_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_sns_topic_info (Resource)
...
- `result` (String) The result contaning the details of one or all AWS SNS topics.
