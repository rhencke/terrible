...
page_title: "terrible_amazon_aws_ec2_spot_instance_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_spot_instance_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. Filter names and values are case sensitive. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeSpotInstanceRequests.html for possible filters.
...
- `spot_instance_request_ids` (String) One or more Spot Instance request IDs.
...
- `spot_request` (String) The gathered information about specified spot instance requests.
