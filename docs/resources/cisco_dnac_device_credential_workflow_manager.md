...
page_title: "terrible_cisco_dnac_device_credential_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_device_credential_workflow_manager (Resource)
...
- `config` (String) List of details of global device credentials and site names.
...
- `dnac_response1` (String) A dictionary or list with the response returned by the Cisco Catalyst Center Python SDK
- `dnac_response2` (String) A dictionary or list with the response returned by the Cisco Catalyst Center Python SDK
