...
page_title: "terrible_dellemc_openmanage_idrac_syslog Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_idrac_syslog (Resource)
...
- `syslog` (String) Enables or disables an iDRAC syslog.
...
- `msg` (String) Overall status of the syslog export operation.
- `syslog_status` (String) Job details of the syslog operation.
