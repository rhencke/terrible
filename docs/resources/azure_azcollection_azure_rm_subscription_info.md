...
page_title: "terrible_azure_azcollection_azure_rm_subscription_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_subscription_info (Resource)
...
- `all` (Boolean) If true, will return all subscriptions. If false will omit disabled subscriptions (default). Option has no effect when searching by id or name, and will be silently ignored.
...
- `subscriptions` (String) List of subscription dicts.
