...
page_title: "terrible_openstack_cloud_keypair_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_keypair_info (Resource)
...
- `limit` (Number) Requests a page size of items. Returns a number of items up to a limit value.
...
- `keypairs` (String) Lists keypairs that are associated with the account.
