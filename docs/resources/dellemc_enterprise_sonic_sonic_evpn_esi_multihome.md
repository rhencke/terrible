...
page_title: "terrible_dellemc_enterprise_sonic_sonic_evpn_esi_multihome Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_evpn_esi_multihome (Resource)
...
- `config` (String) EVPN ESI multihoming configuration
