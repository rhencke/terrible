...
page_title: "terrible_cisco_meraki_organizations_appliance_vpn_site_to_site_ipsec_peers_slas_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_appliance_vpn_site_to_site_ipsec_peers_slas_info (Resource)
...
- `organizationId` (String) Information module for Organizations Appliance Vpn Site To Site Ipsec Peers Slas Info. OrganizationId path parameter. Organization ID.
