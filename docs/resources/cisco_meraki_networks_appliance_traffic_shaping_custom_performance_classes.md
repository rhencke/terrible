...
page_title: "terrible_cisco_meraki_networks_appliance_traffic_shaping_custom_performance_classes Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_traffic_shaping_custom_performance_classes (Resource)
...
- `maxJitter` (Number) Maximum jitter in milliseconds.
- `maxLatency` (Number) Maximum latency in milliseconds.
- `maxLossPercentage` (Number) Maximum percentage of packet loss.
