...
page_title: "terrible_dellemc_enterprise_sonic_sonic_static_routes Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_static_routes (Resource)
...
- `config` (String) Manages 'static_routes' configurations
