...
page_title: "terrible_cisco_dnac_backup_restore_executions_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_backup_restore_executions_info (Resource)
...
- `backupId` (String) BackupId query parameter. The `backupId` of the backup execution to be retrieved.Obtain the `backupId` from the id attribute in the response of the `/dna/system/api/v1/backups` API.
...
- `jobType` (String) JobType query parameter. The `jobType` of the backup execution to be retrieved.
- `limit` (Number) Limit query parameter. The number of records to show for this page.
- `offset` (Number) Offset query parameter. The first record to show for this page.
...
- `status` (String) Status query parameter. The `status` of the backup execution to be retrieved.
