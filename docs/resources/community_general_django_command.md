...
page_title: "terrible_community_general_django_command Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_django_command (Resource)
...
- `command` (String) Django admin command. It must be a valid command accepted by `python -m django` at the target system.
...
- `extra_args` (String) List of extra arguments passed to the django admin command.
