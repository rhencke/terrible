...
page_title: "terrible_cisco_nxos_nxos_evpn_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_evpn_global (Resource)
...
- `nv_overlay_evpn` (Boolean) EVPN control plane.
...
- `commands` (String) The set of commands to be sent to the remote device
