...
page_title: "terrible_kubernetes_core_k8s_taint Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_kubernetes_core_k8s_taint (Resource)
...
- `taints` (String) List containing the taints.
...
- `replace` (Boolean) If `true`, allow taints to be replaced.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Determines whether to add or remove taints.
...
- `result` (String) The tainted Node object. Will be empty in the case of a deletion.
