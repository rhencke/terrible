...
page_title: "terrible_hetzner_hcloud_placement_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_placement_group (Resource)
...
- `state` (String) State of the placement group.
...
- `hcloud_placement_group` (String) The placement group instance
