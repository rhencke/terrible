...
page_title: "terrible_f5networks_f5_modules_bigip_ltm_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigip_ltm_global (Resource)
...
- `connection` (String) Specifies the connection related general LTM settings.
...
- `default_vs_syn_challenge_tresh` (Number) The default value of per-virtual server SYN Cookie activation threshold.
- `global_syn_challenge_tresh` (Number) The default value of the global SYN Cookie activation threshold.
