...
page_title: "terrible_cisco_mso_mso_schema_template_deploy_status Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_deploy_status (Resource)
...
- `state` (String) Use `query` for listing query of objects.
