...
page_title: "terrible_cisco_dnac_wired_network_devices_network_device_id_config_features_intended_configuration_models_preview_activity_id_config Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wired_network_devices_network_device_id_config_features_intended_configuration_models_preview_activity_id_config (Resource)
...
- `previewActivityId` (String) PreviewActivityId path parameter. Activity id is taskId from Step 1- POST /intent/api/v1/wired/networkDevices/{networkDeviceId}/configFeatures/intended/configurationModels'.
