...
page_title: "terrible_cisco_iosxr_iosxr_vrf_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_vrf_global (Resource)
...
- `config` (String) A dictionary of options for VRF configurations.
