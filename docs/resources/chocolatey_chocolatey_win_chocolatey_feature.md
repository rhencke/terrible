...
page_title: "terrible_chocolatey_chocolatey_win_chocolatey_feature Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_chocolatey_chocolatey_win_chocolatey_feature (Resource)
...
- `name` (String) The name of the feature to manage. Run `choco.exe feature list` to get a list of features that can be managed. For a list of options see [Chocolatey feature docs](https://chocolatey.org/docs/chocolatey-configuration#features)
...
- `state` (String) When `disabled` then the feature will be disabled. When `enabled` then the feature will be enabled.
