...
page_title: "terrible_azure_azcollection_azure_rm_snapshot_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_snapshot_info (Resource)
...
- `state` (String) The description of the snapshot instance facts.
