...
page_title: "terrible_community_vmware_vmware_host_firewall_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_firewall_info (Resource)
...
- `hosts_firewall_info` (String) metadata about host's firewall configuration
