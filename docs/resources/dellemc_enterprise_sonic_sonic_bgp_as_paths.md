...
page_title: "terrible_dellemc_enterprise_sonic_sonic_bgp_as_paths Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_bgp_as_paths (Resource)
...
- `config` (String) A list of 'bgp_as_paths' configurations.
