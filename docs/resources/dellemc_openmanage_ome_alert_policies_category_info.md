...
page_title: "terrible_dellemc_openmanage_ome_alert_policies_category_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_alert_policies_category_info (Resource)
...
- `categories` (String) Information about the alert categories.
...
- `msg` (String) Status of the alert policies category fetch operation.
