...
page_title: "terrible_arista_eos_eos_bgp_address_family Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_arista_eos_eos_bgp_address_family (Resource)
...
- `config` (String) Configurations for BGP address family.
