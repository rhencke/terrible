...
page_title: "terrible_cisco_meraki_networks_netflow Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_netflow (Resource)
...
- `collectorPort` (Number) The port that the NetFlow collector will be listening on.
...
- `etaDstPort` (Number) The port that the Encrypted Traffic Analytics collector will be listening on.
