...
page_title: "terrible_cisco_intersight_intersight_network_connectivity_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_network_connectivity_policy_info (Resource)
...
- `name` (String) The name of the Network Connectivity Policy to gather information from.
- `organization` (String) The name of the organization the Network Connectivity Policy belongs to.
