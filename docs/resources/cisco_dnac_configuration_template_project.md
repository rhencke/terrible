...
page_title: "terrible_cisco_dnac_configuration_template_project Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_configuration_template_project (Resource)
...
- `createTime` (Number) Create time of project.
...
- `lastUpdateTime` (Number) Update time of project.
- `name` (String) Name of project.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `projectId` (String) ProjectId path parameter. ProjectId(UUID) of project to be deleted.
...
- `templates` (String) List of templates within the project.
