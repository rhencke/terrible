...
page_title: "terrible_netapp_ontap_na_ontap_security_ipsec_ca_certificate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_security_ipsec_ca_certificate (Resource)
...
- `name` (String) Name of the CA certificate. Certificate must be already installed in svm or cluster scope.
...
- `state` (String) Create or delete security IPsec CA Certificate. The certificate must already be installed on the system, for instance using na_ontap_security_certificates.
- `svm` (String) Name of svm. If not set cluster scope is assumed.
