...
page_title: "terrible_netapp_storagegrid_na_sg_grid_identity_federation Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_identity_federation (Resource)
...
- `resp` (String) Returns information about the StorageGRID management identity source configuration.
