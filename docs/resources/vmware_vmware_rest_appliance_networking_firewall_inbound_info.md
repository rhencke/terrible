...
page_title: "terrible_vmware_vmware_rest_appliance_networking_firewall_inbound_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_networking_firewall_inbound_info (Resource)
...
- `value` (String) Get the firewall inbound configuration
