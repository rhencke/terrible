...
page_title: "terrible_check_point_mgmt_cp_mgmt_install_lsm_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_install_lsm_policy (Resource)
...
- `cp_mgmt_install_lsm_policy` (String) The checkpoint install-lsm-policy output.
