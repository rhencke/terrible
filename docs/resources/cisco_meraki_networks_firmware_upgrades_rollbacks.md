...
page_title: "terrible_cisco_meraki_networks_firmware_upgrades_rollbacks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_firmware_upgrades_rollbacks (Resource)
...
- `reasons` (String) Reasons for the rollback.
...
- `toVersion` (String) Version to downgrade to (if the network has firmware flexibility).
