...
page_title: "terrible_netapp_storagegrid_na_sg_grid_audit_destination Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_audit_destination (Resource)
...
- `defaults` (String) The defaults will be used to configure audit destinations on all nodes which are not in the nodes array.
...
- `nodes` (String) Optional per-node configuration stanzas in the nodes array override the default configuration.
...
- `state` (String) The audit destination should be present.
...
- `resp` (String) Returns information about the StorageGRID Audit destination.
