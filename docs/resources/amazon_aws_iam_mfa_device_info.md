...
page_title: "terrible_amazon_aws_iam_mfa_device_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_iam_mfa_device_info (Resource)
...
- `user_name` (String) The name of the user whose MFA devices will be listed.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `mfa_devices` (String) The MFA devices registered for the given user.
