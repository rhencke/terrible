...
page_title: "terrible_azure_azcollection_azure_rm_natgateway_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_natgateway_info (Resource)
...
- `name` (String) Only show results for a specific NAT gateway.
...
- `gateways` (String) A list of dictionaries containing facts for a NAT gateway.
