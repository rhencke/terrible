...
page_title: "terrible_cisco_dnac_sites_aaa_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sites_aaa_settings (Resource)
...
- `aaaClient` (String) Sites Aaa Settings's aaaClient.
- `aaaNetwork` (String) Sites Aaa Settings's aaaNetwork.
