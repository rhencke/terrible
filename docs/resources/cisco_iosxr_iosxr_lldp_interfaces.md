...
page_title: "terrible_cisco_iosxr_iosxr_lldp_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_lldp_interfaces (Resource)
...
- `config` (String) A dictionary of LLDP interfaces options.
