...
page_title: "terrible_cisco_ios_ios_bgp_address_family Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_bgp_address_family (Resource)
...
- `config` (String) A list of configurations for bgp address family.
