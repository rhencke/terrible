...
page_title: "terrible_cisco_intersight_intersight_ethernet_network_group_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_ethernet_network_group_policy_info (Resource)
...
- `name` (String) The name of the Ethernet Network Group Policy to gather information from.
- `organization` (String) The name of the organization the Ethernet Network Group Policy belongs to.
