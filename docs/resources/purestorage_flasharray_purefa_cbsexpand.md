...
page_title: "terrible_purestorage_flasharray_purefa_cbsexpand Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_cbsexpand (Resource)
...
- `capacity` (Number) Requested capacity of CBS array in bytes.
...
- `state` (String) Action to be performed on the CBS array. I{list) will provide the options that *capacity*, in bytes, can be set to.
