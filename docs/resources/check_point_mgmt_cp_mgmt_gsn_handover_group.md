...
page_title: "terrible_check_point_mgmt_cp_mgmt_gsn_handover_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_gsn_handover_group (Resource)
...
- `enforce_gtp` (Boolean) Enable enforce GTP signal packet rate limit from this group. Available from R81 management version.
...
- `gtp_rate` (Number) Limit of the GTP rate in PDU/sec. Available from R81 management version.
...
- `members` (String) Collection of GSN handover group members identified by the name or UID.
...
- `cp_mgmt_gsn_handover_group` (String) The checkpoint object created or updated.
