...
page_title: "terrible_check_point_mgmt_cp_mgmt_resource_mms Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_resource_mms (Resource)
...
- `action` (String) Accepts or Drops traffic that matches a Firewall Rule using the Resource.
...
- `track` (String) Logs the activity when a packet matches on a Firewall Rule with the Resource.
...
- `cp_mgmt_resource_mms` (String) The checkpoint object created or updated.
