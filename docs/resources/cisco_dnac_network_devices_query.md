...
page_title: "terrible_cisco_dnac_network_devices_query Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_devices_query (Resource)
...
- `aggregateAttributes` (String) Network Devices Query's aggregateAttributes.
...
- `filters` (String) Network Devices Query's filters.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Network Devices Query's page.
