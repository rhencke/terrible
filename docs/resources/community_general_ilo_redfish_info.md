...
page_title: "terrible_community_general_ilo_redfish_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_ilo_redfish_info (Resource)
...
- `category` (String) List of categories to execute on iLO.
...
- `ilo_redfish_info` (String) Returns iLO sessions.
