...
page_title: "terrible_ngine_io_cloudstack_vpn_gateway Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ngine_io_cloudstack_vpn_gateway (Resource)
...
- `state` (String) State of the VPN gateway.
...
- `public_ip` (String) IP address of the VPN site-to-site gateway.
