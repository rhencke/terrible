...
page_title: "terrible_containers_podman_podman_image_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_image_info (Resource)
...
- `name` (String) List of tags or UID to gather info about. If no name is given return info about all images.
