...
page_title: "terrible_vyos_vyos_vyos_firewall_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_firewall_global (Resource)
...
- `config` (String) A dictionary of Firewall global configuration options.
