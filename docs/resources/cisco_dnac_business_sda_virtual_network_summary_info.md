...
page_title: "terrible_cisco_dnac_business_sda_virtual_network_summary_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_business_sda_virtual_network_summary_info (Resource)
...
- `siteNameHierarchy` (String) SiteNameHierarchy query parameter. Complete fabric siteNameHierarchy Path.
