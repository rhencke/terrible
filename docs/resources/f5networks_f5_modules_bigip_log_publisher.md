...
page_title: "terrible_f5networks_f5_modules_bigip_log_publisher Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigip_log_publisher (Resource)
...
- `name` (String) Specifies the name of the log publisher.
...
- `destinations` (String) Specifies log destinations for this log publisher to use.
