...
page_title: "terrible_cisco_dnac_reports_view_group_view_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_reports_view_group_view_info (Resource)
...
- `viewId` (String) ViewId path parameter. View id of view.
