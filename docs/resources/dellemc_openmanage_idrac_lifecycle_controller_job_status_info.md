...
page_title: "terrible_dellemc_openmanage_idrac_lifecycle_controller_job_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_idrac_lifecycle_controller_job_status_info (Resource)
...
- `job_id` (String) JOB ID in the format "JID_123456789012".
...
- `job_info` (String) Displays the status of a Lifecycle Controller job.
