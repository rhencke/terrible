...
page_title: "terrible_cisco_dnac_application_policy_application_set_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_application_policy_application_set_count_info (Resource)
...
- `scalableGroupType` (String) ScalableGroupType query parameter. Scalable group type to retrieve, valid value APPLICATION_GROUP.
