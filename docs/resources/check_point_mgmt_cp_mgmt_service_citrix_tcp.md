...
page_title: "terrible_check_point_mgmt_cp_mgmt_service_citrix_tcp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_service_citrix_tcp (Resource)
...
- `application` (String) Citrix application name.
...
- `cp_mgmt_service_citrix_tcp` (String) The checkpoint object created or updated.
