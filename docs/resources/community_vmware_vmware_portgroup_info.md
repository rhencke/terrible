...
page_title: "terrible_community_vmware_vmware_portgroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_portgroup_info (Resource)
...
- `hosts_portgroup_info` (String) metadata about host's portgroup configuration
