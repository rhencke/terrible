...
page_title: "terrible_cisco_ios_ios_evpn_ethernet Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_evpn_ethernet (Resource)
...
- `config` (String) A dictionary of L2VPN EVPN Ethernet Segment options
