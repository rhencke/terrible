...
page_title: "terrible_ieisystem_inmanage_update_cpld Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_update_cpld (Resource)
...
- `list` (Boolean) Get cpld list. Only the M5 model supports this parameter.
