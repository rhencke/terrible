...
page_title: "terrible_cisco_meraki_devices_camera_quality_and_retention_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_quality_and_retention_info (Resource)
...
- `serial` (String) Information module for Devices Camera Qualityandretention Info. Serial path parameter.
