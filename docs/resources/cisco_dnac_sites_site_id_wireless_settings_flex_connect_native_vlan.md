...
page_title: "terrible_cisco_dnac_sites_site_id_wireless_settings_flex_connect_native_vlan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sites_site_id_wireless_settings_flex_connect_native_vlan (Resource)
...
- `nativeVlanId` (Number) Native VLAN ID is used for any untagged frames.Range is 1 to 4094.
