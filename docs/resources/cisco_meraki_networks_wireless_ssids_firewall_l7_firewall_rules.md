...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_firewall_l7_firewall_rules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_firewall_l7_firewall_rules (Resource)
...
- `rules` (String) An array of L7 firewall rules for this SSID. Rules will get applied in the same order user has specified in request. Empty array will clear the L7 firewall rule configuration.
