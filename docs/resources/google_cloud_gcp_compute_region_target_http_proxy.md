...
page_title: "terrible_google_cloud_gcp_compute_region_target_http_proxy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_compute_region_target_http_proxy (Resource)
...
- `urlMap` (String) A reference to the RegionUrlMap resource that defines the mapping from URL to the BackendService.
