...
page_title: "terrible_cisco_meraki_devices_cellular_gateway_lan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_cellular_gateway_lan (Resource)
...
- `fixedIpAssignments` (String) List of all fixed IP assignments for a single MG.
...
- `reservedIpRanges` (String) List of all reserved IP ranges for a single MG.
