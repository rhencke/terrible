...
page_title: "terrible_community_sap_libs_sap_pyrfc Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_sap_libs_sap_pyrfc (Resource)
...
- `connection` (String) The required connection details.
- `function` (String) The SAP RFC function to call.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `parameters` (String) The parameters which are needed by the function.
...
- `result` (String) The execution description.
