...
page_title: "terrible_cisco_dnac_floors_floor_id_access_point_positions_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_floors_floor_id_access_point_positions_count_info (Resource)
...
- `macAddress` (String) MacAddress query parameter. Access Point mac address.
