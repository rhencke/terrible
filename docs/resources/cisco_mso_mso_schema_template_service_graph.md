...
page_title: "terrible_cisco_mso_mso_schema_template_service_graph Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_service_graph (Resource)
...
- `description` (String) The description of Service Graph.
...
- `filter_after_first_node` (String) The filter applied after the first node.
...
- `service_graph` (String) The name of the Service Graph to manage.
- `service_nodes` (String) A list of node types to be associated with the Service Graph.
