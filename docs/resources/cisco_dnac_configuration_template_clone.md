...
page_title: "terrible_cisco_dnac_configuration_template_clone Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_configuration_template_clone (Resource)
...
- `projectId` (String) ProjectId query parameter. UUID of the project in which the template needs to be created.
...
- `templateId` (String) TemplateId path parameter. UUID of the template to clone it.
