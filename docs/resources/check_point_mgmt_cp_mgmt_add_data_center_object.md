...
page_title: "terrible_check_point_mgmt_cp_mgmt_add_data_center_object Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_add_data_center_object (Resource)
...
- `cp_mgmt_add_data_center_object` (String) The checkpoint add-data-center-object output.
