...
page_title: "terrible_netbox_netbox_netbox_contact_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_contact_role (Resource)
...
- `data` (String) Defines the contact role configuration
...
- `contact_role` (String) Serialized object as created or already existent within NetBox
