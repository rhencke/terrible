...
page_title: "terrible_netbox_netbox_netbox_tenant_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_tenant_group (Resource)
...
- `data` (String) Defines the tenant group configuration
...
- `tenant_group` (String) Serialized object as created or already existent within NetBox
