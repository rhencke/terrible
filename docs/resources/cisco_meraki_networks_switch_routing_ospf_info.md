...
page_title: "terrible_cisco_meraki_networks_switch_routing_ospf_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_routing_ospf_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Routing Ospf Info. NetworkId path parameter. Network ID.
...
- `vrf` (String) Information module for Networks Switch Routing Ospf Info. Vrf query parameter. The VRF to return the OSPF routing configuration for. When not provided, the default VRF is used. Included on networks with IOS XE 17.18 or higher.
