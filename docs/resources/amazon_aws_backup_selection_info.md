...
page_title: "terrible_amazon_aws_backup_selection_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_backup_selection_info (Resource)
...
- `backup_selection_names` (String) Uniquely identifies the backup plan the selections should be listed for.
...
- `backup_selections` (String) List of backup selection objects. Each element consists of a dict with all the information related to that backup selection.
