...
page_title: "terrible_cisco_meraki_devices_sensor_relationships_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_sensor_relationships_info (Resource)
...
- `serial` (String) Information module for Devices Sensor Relationships Info. Serial path parameter.
