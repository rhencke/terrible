...
page_title: "terrible_netapp_ontap_na_ontap_fcp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_fcp (Resource)
...
- `state` (String) Whether the FCP should be enabled or not.
- `status` (String) Whether the FCP should be up or down
