...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_cellular_firewall_rules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_cellular_firewall_rules (Resource)
...
- `rules` (String) An ordered array of the firewall rules (not including the default rule).
