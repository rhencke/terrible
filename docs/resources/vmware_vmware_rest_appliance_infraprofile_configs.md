...
page_title: "terrible_vmware_vmware_rest_appliance_infraprofile_configs Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_infraprofile_configs (Resource)
...
- `profiles` (String) Profiles to be exported/imported. If unset or empty, all profiles will be returned. When clients pass a value of this structure as a parameter, the field must contain the id of resources returned by `vmware.vmware_rest.appliance_infraprofile_configs`.
...
- `value` (String) Export the ApplianceManagement profile
