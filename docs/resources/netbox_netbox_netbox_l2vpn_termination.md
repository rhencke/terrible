...
page_title: "terrible_netbox_netbox_netbox_l2vpn_termination Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_l2vpn_termination (Resource)
...
- `data` (String) Defines the L2VPN termination configuration
...
- `l2vpn_termination` (String) Serialized object as created or already existent within NetBox
