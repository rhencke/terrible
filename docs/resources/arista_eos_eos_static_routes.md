...
page_title: "terrible_arista_eos_eos_static_routes Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_arista_eos_eos_static_routes (Resource)
...
- `gathered` (String) The configuration as structured data transformed for the running configuration fetched from remote host
- `id` (String) Unique task resource ID
- `parsed` (String) The configuration as structured data transformed for the value of `running_config` option
- `rendered` (String) The set of CLI commands generated from the value in `config` option
