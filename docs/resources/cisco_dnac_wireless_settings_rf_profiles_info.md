...
page_title: "terrible_cisco_dnac_wireless_settings_rf_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_rf_profiles_info (Resource)
...
- `enableRadioType6GHz` (Boolean) EnableRadioType6GHz query parameter. Enable Radio Type6GHz.
- `enableRadioTypeA` (Boolean) EnableRadioTypeA query parameter. Enable Radio TypeA.
- `enableRadioTypeB` (Boolean) EnableRadioTypeB query parameter. Enable Radio TypeB.
...
- `rfProfileName` (String) RfProfileName query parameter. RF Profile Name.
