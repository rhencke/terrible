...
page_title: "terrible_junipernetworks_junos_junos_ntp_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_ntp_global (Resource)
...
- `config` (String) A dictionary of NTP configuration.
