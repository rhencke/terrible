...
page_title: "terrible_amazon_aws_ec2_vpc_endpoint_service_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_endpoint_service_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcEndpointServices.html for possible filters.
...
- `service_names` (String) A list of service names which can be used to narrow the search results.
...
- `service_details` (String) Detailed information about the AWS VPC endpoint services.
