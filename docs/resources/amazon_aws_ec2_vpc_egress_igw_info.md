...
page_title: "terrible_amazon_aws_ec2_vpc_egress_igw_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_egress_igw_info (Resource)
...
- `egress_only_internet_gateway_ids` (String) Get details of specific VPC Egress Internet Gateway ID.
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeEgressOnlyInternetGateways.html for possible filters.
...
- `egress_only_internet_gateways` (String) The AWS Egress only internet gateways.
