...
page_title: "terrible_community_general_smartos_image_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_smartos_image_info (Resource)
...
- `filters` (String) Criteria for selecting image. Can be any value from image manifest and `published_date`, `published`, `source`, `clones`, and `size`. More information can be found at https://smartos.org/man/8/imgadm under `imgadm list`.
