...
page_title: "terrible_community_dns_hosttech_dns_record_set_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_dns_hosttech_dns_record_set_info (Resource)
...
- `set` (String) The fetched record set. Is empty if record set does not exist.
- `sets` (String) The list of fetched record sets.
