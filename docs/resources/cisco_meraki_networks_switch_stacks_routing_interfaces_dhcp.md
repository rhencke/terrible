...
page_title: "terrible_cisco_meraki_networks_switch_stacks_routing_interfaces_dhcp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_stacks_routing_interfaces_dhcp (Resource)
...
- `dhcpOptions` (String) Array of DHCP options consisting of code, type and value for the DHCP server running on the switch stack interface.
- `dhcpRelayServerIps` (String) The DHCP relay server IPs to which DHCP packets would get relayed for the switch stack interface.
...
- `fixedIpAssignments` (String) Array of DHCP fixed IP assignments for the DHCP server running on the switch stack interface.
...
- `reservedIpRanges` (String) Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface.
