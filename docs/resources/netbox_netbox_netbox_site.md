...
page_title: "terrible_netbox_netbox_netbox_site Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_site (Resource)
...
- `data` (String) Defines the site configuration
...
- `site` (String) Serialized object as created or already existent within NetBox
