...
page_title: "terrible_f5networks_f5_modules_bigiq_application_fastl4_udp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigiq_application_fastl4_udp (Resource)
...
- `inbound_virtual` (String) Settings to configure the virtual which receives the inbound connection.
