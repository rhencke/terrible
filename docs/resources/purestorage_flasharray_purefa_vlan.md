...
page_title: "terrible_purestorage_flasharray_purefa_vlan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_vlan (Resource)
...
- `name` (String) Interface name, including controller indentifier. VLANs are only supported on iSCSI, NVMe-RoCE and file physical interfaces
- `subnet` (String) Name of subnet interface associated with.
...
- `enabled` (Boolean) Define if VLAN interface is enabled or not.
