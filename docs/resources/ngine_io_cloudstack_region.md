...
page_title: "terrible_ngine_io_cloudstack_region Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ngine_io_cloudstack_region (Resource)
...
- `state` (String) State of the region.
...
- `gslb_service_enabled` (Boolean) Whether the GSLB service is enabled or not.
- `id` (String) Unique task resource ID
- `portable_ip_service_enabled` (Boolean) Whether the portable IP service is enabled or not.
