...
page_title: "terrible_theforeman_foreman_content_credential Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_content_credential (Resource)
...
- `name` (String) Name of the content credential
...
- `content_type` (String) Type of credential Required when creating a new credential
