...
page_title: "terrible_community_vmware_vmware_drs_override Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_drs_override (Resource)
...
- `vm_name` (String) Name of the VM for which the DRS override is set.
...
- `drs_behavior` (String) Desired DRS behavior for the VM.
...
- `msg` (String) A message describing the outcome of the task.
