...
page_title: "terrible_openstack_cloud_identity_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_identity_domain (Resource)
...
- `is_enabled` (Boolean) Whether this domain is enabled or not.
...
- `domain` (String) Dictionary describing the domain.
