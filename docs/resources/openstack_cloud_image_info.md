...
page_title: "terrible_openstack_cloud_image_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_image_info (Resource)
...
- `filters` (String) Dict of properties of the images used for query
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `name` (String) Name or ID of the image
...
- `images` (String) List of dictionaries describing matching images.
