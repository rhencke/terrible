...
page_title: "terrible_cisco_dnac_itsm_integration_events_failed Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_itsm_integration_events_failed (Resource)
...
- `payload` (String) Itsm Integration Events Failed's payload.
