...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_session Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_session (Resource)
...
- `cp_mgmt_set_session` (String) The checkpoint set-session output.
