...
page_title: "terrible_community_general_ilo_redfish_command Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_ilo_redfish_command (Resource)
...
- `ilo_redfish_command` (String) Returns the status of the operation performed on the iLO.
