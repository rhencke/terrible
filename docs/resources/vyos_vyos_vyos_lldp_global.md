...
page_title: "terrible_vyos_vyos_vyos_lldp_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_lldp_global (Resource)
...
- `config` (String) The provided link layer discovery protocol (LLDP) configuration.
...
- `after` (String) The resulting configuration after module invocation.
