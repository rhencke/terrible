...
page_title: "terrible_cisco_dnac_floors_floor_id_planned_access_point_positions_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_floors_floor_id_planned_access_point_positions_count_info (Resource)
...
- `macAddress` (String) MacAddress query parameter. Planned Access Point mac address.
