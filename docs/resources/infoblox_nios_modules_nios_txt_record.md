...
page_title: "terrible_infoblox_nios_modules_nios_txt_record Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_txt_record (Resource)
...
- `ttl` (Number) Configures the TTL to be associated with this txt record.
- `view` (String) Sets the DNS view to associate this tst record with.  The DNS view must already be configured on the system.
