...
page_title: "terrible_check_point_mgmt_cp_mgmt_add_updatable_object Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_add_updatable_object (Resource)
...
- `cp_mgmt_add_updatable_object` (String) The checkpoint add-updatable-object output.
