...
page_title: "terrible_theforeman_foreman_smart_class_parameter_override_value Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_smart_class_parameter_override_value (Resource)
...
- `puppetclass` (String) Puppet Class the Smart Class Parameter belongs to
- `smart_class_parameter` (String) Smart Class Parameter the Override Value belongs to
...
- `omit` (Boolean) Foreman will not send this parameter in classification output
...
- `value` (String) Override value, required if omit is false
