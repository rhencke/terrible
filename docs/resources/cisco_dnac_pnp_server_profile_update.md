...
page_title: "terrible_cisco_dnac_pnp_server_profile_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_pnp_server_profile_update (Resource)
...
- `profile` (String) Pnp Server Profile Update's profile.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `smartAccountId` (String) Smart Account Id.
