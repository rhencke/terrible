...
page_title: "terrible_f5networks_f5_modules_bigip_monitor_udp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigip_monitor_udp (Resource)
...
- `parent` (String) The parent template of this monitor template. Once this value has been set, it cannot be changed. By default, this value is the `udp` parent on the `Common` partition.
