...
page_title: "terrible_community_vmware_vmware_vsan_health_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_vsan_health_info (Resource)
...
- `fetch_from_cache` (Boolean) `true` to return the result from cache directly instead of running the full health check.
...
- `vsan_health_info` (String) vSAN cluster health info
