...
page_title: "terrible_awx_awx_job_cancel Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_job_cancel (Resource)
...
- `job_id` (Number) ID of the job to cancel
...
- `fail_if_not_running` (Boolean) Fail loudly if the *job_id* can not be canceled
