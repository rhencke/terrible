...
page_title: "terrible_netapp_ontap_na_ontap_fdss Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_fdss (Resource)
...
- `name` (String) Specifies the security policy to apply.
- `vserver` (String) Specifies the Vserver that contains the path to which the security policy is applied.
