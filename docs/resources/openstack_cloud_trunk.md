...
page_title: "terrible_openstack_cloud_trunk Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_trunk (Resource)
...
- `name` (String) Name that has to be given to the trunk. This port attribute cannot be updated.
...
- `trunk` (String) Dictionary describing the trunk.
