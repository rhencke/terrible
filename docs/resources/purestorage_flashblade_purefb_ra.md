...
page_title: "terrible_purestorage_flashblade_purefb_ra Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_ra (Resource)
...
- `duration` (Number) Specifies the duration of the remote-assist session in hours It determines the length of time the session will remain active after it's initiated.
...
- `state` (String) Define state of remote assist When set to *enable* the RA port can be exposed using the *debug* module.
