...
page_title: "terrible_theforeman_foreman_subscription_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_subscription_info (Resource)
...
- `subscription` (String) Details about the found subscription
- `subscriptions` (String) List of all found subscriptions and their details
