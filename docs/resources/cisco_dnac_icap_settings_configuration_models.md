...
page_title: "terrible_cisco_dnac_icap_settings_configuration_models Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_icap_settings_configuration_models (Resource)
...
- `payload` (String) Icap Settings Configuration Models's payload.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `previewDescription` (String) PreviewDescription query parameter. The ICAP intent's preview-deploy description string.
