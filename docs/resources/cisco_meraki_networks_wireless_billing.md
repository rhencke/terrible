...
page_title: "terrible_cisco_meraki_networks_wireless_billing Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_billing (Resource)
...
- `plans` (String) Array of billing plans in the node group. (Can configure a maximum of 5).
