...
page_title: "terrible_azure_azcollection_azure_rm_hostgroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_hostgroup_info (Resource)
...
- `hostgroups` (String) Gets a list of dedicated host groups.
