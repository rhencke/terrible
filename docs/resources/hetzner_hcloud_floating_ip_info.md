...
page_title: "terrible_hetzner_hcloud_floating_ip_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_floating_ip_info (Resource)
...
- `name` (String) The name for the Floating IP you want to get.
...
- `hcloud_floating_ip_info` (String) The Floating ip infos as list
