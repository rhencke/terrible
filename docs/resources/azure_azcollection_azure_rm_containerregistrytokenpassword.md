...
page_title: "terrible_azure_azcollection_azure_rm_containerregistrytokenpassword Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_containerregistrytokenpassword (Resource)
...
- `token_id` (String) The ID of the container registry token.
...
- `expiry` (String) The expiry datetime of the password. Sample as 2025/07/25. If not configured, it will never expire.
...
- `name` (String) The name of the password. If not configured, both passwords will be regenerated.
...
- `passwords` (String) A list of dictionaries containing facts for token passwords facts.
