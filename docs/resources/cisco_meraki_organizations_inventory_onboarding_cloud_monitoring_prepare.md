...
page_title: "terrible_cisco_meraki_organizations_inventory_onboarding_cloud_monitoring_prepare Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_inventory_onboarding_cloud_monitoring_prepare (Resource)
...
- `devices` (String) A set of devices to import (or update).
