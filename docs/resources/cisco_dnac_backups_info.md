...
page_title: "terrible_cisco_dnac_backups_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_backups_info (Resource)
...
- `query` (String) Query query parameter. Filter based on the provided text on predefined fields.
