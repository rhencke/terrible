...
page_title: "terrible_google_cloud_gcp_compute_target_vpn_gateway Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_compute_target_vpn_gateway (Resource)
...
- `network` (String) The network this VPN gateway is accepting traffic for. This field represents a link to a Network resource in GCP. It can be specified in two ways. First, you can place a dictionary with key 'selfLink' and value of your resource's selfLink Alternatively, you can add `register: name-of-resource` to a gcp_compute_network task and then set this network field to "{{ name-of-resource }}"
- `region` (String) The region this gateway should sit in.
...
- `forwardingRules` (String) A list of references to the ForwardingRule resources associated with this VPN gateway.
- `id` (String) Unique task resource ID
- `tunnels` (String) A list of references to VpnTunnel resources associated with this VPN gateway.
