...
page_title: "terrible_cisco_intersight_intersight_flow_control_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_flow_control_policy_info (Resource)
...
- `name` (String) The name of the Flow Control Policy to gather information from.
- `organization` (String) The name of the organization the Flow Control Policy belongs to.
