...
page_title: "terrible_cisco_dnac_network_devices_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_devices_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Aggregate Attributes.
...
- `filters` (String) Network Devices Trend Analytics's filters.
- `groupBy` (String) Group By.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Network Devices Trend Analytics's page.
