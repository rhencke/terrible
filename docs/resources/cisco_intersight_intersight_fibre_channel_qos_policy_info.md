...
page_title: "terrible_cisco_intersight_intersight_fibre_channel_qos_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_fibre_channel_qos_policy_info (Resource)
...
- `name` (String) The exact name of the Fibre Channel QoS Policy to retrieve information from. When specified, only the matching policy will be returned.
- `organization` (String) The name of the organization to filter Fibre Channel QoS Policies by. Use 'default' for the default organization. When specified, only policies from this organization will be returned.
...
- `api_response` (String) The API response containing Fibre Channel QoS Policy information. Returns a list.
