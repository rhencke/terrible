...
page_title: "terrible_cisco_meraki_devices_switch_routing_interfaces_dhcp_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_switch_routing_interfaces_dhcp_info (Resource)
...
- `interfaceId` (String) Information module for Devices Switch Routing Interfaces Dhcp Info. InterfaceId path parameter. Interface ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `serial` (String) Information module for Devices Switch Routing Interfaces Dhcp Info. Serial path parameter.
