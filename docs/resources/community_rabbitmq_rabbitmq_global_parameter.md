...
page_title: "terrible_community_rabbitmq_rabbitmq_global_parameter Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_rabbitmq_rabbitmq_global_parameter (Resource)
...
- `name` (String) Name of the global parameter being set
...
- `state` (String) Specify if global parameter is to be added or removed
