...
page_title: "terrible_amazon_aws_rds_subnet_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_rds_subnet_group (Resource)
...
- `name` (String) Database subnet group identifier.
...
- `subnets` (String) List of subnet IDs that make up the database subnet group. Required when `state=present`.
...
- `subnet_group` (String) Dictionary of DB subnet group values,
