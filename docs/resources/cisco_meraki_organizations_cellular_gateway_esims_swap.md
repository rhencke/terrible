...
page_title: "terrible_cisco_meraki_organizations_cellular_gateway_esims_swap Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_cellular_gateway_esims_swap (Resource)
...
- `swaps` (String) Each object represents a swap for one eSIM.
