...
page_title: "terrible_theforeman_foreman_bookmark Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_bookmark (Resource)
...
- `controller` (String) Controller for the bookmark
...
- `public` (Boolean) Make bookmark available for all users
