...
page_title: "terrible_cisco_meraki_networks_cellular_gateway_uplink Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_cellular_gateway_uplink (Resource)
...
- `bandwidthLimits` (String) The bandwidth settings for the 'cellular' uplink.
