...
page_title: "terrible_community_hrobot_storagebox_set_password Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hrobot_storagebox_set_password (Resource)
...
- `password` (String) The new password for the storage box. If not provided, a random password will be created by the Robot API and returned as R`password`. This option is required if `hetzner_token` is provided, since the new API does not support setting (and returning) a random password.
