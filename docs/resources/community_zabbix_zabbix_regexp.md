...
page_title: "terrible_community_zabbix_zabbix_regexp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_regexp (Resource)
...
- `name` (String) Name of this regular expression
...
- `expressions` (String) List of expressions. The regular expression returns true when all expressions return true. Required when `state=present`.
...
- `state` (String) State of the regular expression.
