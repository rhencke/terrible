...
page_title: "terrible_azure_azcollection_azure_rm_virtualwan_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualwan_info (Resource)
...
- `virtual_wans` (String) A list of dict results where the key is the name of the VirtualWan and the values are the facts for that VirtualWan.
