...
page_title: "terrible_cisco_dnac_wireless_access_points_factory_reset_request_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_access_points_factory_reset_request_status_info (Resource)
...
- `taskId` (String) TaskId query parameter. Provide the task id which is returned in the response of ap factory reset post api.
