...
page_title: "terrible_community_aws_ec2_carrier_gateway Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_ec2_carrier_gateway (Resource)
...
- `vpc_id` (String) The VPC ID for the VPC in which to manage the Carrier Gateway.

### Optional

- `async_seconds` (Number) Run the task asynchronously, timing out after this many seconds. 0 = synchronous (default).
- `carrier_gateway_id` (String) The Carrier Gateway ID to manage the Carrier Gateway.
...
- `state` (String) Create or terminate the Carrier Gateway.
