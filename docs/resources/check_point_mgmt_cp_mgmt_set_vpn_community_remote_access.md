...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_vpn_community_remote_access Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_vpn_community_remote_access (Resource)
...
- `override_vpn_domains` (String) The Overrides VPN Domains of the participants GWs. Available from R82 JHF management version.
...
- `user_groups` (String) Collection of User group objects identified by the name or UID.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `cp_mgmt_set_vpn_community_remote_access` (String) The checkpoint set-vpn-community-remote-access output.
