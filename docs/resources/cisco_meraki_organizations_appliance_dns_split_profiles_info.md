...
page_title: "terrible_cisco_meraki_organizations_appliance_dns_split_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_appliance_dns_split_profiles_info (Resource)
...
- `organizationId` (String) Information module for Organizations Appliance Dns Split Profiles Info. OrganizationId path parameter. Organization ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `profileIds` (String) Information module for Organizations Appliance Dns Split Profiles Info. ProfileIds query parameter. Optional parameter to filter the results by profile IDs.
