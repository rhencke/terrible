...
page_title: "terrible_azure_azcollection_azure_rm_virtualnetwork_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualnetwork_info (Resource)
...
- `list_usage` (Boolean) Whether lists usage stats. *list_usage=true* to lists usage stats.
- `name` (String) Only show results for a specific virtual network.
...
- `azure_virtualnetworks` (String) List of virtual network dicts.
- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `virtualnetworks` (String) List of virtual network dicts with same format as `azure.azcollection.azure_rm_virtualnetwork` module parameters.
