...
page_title: "terrible_junipernetworks_junos_junos_routing_options Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_routing_options (Resource)
...
- `config` (String) A dictionary of routing-options configuration.
