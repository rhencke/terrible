...
page_title: "terrible_telekom_mms_icinga_director_icinga_service Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_telekom_mms_icinga_director_icinga_service (Resource)
...
- `object_name` (String) Name of the service.
...
- `service_set` (String) Choose the service set name this single service should be assigned to. This field will be required when `host` is not defined.
...
- `vars` (String) Custom properties of the service.
