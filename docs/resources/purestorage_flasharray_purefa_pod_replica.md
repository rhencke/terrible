...
page_title: "terrible_purestorage_flasharray_purefa_pod_replica Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_pod_replica (Resource)
...
- `name` (String) ActiveDR source pod name
...
- `pause` (Boolean) Pause/unpause a pod replica link
...
- `state` (String) Creates or modifies a pod replica link
...
- `target_pod` (String) Name of target pod Must not be the same as the local pod.
