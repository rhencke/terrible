...
page_title: "terrible_community_aws_lightsail_snapshot Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_lightsail_snapshot (Resource)
...
- `snapshot_name` (String) Name of the new instance snapshot.
...
- `wait` (Boolean) Wait for the instance snapshot to be created before returning.
...
- `snapshot` (String) instance snapshot data
