...
page_title: "terrible_azure_azcollection_azure_rm_containerregistryreplication Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_containerregistryreplication (Resource)
...
- `replication_name` (String) The name of the *replication*.
...
- `status` (String) The status of the replication at the time the operation was called.
