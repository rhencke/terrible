...
page_title: "terrible_cisco_dnac_sda_fabric_multicast_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_multicast_workflow_manager (Resource)
...
- `config` (String) A list of SDA fabric multicast configurations associated with fabric sites. Each entry in the list represents multicast settings for a specific fabric site.
