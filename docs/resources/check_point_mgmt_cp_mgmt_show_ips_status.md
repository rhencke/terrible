...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_ips_status Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_ips_status (Resource)
...
- `cp_mgmt_show_ips_status` (String) The checkpoint show-ips-status output.
