...
page_title: "terrible_cisco_dnac_sda_provision_device Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_provision_device (Resource)
...
- `deviceManagementIpAddress` (String) DeviceManagementIpAddress query parameter. Valid IP address of the device currently provisioned in a fabric site.
...
- `siteNameHierarchy` (String) SiteNameHierarchy of the provisioned device.
