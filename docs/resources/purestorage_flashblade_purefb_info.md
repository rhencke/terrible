...
page_title: "terrible_purestorage_flashblade_purefb_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_info (Resource)
...
- `gather_subset` (String) When supplied, this argument will define the information to be collected. Possible values for this include all, minimum, config, performance, capacity, network, subnets, lags, filesystems, snapshots, buckets, replication, policies, arrays, accounts, admins, ad, kerberos, drives, servers and fleet.
...
- `purefb_info` (String) Returns the information collected from the FlashBlade
