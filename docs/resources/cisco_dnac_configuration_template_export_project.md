...
page_title: "terrible_cisco_dnac_configuration_template_export_project Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_configuration_template_export_project (Resource)
...
- `payload` (String) Configuration Template Export Project's payload.
