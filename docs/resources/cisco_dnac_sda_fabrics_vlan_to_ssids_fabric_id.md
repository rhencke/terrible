...
page_title: "terrible_cisco_dnac_sda_fabrics_vlan_to_ssids_fabric_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabrics_vlan_to_ssids_fabric_id (Resource)
...
- `fabricId` (String) FabricId path parameter. The 'fabricId' represents the Fabric ID of a particular Fabric Site.
...
- `payload` (String) Sda Fabrics Vlan To Ssids Fabric Id's payload.
