...
page_title: "terrible_community_vmware_vmware_host_service_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_service_info (Resource)
...
- `cluster_name` (String) Name of the cluster. Service information about each ESXi server will be returned for given cluster. If `esxi_hostname` is not given, this parameter is required.
...
- `esxi_hostname` (String) ESXi hostname. Service information about this ESXi server will be returned. If `cluster_name` is not given, this parameter is required.
...
- `host_service_info` (String) dict with hostname as key and dict with host service config information
