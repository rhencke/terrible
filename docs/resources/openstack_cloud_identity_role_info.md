...
page_title: "terrible_openstack_cloud_identity_role_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_identity_role_info (Resource)
...
- `domain_id` (String) Domain ID which owns the role.
...
- `name` (String) Name or ID of the role.
...
- `roles` (String) List of dictionaries describing matching identity roles.
