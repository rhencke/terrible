...
page_title: "terrible_openstack_cloud_baremetal_node_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_baremetal_node_info (Resource)
...
- `mac` (String) MAC address that is used to attempt to identify the host.
- `name` (String) Name or ID of the baremetal node.
...
- `baremetal_nodes` (String) Same as `nodes`, kept for backward compatibility.
- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `nodes` (String) Bare Metal node list. A subset of the dictionary keys listed below may
