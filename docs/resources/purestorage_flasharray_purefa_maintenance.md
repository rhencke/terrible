...
page_title: "terrible_purestorage_flasharray_purefa_maintenance Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_maintenance (Resource)
...
- `state` (String) Create or delete maintennance window
