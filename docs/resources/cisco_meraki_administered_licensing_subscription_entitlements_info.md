...
page_title: "terrible_cisco_meraki_administered_licensing_subscription_entitlements_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_administered_licensing_subscription_entitlements_info (Resource)
...
- `skus` (String) Information module for Administered Licensing Subscription Entitlements Info. Skus query parameter. Filter to entitlements with the specified SKUs.
