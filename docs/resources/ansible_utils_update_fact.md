...
page_title: "terrible_ansible_utils_update_fact Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ansible_utils_update_fact (Resource)
...
- `updates` (String) A list of dictionaries, each a desired update to make.
