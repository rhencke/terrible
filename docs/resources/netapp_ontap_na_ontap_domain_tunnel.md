...
page_title: "terrible_netapp_ontap_na_ontap_domain_tunnel Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_domain_tunnel (Resource)
...
- `vserver` (String) The name of the vserver that the domain tunnel should be created or deleted on.
...
- `state` (String) Whether the domain tunnel should exist or not.
