...
page_title: "terrible_check_point_mgmt_cp_mgmt_delete_infinity_idp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_delete_infinity_idp (Resource)
...
- `cp_mgmt_delete_infinity_idp` (String) The checkpoint delete-infinity-idp output.
