...
page_title: "terrible_cisco_nxos_nxos_prefix_lists Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_prefix_lists (Resource)
...
- `config` (String) A list of prefix-list configuration.
