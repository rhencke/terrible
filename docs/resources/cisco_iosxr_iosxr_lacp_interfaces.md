...
page_title: "terrible_cisco_iosxr_iosxr_lacp_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_lacp_interfaces (Resource)
...
- `config` (String) A dictionary of LACP interfaces options.
