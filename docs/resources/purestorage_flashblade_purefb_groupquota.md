...
page_title: "terrible_purestorage_flashblade_purefb_groupquota Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_groupquota (Resource)
...
- `gid` (Number) The group id on which the quota is enforced. Cannot be combined with *gname*
