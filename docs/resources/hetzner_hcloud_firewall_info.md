...
page_title: "terrible_hetzner_hcloud_firewall_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_firewall_info (Resource)
...
- `label_selector` (String) The label selector for the Firewalls you want to get.
- `name` (String) The name for the Firewall you want to get.
...
- `hcloud_firewall_info` (String) List of Firewalls.
