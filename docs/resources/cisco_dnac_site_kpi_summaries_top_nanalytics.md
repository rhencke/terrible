...
page_title: "terrible_cisco_dnac_site_kpi_summaries_top_nanalytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_kpi_summaries_top_nanalytics (Resource)
...
- `filters` (String) Site Kpi Summaries Top Nanalytics's filters.
