...
page_title: "terrible_lowlydba_sqlserver_nonquery Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_lowlydba_sqlserver_nonquery (Resource)
...
- `database` (String) Name of the database to execute the nonquery in.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `nonquery` (String) The nonquery to be executed.
...
- `query_timeout` (Number) Number of seconds to wait before timing out the nonquery execution.
