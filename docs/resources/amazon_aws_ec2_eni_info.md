...
page_title: "terrible_amazon_aws_ec2_eni_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_eni_info (Resource)
...
- `eni_id` (String) The ID of the ENI. This option is mutually exclusive of `filters`.
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeNetworkInterfaces.html for possible filters. This option is mutually exclusive of `eni_id`.
...
- `network_interfaces` (String) List of matching elastic network interfaces.
