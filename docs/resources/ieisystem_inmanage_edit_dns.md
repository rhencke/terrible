...
page_title: "terrible_ieisystem_inmanage_edit_dns Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_dns (Resource)
...
- `dns_manual` (String) DNS Settings. Select whether the DNS interface will be configured manually or automatically.
...
- `domain_manual` (String) Domain Settings. Select whether the domain interface will be configured manually or automatically.
...
- `host_cfg` (String) Host Settings. Select whether the host name will be configured manually or automatically.
