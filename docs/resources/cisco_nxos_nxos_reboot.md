...
page_title: "terrible_cisco_nxos_nxos_reboot Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_reboot (Resource)
...
- `confirm` (Boolean) Safeguard boolean. Set to true if you're sure you want to reboot.
...
- `rebooted` (Boolean) Whether the device was instructed to reboot.
