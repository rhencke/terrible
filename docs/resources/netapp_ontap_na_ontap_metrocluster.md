...
page_title: "terrible_netapp_ontap_na_ontap_metrocluster Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_metrocluster (Resource)
...
- `dr_pairs` (String) disaster recovery pair
...
- `state` (String) Present to set up a MetroCluster
