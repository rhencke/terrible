...
page_title: "terrible_cisco_ios_ios_lag_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_lag_interfaces (Resource)
...
- `config` (String) A list of link aggregation group configurations.
