...
page_title: "terrible_dellemc_enterprise_sonic_sonic_dhcp_snooping Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_dhcp_snooping (Resource)
...
- `config` (String) The DHCP snooping configuration.
