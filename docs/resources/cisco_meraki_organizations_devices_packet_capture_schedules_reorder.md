...
page_title: "terrible_cisco_meraki_organizations_devices_packet_capture_schedules_reorder Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_devices_packet_capture_schedules_reorder (Resource)
...
- `order` (String) Array of schedule IDs and their priorities to reorder.
