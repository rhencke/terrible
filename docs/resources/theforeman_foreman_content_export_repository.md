...
page_title: "terrible_theforeman_foreman_content_export_repository Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_content_export_repository (Resource)
...
- `product` (String) Name of the product that the repository belongs to.
- `repository` (String) Name of the repository to export.
