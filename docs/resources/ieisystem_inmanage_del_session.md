...
page_title: "terrible_ieisystem_inmanage_del_session Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_del_session (Resource)
...
- `sid` (String) Session Id, input "all" to delete all sessions.
