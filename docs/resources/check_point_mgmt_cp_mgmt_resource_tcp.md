...
page_title: "terrible_check_point_mgmt_cp_mgmt_resource_tcp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_resource_tcp (Resource)
...
- `cvp_settings` (String) CVP settings.
...
- `resource_type` (String) The type of the TCP resource.
...
- `ufp_settings` (String) UFP settings.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `cp_mgmt_resource_tcp` (String) The checkpoint object created or updated.
