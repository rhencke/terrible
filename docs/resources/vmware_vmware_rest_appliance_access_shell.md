...
page_title: "terrible_vmware_vmware_rest_appliance_access_shell Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_access_shell (Resource)
...
- `enabled` (Boolean) Enabled can be set to true or false This parameter is mandatory.
...
- `value` (String) Disable the Shell
