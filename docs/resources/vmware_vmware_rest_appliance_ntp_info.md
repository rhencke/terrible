...
page_title: "terrible_vmware_vmware_rest_appliance_ntp_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_ntp_info (Resource)
...
- `value` (String) Get the NTP configuration
