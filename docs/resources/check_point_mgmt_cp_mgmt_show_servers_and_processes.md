...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_servers_and_processes Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_servers_and_processes (Resource)
...
- `cp_mgmt_show_servers_and_processes` (String) The checkpoint show-servers-and-processes output.
