...
page_title: "terrible_azure_azcollection_azure_rm_cdnendpoint_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_cdnendpoint_info (Resource)
...
- `profile_name` (String) Name of CDN profile.
- `resource_group` (String) Name of resource group where this CDN profile belongs to.
...
- `cdnendpoints` (String) List of Azure CDN endpoints.
