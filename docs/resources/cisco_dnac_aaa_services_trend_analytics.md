...
page_title: "terrible_cisco_dnac_aaa_services_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_aaa_services_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Aaa Services Trend Analytics's aggregateAttributes.
...
- `filters` (String) Aaa Services Trend Analytics's filters.
...
- `page` (String) Aaa Services Trend Analytics's page.
