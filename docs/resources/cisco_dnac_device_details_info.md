...
page_title: "terrible_cisco_dnac_device_details_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_device_details_info (Resource)
...
- `searchBy` (String) SearchBy query parameter. MAC Address, device name, or UUID of the network device.
