...
page_title: "terrible_community_vmware_vmware_vm_vss_dvs_migrate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_vm_vss_dvs_migrate (Resource)
...
- `dvportgroup_name` (String) Name of the portgroup to migrate to the virtual machine to
- `host_id` (String) ID of the `terrible_host` to run this task against
- `vm_name` (String) Name of the virtual machine to migrate to a dvSwitch
