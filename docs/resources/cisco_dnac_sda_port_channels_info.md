...
page_title: "terrible_cisco_dnac_sda_port_channels_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_port_channels_info (Resource)
...
- `nativeVlanId` (Number) NativeVlanId query parameter. Native VLAN of the port channel, this option is only applicable to TRUNK connectedDeviceType.(VLAN must be between 1 and 4094. In cases value not set when connectedDeviceType is TRUNK, default value will be '1').
