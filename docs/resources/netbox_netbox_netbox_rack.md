...
page_title: "terrible_netbox_netbox_netbox_rack Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_rack (Resource)
...
- `data` (String) Defines the rack configuration
...
- `rack` (String) Serialized object as created or already existent within NetBox
