...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_gateway_capabilities Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_gateway_capabilities (Resource)
...
- `hardware` (String) Check Point hardware.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `platform` (String) Check Point gateway platform.
...
- `cp_mgmt_show_gateway_capabilities` (String) The checkpoint show-gateway-capabilities output.
