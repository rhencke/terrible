...
page_title: "terrible_junipernetworks_junos_junos_lacp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_lacp (Resource)
...
- `config` (String) A dictionary of LACP global options
