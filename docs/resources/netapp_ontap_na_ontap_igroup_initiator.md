...
page_title: "terrible_netapp_ontap_na_ontap_igroup_initiator Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_igroup_initiator (Resource)
...
- `initiator_group` (String) Name of the initiator group to which the initiator belongs.
- `names` (String) List of initiators to manage.
...
- `force_remove` (Boolean) Forcibly remove the initiators even if there are existing LUNs mapped to the initiator group.
...
- `state` (String) Whether the specified initiator should exist or not in an igroup.
