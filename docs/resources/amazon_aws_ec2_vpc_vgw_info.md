...
page_title: "terrible_amazon_aws_ec2_vpc_vgw_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_vgw_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpnGateways.html for possible filters.
...
- `vpn_gateway_ids` (String) One or more virtual private gateway IDs.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `virtual_gateways` (String) Information about one or more virtual private gateways.
