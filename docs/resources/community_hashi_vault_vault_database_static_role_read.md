...
page_title: "terrible_community_hashi_vault_vault_database_static_role_read Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_database_static_role_read (Resource)
...
- `role_name` (String) The role name to be read from Hashicorp Vault.
