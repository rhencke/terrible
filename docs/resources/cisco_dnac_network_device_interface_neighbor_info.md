...
page_title: "terrible_cisco_dnac_network_device_interface_neighbor_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_interface_neighbor_info (Resource)
...
- `interfaceUuid` (String) InterfaceUuid path parameter. Instanceuuid of interface.
