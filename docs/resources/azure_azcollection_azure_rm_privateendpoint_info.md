...
page_title: "terrible_azure_azcollection_azure_rm_privateendpoint_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_privateendpoint_info (Resource)
...
- `resource_group` (String) Name of resource group, limit results by resource group.
...
- `state` (String) List of private endpoint dict with same format as `azure.azcollection.azure_rm_privateendpoint` module paramter.
