...
page_title: "terrible_community_vmware_vmware_host_passthrough Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_passthrough (Resource)
...
- `devices` (String) List of PCI device name or id.
...
- `state` (String) If `state=present`, passthrough of PCI device will be enabled. If `state=absent`, passthrough of PCI device will be disabled.
...
- `passthrough_configs` (String) list of that PCI devices have been enabled passthrough for each host system.
