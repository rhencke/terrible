...
page_title: "terrible_vultr_cloud_startup_script Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vultr_cloud_startup_script (Resource)
...
- `type` (String) The script type, can not be changed once created.
...
- `vultr_startup_script` (String) Response from Vultr API.
