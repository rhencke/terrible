...
page_title: "terrible_azure_azcollection_azure_rm_virtualmachinesize_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualmachinesize_info (Resource)
...
- `location` (String) Location for which to list the available virtual machine size profiles
...
- `sizes` (String) List of virtual machine size profiles available for the location.
