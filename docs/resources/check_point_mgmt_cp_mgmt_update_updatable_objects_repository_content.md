...
page_title: "terrible_check_point_mgmt_cp_mgmt_update_updatable_objects_repository_content Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_update_updatable_objects_repository_content (Resource)
...
- `cp_mgmt_update_updatable_objects_repository_content` (String) The checkpoint update-updatable-objects-repository-content output.
