...
page_title: "terrible_telekom_mms_icinga_director_icinga_deploy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_telekom_mms_icinga_director_icinga_deploy_info (Resource)
...
- `activities` (String) A list of checksums of activities to query information for
...
- `configs` (String) A list of checksums of configs to query information for
...
- `active_configuration` (String) Checksums of the active configuration Contains current activity checksum, config checksum and a checksum for the stage_name
