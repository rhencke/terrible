...
page_title: "terrible_ieisystem_inmanage_edit_restore_factory_default Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_restore_factory_default (Resource)
...
- `mode` (String) Restore factory defaults mode.
...
- `override` (String) Configuration items that need to be retained. Required when *mode=manual*.
