...
page_title: "terrible_infoblox_nios_modules_nios_nsgroup_forwardstubserver Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_nsgroup_forwardstubserver (Resource)
...
- `external_servers` (String) Specifies the list of name servers to be used
