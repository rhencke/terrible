...
page_title: "terrible_cisco_meraki_devices_switch_routing_static_routes_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_switch_routing_static_routes_info (Resource)
...
- `serial` (String) Information module for Devices Switch Routing Staticroutes Info. Serial path parameter.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `staticRouteId` (String) Information module for Devices Switch Routing Staticroutes Info. StaticRouteId path parameter. Static route ID.
