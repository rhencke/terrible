...
page_title: "terrible_dellemc_enterprise_sonic_sonic_l2_acls Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_l2_acls (Resource)
...
- `config` (String) Specifies Layer 2 ACL configurations.
