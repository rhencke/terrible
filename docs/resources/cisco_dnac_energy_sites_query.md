...
page_title: "terrible_cisco_dnac_energy_sites_query Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_energy_sites_query (Resource)
...
- `aggregateAttributes` (String) Energy Sites Query's aggregateAttributes.
