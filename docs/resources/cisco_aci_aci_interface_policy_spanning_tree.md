...
page_title: "terrible_cisco_aci_aci_interface_policy_spanning_tree Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_aci_aci_interface_policy_spanning_tree (Resource)
...
- `bpdu_filter` (Boolean) The BPDU-Filter state.
- `bpdu_guard` (Boolean) The BPDU-Guard state.
...
- `stp_policy` (String) The name of the STP policy.
