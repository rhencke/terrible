...
page_title: "terrible_azure_azcollection_azure_rm_cognitivesearch_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_cognitivesearch_info (Resource)
...
- `show_keys` (Boolean) Retrieve admin and query keys.
...
- `search` (String) Info for Azure Cognitive Search.
