...
page_title: "terrible_azure_azcollection_azure_rm_galleryimageversion_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_galleryimageversion_info (Resource)
...
- `gallery_image_name` (String) The name of the gallery Image Definition in which the Image Version resides.
...
- `versions` (String) A list of dict results where the key is the name of the version and the values are the info for that version.
