...
page_title: "terrible_netapp_ontap_na_ontap_wwpn_alias Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_wwpn_alias (Resource)
...
- `name` (String) The name of the alias to create or delete.
...
- `state` (String) Whether the specified alias should exist or not.
