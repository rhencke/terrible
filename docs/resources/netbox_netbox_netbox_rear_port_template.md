...
page_title: "terrible_netbox_netbox_netbox_rear_port_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_rear_port_template (Resource)
...
- `data` (String) Defines the rear port template configuration
...
- `rear_port_template` (String) Serialized object as created or already existent within NetBox
