...
page_title: "terrible_netapp_cloudmanager_na_cloudmanager_nss_account Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_cloudmanager_na_cloudmanager_nss_account (Resource)
...
- `username` (String) The NSS username.
...
- `state` (String) Whether the specified nss account should exist or not.
...
- `vsa_list` (String) The working environment list.
