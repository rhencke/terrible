...
page_title: "terrible_community_general_xcc_redfish_command Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_xcc_redfish_command (Resource)
...
- `request_body` (String) The request body to patch or post.
...
- `virtual_media` (String) The options for VirtualMedia commands.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `msg` (String) A message related to the performed action(s).
- `redfish_facts` (String) Resource content.
