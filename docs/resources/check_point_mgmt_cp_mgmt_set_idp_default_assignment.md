...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_idp_default_assignment Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_idp_default_assignment (Resource)
...
- `cp_mgmt_set_idp_default_assignment` (String) The checkpoint set-idp-default-assignment output.
