...
page_title: "terrible_community_proxmox_proxmox_zone_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_proxmox_proxmox_zone_info (Resource)
...
- `type` (String) Filter zones on based on type.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `zones` (String) List of zones. If type is passed it'll filter based on type
