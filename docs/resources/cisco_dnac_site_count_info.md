...
page_title: "terrible_cisco_dnac_site_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_count_info (Resource)
...
- `siteId` (String) SiteId query parameter. Site instance UUID.
