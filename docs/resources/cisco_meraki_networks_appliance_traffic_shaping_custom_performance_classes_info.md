...
page_title: "terrible_cisco_meraki_networks_appliance_traffic_shaping_custom_performance_classes_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_traffic_shaping_custom_performance_classes_info (Resource)
...
- `customPerformanceClassId` (String) Information module for Networks Appliance Trafficshaping Customperformanceclasses Info. CustomPerformanceClassId path parameter. Custom performance class ID.
...
- `networkId` (String) Information module for Networks Appliance Trafficshaping Customperformanceclasses Info. NetworkId path parameter. Network ID.
