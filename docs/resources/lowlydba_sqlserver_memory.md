...
page_title: "terrible_lowlydba_sqlserver_memory Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_lowlydba_sqlserver_memory (Resource)
...
- `max` (Number) The maximum memory in MB that the SQL Server instance can utilize. `0` will automatically calculate the ideal value.
...
- `data` (String) Output from the `Set-DbaMaxMemory` function.
