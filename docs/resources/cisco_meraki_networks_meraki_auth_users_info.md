...
page_title: "terrible_cisco_meraki_networks_meraki_auth_users_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_meraki_auth_users_info (Resource)
...
- `merakiAuthUserId` (String) Information module for Networks Merakiauthusers Info. MerakiAuthUserId path parameter. Meraki auth user ID.
- `networkId` (String) Information module for Networks Merakiauthusers Info. NetworkId path parameter. Network ID.
