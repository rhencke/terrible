...
page_title: "terrible_ngine_io_cloudstack_affinity_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ngine_io_cloudstack_affinity_group (Resource)
...
- `state` (String) State of the affinity group.
