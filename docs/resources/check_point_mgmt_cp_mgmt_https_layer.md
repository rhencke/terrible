...
page_title: "terrible_check_point_mgmt_cp_mgmt_https_layer Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_https_layer (Resource)
...
- `shared` (Boolean) Define the Layer as Shared (TRUE/FALSE).
...
- `cp_mgmt_https_layer` (String) The checkpoint object created or updated.
