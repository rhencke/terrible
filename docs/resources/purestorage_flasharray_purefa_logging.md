...
page_title: "terrible_purestorage_flasharray_purefa_logging Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_logging (Resource)
...
- `limit` (Number) The maximum number of audit events returned
- `log_type` (String) The type of logs to be viewed
