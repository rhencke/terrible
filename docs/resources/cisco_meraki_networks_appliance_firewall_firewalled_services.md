...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_firewalled_services Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_firewalled_services (Resource)
...
- `allowedIps` (String) An array of allowed CIDRs that can access the service. This field is required if "access" is set to "restricted". Otherwise this field is ignored.
