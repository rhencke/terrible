...
page_title: "terrible_netbox_netbox_netbox_l2vpn Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_l2vpn (Resource)
...
- `data` (String) Defines the L2VPN configuration
...
- `l2vpn` (String) Serialized object as created or already existent within NetBox
