...
page_title: "terrible_cisco_dnac_network_device_images_validations_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_images_validations_info (Resource)
...
- `operationType` (String) OperationType query parameter. The operation type, as part of which this validation will get triggered. Available values DISTRIBUTION, ACTIVATION.
