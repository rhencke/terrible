...
page_title: "terrible_azure_azcollection_azure_rm_appgateway_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_appgateway_info (Resource)
...
- `name` (String) Only show results for a specific application gateway.
...
- `gateways` (String) A list of dictionaries containing facts for an application gateway.
