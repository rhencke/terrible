...
page_title: "terrible_cisco_meraki_networks_wireless_ethernet_ports_profiles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ethernet_ports_profiles (Resource)
...
- `ports` (String) AP ports configuration.
...
- `usbPorts` (String) AP usb ports configuration.
