...
page_title: "terrible_ieisystem_inmanage_edit_event_log_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_event_log_policy (Resource)
...
- `policy` (String) Event log policy.
