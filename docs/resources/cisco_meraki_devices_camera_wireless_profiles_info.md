...
page_title: "terrible_cisco_meraki_devices_camera_wireless_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_wireless_profiles_info (Resource)
...
- `serial` (String) Information module for Devices Camera Wirelessprofiles Info. Serial path parameter.
