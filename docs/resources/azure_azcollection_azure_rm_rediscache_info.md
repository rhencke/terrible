...
page_title: "terrible_azure_azcollection_azure_rm_rediscache_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_rediscache_info (Resource)
...
- `resource_group` (String) The resource group to search for the desired Azure Cache for Redis.
...
- `return_access_keys` (Boolean) Indicate weather to return access keys of the Azure Cache for Redis.
...
- `rediscaches` (String) List of Azure Cache for Redis instances.
