...
page_title: "terrible_netbox_netbox_netbox_device Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_device (Resource)
...
- `data` (String) Defines the device configuration
...
- `device` (String) Serialized object as created or already existent within NetBox
