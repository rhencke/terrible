...
page_title: "terrible_dellemc_enterprise_sonic_sonic_acl_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_acl_interfaces (Resource)
...
- `config` (String) Specifies interface access-group configurations.
