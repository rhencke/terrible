...
page_title: "terrible_netapp_ontap_na_ontap_vserver_peer_permissions Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_vserver_peer_permissions (Resource)
...
- `cluster_peer` (String) Specifies name of the peer Cluster.
...
- `state` (String) Whether the specified vserver peer permission should exist or not.
