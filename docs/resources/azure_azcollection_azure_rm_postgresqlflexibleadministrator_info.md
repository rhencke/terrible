...
page_title: "terrible_azure_azcollection_azure_rm_postgresqlflexibleadministrator_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqlflexibleadministrator_info (Resource)
...
- `object_id` (String) Guid of the objectId for the administrator.
...
- `admistrator` (String) A list of dictionaries containing facts for PostgreSQL Flexible Administrator.
