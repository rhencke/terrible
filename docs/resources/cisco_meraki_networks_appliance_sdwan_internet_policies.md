...
page_title: "terrible_cisco_meraki_networks_appliance_sdwan_internet_policies Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_sdwan_internet_policies (Resource)
...
- `wanTrafficUplinkPreferences` (String) Policies with respective traffic filters for an MX network.
