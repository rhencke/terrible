...
page_title: "terrible_junipernetworks_junos_junos_hostname Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_hostname (Resource)
...
- `config` (String) A dictionary of system Hostname configuration.
