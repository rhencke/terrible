...
page_title: "terrible_ansible_windows_win_product_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ansible_windows_win_product_facts (Resource)
...
- `ansible_facts` (String) Dictionary containing all the detailed information about the Windows product and license.
