...
page_title: "terrible_cisco_dnac_maps_export Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_maps_export (Resource)
...
- `siteHierarchyUuid` (String) SiteHierarchyUuid path parameter. The site hierarchy element UUID to export, all child elements starting at this hierarchy element will be included. Limited to a hierarchy that contains 500 or fewer maps.
