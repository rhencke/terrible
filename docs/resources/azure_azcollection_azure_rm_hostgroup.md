...
page_title: "terrible_azure_azcollection_azure_rm_hostgroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_hostgroup (Resource)
...
- `name` (String) The name of the dedicated host group.
...
- `location` (String) Valid Azure location for host group. Defaults to location of resource group.
- `platform_fault_domain_count` (Number) Number of fault domains that the host group can span.
...
- `zones` (String) Availability Zone to use for this host group. Only single zone is supported. The zone can be assigned only during creation. If not provided, the group supports all zones in the region.
