...
page_title: "terrible_cisco_dnac_wired_network_devices_id_config_features_intended_layer2_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wired_network_devices_id_config_features_intended_layer2_info (Resource)
...
- `feature` (String) Feature query parameter. Name of the feature to configure. The API /data/intent/api/wired/networkDevices/{id}/configFeatures/supported/layer2 can be used to get the list of features supported on a device.
