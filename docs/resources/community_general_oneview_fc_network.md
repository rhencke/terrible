...
page_title: "terrible_community_general_oneview_fc_network Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_oneview_fc_network (Resource)
...
- `data` (String) List with the Fibre Channel Network properties.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `state` (String) Indicates the desired state for the Fibre Channel Network resource. `present` ensures data properties are compliant with OneView. `absent` removes the resource from OneView, if it exists.
...
- `fc_network` (String) Has the facts about the managed OneView FC Network.
