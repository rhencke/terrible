...
page_title: "terrible_azure_azcollection_azure_rm_aksagentpoolversion_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_aksagentpoolversion_info (Resource)
...
- `cluster_name` (String) The name of the managed cluster resource.
...
- `azure_orchestrator_version` (String) List of supported kubernetes versions.
