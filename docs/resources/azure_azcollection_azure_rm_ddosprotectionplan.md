...
page_title: "terrible_azure_azcollection_azure_rm_ddosprotectionplan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_ddosprotectionplan (Resource)
...
- `state` (String) Assert the state of the DDoS protection plan. Use `present` to create or update an DDoS protection plan and `absent` to delete it.
