...
page_title: "terrible_ieisystem_inmanage_edit_bios Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_bios (Resource)
...
- `attribute` (String) BIOS setup option. Required when *list=False* and *file_url=None*.
...
- `file_url` (String) BIOS option file. attribute must be used with value. Mutually exclusive with fileurl format, "/directory/filename".
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `list` (Boolean) Show attribute name and configurable value.
...
- `value` (String) BIOS setup option value. Required when *list=False* and *file_url=None*.
