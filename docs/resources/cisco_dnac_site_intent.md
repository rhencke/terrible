...
page_title: "terrible_cisco_dnac_site_intent Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_intent (Resource)
...
- `config` (String) It represents a list of details for creating/managing/deleting sites, including areas, buildings, and floors.
...
- `state` (String) The state of Catalyst Center after module completion.
...
- `response_1` (String) A dictionary with API execution details as returned by the Cisco Catalyst Center Python SDK
- `response_2` (String) A dictionary with existing site details.
- `response_3` (String) A dictionary with API execution details as returned by the Cisco Catalyst Center Python SDK
- `response_4` (String) A list with the response returned by the Cisco Catalyst Center Python
