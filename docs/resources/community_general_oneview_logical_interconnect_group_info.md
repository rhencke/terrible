...
page_title: "terrible_community_general_oneview_logical_interconnect_group_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_oneview_logical_interconnect_group_info (Resource)
...
- `logical_interconnect_groups` (String) Has all the OneView information about the Logical Interconnect Groups.
