...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_nat_rule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_nat_rule (Resource)
...
- `cp_mgmt_set_nat_rule` (String) The checkpoint set-nat-rule output.
