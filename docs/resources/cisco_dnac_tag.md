...
page_title: "terrible_cisco_dnac_tag Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_tag (Resource)
...
- `dynamicRules` (String) Tag's dynamicRules.
...
- `instanceTenantId` (String) InstanceTenantId generated for the tag.
...
- `systemTag` (Boolean) True for system created tags, false for user defined tags.
