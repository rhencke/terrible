...
page_title: "terrible_check_point_mgmt_cp_mgmt_delete_custom_trusted_ca_certificate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_delete_custom_trusted_ca_certificate (Resource)
...
- `cp_mgmt_delete_custom_trusted_ca_certificate` (String) The checkpoint delete-custom-trusted-ca-certificate output.
