...
page_title: "terrible_netbox_netbox_netbox_data_source Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_data_source (Resource)
...
- `data` (String) Defines the data source configuration
...
- `data_source` (String) Serialized object as created or already existent within NetBox
