...
page_title: "terrible_community_aws_mq_broker_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_mq_broker_info (Resource)
...
- `broker_id` (String) Get details for broker with specified ID.
- `broker_name` (String) Get details for broker with specified Name. Is ignored if *broker_id* is specified.
...
- `broker` (String) API response of describe_broker() converted to snake yaml.
