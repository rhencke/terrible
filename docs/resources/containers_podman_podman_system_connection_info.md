...
page_title: "terrible_containers_podman_podman_system_connection_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_system_connection_info (Resource)
...
- `name` (String) Name of the connection to gather info about If not provided, info about all connections will be returned
...
- `connections` (String) Facts from all or specified connections
