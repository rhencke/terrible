...
page_title: "terrible_purestorage_flashblade_purefb_proxy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_proxy (Resource)
...
- `secure` (Boolean) Use http or https as the proxy protocol. True uses https, false uses http.
