...
page_title: "terrible_cisco_dnac_integrate_ise Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_integrate_ise (Resource)
...
- `isCertAcceptedByUser` (Boolean) Value true for accept, false for deny. Remove this field and send empty request payload ( {} ) to retry the failed integration.
