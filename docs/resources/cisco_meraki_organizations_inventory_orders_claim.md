...
page_title: "terrible_cisco_meraki_organizations_inventory_orders_claim Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_inventory_orders_claim (Resource)
...
- `subscriptions` (String) The individual subscriptions to claim.
