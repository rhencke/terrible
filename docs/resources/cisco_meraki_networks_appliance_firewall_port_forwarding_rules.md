...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_port_forwarding_rules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_port_forwarding_rules (Resource)
...
- `rules` (String) An array of port forwarding params.
