...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_l7_firewall_rules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_l7_firewall_rules (Resource)
...
- `rules` (String) An ordered array of the MX L7 firewall rules.
