...
page_title: "terrible_purestorage_flasharray_purefa_phonehome Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_phonehome (Resource)
...
- `excludes` (String) Items that are excluded from phonehome data collection
...
- `state` (String) Define state of phonehome
