...
page_title: "terrible_cisco_dnac_ipam_global_ip_address_pools_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_ipam_global_ip_address_pools_id (Resource)
...
- `addressSpace` (String) Ipam Global Ip Address Pools Id's addressSpace.
...
- `poolType` (String) Once created, a global pool type cannot be changed. Tunnel Assigns IP addresses to site-to-site VPN for IPSec tunneling. Generic used for all other network types.
