...
page_title: "terrible_cisco_dnac_custom_issue_definitions Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_custom_issue_definitions (Resource)
...
- `isNotificationEnabled` (Boolean) Is Notification Enabled.
- `name` (String) Name.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `priority` (String) Priority.
- `rules` (String) Custom Issue Definitions's rules.
