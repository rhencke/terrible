...
page_title: "terrible_cisco_dnac_ipam_global_ip_address_pools_global_ip_address_pool_id_subpools_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_ipam_global_ip_address_pools_global_ip_address_pool_id_subpools_count_info (Resource)
...
- `globalIpAddressPoolId` (String) GlobalIpAddressPoolId path parameter. The `id` of the global IP address pool for which to count subpools.
