...
page_title: "terrible_cisco_dnac_assign_device_to_site Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_assign_device_to_site (Resource)
...
- `device` (String) Assign Device To Site's device.
...
- `siteId` (String) SiteId path parameter. Site Id where device(s) needs to be assigned.
