...
page_title: "terrible_kaytus_ksmanage_edit_m6_log_setting Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_kaytus_ksmanage_edit_m6_log_setting (Resource)
...
- `log_type` (String) Remote Log Type, set when server_id is not none.
...
- `server_port` (Number) Server Address, set when server_id is not none.
