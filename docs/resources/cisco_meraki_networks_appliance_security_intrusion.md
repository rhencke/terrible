...
page_title: "terrible_cisco_meraki_networks_appliance_security_intrusion Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_security_intrusion (Resource)
...
- `protectedNetworks` (String) Set the included/excluded networks from the intrusion engine (optional - omitting will leave current config unchanged). This is available only in 'passthrough' mode.
