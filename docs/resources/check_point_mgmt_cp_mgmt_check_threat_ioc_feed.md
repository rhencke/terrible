...
page_title: "terrible_check_point_mgmt_cp_mgmt_check_threat_ioc_feed Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_check_threat_ioc_feed (Resource)
...
- `ioc_feed` (String) threat ioc feed parameters.
...
- `cp_mgmt_check_threat_ioc_feed` (String) The checkpoint check-threat-ioc-feed output.
