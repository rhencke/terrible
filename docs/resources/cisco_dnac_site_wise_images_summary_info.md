...
page_title: "terrible_cisco_dnac_site_wise_images_summary_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_wise_images_summary_info (Resource)
...
- `siteId` (String) SiteId query parameter. Site identifier to get the aggreagte counts products under the site. The default value is global site id. See https //developer.cisco.com/docs/dna-center(#!get-site) for `siteId`.
