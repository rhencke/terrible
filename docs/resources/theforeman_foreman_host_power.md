...
page_title: "terrible_theforeman_foreman_host_power Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_host_power (Resource)
...
- `name` (String) Name (FQDN) of the host
...
- `power_state` (String) current power state of host
