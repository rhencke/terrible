...
page_title: "terrible_netbox_netbox_netbox_device_bay Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_device_bay (Resource)
...
- `data` (String) Defines the device bay configuration
...
- `device_bay` (String) Serialized object as created or already existent within NetBox
