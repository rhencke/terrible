...
page_title: "terrible_check_point_mgmt_cp_mgmt_service_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_service_group (Resource)
...
- `members` (String) Collection of Network objects identified by the name or UID.
...
- `cp_mgmt_service_group` (String) The checkpoint object created or updated.
