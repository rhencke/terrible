...
page_title: "terrible_azure_azcollection_azure_rm_autoscale_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_autoscale_info (Resource)
...
- `autoscales` (String) List of Azure Scale Settings dicts.
