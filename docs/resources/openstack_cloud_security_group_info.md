...
page_title: "terrible_openstack_cloud_security_group_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_security_group_info (Resource)
...
- `any_tags` (String) A list of tags to filter the list result by. Resources that match any tag in this list will be returned.
...
- `not_any_tags` (String) A list of tags to filter the list result by. Resources that match any tag in this list will be excluded.
- `not_tags` (String) A list of tags to filter the list result by. Resources that match all tags in this list will be excluded.
...
- `security_groups` (String) List of dictionaries describing security groups.
