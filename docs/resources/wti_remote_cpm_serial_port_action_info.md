...
page_title: "terrible_wti_remote_cpm_serial_port_action_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_wti_remote_cpm_serial_port_action_info (Resource)
...
- `port` (String) This is the serial port number that is getting retrieved. It can include a single port number, multiple port numbers separated by commas, a list of port numbers, or an '*' character for all ports.
