...
page_title: "terrible_cisco_dnac_security_advisories_results_network_devices_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_advisories_results_network_devices_count_info (Resource)
...
- `advisoryCount` (Number) AdvisoryCount query parameter. Return network devices with advisoryCount greater than this advisoryCount.
