...
page_title: "terrible_netbox_netbox_netbox_inventory_item Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_inventory_item (Resource)
...
- `data` (String) Defines the inventory item configuration
...
- `inventory_item` (String) Serialized object as created or already existent within NetBox
