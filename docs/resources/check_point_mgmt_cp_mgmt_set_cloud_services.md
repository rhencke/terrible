...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_cloud_services Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_cloud_services (Resource)
...
- `gateways_onboarding_settings` (String) Gateways on-boarding to Infinity Portal settings.
...
- `cp_mgmt_set_cloud_services` (String) The checkpoint set-cloud-services output.
