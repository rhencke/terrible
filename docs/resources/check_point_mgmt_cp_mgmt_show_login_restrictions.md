...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_login_restrictions Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_login_restrictions (Resource)
...
- `cp_mgmt_show_login_restrictions` (String) The checkpoint show-login-restrictions output.
