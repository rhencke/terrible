...
page_title: "terrible_community_general_redis_data_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_redis_data_info (Resource)
...
- `exists` (Boolean) If they key exists in the database.
- `id` (String) Unique task resource ID
- `msg` (String) A short message.
- `value` (String) Value key was set to.
