...
page_title: "terrible_check_point_mgmt_cp_mgmt_lsm_cluster Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_lsm_cluster (Resource)
...
- `main_ip_address` (String) Main IP address.
- `members` (String) Members.
- `name_prefix` (String) A prefix added to the profile name and creates the LSM cluster name.
- `name_suffix` (String) A suffix added to the profile name and creates the LSM cluster name.
...
- `cp_mgmt_lsm_cluster` (String) The checkpoint object created or updated.
