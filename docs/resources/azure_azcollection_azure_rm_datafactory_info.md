...
page_title: "terrible_azure_azcollection_azure_rm_datafactory_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_datafactory_info (Resource)
...
- `if_none_match` (String) ETag of the factory entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned.
...
- `datafactory` (String) Current state fo the data factory.
