...
page_title: "terrible_cisco_aci_aci_aaa_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_aci_aci_aaa_role (Resource)
...
- `description` (String) Description of the aaa role.
...
- `name` (String) The name of the aaa role.
...
- `privileges` (String) The privilege(s) assigned to a role.
