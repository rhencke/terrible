...
page_title: "terrible_cisco_meraki_organizations_wireless_zigbee_door_locks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_wireless_zigbee_door_locks (Resource)
...
- `doorLockId` (String) DoorLockId path parameter. Door lock ID.
