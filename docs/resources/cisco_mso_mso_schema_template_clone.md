...
page_title: "terrible_cisco_mso_mso_schema_template_clone Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_clone (Resource)
...
- `destination_template_display_name` (String) The display name of the destination template.
- `destination_template_name` (String) The name of the destination template.
- `destination_tenant` (String) The name of the destination_schema.
...
- `source_template_name` (String) The name of the source template.
- `state` (String) Use `clone` for adding.
