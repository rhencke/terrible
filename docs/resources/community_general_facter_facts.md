...
page_title: "terrible_community_general_facter_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_facter_facts (Resource)
...
- `arguments` (String) Specifies arguments for facter.
...
- `ansible_facts` (String) Dictionary with one key `facter`.
