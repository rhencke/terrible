...
page_title: "terrible_cisco_dnac_clients_trend_analytics_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_clients_trend_analytics_id (Resource)
...
- `aggregateAttributes` (String) Clients Trend Analytics Id's aggregateAttributes.
...
- `filters` (String) Clients Trend Analytics Id's filters.
...
- `page` (String) Clients Trend Analytics Id's page.
