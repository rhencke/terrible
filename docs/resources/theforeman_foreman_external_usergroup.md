...
page_title: "terrible_theforeman_foreman_external_usergroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_external_usergroup (Resource)
...
- `auth_source` (String) Name of the authentication source to be used for this group
- `host_id` (String) ID of the `terrible_host` to run this task against
- `name` (String) Name of the group
- `usergroup` (String) Name of the linked usergroup
