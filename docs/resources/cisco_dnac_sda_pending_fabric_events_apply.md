...
page_title: "terrible_cisco_dnac_sda_pending_fabric_events_apply Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_pending_fabric_events_apply (Resource)
...
- `payload` (String) Sda Pending Fabric Events Apply's payload.
