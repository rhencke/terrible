...
page_title: "terrible_cisco_iosxr_iosxr_netconf Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_netconf (Resource)
...
- `netconf_vrf` (String) netconf vrf name
...
- `state` (String) Specifies the state of the `iosxr_netconf` resource on the remote device.  If the *state* argument is set to *present* the netconf service will be configured.  If the *state* argument is set to *absent* the netconf service will be removed from the configuration.
