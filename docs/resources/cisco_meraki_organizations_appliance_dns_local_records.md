...
page_title: "terrible_cisco_meraki_organizations_appliance_dns_local_records Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_appliance_dns_local_records (Resource)
...
- `profile` (String) The profile the DNS record is associated with.
- `recordId` (String) RecordId path parameter. Record ID.
