...
page_title: "terrible_cisco_dnac_tags_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_tags_workflow_manager (Resource)
...
- `config` (String) A list of dictionaries defining attributes and parameters required for managing tags and tag memberships. It is used to configure tag and tag membership operations in Cisco Catalyst Center.
...
- `dnac_version` (String) The Catalyst Center version required for using 'tags_workflow_manager' module.
