...
page_title: "terrible_cisco_dnac_topology_layer_3_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_topology_layer_3_info (Resource)
...
- `topologyType` (String) TopologyType path parameter. Type of topology(OSPF,ISIS,etc).
