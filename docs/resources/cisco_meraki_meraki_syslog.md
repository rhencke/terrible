...
page_title: "terrible_cisco_meraki_meraki_syslog Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_meraki_syslog (Resource)
...
- `servers` (String) List of syslog server settings
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Query or edit syslog servers To delete a syslog server, do not include server in list of servers
