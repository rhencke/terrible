...
page_title: "terrible_azure_azcollection_azure_rm_containerregistry_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_containerregistry_info (Resource)
...
- `retrieve_credentials` (Boolean) Retrieve credentials for container registry.
...
- `registries` (String) A list of dictionaries containing facts for registries.
