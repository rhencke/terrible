...
page_title: "terrible_azure_azcollection_azure_rm_loadbalancer_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_loadbalancer_info (Resource)
...
- `resource_group` (String) The resource group to search for the desired load balancer.
...
- `loadbalancers` (String) Gets a list of load balancers.
