...
page_title: "terrible_cisco_meraki_organizations_config_templates_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_config_templates_info (Resource)
...
- `configTemplateId` (String) Information module for Organizations Configtemplates Info. ConfigTemplateId path parameter. Config template ID.
...
- `organizationId` (String) Information module for Organizations Configtemplates Info. OrganizationId path parameter. Organization ID.
