...
page_title: "terrible_cisco_dnac_sda_fabric_zones Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_zones (Resource)
...
- `payload` (String) Sda Fabric Zones's payload.
