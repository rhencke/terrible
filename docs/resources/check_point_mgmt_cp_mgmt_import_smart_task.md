...
page_title: "terrible_check_point_mgmt_cp_mgmt_import_smart_task Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_import_smart_task (Resource)
...
- `file_path` (String) Path to the SmartTask file to be imported. <br>Should be the full file path (example, "/home/admin/exported-smart-task.txt").
...
- `cp_mgmt_import_smart_task` (String) The checkpoint import-smart-task output.
