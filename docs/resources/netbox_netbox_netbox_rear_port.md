...
page_title: "terrible_netbox_netbox_netbox_rear_port Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_rear_port (Resource)
...
- `data` (String) Defines the rear port configuration
...
- `rear_port` (String) Serialized object as created or already existent within NetBox
