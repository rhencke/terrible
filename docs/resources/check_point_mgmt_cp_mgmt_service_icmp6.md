...
page_title: "terrible_check_point_mgmt_cp_mgmt_service_icmp6 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_service_icmp6 (Resource)
...
- `icmp_code` (Number) As listed in, <a href="http,//www.iana.org/assignments/icmp-parameters" target="_blank">RFC 792</a>.
- `icmp_type` (Number) As listed in, <a href="http,//www.iana.org/assignments/icmp-parameters" target="_blank">RFC 792</a>.
...
- `cp_mgmt_service_icmp6` (String) The checkpoint object created or updated.
