...
page_title: "terrible_cisco_meraki_networks_appliance_vlans_settings_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_vlans_settings_info (Resource)
...
- `networkId` (String) Information module for Networks Appliance Vlans Settings Info. NetworkId path parameter. Network ID.
...
- `meraki_response` (Number) A dictionary or list with the response returned by the Cisco Meraki Python SDK
