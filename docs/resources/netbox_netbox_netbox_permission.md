...
page_title: "terrible_netbox_netbox_netbox_permission Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_permission (Resource)
...
- `data` (String) Defines the permission configuration
...
- `permissions` (String) Serialized object as created or already existent within NetBox
