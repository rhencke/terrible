...
page_title: "terrible_community_general_keycloak_realm_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_keycloak_realm_info (Resource)
...
- `auth_keycloak_url` (String) URL to the Keycloak instance.
...
- `realm` (String) They Keycloak realm ID.
...
- `validate_certs` (Boolean) Verify TLS certificates (do not disable this in production).
...
- `realm_info` (String) Representation of the realm public information.
