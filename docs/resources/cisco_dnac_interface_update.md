...
page_title: "terrible_cisco_dnac_interface_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_interface_update (Resource)
...
- `adminStatus` (String) Admin status as ('UP'/'DOWN').
...
- `vlanId` (Number) VLAN Id to be Updated.
- `voiceVlanId` (Number) Voice Vlan Id to be Updated.
