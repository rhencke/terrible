...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_validations Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_validations (Resource)
...
- `cp_mgmt_show_validations` (String) The checkpoint show-validations output.
