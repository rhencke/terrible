...
page_title: "terrible_netbox_netbox_netbox_wireless_link Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_wireless_link (Resource)
...
- `data` (String) Defines the wireless link configuration
...
- `wireless_link` (String) Serialized object as created or already existent within NetBox
