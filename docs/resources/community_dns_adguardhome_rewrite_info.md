...
page_title: "terrible_community_dns_adguardhome_rewrite_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_dns_adguardhome_rewrite_info (Resource)
...
- `rules` (String) The list of fetched rewrite rules.
