...
page_title: "terrible_ieisystem_inmanage_system_log_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_system_log_info (Resource)
...
- `count` (Number) Get the most recent log of a specified number.
...
- `system_file` (String) Store logs to a file.
