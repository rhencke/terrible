...
page_title: "terrible_awx_awx_host Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_host (Resource)
...
- `inventory` (String) Inventory name, ID, or named URL the host should be made a member of.
- `name` (String) The name to use for the host.
...
- `enabled` (Boolean) If the host should be enabled.
...
- `variables` (String) Variables to use for the host.
