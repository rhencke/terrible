...
page_title: "terrible_cisco_dnac_assurance_icap_settings_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_assurance_icap_settings_workflow_manager (Resource)
...
- `config` (String) List of parameters required to configure, create, and deploy ICAP settings in Cisco Catalyst Center.
...
- `config_verify` (Boolean) Set to 'true' to verify the ICAP configuration on Cisco Catalyst Center after deployment.
