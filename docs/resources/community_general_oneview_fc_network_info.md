...
page_title: "terrible_community_general_oneview_fc_network_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_oneview_fc_network_info (Resource)
...
- `fc_networks` (String) Has all the OneView information about the Fibre Channel Networks.
