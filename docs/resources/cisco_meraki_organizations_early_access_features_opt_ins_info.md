...
page_title: "terrible_cisco_meraki_organizations_early_access_features_opt_ins_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_early_access_features_opt_ins_info (Resource)
...
- `optInId` (String) Information module for Organizations Earlyaccess Features Optins Info. OptInId path parameter. Opt in ID.
- `organizationId` (String) Information module for Organizations Earlyaccess Features Optins Info. OrganizationId path parameter. Organization ID.
