...
page_title: "terrible_cisco_dnac_security_rogue_wireless_containment_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_rogue_wireless_containment_status_info (Resource)
...
- `macAddress` (String) MacAddress path parameter. MAC Address of the Wireless Rogue AP.
