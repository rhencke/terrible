...
page_title: "terrible_netbox_netbox_netbox_journal_entry Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_journal_entry (Resource)
...
- `data` (String) Defines the journal entry
...
- `state` (String) Use `new` for adding a journal entry.
...
- `journal_entry` (String) Serialized object as created or already existent within NetBox
