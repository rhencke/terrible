...
page_title: "terrible_cisco_meraki_networks_switch_access_control_lists_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_access_control_lists_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Accesscontrollists Info. NetworkId path parameter. Network ID.
