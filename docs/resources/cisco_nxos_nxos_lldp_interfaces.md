...
page_title: "terrible_cisco_nxos_nxos_lldp_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_lldp_interfaces (Resource)
...
- `config` (String) A list of link layer discovery configurations for interfaces.
