...
page_title: "terrible_azure_azcollection_azure_rm_privateendpointdnszonegroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_privateendpointdnszonegroup (Resource)
...
- `private_endpoint` (String) Name of private endpoint.
- `resource_group` (String) Resource group of the private endpoint.
...
- `private_dns_zone_configs` (String) The Private DNS zones configurations.
