...
page_title: "terrible_netapp_ontap_na_ontap_fdsp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_fdsp (Resource)
...
- `vserver` (String) Specifies the vserver for the security policy.
...
- `state` (String) Whether the specified policy should exist or not.
