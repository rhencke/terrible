...
page_title: "terrible_cisco_dnac_reports_executions_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_reports_executions_info (Resource)
...
- `saveFile` (Boolean) Enable or disable automatic file creation of raw response.
