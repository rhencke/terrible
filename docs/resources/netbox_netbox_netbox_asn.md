...
page_title: "terrible_netbox_netbox_netbox_asn Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_asn (Resource)
...
- `data` (String) Defines the ASN configuration
...
- `asn` (String) Serialized object as created or already existent within NetBox
