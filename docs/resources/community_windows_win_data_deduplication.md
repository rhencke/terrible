...
page_title: "terrible_community_windows_win_data_deduplication Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_windows_win_data_deduplication (Resource)
...
- `drive_letter` (String) Windows drive letter on which to enable data deduplication.
...
- `settings` (String) Dictionary of settings to pass to the Set-DedupVolume powershell command.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Wether to enable or disable data deduplication on the selected volume.
