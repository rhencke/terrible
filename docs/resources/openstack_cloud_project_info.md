...
page_title: "terrible_openstack_cloud_project_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_project_info (Resource)
...
- `filters` (String) A dictionary of meta data to use for filtering projects. Elements of *filters* are passed as query parameters to OpenStack Identity API.
...
- `projects` (String) List of dictionaries describing Identity (Keystone) projects.
