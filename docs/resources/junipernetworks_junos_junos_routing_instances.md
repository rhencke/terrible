...
page_title: "terrible_junipernetworks_junos_junos_routing_instances Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_routing_instances (Resource)
...
- `config` (String) The provided Routing instance configuration list.
