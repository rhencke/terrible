...
page_title: "terrible_cisco_dnac_wired_network_devices_id_config_features_deployed_layer2_feature_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wired_network_devices_id_config_features_deployed_layer2_feature_info (Resource)
...
- `feature` (String) Feature path parameter. Name of the feature to retrieve Layer 2 configuration for. The API /dna/intent/api/v1/networkDevices/{id}/configFeatures/supported/layer2 can be used to get the list of features supported on a device.
