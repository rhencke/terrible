...
page_title: "terrible_purestorage_flashblade_purefb_bladename Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_bladename (Resource)
...
- `name` (String) Name of the FlashBlade. Must conform to correct naming schema.
...
- `state` (String) Set the FlashBlade name
