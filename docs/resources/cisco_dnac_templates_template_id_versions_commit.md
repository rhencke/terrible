...
page_title: "terrible_cisco_dnac_templates_template_id_versions_commit Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_templates_template_id_versions_commit (Resource)
...
- `commitNote` (String) A message to leave as a note with the commit of a template. The maximum length allowed is 255 characters.
...
- `templateId` (String) TemplateId path parameter. The id of the template to commit a new version for, retrieveable from `GET /dna/intent/api/v1/templates`.
