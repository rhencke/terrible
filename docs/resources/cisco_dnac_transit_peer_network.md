...
page_title: "terrible_cisco_dnac_transit_peer_network Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_transit_peer_network (Resource)
...
- `ipTransitSettings` (String) Transit Peer Network's ipTransitSettings.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `sdaTransitSettings` (String) Transit Peer Network's sdaTransitSettings.
