...
page_title: "terrible_cisco_dnac_sda_fabric_transits_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_transits_workflow_manager (Resource)
...
- `config` (String) A list of SDA fabric transit configurations. Each entry in the list represents a transit network configuration.
