...
page_title: "terrible_cisco_nxos_nxos_vrf_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_vrf_interface (Resource)
...
- `interface` (String) Full name of interface to be managed, i.e. Ethernet1/1.
- `vrf` (String) Name of VRF to be managed.
