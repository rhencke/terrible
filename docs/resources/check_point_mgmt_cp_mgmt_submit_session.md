...
page_title: "terrible_check_point_mgmt_cp_mgmt_submit_session Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_submit_session (Resource)
...
- `cp_mgmt_submit_session` (String) The checkpoint submit-session output.
