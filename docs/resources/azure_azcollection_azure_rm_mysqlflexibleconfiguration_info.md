...
page_title: "terrible_azure_azcollection_azure_rm_mysqlflexibleconfiguration_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mysqlflexibleconfiguration_info (Resource)
...
- `settings` (String) A list of dictionaries containing MySQL Server settings.
