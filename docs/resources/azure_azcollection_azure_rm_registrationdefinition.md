...
page_title: "terrible_azure_azcollection_azure_rm_registrationdefinition Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_registrationdefinition (Resource)
...
- `plan` (String) Plan details for the managed services.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `properties` (String) Properties of a registration definition.
- `registration_definition_id` (String) ID of the registration definition. If is not specified, an UUID will be generated for it.
...
- `state` (String) Assert the state of the RegistrationDefinition. Use `present` to create or update an RegistrationDefinition and `absent` to delete it.
