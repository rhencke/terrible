...
page_title: "terrible_ngine_io_cloudstack_instance_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ngine_io_cloudstack_instance_group (Resource)
...
- `state` (String) State of the instance group.
...
- `created` (String) Date when the instance group was created.
