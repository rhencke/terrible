...
page_title: "terrible_netbox_netbox_netbox_tenant Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_tenant (Resource)
...
- `data` (String) Defines the tenant configuration
...
- `tenant` (String) Serialized object as created or already existent within NetBox
