...
page_title: "terrible_dellemc_enterprise_sonic_sonic_sflow Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_sflow (Resource)
...
- `config` (String) Defines configuration and operational state data related to data plane traffic sampling based on sflow.
