...
page_title: "terrible_cisco_meraki_networks_firmware_upgrades_staged_events Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_firmware_upgrades_staged_events (Resource)
...
- `products` (String) Contains firmware upgrade version information.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `stages` (String) All firmware upgrade stages in the network with their start time.
