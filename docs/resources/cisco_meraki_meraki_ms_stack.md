...
page_title: "terrible_cisco_meraki_meraki_ms_stack Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_meraki_ms_stack (Resource)
...
- `serials` (String) List of switch serial numbers which should be included or removed from a stack.
