...
page_title: "terrible_awx_awx_application Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_application (Resource)
...
- `organization` (String) Name, ID, or named URL of organization for application.
...
- `redirect_uris` (String) Allowed urls list, space separated. Required when authorization-grant-type=authorization-code
