...
page_title: "terrible_azure_azcollection_azure_rm_managementgroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_managementgroup (Resource)
...
- `group_id` (String) Management Group ID.
...
- `properties` (String) The properties of the management group.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Assert the state of the ManagementGroup. Use `present` to create or update an ManagementGroup and `absent` to delete it.
