...
page_title: "terrible_hetzner_hcloud_storage_box_snapshot_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_storage_box_snapshot_info (Resource)
...
- `label_selector` (String) Label selector to filter the Storage Box Snapshots to get.
- `name` (String) Name of the Storage Box Snapshot to get.
...
- `hcloud_storage_box_snapshot_info` (String) List of Storage Box Snapshots.
