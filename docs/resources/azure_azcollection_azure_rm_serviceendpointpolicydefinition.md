...
page_title: "terrible_azure_azcollection_azure_rm_serviceendpointpolicydefinition Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_serviceendpointpolicydefinition (Resource)
...
- `name` (String) The name of the service endpoint policy definition name.
- `resource_group` (String) The name of the resource group.
- `service_endpoint_policy_name` (String) The name of the service endpoint policy name.
...
- `service_resources` (String) A list of service resources.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Set to `present` to create or update the service endpoint policy definition. Set to `absent` to remove the service endpoint policy definition.
...
- `serviceendpointpolicydefinition` (String) The fact of the service endpoint policy definitions in a service end point policy.
