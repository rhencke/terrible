...
page_title: "terrible_cisco_meraki_networks_switch_routing_multicast_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_routing_multicast_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Routing Multicast Info. NetworkId path parameter. Network ID.
