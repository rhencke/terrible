...
page_title: "terrible_cisco_meraki_networks_switch_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_settings (Resource)
...
- `macBlocklist` (String) MAC blocklist.
...
- `powerExceptions` (String) Exceptions on a per switch basis to "useCombinedPower".
...
- `uplinkClientSampling` (String) Uplink client sampling.
- `uplinkSelection` (String) Settings related to uplink selection on IOS-XE switches.
