...
page_title: "terrible_openstack_cloud_dns_zone_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_dns_zone_info (Resource)
...
- `email` (String) Email of the zone owner Only applies to primary zones.
...
- `zones` (String) Dictionary describing the DNS zones.
