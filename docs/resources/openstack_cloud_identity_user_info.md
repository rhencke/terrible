...
page_title: "terrible_openstack_cloud_identity_user_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_identity_user_info (Resource)
...
- `domain` (String) Name or ID of the domain containing the user.
...
- `users` (String) Dictionary describing all matching identity users.
