...
page_title: "terrible_cisco_mso_ndo_match_rule_community_term Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_match_rule_community_term (Resource)
...
- `description` (String) The description of the Match Community Term.
...
- `match_community_factors` (String) The list of Match Community Factors.
...
- `name` (String) The name of the Match Community Term.
