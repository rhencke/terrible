...
page_title: "terrible_cisco_dnac_feature_templates_wireless_rrm_fra_configurations Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_feature_templates_wireless_rrm_fra_configurations (Resource)
...
- `featureAttributes` (String) Feature Templates Wireless Rrm Fra Configurations's featureAttributes.
