...
page_title: "terrible_openstack_cloud_server_volume Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_server_volume (Resource)
...
- `server` (String) Name or ID of server you want to attach a volume to
- `volume` (String) Name or id of volume you want to attach to a server
