...
page_title: "terrible_azure_azcollection_azure_rm_openshiftmanagedclusterversion_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_openshiftmanagedclusterversion_info (Resource)
...
- `location` (String) List install versions available for the defined region.
...
- `versions` (String) openshift versions values
