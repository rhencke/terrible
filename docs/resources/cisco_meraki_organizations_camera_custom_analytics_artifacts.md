...
page_title: "terrible_cisco_meraki_organizations_camera_custom_analytics_artifacts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_camera_custom_analytics_artifacts (Resource)
...
- `artifactId` (String) ArtifactId path parameter. Artifact ID.
