...
page_title: "terrible_google_cloud_gcp_compute_target_instance Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_compute_target_instance (Resource)
...
- `nat_policy` (String) NAT option controlling how IPs are NAT'ed to the instance. Currently only NO_NAT (default value) is supported. Some valid choices include: "NO_NAT"
