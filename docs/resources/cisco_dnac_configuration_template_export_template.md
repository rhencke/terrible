...
page_title: "terrible_cisco_dnac_configuration_template_export_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_configuration_template_export_template (Resource)
...
- `payload` (String) Configuration Template Export Template's payload.
