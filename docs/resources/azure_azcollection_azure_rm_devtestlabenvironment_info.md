...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabenvironment_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabenvironment_info (Resource)
...
- `environments` (String) A list of dictionaries containing facts for Environment.
