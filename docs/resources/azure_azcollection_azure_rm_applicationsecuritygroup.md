...
page_title: "terrible_azure_azcollection_azure_rm_applicationsecuritygroup Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_applicationsecuritygroup (Resource)
...
- `state` (String) Assert the state of the Application Security Group. Use `present` to create or update an Application Security Group and `absent` to delete it.
