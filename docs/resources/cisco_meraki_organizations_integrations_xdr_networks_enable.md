...
page_title: "terrible_cisco_meraki_organizations_integrations_xdr_networks_enable Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_integrations_xdr_networks_enable (Resource)
...
- `networks` (String) List containing the network ID and the product type to enable XDR on.
