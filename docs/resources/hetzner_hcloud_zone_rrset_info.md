...
page_title: "terrible_hetzner_hcloud_zone_rrset_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_zone_rrset_info (Resource)
...
- `label_selector` (String) Label selector to filter the Zone RRSets you want to get.
- `name` (String) Name of the Zone RRSets you want to get.
...
- `type` (String) Type of the Zone RRSets you want to get.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `hcloud_zone_rrset_info` (String) Zone RRSet infos as list.
