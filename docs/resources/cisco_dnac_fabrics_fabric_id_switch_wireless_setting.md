...
page_title: "terrible_cisco_dnac_fabrics_fabric_id_switch_wireless_setting Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_fabrics_fabric_id_switch_wireless_setting (Resource)
...
- `enableWireless` (Boolean) Enable Wireless.
- `environment` (String) Environment variables set for the task (dict of name→value).
- `fabricId` (String) FabricId path parameter. The 'fabricId' represents the Fabric ID of a particular Fabric Site. The 'fabricId' can be obtained using the api /dna/intent/api/v1/sda/fabricSites. Example e290f1ee-6c54-4b01-90e6-d701748f0851.
...
- `rollingApUpgrade` (String) Fabrics Fabric Id Switch Wireless Setting's rollingApUpgrade.
