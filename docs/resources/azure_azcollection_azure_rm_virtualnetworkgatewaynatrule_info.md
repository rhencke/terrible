...
page_title: "terrible_azure_azcollection_azure_rm_virtualnetworkgatewaynatrule_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_virtualnetworkgatewaynatrule_info (Resource)
...
- `state` (String) Gets the nat rules for a particular virtual network gateway
