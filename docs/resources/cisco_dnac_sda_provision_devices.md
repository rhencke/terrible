...
page_title: "terrible_cisco_dnac_sda_provision_devices Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_provision_devices (Resource)
...
- `cleanUpConfig` (Boolean) CleanUpConfig query parameter. Enable/disable configuration cleanup for the device(s). Defaults to true.
...
- `payload` (String) Sda Provision Devices's payload.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `siteId` (String) SiteId query parameter. ID of the site hierarchy.
