...
page_title: "terrible_netbox_netbox_netbox_ipam_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_ipam_role (Resource)
...
- `data` (String) Defines the ipam role configuration
...
- `role` (String) Serialized object as created or already existent within NetBox
