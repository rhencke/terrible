...
page_title: "terrible_community_vmware_vmware_host_acceptance_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_acceptance_info (Resource)
...
- `cluster_name` (String) Name of the cluster. Acceptance level of all ESXi host system in the given cluster will be gathered. If `esxi_hostname` is not given, this parameter is required.
...
- `esxi_hostname` (String) ESXi hostname. Acceptance level of this ESXi host system will be gathered. If `cluster_name` is not given, this parameter is required.
...
- `host_acceptance_info` (String) dict with hostname as key and dict with acceptance level facts, error as value
