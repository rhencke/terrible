...
page_title: "terrible_cisco_meraki_devices_wireless_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_wireless_status_info (Resource)
...
- `serial` (String) Information module for Devices Wireless Status Info. Serial path parameter.
