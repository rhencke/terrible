...
page_title: "terrible_azure_azcollection_azure_rm_roledefinition_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_roledefinition_info (Resource)
...
- `scope` (String) The scope of role definition.
...
- `roledefinitions` (String) A list of Role Definition facts.
