...
page_title: "terrible_cisco_nxos_nxos_lldp_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_lldp_global (Resource)
...
- `config` (String) A list of link layer discovery configurations
...
- `state` (String) The state of the configuration after module completion. States `replaced` and `overridden` have the same behaviour for this module.
