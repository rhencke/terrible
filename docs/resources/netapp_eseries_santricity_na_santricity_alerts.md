...
page_title: "terrible_netapp_eseries_santricity_na_santricity_alerts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_eseries_santricity_na_santricity_alerts (Resource)
...
- `server` (String) A fully qualified domain name, IPv4 address, or IPv6 address of a mail server. To use a fully qualified domain name, you must configure a DNS server on both controllers using `netapp_eseries.santricity.na_santricity_mgmt_interface`. - Required when *state=enabled*.
