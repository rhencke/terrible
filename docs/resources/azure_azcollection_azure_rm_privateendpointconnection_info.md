...
page_title: "terrible_azure_azcollection_azure_rm_privateendpointconnection_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_privateendpointconnection_info (Resource)
...
- `endpoint_connection` (String) List of private endpoint connection info.
