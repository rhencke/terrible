...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabvirtualnetwork_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabvirtualnetwork_info (Resource)
...
- `lab_name` (String) The name of DevTest Lab.
...
- `virtualnetworks` (String) A list of dictionaries containing facts for DevTest Lab Virtual Network.
