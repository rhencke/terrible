...
page_title: "terrible_cisco_intersight_intersight_ip_pool_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_ip_pool_info (Resource)
...
- `name` (String) The name of the IP Pool that will have information gathered from.
