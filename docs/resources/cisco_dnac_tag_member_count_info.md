...
page_title: "terrible_cisco_dnac_tag_member_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_tag_member_count_info (Resource)
...
- `memberAssociationType` (String) MemberAssociationType query parameter.
- `memberType` (String) MemberType query parameter.
