...
page_title: "terrible_cisco_dnac_maps_import Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_maps_import (Resource)
...
- `importContextUuid` (String) ImportContextUuid path parameter. The unique import context UUID given by a previous call to Start Import API.
