...
page_title: "terrible_dellemc_openmanage_ome_user_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_user_info (Resource)
...
- `account_id` (Number) Unique Id of the account.
...
- `system_query_options` (String) Options for filtering the output.
...
- `msg` (String) Over all status of fetching user facts.
- `user_info` (String) Details of the user.
