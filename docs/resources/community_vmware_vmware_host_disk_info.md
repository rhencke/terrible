...
page_title: "terrible_community_vmware_vmware_host_disk_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_disk_info (Resource)
...
- `hosts_disk_info` (String) list of information for all disks attached to each ESXi host
