...
page_title: "terrible_check_point_mgmt_cp_mgmt_mobile_access_profile_section Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_mobile_access_profile_section (Resource)
...
- `relative_position` (String) Position in the rulebase. Use of this field is relevant only for "add" operation.
...
- `cp_mgmt_mobile_access_profile_section` (String) The checkpoint object created or updated.
