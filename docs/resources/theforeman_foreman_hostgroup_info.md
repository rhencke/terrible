...
page_title: "terrible_theforeman_foreman_hostgroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_hostgroup_info (Resource)
...
- `hostgroup` (String) Details about the found hostgroup
- `hostgroups` (String) List of all found hostgroups and their details
