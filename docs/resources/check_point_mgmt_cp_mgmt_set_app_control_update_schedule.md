...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_app_control_update_schedule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_app_control_update_schedule (Resource)
...
- `schedule_gateway_update` (String) Application Control & URL Filtering Update Schedule on Gateway.
- `schedule_management_update` (String) Application Control & URL Filtering Update Schedule on Management Server.
...
- `cp_mgmt_set_app_control_update_schedule` (String) The checkpoint set-app-control-update-schedule output.
