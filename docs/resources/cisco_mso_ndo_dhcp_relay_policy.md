...
page_title: "terrible_cisco_mso_ndo_dhcp_relay_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_dhcp_relay_policy (Resource)
...
- `description` (String) The description of the DHCP Relay Policy.
...
- `providers` (String) A list of providers attached to the DHCP Relay Policy. The list of configured providers must contain at least one provider. When the list of providers is null the update will not change existing providers configuration.
- `relay_policy` (String) The name of the DHCP Relay Policy.
- `relay_policy_uuid` (String) The uuid of the DHCP Relay Policy. This parameter is required when the `relay_policy` needs to be updated.
