...
page_title: "terrible_cisco_mso_mso_version Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_version (Resource)
...
- `state` (String) Use `query` for retrieving the version object.
