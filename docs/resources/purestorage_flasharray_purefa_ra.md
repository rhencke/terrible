...
page_title: "terrible_purestorage_flasharray_purefa_ra Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_ra (Resource)
...
- `duration` (Number) Number of hours Remote Assist port stays open for. Must be an integer between 4 and 48
