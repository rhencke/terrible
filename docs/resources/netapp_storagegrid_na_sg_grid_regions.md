...
page_title: "terrible_netapp_storagegrid_na_sg_grid_regions Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_regions (Resource)
...
- `regions` (String) List of the regions.
...
- `state` (String) Whether the specified regions should be present.
...
- `resp` (String) Returns information about the configured regions.
