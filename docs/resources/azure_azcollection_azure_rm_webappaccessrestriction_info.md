...
page_title: "terrible_azure_azcollection_azure_rm_webappaccessrestriction_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_webappaccessrestriction_info (Resource)
...
- `scm_ip_security_restrictions` (String) The web app's SCM access restrictions.
- `scm_ip_security_restrictions_use_main` (Boolean) Whether the HTTP access restrictions are used for SCM access.
