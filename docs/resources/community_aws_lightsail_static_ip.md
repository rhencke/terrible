...
page_title: "terrible_community_aws_lightsail_static_ip Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_lightsail_static_ip (Resource)
...
- `name` (String) Name of the static IP.
...
- `static_ip` (String) static_ipinstance data
