...
page_title: "terrible_azure_azcollection_azure_rm_monitorscheduledqueryrules_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_monitorscheduledqueryrules_info (Resource)
...
- `name` (String) The name of the scheduled query rule you're trying to get details about.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `resource_group` (String) The name of the resource group in which the scheduled query rule is (if you use name) The name of the resource group where you want to list Scheduled query rules (if you don't use name)
...
- `scheduledqueryrules` (String) List of Scheduled query rules Can be empty if listing Scheduled query rules
