...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_software_packages_per_targets Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_software_packages_per_targets (Resource)
...
- `display` (String) Filter the displayed results.
...
- `targets` (String) On what targets to execute this command. Targets may be identified by their object name, or object unique identifier.
...
- `cp_mgmt_show_software_packages_per_targets` (String) The checkpoint show-software-packages-per-targets output.
