...
page_title: "terrible_cisco_dnac_network_device_sync Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_sync (Resource)
...
- `forceSync` (Boolean) ForceSync query parameter.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `payload` (String) Network Device Sync's payload.
