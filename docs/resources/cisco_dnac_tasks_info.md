...
page_title: "terrible_cisco_dnac_tasks_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_tasks_info (Resource)
...
- `endTime` (Number) EndTime query parameter. This is the epoch millisecond end time upto which task records need to be fetched.
...
- `rootId` (String) RootId query parameter. Fetch tasks that have this root Id.
...
- `startTime` (Number) StartTime query parameter. This is the epoch millisecond start time from which tasks need to be fetched.
