...
page_title: "terrible_cisco_dnac_app_policy_intent_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_app_policy_intent_create (Resource)
...
- `createList` (String) App Policy Intent Create's createList.
- `delegate_to_id` (String) ID of another terrible_host to delegate execution to.
- `deleteList` (String) Delete list of Group Based Policy ids.
...
- `updateList` (String) App Policy Intent Create's updateList.
