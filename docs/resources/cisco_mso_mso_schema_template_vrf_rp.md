...
page_title: "terrible_cisco_mso_mso_schema_template_vrf_rp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_vrf_rp (Resource)
...
- `ip` (String) The IP address of the RP.
- `multicast_route_map_policy` (String) The name of the Multicast Route Map Policy. The Multicast Route Map Policy must reside in the same tenant as the tenant associated to the schema. Use `multicast_route_map_policy=""` to remove the Multicast Route Map Policy.
...
- `type` (String) The type of the RP.
