...
page_title: "terrible_cisco_meraki_meraki_mx_network_vlan_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_meraki_mx_network_vlan_settings (Resource)
...
- `vlans_enabled` (Boolean) Whether VLANs are enabled on the network.
