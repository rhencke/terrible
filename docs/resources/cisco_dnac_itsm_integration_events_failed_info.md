...
page_title: "terrible_cisco_dnac_itsm_integration_events_failed_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_itsm_integration_events_failed_info (Resource)
...
- `instanceId` (String) InstanceId query parameter. Instance Id of the failed event as in the Runtime Dashboard.
