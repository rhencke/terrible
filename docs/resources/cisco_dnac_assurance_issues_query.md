...
page_title: "terrible_cisco_dnac_assurance_issues_query Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_assurance_issues_query (Resource)
...
- `filters` (String) Assurance Issues Query's filters.
