...
page_title: "terrible_cisco_meraki_networks_group_policies_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_group_policies_info (Resource)
...
- `groupPolicyId` (String) Information module for Networks Grouppolicies Info. GroupPolicyId path parameter. Group policy ID.
- `headers` (String) Additional headers.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `networkId` (String) Information module for Networks Grouppolicies Info. NetworkId path parameter. Network ID.
