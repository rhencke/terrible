...
page_title: "terrible_community_vmware_vmware_sdrs_vm_overrides_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_sdrs_vm_overrides_info (Resource)
...
- `result` (String) information about datastore clusters with VMs with SDRS enabled
