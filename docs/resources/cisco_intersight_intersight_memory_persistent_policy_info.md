...
page_title: "terrible_cisco_intersight_intersight_memory_persistent_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_memory_persistent_policy_info (Resource)
...
- `name` (String) The name of the Memory Persistent Policy to gather information from.
- `organization` (String) The name of the organization the Memory Persistent Policy belongs to.
