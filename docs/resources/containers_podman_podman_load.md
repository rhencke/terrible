...
page_title: "terrible_containers_podman_podman_load Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_load (Resource)
...
- `input` (String) Path to image file to load.
