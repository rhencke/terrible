...
page_title: "terrible_community_okd_openshift_adm_migrate_template_instances Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_okd_openshift_adm_migrate_template_instances (Resource)
...
- `result` (String) List with all TemplateInstances that have been migrated.
