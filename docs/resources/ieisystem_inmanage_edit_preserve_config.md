...
page_title: "terrible_ieisystem_inmanage_edit_preserve_config Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_preserve_config (Resource)
...
- `setting` (String) Preserve option, all - preserve all config; none - overwrite all config; manual - manual choose.
...
- `override` (String) Configuration items that need to be retained. Required when *setting=manual*.
