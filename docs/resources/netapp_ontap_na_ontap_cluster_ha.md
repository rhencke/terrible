...
page_title: "terrible_netapp_ontap_na_ontap_cluster_ha Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_cluster_ha (Resource)
...
- `state` (String) Whether HA on cluster should be enabled or disabled.
