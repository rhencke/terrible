...
page_title: "terrible_check_point_mgmt_cp_mgmt_change_password_on_next_login Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_change_password_on_next_login (Resource)
...
- `cp_mgmt_change_password_on_next_login` (String) The checkpoint change-password-on-next-login output.
