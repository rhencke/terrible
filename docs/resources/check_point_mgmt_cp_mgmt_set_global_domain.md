...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_global_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_global_domain (Resource)
...
- `servers` (String) Multi Domain Servers. When the field is provided, 'set-global-domain' command is executed asynchronously.
...
- `cp_mgmt_set_global_domain` (String) The checkpoint set-global-domain output.
