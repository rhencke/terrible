...
page_title: "terrible_awx_awx_workflow_approval Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_workflow_approval (Resource)
...
- `name` (String) Name of the Approval node to approve or deny.
- `workflow_job_id` (Number) ID of the workflow job to monitor for approval.

### Optional

- `action` (String) Type of action to take.
