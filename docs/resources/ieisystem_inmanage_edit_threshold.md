...
page_title: "terrible_ieisystem_inmanage_edit_threshold Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_threshold (Resource)
...
- `lc` (Number) Lower critical threshold, should be integer.
- `lnc` (Number) Lower non critical threshold, should be integer.
- `lnr` (Number) Lower non recoverable threshold, should be integer.
...
- `uc` (Number) Up critical threshold, should be integer.
- `unc` (Number) Up non critical threshold, should be integer.
- `unr` (Number) Up non recoverable threshold, should be integer.
