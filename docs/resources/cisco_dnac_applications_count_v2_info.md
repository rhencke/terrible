...
page_title: "terrible_cisco_dnac_applications_count_v2_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_applications_count_v2_info (Resource)
...
- `scalableGroupType` (String) ScalableGroupType query parameter. Scalable group type to retrieve, valid value APPLICATION.
