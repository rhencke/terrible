...
page_title: "terrible_cisco_dnac_wireless_dynamic_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_dynamic_interface (Resource)
...
- `interfaceName` (String) InterfaceName query parameter. Valid interface-name to be deleted.
