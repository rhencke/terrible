...
page_title: "terrible_cisco_meraki_networks_camera_quality_retention_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_camera_quality_retention_profiles_info (Resource)
...
- `networkId` (String) Information module for Networks Camera Qualityretentionprofiles Info. NetworkId path parameter. Network ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `qualityRetentionProfileId` (String) Information module for Networks Camera Qualityretentionprofiles Info. QualityRetentionProfileId path parameter. Quality retention profile ID.
