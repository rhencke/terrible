...
page_title: "terrible_check_point_mgmt_cp_mgmt_override_categorization_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_override_categorization_facts (Resource)
...
- `url` (String) The URL for which we want to update the category and risk definitions, the URL and the object name are the same for Override Categorization.
