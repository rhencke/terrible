...
page_title: "terrible_community_proxysql_proxysql_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_proxysql_proxysql_info (Resource)
...
- `stdout` (String) The number of tables that returns, depends on the underlying proyxsql server version.
