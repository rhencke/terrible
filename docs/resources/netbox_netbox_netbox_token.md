...
page_title: "terrible_netbox_netbox_netbox_token Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_token (Resource)
...
- `data` (String) Defines the token configuration
...
- `token` (String) Serialized object as created or already existent within NetBox
