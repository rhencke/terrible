...
page_title: "terrible_check_point_mgmt_cp_mgmt_data_type_patterns Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_data_type_patterns (Resource)
...
- `number_of_occurrences` (Number) Define how many times the patterns must appear to be considered data to be protected.
- `patterns` (String) Regular expressions to be evaluated.
...
- `cp_mgmt_data_type_patterns` (String) The checkpoint object created or updated.
