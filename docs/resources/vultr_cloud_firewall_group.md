...
page_title: "terrible_vultr_cloud_firewall_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vultr_cloud_firewall_group (Resource)
...
- `description` (String) Description of the firewall group.
...
- `state` (String) State of the firewall group.
...
- `vultr_firewall_group` (String) Response from Vultr API.
