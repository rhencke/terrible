...
page_title: "terrible_community_general_packet_sshkey Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_packet_sshkey (Resource)
...
- `key_file` (String) File with the public key.
- `label` (String) Label for the key. If you keep it empty, it is read from key string.
...
- `sshkeys` (String) Information about sshkeys that were created/removed.
