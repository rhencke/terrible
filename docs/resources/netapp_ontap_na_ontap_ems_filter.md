...
page_title: "terrible_netapp_ontap_na_ontap_ems_filter Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_ems_filter (Resource)
...
- `name` (String) Name of the EMS Filter
...
- `rules` (String) List of EMS filter rules
