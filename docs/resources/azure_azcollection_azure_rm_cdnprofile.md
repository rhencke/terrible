...
page_title: "terrible_azure_azcollection_azure_rm_cdnprofile Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_cdnprofile (Resource)
...
- `resource_group` (String) Name of a resource group where the CDN profile exists or will be created.
...
- `sku` (String) The pricing tier, defines a CDN provider, feature list and rate of the CDN profile. Detailed pricing can be find at https://azure.microsoft.com/en-us/pricing/details/cdn/.
