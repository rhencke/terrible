...
page_title: "terrible_cisco_dnac_dns_services_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_dns_services_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Dns Services Trend Analytics's aggregateAttributes.
...
- `filters` (String) Dns Services Trend Analytics's filters.
...
- `page` (String) Dns Services Trend Analytics's page.
