...
page_title: "terrible_community_vmware_vmware_vm_storage_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_vm_storage_policy_info (Resource)
...
- `spbm_profiles` (String) list of dictionary of SPBM info
