...
page_title: "terrible_azure_azcollection_azure_rm_sqldatabase_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_sqldatabase_info (Resource)
...
- `elastic_pool_name` (String) The name of the elastic pool.
...
- `databases` (String) A list of dictionaries containing facts for SQL Database.
