...
page_title: "terrible_community_general_ip2location_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_ip2location_info (Resource)
...
- `http_agent` (String) Set HTTP user agent.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `ip` (String) IP address to retrieve geolocation information.
...
- `record` (String) Dictionary of IP geolocation information for the IP address.
