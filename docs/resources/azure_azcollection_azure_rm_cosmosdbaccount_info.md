...
page_title: "terrible_azure_azcollection_azure_rm_cosmosdbaccount_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_cosmosdbaccount_info (Resource)
...
- `retrieve_connection_strings` (Boolean) Retrieve connection strings.
- `retrieve_keys` (String) Retrieve keys and connection strings.
...
- `accounts` (String) A list of dictionaries containing facts for Database Account.
