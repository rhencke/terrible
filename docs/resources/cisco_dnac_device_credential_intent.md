...
page_title: "terrible_cisco_dnac_device_credential_intent Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_device_credential_intent (Resource)
...
- `state` (String) The state of Cisco DNA Center after module completion.
...
- `dnac_response1` (String) A dictionary or list with the response returned by the Cisco DNAC Python SDK
- `dnac_response2` (String) A dictionary or list with the response returned by the Cisco DNAC Python SDK
