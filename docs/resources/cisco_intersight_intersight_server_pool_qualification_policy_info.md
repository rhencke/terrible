...
page_title: "terrible_cisco_intersight_intersight_server_pool_qualification_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_server_pool_qualification_policy_info (Resource)
...
- `name` (String) The name of the Server Pool Qualification Policy to gather information from.
- `organization` (String) The name of the organization the Server Pool Qualification Policy belongs to.
