...
page_title: "terrible_cisco_dnac_dhcp_services_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_dhcp_services_query_count (Resource)
...
- `filters` (String) Dhcp Services Query Count's filters.
