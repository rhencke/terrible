...
page_title: "terrible_cisco_meraki_networks_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_settings (Resource)
...
- `localStatusPage` (String) A hash of Local Status page(s)' authentication options applied to the Network.
...
- `namedVlans` (String) A hash of Named VLANs options applied to the Network.
...
- `securePort` (String) A hash of SecureConnect options applied to the Network.
