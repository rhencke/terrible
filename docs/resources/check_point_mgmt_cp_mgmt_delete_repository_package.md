...
page_title: "terrible_check_point_mgmt_cp_mgmt_delete_repository_package Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_delete_repository_package (Resource)
...
- `cp_mgmt_delete_repository_package` (String) The checkpoint delete-repository-package output.
