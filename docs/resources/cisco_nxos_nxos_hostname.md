...
page_title: "terrible_cisco_nxos_nxos_hostname Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_hostname (Resource)
...
- `config` (String) A dictionary of hostname configuration.
...
- `state` (String) The state the configuration should be left in. The states *merged*, *replaced* and *overridden* have identical behaviour for this module. Refer to examples for more details.
