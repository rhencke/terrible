...
page_title: "terrible_cisco_dnac_dna_network_devices_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_dna_network_devices_query_count (Resource)
...
- `filters` (String) Dna Network Devices Query Count's filters.
