...
page_title: "terrible_cisco_intersight_intersight_mac_pool_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_mac_pool_info (Resource)
...
- `name` (String) The name of the MAC Pool that will have information gathered from.
