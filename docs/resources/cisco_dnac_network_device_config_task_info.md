...
page_title: "terrible_cisco_dnac_network_device_config_task_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_config_task_info (Resource)
...
- `parentTaskId` (String) ParentTaskId query parameter. Task Id.
