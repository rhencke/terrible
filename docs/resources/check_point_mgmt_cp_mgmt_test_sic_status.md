...
page_title: "terrible_check_point_mgmt_cp_mgmt_test_sic_status Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_test_sic_status (Resource)
...
- `cp_mgmt_test_sic_status` (String) The checkpoint test-sic-status output.
