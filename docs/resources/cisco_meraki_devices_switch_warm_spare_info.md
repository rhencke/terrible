...
page_title: "terrible_cisco_meraki_devices_switch_warm_spare_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_switch_warm_spare_info (Resource)
...
- `serial` (String) Information module for Devices Switch Warmspare Info. Serial path parameter.
