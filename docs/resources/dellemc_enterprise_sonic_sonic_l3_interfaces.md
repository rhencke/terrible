...
page_title: "terrible_dellemc_enterprise_sonic_sonic_l3_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_l3_interfaces (Resource)
...
- `config` (String) A list of l3_interfaces configurations.
