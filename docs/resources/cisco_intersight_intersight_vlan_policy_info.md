...
page_title: "terrible_cisco_intersight_intersight_vlan_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_vlan_policy_info (Resource)
...
- `api_response` (String) The API response containing policy and VLAN information. Returns a dictionary when querying a single policy or no policies found. Returns a list when multiple policies are found.
