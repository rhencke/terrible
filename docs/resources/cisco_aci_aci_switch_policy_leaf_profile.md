...
page_title: "terrible_cisco_aci_aci_switch_policy_leaf_profile Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_aci_aci_switch_policy_leaf_profile (Resource)
...
- `description` (String) Description for the Leaf Profile.
...
- `leaf_profile` (String) The name of the Leaf Profile.
