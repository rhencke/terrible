...
page_title: "terrible_community_vmware_vmware_content_library_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_content_library_info (Resource)
...
- `content_lib_details` (String) list of content library metadata
- `content_libs` (String) list of content libraries
