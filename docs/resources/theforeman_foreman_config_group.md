...
page_title: "terrible_theforeman_foreman_config_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_config_group (Resource)
...
- `name` (String) The config group name
...
- `puppetclasses` (String) List of puppet classes to include in this group
