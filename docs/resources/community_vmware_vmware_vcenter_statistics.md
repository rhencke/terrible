...
page_title: "terrible_community_vmware_vmware_vcenter_statistics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_vcenter_statistics (Resource)
...
- `interval_past_day` (String) Settings for vCenter server past day statistic collection.
- `interval_past_month` (String) Settings for vCenter server past month statistic collection.
- `interval_past_week` (String) Settings for vCenter server past week statistic collection.
- `interval_past_year` (String) Settings for vCenter server past month statistic collection.
...
- `results` (String) metadata about vCenter statistics settings
