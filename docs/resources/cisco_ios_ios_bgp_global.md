...
page_title: "terrible_cisco_ios_ios_bgp_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_bgp_global (Resource)
...
- `config` (String) A dictionary of options for bgp configurations.
