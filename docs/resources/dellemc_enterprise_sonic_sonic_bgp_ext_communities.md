...
page_title: "terrible_dellemc_enterprise_sonic_sonic_bgp_ext_communities Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_bgp_ext_communities (Resource)
...
- `config` (String) A list of 'bgp_extcommunity_list' configurations.
