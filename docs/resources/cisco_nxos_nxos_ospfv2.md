...
page_title: "terrible_cisco_nxos_nxos_ospfv2 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_ospfv2 (Resource)
...
- `config` (String) A list of OSPF process configuration.
