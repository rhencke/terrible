...
page_title: "terrible_cisco_dnac_sda_fabric_border_device Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_border_device (Resource)
...
- `payload` (String) Sda Fabric Border Device's payload.
