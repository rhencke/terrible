...
page_title: "terrible_cisco_meraki_meraki_management_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_meraki_management_interface (Resource)
...
- `serial` (String) serial number of the device to configure.
...
- `wan1` (String) Management interface details for management interface.
- `wan2` (String) Management interface details for management interface.
