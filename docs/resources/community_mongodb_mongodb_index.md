...
page_title: "terrible_community_mongodb_mongodb_index Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_mongodb_mongodb_index (Resource)
...
- `indexes` (String) List of indexes to create or drop
...
- `failed` (Boolean) Indicates the module has failed.
- `id` (String) Unique task resource ID
- `indexes_created` (String) List of indexes created.
- `indexes_dropped` (String) List of indexes dropped.
