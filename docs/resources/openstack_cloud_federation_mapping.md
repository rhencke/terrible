...
page_title: "terrible_openstack_cloud_federation_mapping Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_federation_mapping (Resource)
...
- `name` (String) The name of the mapping to manage.
...
- `rules` (String) The rules that comprise the mapping. These are pairs of *local* and *remote* definitions. For more details on how these work please see the OpenStack documentation https://docs.openstack.org/keystone/latest/admin/federation/mapping_combinations.html. Required if *state* is `present`.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Whether the mapping should be `present` or `absent`.
...
- `mapping` (String) Dictionary describing the federation mapping.
