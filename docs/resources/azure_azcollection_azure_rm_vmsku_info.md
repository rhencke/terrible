...
page_title: "terrible_azure_azcollection_azure_rm_vmsku_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_vmsku_info (Resource)
...
- `resource_type` (String) Resource types e.g. "availabilitySets", "snapshots", "disks", etc.
- `size` (String) Size name, partial name is accepted.
...
- `zone` (Boolean) Show skus supporting availability zones.

### Read-Only

- `available_skus` (String) List of compute-related resource SKUs.
