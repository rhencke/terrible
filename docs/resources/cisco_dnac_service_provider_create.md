...
page_title: "terrible_cisco_dnac_service_provider_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_service_provider_create (Resource)
...
- `settings` (String) Service Provider Create's settings.
