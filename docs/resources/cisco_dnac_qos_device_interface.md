...
page_title: "terrible_cisco_dnac_qos_device_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_qos_device_interface (Resource)
...
- `payload` (String) Qos Device Interface's payload.
