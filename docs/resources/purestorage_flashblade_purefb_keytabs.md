...
page_title: "terrible_purestorage_flashblade_purefb_keytabs Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_keytabs (Resource)
...
- `filetype` (String) Format of the keytab file
...
- `state` (String) Manage Kerberos Keytabs
...
- `download_file` (String) Name of file containing exported keytab
