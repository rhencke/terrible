...
page_title: "terrible_amazon_aws_aws_az_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_aws_az_info (Resource)
...
- `availability_zones` (String) Availability zones that match the provided filters. Each element consists of a dict with all the information related to that available zone.
