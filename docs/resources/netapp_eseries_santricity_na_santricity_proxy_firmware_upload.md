...
page_title: "terrible_netapp_eseries_santricity_na_santricity_proxy_firmware_upload Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_eseries_santricity_na_santricity_proxy_firmware_upload (Resource)
...
- `firmware` (String) List of paths and/or directories containing firmware/NVSRAM files. All firmware/NVSRAM files that are not specified will be removed from the proxy if they exist.
