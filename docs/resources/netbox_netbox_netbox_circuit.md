...
page_title: "terrible_netbox_netbox_netbox_circuit Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_circuit (Resource)
...
- `data` (String) Defines the circuit configuration
...
- `circuit` (String) Serialized object as created or already existent within NetBox
