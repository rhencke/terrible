...
page_title: "terrible_junipernetworks_junos_junos_security_policies_global Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_security_policies_global (Resource)
...
- `config` (String) A dictionary of security policies
