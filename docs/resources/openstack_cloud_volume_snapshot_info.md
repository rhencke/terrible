...
page_title: "terrible_openstack_cloud_volume_snapshot_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_volume_snapshot_info (Resource)
...
- `details` (Boolean) More detailed output
...
- `status` (String) Specifies the snapshot status.
...
- `volume_snapshots` (String) List of dictionaries describing volume snapshots.
