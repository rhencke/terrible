...
page_title: "terrible_cisco_meraki_networks_wireless_ethernet_ports_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ethernet_ports_profiles_info (Resource)
...
- `networkId` (String) Information module for Networks Wireless Ethernet Ports Profiles Info. NetworkId path parameter. Network ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `profileId` (String) Information module for Networks Wireless Ethernet Ports Profiles Info. ProfileId path parameter. Profile ID.
