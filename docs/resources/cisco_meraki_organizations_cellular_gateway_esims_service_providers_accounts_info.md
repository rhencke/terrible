...
page_title: "terrible_cisco_meraki_organizations_cellular_gateway_esims_service_providers_accounts_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_cellular_gateway_esims_service_providers_accounts_info (Resource)
...
- `accountIds` (String) Information module for Organizations Cellular Gateway Esims Service Providers Accounts Info. AccountIds query parameter. Optional parameter to filter the results by service provider account IDs.
...
- `organizationId` (String) Information module for Organizations Cellular Gateway Esims Service Providers Accounts Info. OrganizationId path parameter. Organization ID.
