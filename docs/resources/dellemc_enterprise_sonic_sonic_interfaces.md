...
page_title: "terrible_dellemc_enterprise_sonic_sonic_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_interfaces (Resource)
...
- `config` (String) A list of interface configurations.
