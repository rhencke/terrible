...
page_title: "terrible_check_point_mgmt_cp_mgmt_add_rules_batch Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_add_rules_batch (Resource)
...
- `cp_mgmt_add_rules_batch` (String) The checkpoint add-rules-batch output.
