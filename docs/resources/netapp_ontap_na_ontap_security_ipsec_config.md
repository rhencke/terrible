...
page_title: "terrible_netapp_ontap_na_ontap_security_ipsec_config Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_security_ipsec_config (Resource)
...
- `enabled` (Boolean) Indicates whether or not IPsec is enabled.
...
- `replay_window` (String) Replay window size in packets, where 0 indicates that the relay window is disabled.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) modify IPsec configuration, only present is supported.
