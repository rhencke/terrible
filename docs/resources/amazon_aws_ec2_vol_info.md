...
page_title: "terrible_amazon_aws_ec2_vol_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vol_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVolumes.html for possible filters.
...
- `volumes` (String) Volumes that match the provided filters. Each element consists of a dict with all the information related to that volume.
