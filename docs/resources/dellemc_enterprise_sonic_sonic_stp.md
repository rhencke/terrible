...
page_title: "terrible_dellemc_enterprise_sonic_sonic_stp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_stp (Resource)
...
- `config` (String) Specifies STP configurations *mstp*, *pvst* and *rapid_pvst* are mutually exclusive.
