...
page_title: "terrible_azure_azcollection_azure_rm_storageaccountmanagementpolicy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_storageaccountmanagementpolicy_info (Resource)
...
- `storage_account_name` (String) Name of the storage account to update or create.
...
- `state` (String) The data policy rules associated with the specified storage account.
