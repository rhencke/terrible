...
page_title: "terrible_azure_azcollection_azure_rm_tags Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_tags (Resource)
...
- `operation` (String) The operation type for the patch API. The default value is *operation=Merge* and use to add tags.
