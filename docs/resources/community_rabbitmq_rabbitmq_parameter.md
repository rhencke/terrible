...
page_title: "terrible_community_rabbitmq_rabbitmq_parameter Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_rabbitmq_rabbitmq_parameter (Resource)
...
- `component` (String) Name of the component of which the parameter is being set
- `host_id` (String) ID of the `terrible_host` to run this task against
- `name` (String) Name of the parameter being set
...
- `state` (String) Specify if parameter is to be added or removed
...
- `vhost` (String) vhost to apply access privileges.
