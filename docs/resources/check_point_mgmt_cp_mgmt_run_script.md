...
page_title: "terrible_check_point_mgmt_cp_mgmt_run_script Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_run_script (Resource)
...
- `cp_mgmt_run_script` (String) The checkpoint run-script output.
