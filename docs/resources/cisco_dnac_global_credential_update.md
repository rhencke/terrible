...
page_title: "terrible_cisco_dnac_global_credential_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_global_credential_update (Resource)
...
- `siteUuids` (String) List of siteUuids where credential is to be updated.
