...
page_title: "terrible_dellemc_openmanage_ome_template_network_vlan_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_template_network_vlan_info (Resource)
...
- `template_id` (Number) Id of the template. This is mutually exclusive with *template_name*.
...
- `msg` (String) Status of template VLAN information retrieval.
- `vlan_info` (String) Information about the template network VLAN.
