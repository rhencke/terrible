...
page_title: "terrible_dellemc_enterprise_sonic_sonic_radius_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_radius_server (Resource)
...
- `config` (String) Specifies the radius server related configuration.
