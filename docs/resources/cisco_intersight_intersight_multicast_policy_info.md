...
page_title: "terrible_cisco_intersight_intersight_multicast_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_multicast_policy_info (Resource)
...
- `name` (String) The name of the Multicast Policy to gather information from.
- `organization` (String) The name of the organization the Multicast Policy belongs to.
