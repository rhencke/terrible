...
page_title: "terrible_check_point_mgmt_cp_mgmt_voip_domain_h323_gatekeeper Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_voip_domain_h323_gatekeeper (Resource)
...
- `endpoints_domain` (String) The related endpoints domain to which the VoIP domain will connect. Identified by name or UID.
...
- `installed_at` (String) The machine the VoIP is installed at. Identified by name or UID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `routing_mode` (String) The routing mode of the VoIP Domain H323 gatekeeper.
...
- `cp_mgmt_voip_domain_h323_gatekeeper` (String) The checkpoint object created or updated.
