...
page_title: "terrible_cisco_dnac_event_subscription_email Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_subscription_email (Resource)
...
- `payload` (String) Event Subscription Email's payload.
