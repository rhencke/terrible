...
page_title: "terrible_amazon_aws_ec2_eip_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_eip_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and filter value. See https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-addresses.html#options for possible filters. Filter names and values are case sensitive.
...
- `addresses` (String) Properties of all Elastic IP addresses matching the provided filters. Each element is a dict with all the information related to an EIP.
