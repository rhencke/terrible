...
page_title: "terrible_community_aws_dms_replication_subnet_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_dms_replication_subnet_group (Resource)
...
- `identifier` (String) The name for the replication subnet group. This value is stored as a lowercase string. Must contain no more than 255 alphanumeric characters, periods, spaces, underscores, or hyphens. Must not be "default".
- `subnet_ids` (String) A list containing the subnet ids for the replication subnet group, needs to be at least 2 items in the list.
...
- `state` (String) State of the subnet group.
