...
page_title: "terrible_dellemc_enterprise_sonic_sonic_lag_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_lag_interfaces (Resource)
...
- `config` (String) A list of LAG configurations.
...
- `state` (String) The state that the configuration should be left in.
...
- `after(generated)` (String) The configuration expected as a result of module invocation.
