...
page_title: "terrible_community_general_idrac_redfish_config Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_idrac_redfish_config (Resource)
...
- `command` (String) List of commands to execute on iDRAC. `SetManagerAttributes`, `SetLifecycleControllerAttributes` and `SetSystemAttributes` are mutually exclusive commands when `category` is `Manager`.
...
- `manager_attributes` (String) Dictionary of iDRAC attribute name and value pairs to update.
