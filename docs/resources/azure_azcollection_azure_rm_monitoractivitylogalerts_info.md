...
page_title: "terrible_azure_azcollection_azure_rm_monitoractivitylogalerts_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_monitoractivitylogalerts_info (Resource)
...
- `name` (String) The name of the activity log alert you're trying to get details about.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `resource_group` (String) The name of the resource group in which the activity log alert is (if you use name) The name of the resource group where you want to list Activity log alerts (if you don't use name)
...
- `activitylogalerts` (String) List of Activity log alerts Can be empty if listing Activity log alerts
