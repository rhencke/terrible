...
page_title: "terrible_awx_awx_bulk_host_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_bulk_host_create (Resource)
...
- `hosts` (String) List of hosts to add to inventory.
- `inventory` (String) Inventory name, ID, or named URL the hosts should be made a member of.
