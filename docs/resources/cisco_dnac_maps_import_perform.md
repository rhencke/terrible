...
page_title: "terrible_cisco_dnac_maps_import_perform Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_maps_import_perform (Resource)
...
- `importContextUuid` (String) ImportContextUuid path parameter. The unique import context UUID given by a previous call of Start Import API.
