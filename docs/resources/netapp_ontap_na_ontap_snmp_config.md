...
page_title: "terrible_netapp_ontap_na_ontap_snmp_config Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_snmp_config (Resource)
...
- `auth_traps_enabled` (Boolean) Specifies whether to enable or disable SNMP authentication traps.
...
- `enabled` (Boolean) Specifies whether to enable or disable SNMP.
...
- `state` (String) Modify SNMP configuration, only present is supported.
- `tags` (String) Run only tasks with these Ansible tags (list of strings).
- `timeout` (Number) Override the default execution timeout (seconds). Defaults to 300.
- `traps_enabled` (Boolean) Specifies whether to enable or disable SNMP traps. Requires ONTAP 9.10.1 or later.
