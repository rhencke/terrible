...
page_title: "terrible_vultr_cloud_plan_metal_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vultr_cloud_plan_metal_info (Resource)
...
- `vultr_plan_info` (String) Response from Vultr API as list.
