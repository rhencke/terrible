...
page_title: "terrible_ieisystem_inmanage_edit_connect_media Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_connect_media (Resource)
...
- `image_type` (String) Virtual media type. Only the M5 model supports this parameter.
- `op_type` (String) Start or stop media.
