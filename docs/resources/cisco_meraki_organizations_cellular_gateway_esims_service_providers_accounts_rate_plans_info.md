...
page_title: "terrible_cisco_meraki_organizations_cellular_gateway_esims_service_providers_accounts_rate_plans_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_cellular_gateway_esims_service_providers_accounts_rate_plans_info (Resource)
...
- `accountIds` (String) Information module for Organizations Cellular Gateway Esims Service Providers Accounts Rate Plans Info. AccountIds query parameter. Account IDs that rate plans will be fetched for.
...
- `organizationId` (String) Information module for Organizations Cellular Gateway Esims Service Providers Accounts Rate Plans Info. OrganizationId path parameter. Organization ID.
