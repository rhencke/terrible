...
page_title: "terrible_cisco_dnac_network_devices_trend_analytics_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_devices_trend_analytics_id (Resource)
...
- `aggregateAttributes` (String) Network Devices Trend Analytics Id's aggregateAttributes.
...
- `filters` (String) Network Devices Trend Analytics Id's filters.
- `groupBy` (String) Group By.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Network Devices Trend Analytics Id's page.
...
- `trendIntervalInMinutes` (Number) Trend Interval In Minutes.
