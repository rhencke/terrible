...
page_title: "terrible_community_aws_config_aggregator Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_config_aggregator (Resource)
...
- `account_sources` (String) Provides a list of source accounts and regions to be aggregated.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `name` (String) The name of the AWS Config resource.
- `organization_source` (String) The region authorized to collect aggregated data.
