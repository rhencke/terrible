...
page_title: "terrible_google_cloud_gcp_iam_service_account Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_iam_service_account (Resource)
...
- `displayName` (String) User specified description of service account.
