...
page_title: "terrible_cisco_meraki_organizations_inventory_onboarding_cloud_monitoring_imports_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_inventory_onboarding_cloud_monitoring_imports_info (Resource)
...
- `importIds` (String) Information module for Organizations Inventory Onboarding Cloudmonitoring Imports Info. ImportIds query parameter. Import ids from an imports.
- `organizationId` (String) Information module for Organizations Inventory Onboarding Cloudmonitoring Imports Info. OrganizationId path parameter. Organization ID.
