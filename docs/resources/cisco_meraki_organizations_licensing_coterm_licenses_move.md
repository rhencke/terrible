...
page_title: "terrible_cisco_meraki_organizations_licensing_coterm_licenses_move Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_licensing_coterm_licenses_move (Resource)
...
- `destination` (String) Destination data for the license move.
...
- `licenses` (String) The list of licenses to move.
