...
page_title: "terrible_cisco_dnac_endpoint_analytics_dictionaries_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_endpoint_analytics_dictionaries_info (Resource)
...
- `includeAttributes` (Boolean) IncludeAttributes query parameter. Flag to indicate whether attribute list for each dictionary should be included in response.
