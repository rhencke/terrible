...
page_title: "terrible_azure_azcollection_azure_rm_apimanagementservice_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_apimanagementservice_info (Resource)
...
- `api_management_service` (String) A list of dict results where the key is the name of the ApiManagementService. The values are the facts for that ApiManagementService.
