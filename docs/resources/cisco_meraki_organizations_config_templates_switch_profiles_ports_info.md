...
page_title: "terrible_cisco_meraki_organizations_config_templates_switch_profiles_ports_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_config_templates_switch_profiles_ports_info (Resource)
...
- `configTemplateId` (String) Information module for Organizations Configtemplates Switch Profiles Ports Info. ConfigTemplateId path parameter. Config template ID.
...
- `organizationId` (String) Information module for Organizations Configtemplates Switch Profiles Ports Info. OrganizationId path parameter. Organization ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `portId` (String) Information module for Organizations Configtemplates Switch Profiles Ports Info. PortId path parameter. Port ID.
- `profileId` (String) Information module for Organizations Configtemplates Switch Profiles Ports Info. ProfileId path parameter. Profile ID.
