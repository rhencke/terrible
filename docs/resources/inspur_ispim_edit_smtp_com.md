...
page_title: "terrible_inspur_ispim_edit_smtp_com Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_inspur_ispim_edit_smtp_com (Resource)
...
- `server_secure_port` (Number) SMTP server sesure port,The Identification for retry count configuration(1-65535).
