...
page_title: "terrible_cisco_meraki_organizations_saml_roles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_saml_roles_info (Resource)
...
- `organizationId` (String) Information module for Organizations Samlroles Info. OrganizationId path parameter. Organization ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `samlRoleId` (String) Information module for Organizations Samlroles Info. SamlRoleId path parameter. Saml role ID.
