...
page_title: "terrible_cisco_dnac_swim_import_via_url Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_swim_import_via_url (Resource)
...
- `payload` (String) Swim Import Via Url's payload.
