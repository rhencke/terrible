...
page_title: "terrible_cisco_dnac_field_notices_results_trend_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_field_notices_results_trend_count_info (Resource)
...
- `scanTime` (Number) ScanTime query parameter. Return field notices trend with scanTime greater than this scanTime.
