...
page_title: "terrible_cisco_meraki_devices_live_tools_leds_blink_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_live_tools_leds_blink_info (Resource)
...
- `ledsBlinkId` (String) Information module for Devices Live Tools Leds Blink Info. LedsBlinkId path parameter. Leds blink ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `serial` (String) Information module for Devices Live Tools Leds Blink Info. Serial path parameter.
