...
page_title: "terrible_netapp_storagegrid_na_sg_grid_ntp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_ntp (Resource)
...
- `ntp_servers` (String) List of comma separated NTP server address.
- `passphrase` (String) passphrase for GRID.
...
- `resp` (String) Returns information about the configured NTP servers.
