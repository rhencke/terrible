...
page_title: "terrible_cisco_dnac_global_credential_v2 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_global_credential_v2 (Resource)
...
- `cliCredential` (String) Global Credential V2's cliCredential.
...
- `httpsRead` (String) Global Credential V2's httpsRead.
- `httpsWrite` (String) Global Credential V2's httpsWrite.
...
- `snmpV2cRead` (String) Global Credential V2's snmpV2cRead.
- `snmpV2cWrite` (String) Global Credential V2's snmpV2cWrite.
- `snmpV3` (String) Global Credential V2's snmpV3.
