...
page_title: "terrible_cisco_intersight_intersight_drive_security_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_drive_security_policy_info (Resource)
...
- `name` (String) The name of the Drive Security Policy to gather information from.
- `organization` (String) The name of the organization the Drive Security Policy belongs to.
