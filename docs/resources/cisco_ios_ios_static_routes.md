...
page_title: "terrible_cisco_ios_ios_static_routes Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_static_routes (Resource)
...
- `config` (String) A dictionary of static route options
