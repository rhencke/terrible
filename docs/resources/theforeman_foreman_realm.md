...
page_title: "terrible_theforeman_foreman_realm Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_realm (Resource)
...
- `realm_proxy` (String) Proxy to use for this realm
- `realm_type` (String) Realm type
