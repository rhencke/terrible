...
page_title: "terrible_group_by Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_group_by (Resource)
...
- `key` (String) The variables whose values will be used as groups.
...
- `parents` (String) The list of the parent groups.
