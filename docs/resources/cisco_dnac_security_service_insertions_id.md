...
page_title: "terrible_cisco_dnac_security_service_insertions_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_service_insertions_id (Resource)
...
- `siteId` (String) The ID of the fabric site where the service insertion is configured.
...
- `virtualNetworks` (String) Security Service Insertions Id's virtualNetworks.
