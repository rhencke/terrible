...
page_title: "terrible_google_cloud_gcp_resourcemanager_project_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_google_cloud_gcp_resourcemanager_project_info (Resource)
...
- `page_size` (Number) Indicates the number of projects that should be returned by the API request
