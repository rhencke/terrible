...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabarmtemplate_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabarmtemplate_info (Resource)
...
- `artifact_source_name` (String) The name of the artifact source.
...
- `arm_templates` (String) A list of dictionaries containing facts for DevTest Lab ARM Template.
