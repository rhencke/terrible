...
page_title: "terrible_cisco_dnac_sda_virtual_network_v2 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_virtual_network_v2 (Resource)
...
- `isGuestVirtualNetwork` (Boolean) Guest Virtual Network enablement flag, default value is False.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `scalableGroupNames` (String) Scalable Group to be associated to virtual network.
