...
page_title: "terrible_community_mongodb_mongodb_oplog Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_mongodb_mongodb_oplog (Resource)
...
- `oplog_size_mb` (Number) New size of the oplog in MB.
...
- `compact` (Boolean) Runs compact against the oplog.rs collection in the local database to reclaim disk space. Performs no actions against PRIMARY members. The MongoDB user must have the compact role on the local database for this feature to work.
...
- `compacted` (Boolean) Whether the member oplog was compacted.
