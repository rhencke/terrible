...
page_title: "terrible_community_rabbitmq_rabbitmq_binding Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_rabbitmq_rabbitmq_binding (Resource)
...
- `destination` (String) destination exchange or queue for the binding.
- `destination_type` (String) Either queue or exchange.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `name` (String) source exchange to create binding on.
...
- `routing_key` (String) routing key for the binding.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `state` (String) Whether the bindings should be present or absent.
