...
page_title: "terrible_telekom_mms_icinga_director_icinga_command_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_telekom_mms_icinga_director_icinga_command_template (Resource)
...
- `object_name` (String) Name of the command template.
...
- `vars` (String) Custom properties of the command template.
