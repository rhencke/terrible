...
page_title: "terrible_dellemc_openmanage_idrac_user_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_idrac_user_info (Resource)
...
- `user_id` (Number) Sequential user id numbers that supports from 1 to 16. *user_id* is mutually exclusive with *username*
...
- `msg` (String) Status of user information retrieval.
- `user_info` (String) Information about the user.
