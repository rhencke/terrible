...
page_title: "terrible_netbox_netbox_netbox_device_interface_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_device_interface_template (Resource)
...
- `data` (String) Defines the interface template configuration
...
- `interface_template` (String) Serialized object as created or already existent within NetBox
