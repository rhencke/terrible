...
page_title: "terrible_cisco_meraki_organizations_inventory_claim Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_inventory_claim (Resource)
...
- `licenses` (String) The licenses that should be claimed.
- `orders` (String) The numbers of the orders that should be claimed.
...
- `serials` (String) The serials of the devices that should be claimed.
