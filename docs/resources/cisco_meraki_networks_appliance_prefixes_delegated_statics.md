...
page_title: "terrible_cisco_meraki_networks_appliance_prefixes_delegated_statics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_prefixes_delegated_statics (Resource)
...
- `origin` (String) The origin of the prefix.
...
- `staticDelegatedPrefixId` (String) StaticDelegatedPrefixId path parameter. Static delegated prefix ID.
