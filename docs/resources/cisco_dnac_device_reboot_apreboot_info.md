...
page_title: "terrible_cisco_dnac_device_reboot_apreboot_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_device_reboot_apreboot_info (Resource)
...
- `parentTaskId` (String) ParentTaskId query parameter. Task id of ap reboot request.
