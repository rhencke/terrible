...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_place_holder Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_place_holder (Resource)
...
- `cp_mgmt_show_place_holder` (String) The checkpoint show-place-holder output.
