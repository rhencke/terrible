...
page_title: "terrible_cisco_dnac_network_device_images_validation_results_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_images_validation_results_count_info (Resource)
...
- `status` (String) Status query parameter. Status of the validation result. Available values SUCCESS, FAILED, IN_PROGRESS, WARNING.
