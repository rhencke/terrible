...
page_title: "terrible_cisco_dnac_field_notices_results_network_devices_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_field_notices_results_network_devices_info (Resource)
...
- `noticeCount` (Number) NoticeCount query parameter. Return network devices with noticeCount greater than this noticeCount.
...
- `scanStatus` (String) ScanStatus query parameter. Status of the scan on the network device. Available values NOT_SCANNED, IN_PROGRESS, SUCCESS, FAILED.
