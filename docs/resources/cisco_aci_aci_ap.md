...
page_title: "terrible_cisco_aci_aci_ap Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_aci_aci_ap (Resource)
...
- `ap` (String) The name of the application network profile.
...
- `description` (String) Description for the AP.
