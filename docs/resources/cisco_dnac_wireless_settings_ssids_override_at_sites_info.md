...
page_title: "terrible_cisco_dnac_wireless_settings_ssids_override_at_sites_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_ssids_override_at_sites_info (Resource)
...
- `siteId` (String) SiteId query parameter. Site UUID.
