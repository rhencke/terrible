...
page_title: "terrible_cisco_dnac_product_series_product_series_ordinal_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_product_series_product_series_ordinal_info (Resource)
...
- `productSeriesOrdinal` (Number) ProductSeriesOrdinal path parameter. Unique identifier of product series.
