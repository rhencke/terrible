...
page_title: "terrible_cisco_dnac_device_interface_by_ip_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_device_interface_by_ip_info (Resource)
...
- `ipAddress` (String) IpAddress path parameter. IP address of the interface.
