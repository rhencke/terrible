...
page_title: "terrible_check_point_mgmt_cp_mgmt_application_site_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_application_site_group (Resource)
...
- `members` (String) Collection of application and URL filtering objects identified by the name or UID.
...
- `cp_mgmt_application_site_group` (String) The checkpoint object created or updated.
