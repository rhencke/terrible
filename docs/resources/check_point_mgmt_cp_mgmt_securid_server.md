...
page_title: "terrible_check_point_mgmt_cp_mgmt_securid_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_securid_server (Resource)
...
- `base64_config_file_content` (String) Base64 encoded configuration file for authentication.
...
- `cp_mgmt_securid_server` (String) The checkpoint object created or updated.
