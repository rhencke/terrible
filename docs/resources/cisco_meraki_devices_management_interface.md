...
page_title: "terrible_cisco_meraki_devices_management_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_management_interface (Resource)
...
- `wan1` (String) WAN 1 settings.
- `wan2` (String) WAN 2 settings (only for MX devices).
