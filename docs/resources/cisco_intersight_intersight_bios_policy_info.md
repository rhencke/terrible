...
page_title: "terrible_cisco_intersight_intersight_bios_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_bios_policy_info (Resource)
...
- `name` (String) The name of the BIOS Policy to gather information from.
- `organization` (String) The name of the organization the BIOS Policy belongs to.
