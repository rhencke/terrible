...
page_title: "terrible_check_point_mgmt_cp_mgmt_voip_domain_h323_gateway Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_voip_domain_h323_gateway (Resource)
...
- `routing_mode` (String) The routing mode of the VoIP Domain H323 gateway.
...
- `cp_mgmt_voip_domain_h323_gateway` (String) The checkpoint object created or updated.
