...
page_title: "terrible_cisco_dnac_wireless_controllers_assign_managed_ap_locations Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_controllers_assign_managed_ap_locations (Resource)
...
- `primaryManagedAPLocationsSiteIds` (String) Site IDs of Primary Managed AP Locations. These values can be obtained by using the API call GET /dna/intent/api/v1/site.
- `secondaryManagedAPLocationsSiteIds` (String) Site IDs of Secondary Managed AP Locations. These values can be obtained by using the API call GET /dna/intent/api/v1/site.
