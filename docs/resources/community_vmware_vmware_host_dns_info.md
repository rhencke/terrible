...
page_title: "terrible_community_vmware_vmware_host_dns_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_dns_info (Resource)
...
- `hosts_dns_info` (String) metadata about DNS config from given cluster / host system
