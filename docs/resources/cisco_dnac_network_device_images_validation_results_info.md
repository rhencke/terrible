...
page_title: "terrible_cisco_dnac_network_device_images_validation_results_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_images_validation_results_info (Resource)
...
- `networkDeviceId` (String) NetworkDeviceId query parameter. Network device identifier.
...
- `status` (String) Status query parameter. Status of the validation result. SUCCESS, FAILED, IN_PROGRESS, WARNING.
