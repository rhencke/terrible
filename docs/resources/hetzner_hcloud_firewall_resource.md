...
page_title: "terrible_hetzner_hcloud_firewall_resource Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_firewall_resource (Resource)
...
- `firewall` (String) Name or ID of the Hetzner Cloud Firewall.
...
- `hcloud_firewall_resource` (String) The Resources a Hetzner Cloud Firewall is applied to.
