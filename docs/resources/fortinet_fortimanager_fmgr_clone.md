...
page_title: "terrible_fortinet_fortimanager_fmgr_clone Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_fortinet_fortimanager_fmgr_clone (Resource)
...
- `workspace_locking_timeout` (Number) The maximum time in seconds to wait for other users to release workspace lock.
