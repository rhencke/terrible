...
page_title: "terrible_azure_azcollection_azure_rm_registrationdefinition_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_registrationdefinition_info (Resource)
...
- `registration_definitions` (String) A list of dict results where the key is the name of the RegistrationDefinition and the values are the facts for that RegistrationDefinition.
