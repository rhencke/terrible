...
page_title: "terrible_junipernetworks_junos_junos_acls Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_acls (Resource)
...
- `config` (String) A dictionary of acls options
