...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_login_message Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_login_message (Resource)
...
- `cp_mgmt_show_login_message` (String) The checkpoint show-login-message output.
