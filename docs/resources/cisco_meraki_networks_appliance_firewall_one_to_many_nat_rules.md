...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_one_to_many_nat_rules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_one_to_many_nat_rules (Resource)
...
- `rules` (String) An array of 1 Many nat rules.
