...
page_title: "terrible_cisco_intersight_intersight_system_qos_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_system_qos_policy_info (Resource)
...
- `name` (String) The exact name of the System QoS Policy to retrieve information from. When specified, only the matching policy and its classes will be returned.
- `organization` (String) The name of the organization to filter System QoS Policies by. Use 'default' for the default organization. When specified, only policies from this organization will be returned.
...
- `intersight_system_qos_policies` (String) A list of System QoS Policies with their configurations
