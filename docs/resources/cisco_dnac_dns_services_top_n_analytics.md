...
page_title: "terrible_cisco_dnac_dns_services_top_n_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_dns_services_top_n_analytics (Resource)
...
- `aggregateAttributes` (String) Dns Services Top N Analytics's aggregateAttributes.
...
- `filters` (String) Dns Services Top N Analytics's filters.
...
- `page` (String) Dns Services Top N Analytics's page.
