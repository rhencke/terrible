...
page_title: "terrible_cisco_dnac_aaa_services_id_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_aaa_services_id_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Aaa Services Id Trend Analytics's aggregateAttributes.
...
- `filters` (String) Aaa Services Id Trend Analytics's filters.
...
- `page` (String) Aaa Services Id Trend Analytics's page.
