...
page_title: "terrible_theforeman_foreman_host_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_host_info (Resource)
...
- `host` (String) Details about the found host
- `hosts` (String) List of all found hosts and their details
