...
page_title: "terrible_netapp_storagegrid_na_sg_org_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_org_group (Resource)
...
- `s3_policy` (String) StorageGRID S3 Group Policy.
...
- `resp` (String) Returns information about the StorageGRID tenant group attributes.
