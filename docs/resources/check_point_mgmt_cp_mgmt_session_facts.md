...
page_title: "terrible_check_point_mgmt_cp_mgmt_session_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_session_facts (Resource)
...
- `order` (String) Sorts results by the given field. By default the results are sorted in the descending order by the session publish time. This parameter is relevant only for getting few objects.
...
- `view_published_sessions` (Boolean) Show a list of published sessions. Available from R80.10 management version.
