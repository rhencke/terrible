...
page_title: "terrible_openstack_cloud_dns_zone Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_dns_zone (Resource)
...
- `masters` (String) Master nameservers Only applies if *type* is `secondary`.
...
- `state` (String) Whether the zone should be `present` or `absent`.
...
- `type` (String) Zone type. This attribute cannot be updated.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `zone` (String) Dictionary describing the zone.
