...
page_title: "terrible_azure_azcollection_azure_rm_serviceendpointpolicydefinition_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_serviceendpointpolicydefinition_info (Resource)
...
- `serviceendpointpolicydefinitions` (String) List of the service endpoint policy definitions in a service end point policy.
