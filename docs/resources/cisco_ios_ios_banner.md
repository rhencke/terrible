...
page_title: "terrible_cisco_ios_ios_banner Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_banner (Resource)
...
- `banner` (String) Specifies which banner should be configured on the remote device. In Ansible 2.4 and earlier only *login* and *motd* were supported.
...
- `multiline_delimiter` (String) Specify the delimiting character than will be used for configuration.
