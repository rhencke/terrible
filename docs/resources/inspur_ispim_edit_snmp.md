...
page_title: "terrible_inspur_ispim_edit_snmp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_inspur_ispim_edit_snmp (Resource)
...
- `auth_protocol` (String) Choose authentication of V3 trap or v3get/v3set.
...
- `priv_protocol` (String) Choose Privacy of V3 trap or v3get/v3set.
