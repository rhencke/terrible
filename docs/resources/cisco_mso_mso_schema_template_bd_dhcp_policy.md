...
page_title: "terrible_cisco_mso_mso_schema_template_bd_dhcp_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_bd_dhcp_policy (Resource)
...
- `dhcp_option_policy` (String) The DHCP Option Policy.
...
- `version` (Number) The version of DHCP Relay Policy.
