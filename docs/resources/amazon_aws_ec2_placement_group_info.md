...
page_title: "terrible_amazon_aws_ec2_placement_group_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_placement_group_info (Resource)
...
- `names` (String) A list of names to filter on. If a listed group does not exist, there will be no corresponding entry in the result; no error will be raised.
...
- `placement_groups` (String) Placement group attributes.
