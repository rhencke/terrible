...
page_title: "terrible_check_point_mgmt_cp_mgmt_resource_uri_for_qos Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_resource_uri_for_qos (Resource)
...
- `search_for_url` (String) URL string that will be matched to an HTTP connection.
...
- `cp_mgmt_resource_uri_for_qos` (String) The checkpoint object created or updated.
