...
page_title: "terrible_purestorage_flasharray_purefa_banner Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_banner (Resource)
...
- `banner` (String) Banner text, or MOTD, to use
...
- `state` (String) Set ot delete the MOTD
