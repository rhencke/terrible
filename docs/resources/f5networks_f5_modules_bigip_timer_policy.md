...
page_title: "terrible_f5networks_f5_modules_bigip_timer_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigip_timer_policy (Resource)
...
- `name` (String) Specifies the name of the timer policy.
...
- `rules` (String) Rules you want assigned to the timer policy.
