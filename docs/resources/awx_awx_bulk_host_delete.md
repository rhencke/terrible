...
page_title: "terrible_awx_awx_bulk_host_delete Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_bulk_host_delete (Resource)
...
- `hosts` (String) List of hosts id's to delete from inventory.
