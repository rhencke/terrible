...
page_title: "terrible_purestorage_flasharray_purefa_arrayname Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_arrayname (Resource)
...
- `name` (String) Name of the array. Must conform to correct naming schema.
...
- `state` (String) Set the array name
