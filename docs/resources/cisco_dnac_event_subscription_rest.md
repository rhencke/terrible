...
page_title: "terrible_cisco_dnac_event_subscription_rest Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_subscription_rest (Resource)
...
- `payload` (String) Event Subscription Rest's payload.
