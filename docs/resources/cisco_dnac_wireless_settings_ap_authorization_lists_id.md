...
page_title: "terrible_cisco_dnac_wireless_settings_ap_authorization_lists_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_ap_authorization_lists_id (Resource)
...
- `apAuthorizationListName` (String) AP Authorization List Name. For a AP Authorization List to be created successfully, either Local Authorization or Remote Authorization is mandatory.
...
- `localAuthorization` (String) Wireless Settings Ap Authorization Lists Id's localAuthorization.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `remoteAuthorization` (String) Wireless Settings Ap Authorization Lists Id's remoteAuthorization.
