...
page_title: "terrible_vmware_vmware_rest_appliance_system_storage Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_system_storage (Resource)
...
- `value` (String) Resize the first partition and return the state of the partition before and after the operation
