...
page_title: "terrible_netbox_netbox_netbox_tunnel Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_tunnel (Resource)
...
- `data` (String) Defines the tunnel configuration
...
- `tunnel` (String) Serialized object as created or already existent within NetBox
