...
page_title: "terrible_check_point_mgmt_cp_mgmt_discard Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_discard (Resource)
...
- `cp_mgmt_discard` (String) The checkpoint discard output.
