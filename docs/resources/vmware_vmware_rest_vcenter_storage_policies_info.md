...
page_title: "terrible_vmware_vmware_rest_vcenter_storage_policies_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_vcenter_storage_policies_info (Resource)
...
- `policies` (String) Identifiers of storage policies that can match the filter. If unset or empty, storage policies with any identifiers match the filter. When clients pass a value of this structure as a parameter, the field must contain the id of resources returned by `vmware.vmware_rest.vcenter_storage_policies_info`.
...
- `value` (String) List existing storage policies
