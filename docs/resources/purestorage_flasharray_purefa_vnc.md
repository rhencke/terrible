...
page_title: "terrible_purestorage_flasharray_purefa_vnc Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_vnc (Resource)
...
- `state` (String) Define state of VNC
...
- `vnc` (String) VNC port information for application
