...
page_title: "terrible_cisco_dnac_wireless_settings_interfaces_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_interfaces_info (Resource)
...
- `interfaceName` (String) InterfaceName query parameter. Interface Name.
...
- `vlanId` (Number) VlanId query parameter. Vlan Id.
