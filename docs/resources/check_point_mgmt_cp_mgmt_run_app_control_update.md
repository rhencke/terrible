...
page_title: "terrible_check_point_mgmt_cp_mgmt_run_app_control_update Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_run_app_control_update (Resource)
...
- `cp_mgmt_run_app_control_update` (String) The checkpoint run-app-control-update output.
