...
page_title: "terrible_netbox_netbox_netbox_tunnel_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_tunnel_group (Resource)
...
- `data` (String) Defines the tunnel group configuration
...
- `tunnel_group` (String) Serialized object as created or already existent within NetBox
