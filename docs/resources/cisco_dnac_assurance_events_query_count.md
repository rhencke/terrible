...
page_title: "terrible_cisco_dnac_assurance_events_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_assurance_events_query_count (Resource)
...
- `filters` (String) Assurance Events Query Count's filters.
