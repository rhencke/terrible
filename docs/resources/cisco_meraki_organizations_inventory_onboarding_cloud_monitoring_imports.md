...
page_title: "terrible_cisco_meraki_organizations_inventory_onboarding_cloud_monitoring_imports Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_inventory_onboarding_cloud_monitoring_imports (Resource)
...
- `devices` (String) A set of device imports to commit.
