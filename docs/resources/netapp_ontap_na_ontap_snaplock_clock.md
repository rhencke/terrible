...
page_title: "terrible_netapp_ontap_na_ontap_snaplock_clock Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_snaplock_clock (Resource)
...
- `node` (String) Name of the node to set compliance clock on.
