...
page_title: "terrible_cisco_dnac_event_series_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_series_count_info (Resource)
...
- `endTime` (Number) EndTime query parameter. End Time in milliseconds.
...
- `startTime` (Number) StartTime query parameter. Start Time in milliseconds.
