...
page_title: "terrible_azure_azcollection_azure_rm_webapp_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_webapp_info (Resource)
...
- `return_publish_profile` (Boolean) Indicate whether to return publishing profile of the web app.
...
- `webapps` (String) List of web apps.
