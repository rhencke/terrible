...
page_title: "terrible_cisco_mso_mso_schema_site_service_graph Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_site_service_graph (Resource)
...
- `devices` (String) A list of devices to be associated with the Service Graph.
