...
page_title: "terrible_cisco_dnac_network_applications_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_applications_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Network Applications Trend Analytics's aggregateAttributes.
...
- `filters` (String) Network Applications Trend Analytics's filters.
...
- `page` (String) Network Applications Trend Analytics's page.
