...
page_title: "terrible_cisco_dnac_swim_trigger_distribution Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_swim_trigger_distribution (Resource)
...
- `payload` (String) Swim Trigger Distribution's payload.
