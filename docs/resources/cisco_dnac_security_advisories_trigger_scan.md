...
page_title: "terrible_cisco_dnac_security_advisories_trigger_scan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_advisories_trigger_scan (Resource)
...
- `failedDevicesOnly` (Boolean) FailedDevicesOnly query parameter. Used to specify if the scan should run only for the network devices that failed during the previous scan. If not specified, this parameter defaults to false.
