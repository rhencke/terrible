...
page_title: "terrible_azure_azcollection_azure_rm_notificationhub Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_notificationhub (Resource)
...
- `namespace_name` (String) Name of the namespace in which to create notification hub.
...
- `sku` (String) The name of the SKU. Please see [https://azure.microsoft.com/en-in/pricing/details/notification-hubs/]().
- `state` (String) Assert the state of the Notification Hub. Use `present` to create or update an notification hub and `absent` to delete it.
