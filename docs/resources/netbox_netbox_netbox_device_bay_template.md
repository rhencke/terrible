...
page_title: "terrible_netbox_netbox_netbox_device_bay_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_device_bay_template (Resource)
...
- `data` (String) Defines the device bay template configuration
...
- `device_bay_template` (String) Serialized object as created or already existent within NetBox
