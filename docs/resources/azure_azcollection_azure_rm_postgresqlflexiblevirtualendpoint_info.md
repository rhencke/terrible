...
page_title: "terrible_azure_azcollection_azure_rm_postgresqlflexiblevirtualendpoint_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqlflexiblevirtualendpoint_info (Resource)
...
- `server_name` (String) The name of the post gresql server.
...
- `virtual_endpoint_name` (String) The name of the post gresql virtual endpoint.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `id` (String) Unique task resource ID
- `virtual_endpoints` (String) A list of dictionaries containing facts for PostgreSQL Flexible Virtual Endpoints.
