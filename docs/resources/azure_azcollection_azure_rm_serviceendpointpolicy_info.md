...
page_title: "terrible_azure_azcollection_azure_rm_serviceendpointpolicy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_serviceendpointpolicy_info (Resource)
...
- `serviceendpointpolicies` (String) List the facts of service endpoint policy.
