...
page_title: "terrible_cisco_aci_aci_endpoint_tag_ip Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_aci_aci_endpoint_tag_ip (Resource)
...
- `ip` (String) The IPv4 or IPv6 address of the Endpoint Tag IP.
