...
page_title: "terrible_cisco_meraki_organizations_inventory_release Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_inventory_release (Resource)
...
- `serials` (String) Serials of the devices that should be released.
