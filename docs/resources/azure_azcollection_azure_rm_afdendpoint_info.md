...
page_title: "terrible_azure_azcollection_azure_rm_afdendpoint_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_afdendpoint_info (Resource)
...
- `name` (String) Limit results to a specific AFD Endpoint.
...
- `afdendpoints` (String) List of AFD Endpoints.
