...
page_title: "terrible_netbox_netbox_netbox_provider Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_provider (Resource)
...
- `data` (String) Defines the provider configuration
...
- `provider` (String) Serialized object as created or already existent within NetBox
