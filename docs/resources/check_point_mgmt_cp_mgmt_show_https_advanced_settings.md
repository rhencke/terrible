...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_https_advanced_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_https_advanced_settings (Resource)
...
- `cp_mgmt_show_https_advanced_settings` (String) The checkpoint show-https-advanced-settings output.
