...
page_title: "terrible_cisco_dnac_transit_peer_network_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_transit_peer_network_info (Resource)
...
- `transitPeerNetworkName` (String) TransitPeerNetworkName query parameter. Transit or Peer Network Name.
