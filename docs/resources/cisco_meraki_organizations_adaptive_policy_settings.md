...
page_title: "terrible_cisco_meraki_organizations_adaptive_policy_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_adaptive_policy_settings (Resource)
...
- `enabledNetworks` (String) List of network IDs with adaptive policy enabled.
