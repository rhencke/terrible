...
page_title: "terrible_cisco_meraki_networks_switch_dscp_to_cos_mappings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_dscp_to_cos_mappings (Resource)
...
- `mappings` (String) An array of DSCP to CoS mappings. An empty array will reset the mappings to default.
