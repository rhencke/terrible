...
page_title: "terrible_cisco_meraki_networks_switch_port_schedules_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_port_schedules_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Portschedules Info. NetworkId path parameter. Network ID.
