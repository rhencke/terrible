...
page_title: "terrible_cisco_meraki_networks_sm_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sm_profiles_info (Resource)
...
- `networkId` (String) Information module for Networks Sm Profiles Info. NetworkId path parameter. Network ID.
- `payloadTypes` (String) Information module for Networks Sm Profiles Info. PayloadTypes query parameter. Filter by payload types.
