...
page_title: "terrible_ieisystem_inmanage_bios_export Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_bios_export (Resource)
...
- `file_url` (String) Suffix is .json/.conf, FILEURI format, "/directory/filename".
