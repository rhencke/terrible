...
page_title: "terrible_community_zabbix_zabbix_discoveryrule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_zabbix_zabbix_discoveryrule (Resource)
...
- `name` (String) Name of discovery rule to create or delete.
...
- `params` (String) Parameters to create/update discovery rule with. Required if state is "present". Parameters as defined at https://www.zabbix.com/documentation/current/en/manual/api/reference/discoveryrule/object Additionally supported parameters are below
...
- `state` (String) Create or delete discovery rule.
