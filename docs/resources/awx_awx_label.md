...
page_title: "terrible_awx_awx_label Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_label (Resource)
...
- `organization` (String) Organization name, ID, or named URL this label belongs to.
