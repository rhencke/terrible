...
page_title: "terrible_cisco_dnac_energy_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_energy_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Energy Trend Analytics's aggregateAttributes.
...
- `filters` (String) Energy Trend Analytics's filters.
...
- `page` (String) Energy Trend Analytics's page.
