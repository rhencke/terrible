...
page_title: "terrible_dellemc_enterprise_sonic_sonic_ip_neighbor Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_ip_neighbor (Resource)
...
- `config` (String) Specifies IP neighbor global configurations.
