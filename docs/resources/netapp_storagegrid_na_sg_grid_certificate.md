...
page_title: "terrible_netapp_storagegrid_na_sg_grid_certificate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_certificate (Resource)
...
- `type` (String) Which certificate to update.
...
- `state` (String) Whether the specified certificate should be set.
