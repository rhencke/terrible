...
page_title: "terrible_azure_azcollection_azure_rm_diskencryptionset_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_diskencryptionset_info (Resource)
...
- `diskencryptionsets` (String) Gets a list of disk encryption sets.
