...
page_title: "terrible_cisco_mso_ndo_schema_template_bd_dhcp_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_schema_template_bd_dhcp_policy (Resource)
...
- `dhcp_option_policy` (String) The name of the DHCP Option Policy. When the `dhcp_option_policy` is provided, the `dhcp_relay_policy` must also be provided.
- `dhcp_relay_policy` (String) The name of the DHCP Relay Policy.
