...
page_title: "terrible_azure_azcollection_azure_rm_diskaccess_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_diskaccess_info (Resource)
...
- `disk_accesses` (String) Details for the disk access.
