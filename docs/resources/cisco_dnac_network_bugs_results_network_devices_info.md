...
page_title: "terrible_cisco_dnac_network_bugs_results_network_devices_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_bugs_results_network_devices_info (Resource)
...
- `bugCount` (Number) BugCount query parameter. Return network devices with bugCount greater than this bugCount.
