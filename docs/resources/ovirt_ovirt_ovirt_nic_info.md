...
page_title: "terrible_ovirt_ovirt_ovirt_nic_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ovirt_ovirt_ovirt_nic_info (Resource)
...
- `follow` (String) List of linked entities, which should be fetched along with the main entity. This parameter replaces usage of `fetch_nested` and `nested_attributes`. All follow parameters can be found at following url: https://ovirt.github.io/ovirt-engine-api-model/master/#types/nic/links_summary
...
- `template` (String) Name of the template where NIC is attached. You must provide either `vm` parameter or `template` parameter.
...
- `ovirt_nics` (String) List of dictionaries describing the network interfaces. NIC attributes are mapped to dictionary keys, all NICs attributes can be found at following url: http://ovirt.github.io/ovirt-engine-api-model/master/#types/nic.
