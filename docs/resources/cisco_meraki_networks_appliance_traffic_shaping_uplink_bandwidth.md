...
page_title: "terrible_cisco_meraki_networks_appliance_traffic_shaping_uplink_bandwidth Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_traffic_shaping_uplink_bandwidth (Resource)
...
- `bandwidthLimits` (String) A mapping of uplinks to their bandwidth settings (be sure to check which uplinks are supported for your network).
