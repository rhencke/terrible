...
page_title: "terrible_ieisystem_inmanage_upload_ssl Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_upload_ssl (Resource)
...
- `certificate` (String) New Certificate file.
- `host_id` (String) ID of the `terrible_host` to run this task against
- `private` (String) New Private Key file.
