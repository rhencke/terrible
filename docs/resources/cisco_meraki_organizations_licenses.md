...
page_title: "terrible_cisco_meraki_organizations_licenses Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_licenses (Resource)
...
- `licenseId` (String) LicenseId path parameter. License ID.
