...
page_title: "terrible_purestorage_flasharray_purefa_eula Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flasharray_purefa_eula (Resource)
...
- `company` (String) Full legal name of the entity. The value must be between 1 and 64 characters in length.
...
- `name` (String) Full legal name of the individual at the company who has the authority to accept the terms of the agreement. The value must be between 1 and 64 characters in length.
...
- `title` (String) Individual's job title at the company. The value must be between 1 and 64 characters in length.
