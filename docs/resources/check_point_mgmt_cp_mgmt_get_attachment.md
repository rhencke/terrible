...
page_title: "terrible_check_point_mgmt_cp_mgmt_get_attachment Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_get_attachment (Resource)
...
- `cp_mgmt_get_attachment` (String) The checkpoint get-attachment output.
