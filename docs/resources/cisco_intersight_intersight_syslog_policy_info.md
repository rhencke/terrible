...
page_title: "terrible_cisco_intersight_intersight_syslog_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_syslog_policy_info (Resource)
...
- `name` (String) The name of the specific Syslog Policy to retrieve.
- `organization` (String) The name of the organization to which the Syslog Policy belongs.
