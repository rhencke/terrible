...
page_title: "terrible_netbox_netbox_netbox_service_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_service_template (Resource)
...
- `data` (String) Defines the service template configuration
...
- `service_template` (String) Serialized object as created or already existent within NetBox
