...
page_title: "terrible_cisco_dnac_network_device_functional_capability_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_functional_capability_info (Resource)
...
- `deviceId` (String) DeviceId query parameter. Accepts comma separated deviceid's and return list of functional-capabilities for the given id's. If invalid or not-found id's are provided, null entry will be returned in the list.
...
- `functionName` (String) FunctionName query parameter.
