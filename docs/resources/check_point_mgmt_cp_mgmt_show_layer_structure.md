...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_layer_structure Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_layer_structure (Resource)
...
- `package` (String) Name of the package. Must be set when want to receive the resolved rule instead of the place holder in global domain layer.
...
- `cp_mgmt_show_layer_structure` (String) The checkpoint show-layer-structure output.
