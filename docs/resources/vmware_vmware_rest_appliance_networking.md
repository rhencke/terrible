...
page_title: "terrible_vmware_vmware_rest_appliance_networking Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_networking (Resource)
...
- `ipv6_enabled` (Boolean) IPv6 Enabled or not If unspecified, leaves the current state of Ipv6.
...
- `value` (String) Set network information
