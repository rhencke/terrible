...
page_title: "terrible_azure_azcollection_azure_rm_devtestlab_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlab_info (Resource)
...
- `labs` (String) A list of dictionaries containing facts for Lab.
