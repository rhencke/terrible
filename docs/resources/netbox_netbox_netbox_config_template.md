...
page_title: "terrible_netbox_netbox_netbox_config_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_config_template (Resource)
...
- `data` (String) Defines the config template configuration
...
- `config_templates` (String) Serialized object as created/existent/updated/deleted within NetBox
