...
page_title: "terrible_check_point_mgmt_cp_mgmt_delete_outbound_inspection_certificate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_delete_outbound_inspection_certificate (Resource)
...
- `cp_mgmt_delete_outbound_inspection_certificate` (String) The checkpoint delete-outbound-inspection-certificate output.
