...
page_title: "terrible_cisco_meraki_networks_switch_access_control_lists Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_access_control_lists (Resource)
...
- `rules` (String) An ordered array of the access control list rules (not including the default rule). An empty array will clear the rules.
