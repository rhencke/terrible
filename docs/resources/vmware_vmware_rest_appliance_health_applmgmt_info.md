...
page_title: "terrible_vmware_vmware_rest_appliance_health_applmgmt_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_health_applmgmt_info (Resource)
...
- `value` (String) Get the health state of applmgmt
