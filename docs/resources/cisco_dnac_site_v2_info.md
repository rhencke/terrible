...
page_title: "terrible_cisco_dnac_site_v2_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_v2_info (Resource)
...
- `groupNameHierarchy` (String) GroupNameHierarchy query parameter. Site name hierarchy (E.g. Global/USA/CA).
