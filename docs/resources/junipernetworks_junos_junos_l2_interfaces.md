...
page_title: "terrible_junipernetworks_junos_junos_l2_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_l2_interfaces (Resource)
...
- `config` (String) A dictionary of Layer-2 interface options
