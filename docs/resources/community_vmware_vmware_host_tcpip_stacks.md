...
page_title: "terrible_community_vmware_vmware_host_tcpip_stacks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_tcpip_stacks (Resource)
...
- `esxi_hostname` (String) Name of the ESXi host.
...
- `default` (String) The TCP/IP stacks configuration of the *default*.
...
- `provisioning` (String) The TCP/IP stacks configuration of the *provisioning*.
...
- `vmotion` (String) The TCP/IP stacks configuration of the *vmotion*.
- `vxlan` (String) The TCP/IP stacks configuration of the *vxlan*.
