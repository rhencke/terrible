...
page_title: "terrible_netbox_netbox_netbox_cluster_type Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_cluster_type (Resource)
...
- `data` (String) Defines the cluster type configuration
...
- `cluster_type` (String) Serialized object as created or already existent within NetBox
