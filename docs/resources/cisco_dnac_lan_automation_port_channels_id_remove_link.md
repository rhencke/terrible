...
page_title: "terrible_cisco_dnac_lan_automation_port_channels_id_remove_link Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_lan_automation_port_channels_id_remove_link (Resource)
...
- `portChannelMembers` (String) Lan Automation Port Channels Id Remove Link's portChannelMembers.
