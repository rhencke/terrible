...
page_title: "terrible_check_point_mgmt_cp_mgmt_https_rule_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_https_rule_facts (Resource)
...
- `name` (String) Object name. Must be unique in the domain. This parameter is relevant only for getting few objects.
...
- `use_object_dictionary` (Boolean) Receiving the mapping between the objects id and the whole objects.
