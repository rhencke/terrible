...
page_title: "terrible_check_point_mgmt_cp_mgmt_delete_rules_batch Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_delete_rules_batch (Resource)
...
- `objects` (String) Batch of rules separated by types.
...
- `cp_mgmt_delete_rules_batch` (String) The checkpoint delete-rules-batch output.
