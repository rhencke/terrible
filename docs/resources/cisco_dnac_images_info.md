...
page_title: "terrible_cisco_dnac_images_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_images_info (Resource)
...
- `productNameOrdinal` (Number) ProductNameOrdinal query parameter. The product name ordinal is a unique value for each network device product. The productNameOrdinal can be obtained from the response of API `/dna/intent/api/v1/siteWiseProductNames`.
