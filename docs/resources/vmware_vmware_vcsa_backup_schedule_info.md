...
page_title: "terrible_vmware_vmware_vcsa_backup_schedule_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_vcsa_backup_schedule_info (Resource)
...
- `name` (String) The name of the backup schedule for which to gather info. If no name is provided, all backup schedules are returned.
...
- `schedules` (String) List of dictionaries describing the backup schedules found
