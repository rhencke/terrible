...
page_title: "terrible_cisco_meraki_devices_appliance_radio_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_appliance_radio_settings (Resource)
...
- `fiveGhzSettings` (String) Manual radio settings for 5 GHz.
...
- `twoFourGhzSettings` (String) Manual radio settings for 2.4 GHz.
