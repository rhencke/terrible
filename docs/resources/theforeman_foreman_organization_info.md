...
page_title: "terrible_theforeman_foreman_organization_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_organization_info (Resource)
...
- `organization` (String) Details about the found organization
- `organizations` (String) List of all found organizations and their details
