...
page_title: "terrible_junipernetworks_junos_junos_bgp_address_family Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_bgp_address_family (Resource)
...
- `config` (String) The provided link BGP address family dictionary.
