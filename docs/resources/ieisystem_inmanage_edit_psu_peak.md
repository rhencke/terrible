...
page_title: "terrible_ieisystem_inmanage_edit_psu_peak Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_edit_psu_peak (Resource)
...
- `status` (String) Power peak status.
...
- `time` (Number) Maximum random time, range of values(1-600), unit(second).
