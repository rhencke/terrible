...
page_title: "terrible_cisco_dnac_application_sets Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_application_sets (Resource)
...
- `payload` (String) Application Sets's payload.
