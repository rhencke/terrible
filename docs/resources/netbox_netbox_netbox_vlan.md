...
page_title: "terrible_netbox_netbox_netbox_vlan Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_vlan (Resource)
...
- `data` (String) Defines the vlan configuration
...
- `vlan` (String) Serialized object as created or already existent within NetBox
