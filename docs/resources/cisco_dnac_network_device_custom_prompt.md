...
page_title: "terrible_cisco_dnac_network_device_custom_prompt Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_custom_prompt (Resource)
...
- `passwordPrompt` (String) Password for Custom Prompt.
...
- `usernamePrompt` (String) Username for Custom Prompt.
