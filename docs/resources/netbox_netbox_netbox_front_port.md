...
page_title: "terrible_netbox_netbox_netbox_front_port Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_front_port (Resource)
...
- `data` (String) Defines the front port configuration
...
- `front_port` (String) Serialized object as created or already existent within NetBox
