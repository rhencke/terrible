...
page_title: "terrible_amazon_aws_ec2_vpc_peering_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_vpc_peering_info (Resource)
...
- `filters` (String) A dict of filters to apply. Each dict item consists of a filter key and a filter value. See https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcPeeringConnections.html for possible filters.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `peer_connection_ids` (String) List of specific VPC peer IDs to get details for.
...
- `vpc_peering_connections` (String) Details of the matching VPC peering connections.
