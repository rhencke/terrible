...
page_title: "terrible_vyos_vyos_vyos_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_interfaces (Resource)
...
- `config` (String) The provided interface configuration.
