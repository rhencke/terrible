...
page_title: "terrible_cisco_dnac_swim_trigger_activation Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_swim_trigger_activation (Resource)
...
- `payload` (String) Swim Trigger Activation's payload.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `scheduleValidate` (Boolean) ScheduleValidate query parameter. ScheduleValidate, validates data before schedule (Optional).
