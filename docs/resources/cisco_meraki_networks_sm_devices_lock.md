...
page_title: "terrible_cisco_meraki_networks_sm_devices_lock Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sm_devices_lock (Resource)
...
- `scope` (String) The scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags of the devices to be locked.
