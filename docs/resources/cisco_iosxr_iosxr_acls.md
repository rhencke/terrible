...
page_title: "terrible_cisco_iosxr_iosxr_acls Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_acls (Resource)
...
- `config` (String) A list of dictionaries specifying ACL configurations.
