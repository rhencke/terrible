...
page_title: "terrible_cisco_meraki_devices_lldp_cdp_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_lldp_cdp_info (Resource)
...
- `serial` (String) Information module for Devices Lldpcdp Info. Serial path parameter.
