...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_firewalled_services_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_firewalled_services_info (Resource)
...
- `networkId` (String) Information module for Networks Appliance Firewall Firewalledservices Info. NetworkId path parameter. Network ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `service` (String) Information module for Networks Appliance Firewall Firewalledservices Info. Service path parameter.
