...
page_title: "terrible_azure_azcollection_azure_rm_automationaccount Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_automationaccount (Resource)
...
- `state` (String) State of the automation account. Use `present` to create or update a automation account and `absent` to delete an automation account.
