...
page_title: "terrible_ansible_windows_win_hostname Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ansible_windows_win_hostname (Resource)
...
- `name` (String) The hostname to set for the computer.
...
- `old_name` (String) The original hostname that was set before it was changed.
- `reboot_required` (Boolean) Whether a reboot is required to complete the hostname change.
