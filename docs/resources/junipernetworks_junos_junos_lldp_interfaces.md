...
page_title: "terrible_junipernetworks_junos_junos_lldp_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_lldp_interfaces (Resource)
...
- `config` (String) The list of link layer discovery protocol interface attribute configurations
