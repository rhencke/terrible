...
page_title: "terrible_community_aws_ecs_tag Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_ecs_tag (Resource)
...
- `cluster_name` (String) The name of the cluster whose resources we are tagging.
...
- `resource` (String) The ECS resource name. Required unless *resource_type=cluster*.
