...
page_title: "terrible_fortinet_fortimanager_fmgr_dvm_cmd_add_device Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_fortinet_fortimanager_fmgr_dvm_cmd_add_device (Resource)
...
- `dvm_cmd_add_device` (String) The top level parameters set.
