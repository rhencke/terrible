...
page_title: "terrible_f5networks_f5_modules_bigip_gtm_monitor_http Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigip_gtm_monitor_http (Resource)
...
- `ip` (String) IP address part of the IP/port definition. If this parameter is not provided when creating a new monitor, the default value is '*'. If this value is an IP address, then a `port` number must be specified.
