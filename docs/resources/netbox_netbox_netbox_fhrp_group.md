...
page_title: "terrible_netbox_netbox_netbox_fhrp_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_fhrp_group (Resource)
...
- `data` (String) Defines the FHRP group configuration
