...
page_title: "terrible_cisco_meraki_networks_camera_wireless_profiles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_camera_wireless_profiles (Resource)
...
- `identity` (String) The identity of the wireless profile. Required for creating wireless profiles in 8021x-radius auth mode.
...
- `ssid` (String) The details of the SSID config.
