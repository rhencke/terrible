...
page_title: "terrible_dellemc_enterprise_sonic_sonic_fips Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_fips (Resource)
...
- `config` (String) The mode of FIPS configuration with specifications of security requirements for cryptographic modules.
