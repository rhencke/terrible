...
page_title: "terrible_cisco_meraki_meraki_mx_nat Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_meraki_mx_nat (Resource)
...
- `one_to_many` (String) List of 1:many NAT rules.
- `one_to_one` (String) List of 1:1 NAT rules.
