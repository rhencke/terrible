...
page_title: "terrible_cisco_meraki_organizations_branding_policies Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_branding_policies (Resource)
...
- `adminSettings` (String) Settings for describing which kinds of admins this policy applies to.
...
- `customLogo` (String) Properties describing the custom logo attached to the branding policy.
