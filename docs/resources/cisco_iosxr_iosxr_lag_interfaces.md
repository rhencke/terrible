...
page_title: "terrible_cisco_iosxr_iosxr_lag_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_lag_interfaces (Resource)
...
- `config` (String) A provided Link Aggregation Group (LAG) configuration.
