...
page_title: "terrible_cisco_dnac_application_visibility_network_devices_disable_app_telemetry Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_application_visibility_network_devices_disable_app_telemetry (Resource)
...
- `networkDeviceIds` (String) List of network device ids where Application Telemetry has to be disabled.
