...
page_title: "terrible_cisco_meraki_meraki_ms_link_aggregation Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_meraki_ms_link_aggregation (Resource)
...
- `switch_ports` (String) List of switchports to include in link aggregation.
...
- `data` (String) List of aggregated links.
