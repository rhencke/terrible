...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_traffic_shaping_rules Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_traffic_shaping_rules (Resource)
...
- `rules` (String) An array of traffic shaping rules. Rules are applied in the order that they are specified in. An empty list (or null) means no rules. Note that you are allowed a maximum of 8 rules.
