...
page_title: "terrible_junipernetworks_junos_junos_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_interfaces (Resource)
...
- `config` (String) The provided configuration
...
- `xml` (String) The set of xml rpc payload pushed to the remote device.
