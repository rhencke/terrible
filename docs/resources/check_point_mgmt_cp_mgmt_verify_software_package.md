...
page_title: "terrible_check_point_mgmt_cp_mgmt_verify_software_package Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_verify_software_package (Resource)
...
- `download_package` (Boolean) NOTE, Supported from Check Point version R81 Should the package be downloaded before verification.
- `download_package_from` (String) NOTE, Supported from Check Point version R81 Where is the package located.
...
- `cp_mgmt_verify_software_package` (String) The checkpoint verify-software-package output.
