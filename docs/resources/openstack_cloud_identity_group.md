...
page_title: "terrible_openstack_cloud_identity_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_identity_group (Resource)
...
- `domain_id` (String) Domain id to create the group in.
...
- `group` (String) Dictionary describing the identity group.
