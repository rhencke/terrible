...
page_title: "terrible_netbox_netbox_netbox_module_bay Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_module_bay (Resource)
...
- `data` (String) Defines the module bay configuration
...
- `module_bay` (String) Serialized object as created or already existent within NetBox
