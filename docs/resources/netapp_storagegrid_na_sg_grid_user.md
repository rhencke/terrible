...
page_title: "terrible_netapp_storagegrid_na_sg_grid_user Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_user (Resource)
...
- `resp` (String) Returns information about the StorageGRID Grid user.
