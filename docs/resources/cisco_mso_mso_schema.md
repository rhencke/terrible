...
page_title: "terrible_cisco_mso_mso_schema Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema (Resource)
...
- `state` (String) Use `absent` for removing. Use `query` for listing an object or multiple objects. Use `present` for creating or updating. Only supported on versions of MSO that are 4.1 or greater.
