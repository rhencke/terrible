...
page_title: "terrible_check_point_mgmt_cp_mgmt_connect_cloud_services Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_connect_cloud_services (Resource)
...
- `auth_token` (String) Copy the authentication token from the Smart-1 cloud service hosted in the Infinity Portal.
...
- `cp_mgmt_connect_cloud_services` (String) The checkpoint connect-cloud-services output.
