...
page_title: "terrible_cisco_dnac_application_visibility_network_devices_enable_cbar Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_application_visibility_network_devices_enable_cbar (Resource)
...
- `networkDevices` (String) Application Visibility Network Devices Enable Cbar's networkDevices.
