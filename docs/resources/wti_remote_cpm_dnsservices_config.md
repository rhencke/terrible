...
page_title: "terrible_wti_remote_cpm_dnsservices_config Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_wti_remote_cpm_dnsservices_config (Resource)
...
- `dnsservers` (String) Actual DNS Server to send to the WTI device.
...
- `index` (String) Index in which DNS Server should be inserted. If not defined entry will start at position one.
