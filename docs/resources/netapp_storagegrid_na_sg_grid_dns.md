...
page_title: "terrible_netapp_storagegrid_na_sg_grid_dns Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_storagegrid_na_sg_grid_dns (Resource)
...
- `dns_servers` (String) List of comma separated DNS Addresses to be updated or delete.
...
- `state` (String) Whether the specified DNS address should exist or not. Required for all operations.
...
- `resp` (String) Returns information about the configured DNS servers.
