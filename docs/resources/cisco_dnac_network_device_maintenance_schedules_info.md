...
page_title: "terrible_cisco_dnac_network_device_maintenance_schedules_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_maintenance_schedules_info (Resource)
...
- `networkDeviceIds` (String) NetworkDeviceIds query parameter. List of network device ids.
