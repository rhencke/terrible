...
page_title: "terrible_cisco_dnac_sda_multicast_virtual_networks_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_multicast_virtual_networks_count_info (Resource)
...
- `fabricId` (String) FabricId query parameter. ID of the fabric site the multicast configuration is associated with.
