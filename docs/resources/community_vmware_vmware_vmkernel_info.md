...
page_title: "terrible_community_vmware_vmware_vmkernel_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_vmkernel_info (Resource)
...
- `host_vmk_info` (String) metadata about VMKernel present on given host system
