...
page_title: "terrible_azure_azcollection_azure_rm_mariadbconfiguration_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mariadbconfiguration_info (Resource)
...
- `settings` (String) A list of dictionaries containing MariaDB Server settings.
