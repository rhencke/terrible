...
page_title: "terrible_dellemc_enterprise_sonic_sonic_qos_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_qos_interfaces (Resource)
...
- `config` (String) QoS interfaces configuration
...
- `state` (String) The state of the configuration after module completion Replaced and overridden states are not supported for this module due to configuration constraints
