...
page_title: "terrible_dellemc_enterprise_sonic_sonic_ospfv2 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_ospfv2 (Resource)
...
- `config` (String) Specifies the OSPFv2 related configuration. *non_passive_interfaces* and *passive_interfaces* are mutually exclusive. When *default_passive=True*, *passive_interfaces* cannot be configured. When *default_passive=False*, *non_passive_interfaces* cannot be configured.
