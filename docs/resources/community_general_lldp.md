...
page_title: "terrible_community_general_lldp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_lldp (Resource)
...
- `multivalues` (Boolean) If lldpctl outputs an attribute multiple time represent all values as a list.
