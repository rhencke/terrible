...
page_title: "terrible_cisco_dnac_buildings_planned_access_points_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_buildings_planned_access_points_info (Resource)
...
- `buildingId` (String) BuildingId path parameter. The instance UUID of the building hierarchy element.
