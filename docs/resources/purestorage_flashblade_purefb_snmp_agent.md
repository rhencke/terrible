...
page_title: "terrible_purestorage_flashblade_purefb_snmp_agent Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_snmp_agent (Resource)
...
- `version` (String) Version of SNMP protocol to use for the agent.
