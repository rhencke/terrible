...
page_title: "terrible_cisco_dnac_assurance_issues_trend_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_assurance_issues_trend_analytics (Resource)
...
- `aggregateAttributes` (String) Assurance Issues Trend Analytics's aggregateAttributes.
...
- `filters` (String) Assurance Issues Trend Analytics's filters.
...
- `page` (String) Assurance Issues Trend Analytics's page.
