...
page_title: "terrible_cisco_dnac_sda_multicast_virtual_networks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_multicast_virtual_networks (Resource)
...
- `payload` (String) Sda Multicast Virtual Networks's payload.
