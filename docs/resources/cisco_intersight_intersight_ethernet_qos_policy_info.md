...
page_title: "terrible_cisco_intersight_intersight_ethernet_qos_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_ethernet_qos_policy_info (Resource)
...
- `name` (String) The name of the Ethernet QoS Policy to gather information from.
- `organization` (String) The name of the organization the Ethernet QoS Policy belongs to.
