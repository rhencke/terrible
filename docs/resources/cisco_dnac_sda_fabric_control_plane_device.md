...
page_title: "terrible_cisco_dnac_sda_fabric_control_plane_device Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_control_plane_device (Resource)
...
- `routeDistributionProtocol` (String) Route Distribution Protocol for Control Plane Device. Allowed values are "LISP_BGP" or "LISP_PUB_SUB". Default value is "LISP_BGP".
- `siteNameHierarchy` (String) SiteNameHierarchy of the Provisioned Device(site should be part of Fabric Site).
