...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_bonjour_forwarding Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_bonjour_forwarding (Resource)
...
- `exception` (String) Bonjour forwarding exception.
...
- `rules` (String) List of bonjour forwarding rules.
