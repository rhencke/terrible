...
page_title: "terrible_ieisystem_inmanage_collect_log Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_collect_log (Resource)
...
- `file_url` (String) File download path or path with filename, for example filepath/filename.tar.
