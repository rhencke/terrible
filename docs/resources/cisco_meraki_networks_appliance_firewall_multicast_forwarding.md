...
page_title: "terrible_cisco_meraki_networks_appliance_firewall_multicast_forwarding Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_appliance_firewall_multicast_forwarding (Resource)
...
- `rules` (String) Static multicast forwarding rules. Pass an empty array to clear all rules.
