...
page_title: "terrible_vyos_vyos_vyos_ospf_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vyos_vyos_vyos_ospf_interfaces (Resource)
...
- `config` (String) A list of OSPF configuration for interfaces.
