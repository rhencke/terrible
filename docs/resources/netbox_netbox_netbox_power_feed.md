...
page_title: "terrible_netbox_netbox_netbox_power_feed Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_power_feed (Resource)
...
- `data` (String) Defines the power feed configuration
...
- `power_feed` (String) Serialized object as created or already existent within NetBox
