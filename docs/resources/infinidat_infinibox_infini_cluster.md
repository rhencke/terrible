...
page_title: "terrible_infinidat_infinibox_infini_cluster Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infinidat_infinibox_infini_cluster (Resource)
...
- `cluster_hosts` (String) A list of hosts to add to a cluster when state is present.
...
- `state` (String) Creates/Modifies Cluster when present, removes when absent, or provides details of a cluster when stat.
