...
page_title: "terrible_cisco_meraki_organizations_appliance_dns_local_profiles_assignments_bulk_delete Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_appliance_dns_local_profiles_assignments_bulk_delete (Resource)
...
- `items` (String) List containing the assignment ID.
