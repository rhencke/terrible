...
page_title: "terrible_cisco_dnac_sda_port_assignments Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_port_assignments (Resource)
...
- `payload` (String) Sda Port Assignments's payload.
