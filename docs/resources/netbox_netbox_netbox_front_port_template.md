...
page_title: "terrible_netbox_netbox_netbox_front_port_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_front_port_template (Resource)
...
- `data` (String) Defines the front port template configuration
...
- `front_port_template` (String) Serialized object as created or already existent within NetBox
