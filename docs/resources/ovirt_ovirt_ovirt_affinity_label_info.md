...
page_title: "terrible_ovirt_ovirt_ovirt_affinity_label_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ovirt_ovirt_ovirt_affinity_label_info (Resource)
...
- `follow` (String) List of linked entities, which should be fetched along with the main entity. This parameter replaces usage of `fetch_nested` and `nested_attributes`. All follow parameters can be found at following url: https://ovirt.github.io/ovirt-engine-api-model/master/#types/affinity_label/links_summary
...
- `ovirt_affinity_labels` (String) List of dictionaries describing the affinity labels. Affinity labels attributes are mapped to dictionary keys, all affinity labels attributes can be found at following url: http://ovirt.github.io/ovirt-engine-api-model/master/#types/affinity_label.
