...
page_title: "terrible_netbox_netbox_netbox_site_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_site_group (Resource)
...
- `data` (String) Defines the site group configuration
...
- `site_group` (String) Serialized object as created or already existent within NetBox
