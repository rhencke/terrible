...
page_title: "terrible_netbox_netbox_netbox_vm_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_vm_interface (Resource)
...
- `data` (String) Defines the vm interface configuration
