...
page_title: "terrible_check_point_mgmt_cp_mgmt_mobile_profile Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_mobile_profile (Resource)
...
- `applications` (String) Applications settings.
...
- `client_customization` (String) Client customization settings.
- `color` (String) Color of the object. Should be one of existing colors.
- `comments` (String) Comments string.
- `data_leak_prevention` (String) Data leak prevention settings.
...
- `harmony_mobile` (String) Integrations settings.
...
- `cp_mgmt_mobile_profile` (String) The checkpoint object created or updated.
