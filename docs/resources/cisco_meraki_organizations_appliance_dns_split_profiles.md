...
page_title: "terrible_cisco_meraki_organizations_appliance_dns_split_profiles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_appliance_dns_split_profiles (Resource)
...
- `nameservers` (String) Contains the nameserver information for redirection.
