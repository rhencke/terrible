...
page_title: "terrible_cisco_dnac_assurance_issues_summary_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_assurance_issues_summary_analytics (Resource)
...
- `aggregateAttributes` (String) Assurance Issues Summary Analytics's aggregateAttributes.
...
- `filters` (String) Assurance Issues Summary Analytics's filters.
...
- `page` (String) Assurance Issues Summary Analytics's page.
