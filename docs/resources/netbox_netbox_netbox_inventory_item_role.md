...
page_title: "terrible_netbox_netbox_netbox_inventory_item_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_inventory_item_role (Resource)
...
- `data` (String) Defines the inventory item role configuration
...
- `inventory_item_role` (String) Serialized object as created or already existent within NetBox
