...
page_title: "terrible_cisco_meraki_networks_cellular_gateway_dhcp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_cellular_gateway_dhcp (Resource)
...
- `dnsCustomNameservers` (String) List of fixed IPs representing the the DNS Name servers when the mode is 'custom'.
