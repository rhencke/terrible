...
page_title: "terrible_cisco_meraki_organizations_webhooks_callbacks_statuses_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_webhooks_callbacks_statuses_info (Resource)
...
- `callbackId` (String) Information module for Organizations Webhooks Callbacks Statuses Info. CallbackId path parameter. Callback ID.
...
- `organizationId` (String) Information module for Organizations Webhooks Callbacks Statuses Info. OrganizationId path parameter. Organization ID.
