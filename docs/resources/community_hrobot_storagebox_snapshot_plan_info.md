...
page_title: "terrible_community_hrobot_storagebox_snapshot_plan_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hrobot_storagebox_snapshot_plan_info (Resource)
...
- `plans` (String) The storage box's snapshot plan configurations. All date and time parameters are in UTC.
