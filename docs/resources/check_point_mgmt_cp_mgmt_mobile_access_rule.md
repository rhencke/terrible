...
page_title: "terrible_check_point_mgmt_cp_mgmt_mobile_access_rule Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_mobile_access_rule (Resource)
...
- `applications` (String) Available apps that will be associated with the user groups - identified by the name or UID.
...
- `user_groups` (String) User groups that will be associated with the apps - identified by the name or UID.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `cp_mgmt_mobile_access_rule` (String) The checkpoint object created or updated.
