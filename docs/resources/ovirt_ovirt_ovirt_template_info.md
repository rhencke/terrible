...
page_title: "terrible_ovirt_ovirt_ovirt_template_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ovirt_ovirt_ovirt_template_info (Resource)
...
- `ovirt_templates` (String) List of dictionaries describing the templates. Template attributes are mapped to dictionary keys, all templates attributes can be found at following url: http://ovirt.github.io/ovirt-engine-api-model/master/#types/template.
