...
page_title: "terrible_chocolatey_chocolatey_win_chocolatey_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_chocolatey_chocolatey_win_chocolatey_facts (Resource)
...
- `filter` (String) If supplied, restrict the facts collected to the given subset. Possible values: `all`, `config`, `feature`, `outdated`, `packages`, `sources`. You can provide a list of values to specify a larger subset.
...
- `ansible_facts` (String) Detailed information about the Chocolatey installation
