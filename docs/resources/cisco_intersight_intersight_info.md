...
page_title: "terrible_cisco_intersight_intersight_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_info (Resource)
...
- `server_names` (String) Server names to retrieve information from. An empty list will return all servers.
...
- `intersight_servers` (String) A list of Intersight Servers.  See [Cisco Intersight](https://intersight.com/apidocs) for details.
