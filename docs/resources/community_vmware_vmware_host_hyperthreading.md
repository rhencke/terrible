...
page_title: "terrible_community_vmware_vmware_host_hyperthreading Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_hyperthreading (Resource)
...
- `state` (String) Enable or disable Hyperthreading. You need to reboot the ESXi host if you change the configuration. Make sure that Hyperthreading is enabled in the BIOS. Otherwise, it will be enabled, but never activated.
...
- `results` (String) metadata about host system's Hyperthreading configuration
