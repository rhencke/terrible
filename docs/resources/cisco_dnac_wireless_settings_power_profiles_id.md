...
page_title: "terrible_cisco_dnac_wireless_settings_power_profiles_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_settings_power_profiles_id (Resource)
...
- `profileName` (String) Name of the Power Profile. Max length is 32 characters.
- `rules` (String) Wireless Settings Power Profiles Id's rules.
