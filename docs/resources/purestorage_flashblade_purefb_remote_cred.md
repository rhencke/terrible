...
page_title: "terrible_purestorage_flashblade_purefb_remote_cred Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_remote_cred (Resource)
...
- `target` (String) Define whether to initialize the S3 bucket
...
- `state` (String) Define state of remote credential
