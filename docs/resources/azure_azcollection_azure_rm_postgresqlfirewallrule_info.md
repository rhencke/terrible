...
page_title: "terrible_azure_azcollection_azure_rm_postgresqlfirewallrule_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_postgresqlfirewallrule_info (Resource)
...
- `rules` (String) A list of dictionaries containing facts for PostgreSQL Firewall Rule.
