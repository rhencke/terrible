...
page_title: "terrible_cisco_meraki_devices_management_interface_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_management_interface_info (Resource)
...
- `serial` (String) Information module for Devices Managementinterface Info. Serial path parameter.
