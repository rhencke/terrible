...
page_title: "terrible_infoblox_nios_modules_nios_aaaa_record Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_aaaa_record (Resource)
...
- `ipv6addr` (String) Configures the IPv6 address for this AAAA record.
...
- `ttl` (Number) Configures the TTL to be associated with this AAAA record.
- `view` (String) Sets the DNS view to associate this AAAA record with.  The DNS view must already be configured on the system.
