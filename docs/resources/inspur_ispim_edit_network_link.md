...
page_title: "terrible_inspur_ispim_edit_network_link Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_inspur_ispim_edit_network_link (Resource)
...
- `auto_nego` (String) This option is enabled to allow the device to perform automatic configuration to achieve the best possible mode of operation(speed and duplex) over a link.
