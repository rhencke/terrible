...
page_title: "terrible_netapp_ontap_na_ontap_lun_map_reporting_nodes Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_lun_map_reporting_nodes (Resource)
...
- `nodes` (String) List of reporting nodes to add or remove
- `path` (String) Path of the LUN. For ASA R2 systems, The path should match the format <name>[@<snapshot-name>].
- `vserver` (String) The name of the vserver owning the LUN.
...
- `state` (String) Whether to add or remove reporting nodes
