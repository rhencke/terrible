...
page_title: "terrible_netapp_ontap_na_ontap_cifs_local_user_modify Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_ontap_na_ontap_cifs_local_user_modify (Resource)
...
- `is_account_disabled` (Boolean) Whether the local cifs user is disabled or not
