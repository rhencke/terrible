...
page_title: "terrible_cisco_meraki_networks_sensor_mqtt_brokers_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sensor_mqtt_brokers_info (Resource)
...
- `mqttBrokerId` (String) Information module for Networks Sensor Mqttbrokers Info. MqttBrokerId path parameter. Mqtt broker ID.
- `networkId` (String) Information module for Networks Sensor Mqttbrokers Info. NetworkId path parameter. Network ID.
