...
page_title: "terrible_cisco_dnac_network_devices_summary_analytics Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_devices_summary_analytics (Resource)
...
- `aggregateAttributes` (String) Network Devices Summary Analytics's aggregateAttributes.
...
- `filters` (String) Network Devices Summary Analytics's filters.
- `groupBy` (String) Group By.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Network Devices Summary Analytics's page.
