...
page_title: "terrible_vmware_vmware_rest_appliance_networking_dns_servers_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_rest_appliance_networking_dns_servers_info (Resource)
...
- `value` (String) Get the DNS servers
