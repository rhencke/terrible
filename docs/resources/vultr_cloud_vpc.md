...
page_title: "terrible_vultr_cloud_vpc Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vultr_cloud_vpc (Resource)
...
- `v4_subnet_mask` (Number) IPv4 subnet mask of the VPC. Required if *state=present*.
...
- `vultr_vpc` (String) Response from Vultr API.
