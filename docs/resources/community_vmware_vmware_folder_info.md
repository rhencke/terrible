...
page_title: "terrible_community_vmware_vmware_folder_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_folder_info (Resource)
...
- `flat_folder_info` (String) list of dict about folders in flat structure
- `folder_info` (String) dict about folders
