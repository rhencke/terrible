...
page_title: "terrible_community_general_influxdb_write Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_influxdb_write (Resource)
...
- `data_points` (String) Data points as dict to write into the database.
