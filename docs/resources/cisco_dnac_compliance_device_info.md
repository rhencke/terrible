...
page_title: "terrible_cisco_dnac_compliance_device_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_compliance_device_info (Resource)
...
- `deviceUuid` (String) DeviceUuid query parameter. Comma separated 'Device Ids'.
