...
page_title: "terrible_dellemc_powerflex_volume Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_powerflex_volume (Resource)
...
- `compression_type` (String) Type of the compression method.
...
- `use_rmcache` (Boolean) Whether to use RM Cache or not.
