...
page_title: "terrible_azure_azcollection_azure_rm_trafficmanagerprofile_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_trafficmanagerprofile_info (Resource)
...
- `tms` (String) List of Traffic Manager profiles.
