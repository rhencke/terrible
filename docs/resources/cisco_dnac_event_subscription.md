...
page_title: "terrible_cisco_dnac_event_subscription Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_subscription (Resource)
...
- `payload` (String) Event Subscription's payload.
...
- `subscriptions` (String) Subscriptions query parameter. List of EventSubscriptionId's for removal.
