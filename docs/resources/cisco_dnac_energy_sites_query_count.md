...
page_title: "terrible_cisco_dnac_energy_sites_query_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_energy_sites_query_count (Resource)
...
- `aggregateAttributes` (String) Energy Sites Query Count's aggregateAttributes.
...
- `filters` (String) Energy Sites Query Count's filters.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `page` (String) Energy Sites Query Count's page.
