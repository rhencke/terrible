...
page_title: "terrible_cisco_dnac_icap_settings_configuration_models_preview_activity_id_network_devices_network_device_id_config_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_icap_settings_configuration_models_preview_activity_id_network_devices_network_device_id_config_info (Resource)
...
- `networkDeviceId` (String) NetworkDeviceId path parameter. Device id from intent/api/v1/network-device.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `previewActivityId` (String) PreviewActivityId path parameter. Activity from the POST /deviceConfigugrationModels task response.
