...
page_title: "terrible_cisco_dnac_event_subscription_syslog Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_subscription_syslog (Resource)
...
- `payload` (String) Event Subscription Syslog's payload.
