...
page_title: "terrible_check_point_mgmt_cp_mgmt_unlock_administrator Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_unlock_administrator (Resource)
...
- `cp_mgmt_unlock_administrator` (String) The checkpoint unlock-administrator output.
