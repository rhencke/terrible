...
page_title: "terrible_cisco_meraki_networks_wireless_ssids_hotspot20_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_ssids_hotspot20_info (Resource)
...
- `networkId` (String) Information module for Networks Wireless Ssids Hotspot20 Info. NetworkId path parameter. Network ID.
- `number` (String) Information module for Networks Wireless Ssids Hotspot20 Info. Number path parameter.
