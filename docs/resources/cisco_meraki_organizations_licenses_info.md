...
page_title: "terrible_cisco_meraki_organizations_licenses_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_licenses_info (Resource)
...
- `licenseId` (String) Information module for Organizations Licenses Info. LicenseId path parameter. License ID.
- `organizationId` (String) Information module for Organizations Licenses Info. OrganizationId path parameter. Organization ID.
