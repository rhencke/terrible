...
page_title: "terrible_netbox_netbox_netbox_device_role Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_device_role (Resource)
...
- `data` (String) Defines the device role configuration
...
- `device_role` (String) Serialized object as created or already existent within NetBox
