...
page_title: "terrible_azure_azcollection_azure_rm_manageddisk_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_manageddisk_info (Resource)
...
- `managed_by` (String) Limit results to disks managed by the given VM fqid.
...
- `resource_group` (String) Limit results to a specific resource group. Required if *name* is set
...
- `azure_managed_disk` (String) List of managed disk dicts.
