...
page_title: "terrible_cisco_dnac_security_threats_details_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_threats_details_count (Resource)
...
- `isNewThreat` (Boolean) Is New Threat.
- `limit` (Number) Limit.
