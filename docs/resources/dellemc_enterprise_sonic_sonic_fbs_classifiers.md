...
page_title: "terrible_dellemc_enterprise_sonic_sonic_fbs_classifiers Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_fbs_classifiers (Resource)
...
- `config` (String) FBS classifiers configuration *match_acl* and *match_hdr_fields* are mutually exclusive.
