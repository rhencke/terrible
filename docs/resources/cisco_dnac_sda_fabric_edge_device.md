...
page_title: "terrible_cisco_dnac_sda_fabric_edge_device Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_fabric_edge_device (Resource)
...
- `deviceManagementIpAddress` (String) Management Ip Address of the Device which is provisioned successfully.
