...
page_title: "terrible_arista_eos_eos_prefix_lists Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_arista_eos_eos_prefix_lists (Resource)
...
- `config` (String) A list of dictionary of prefix-list options
