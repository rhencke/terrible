...
page_title: "terrible_cisco_dnac_site_delete Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_site_delete (Resource)
...
- `siteId` (String) SiteId path parameter. Site id to which site details to be deleted.
