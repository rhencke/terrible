...
page_title: "terrible_purestorage_flashblade_purefb_target Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_target (Resource)
...
- `name` (String) Name of S3-capable target (IP or FQDN)
...
- `state` (String) Create or delete remote target
