...
page_title: "terrible_cisco_meraki_organizations_adaptive_policy_acls_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_adaptive_policy_acls_info (Resource)
...
- `aclId` (String) Information module for Organizations Adaptivepolicy Acls Info. AclId path parameter. Acl ID.
...
- `organizationId` (String) Information module for Organizations Adaptivepolicy Acls Info. OrganizationId path parameter. Organization ID.
