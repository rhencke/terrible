...
page_title: "terrible_cisco_dnac_cli_credential Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_cli_credential (Resource)
...
- `comments` (String) Comments to identify the CLI credential.
- `credentialType` (String) Credential type to identify the application that uses the CLI credential.
- `delegate_to_id` (String) ID of another terrible_host to delegate execution to.
- `description` (String) Description for CLI Credentials.
