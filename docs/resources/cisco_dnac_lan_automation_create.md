...
page_title: "terrible_cisco_dnac_lan_automation_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_lan_automation_create (Resource)
...
- `payload` (String) Lan Automation Create's payload.
