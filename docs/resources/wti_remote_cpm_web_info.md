...
page_title: "terrible_wti_remote_cpm_web_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_wti_remote_cpm_web_info (Resource)
...
- `include_certs` (Boolean) If true, will return the Signed, Private and Intermediate Keys from the WTI device.
- `interface` (String) This is the ethernet port name that is getting retrieved. It can include a single ethernet port name, multiple ethernet port names separated by commas or not defined for all ports.
