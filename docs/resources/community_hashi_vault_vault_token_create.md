...
page_title: "terrible_community_hashi_vault_vault_token_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hashi_vault_vault_token_create (Resource)
...
- `login` (String) The result of the token creation operation.
