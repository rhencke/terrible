...
page_title: "terrible_community_grafana_grafana_user Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_grafana_grafana_user (Resource)
...
- `is_admin` (Boolean) The Grafana User is an admin.
...
- `state` (String) State if the user should be present in Grafana or not
...
- `user` (String) Information about the User
