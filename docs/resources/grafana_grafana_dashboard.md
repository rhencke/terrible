...
page_title: "terrible_grafana_grafana_dashboard Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_grafana_grafana_dashboard (Resource)
...
- `dashboard` (String) JSON source code for dashboard.
...
- `state` (String) State for the Grafana Dashboard.
