...
page_title: "terrible_cisco_meraki_networks_switch_link_aggregations Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_link_aggregations (Resource)
...
- `linkAggregationId` (String) LinkAggregationId path parameter. Link aggregation ID.
...
- `switchPorts` (String) Array of switch or stack ports for creating aggregation group. Minimum 2 and maximum 8 ports are supported.
- `switchProfilePorts` (String) Array of switch profile ports for creating aggregation group. Minimum 2 and maximum 8 ports are supported.
