...
page_title: "terrible_azure_azcollection_azure_rm_subnet_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_subnet_info (Resource)
...
- `subnets` (String) A list of dictionaries containing facts for subnet.
