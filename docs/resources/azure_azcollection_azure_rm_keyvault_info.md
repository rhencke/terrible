...
page_title: "terrible_azure_azcollection_azure_rm_keyvault_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_keyvault_info (Resource)
...
- `resource_group` (String) The name of the resource group to which the key vault belongs.
...
- `keyvaults` (String) List of Azure Key Vaults.
