...
page_title: "terrible_wti_remote_cpm_plugcontrol Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_wti_remote_cpm_plugcontrol (Resource)
...
- `plug_id` (String) This is the plug number or the plug name that is to be manipulated For the plugget command, the plug_id 'all' will return the status of all the plugs the user has rights to access.
...
- `plug_state` (String) This is what action to take on the plug.
