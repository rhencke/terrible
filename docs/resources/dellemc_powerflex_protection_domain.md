...
page_title: "terrible_dellemc_powerflex_protection_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_powerflex_protection_domain (Resource)
...
- `state` (String) State of the protection domain.
...
- `is_active` (Boolean) Used to activate or deactivate the protection domain.
- `network_limits` (String) Network bandwidth limit used by all SDS in protection domain.
...
- `rf_cache_limits` (String) Used to set the RFcache parameters of the protection domain.
