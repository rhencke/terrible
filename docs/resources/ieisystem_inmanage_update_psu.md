...
page_title: "terrible_ieisystem_inmanage_update_psu Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_update_psu (Resource)
...
- `mode` (String) Server Auto Reset Option, Manual or Auto(default).
