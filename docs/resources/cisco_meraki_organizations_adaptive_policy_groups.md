...
page_title: "terrible_cisco_meraki_organizations_adaptive_policy_groups Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_adaptive_policy_groups (Resource)
...
- `policyObjects` (String) The policy objects that belong to this group; traffic from addresses specified by these policy objects will be tagged with this group's SGT value if no other tagging scheme is being used (each requires one unique attribute) (default ).
