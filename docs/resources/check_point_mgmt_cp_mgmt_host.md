...
page_title: "terrible_check_point_mgmt_cp_mgmt_host Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_host (Resource)
...
- `host_servers` (String) Servers Configuration.
...
- `interfaces` (String) Host interfaces. Available from R80.10 management version.
...
- `cp_mgmt_host` (String) The checkpoint object created or updated.
