...
page_title: "terrible_awx_awx_workflow_node_wait Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_workflow_node_wait (Resource)
...
- `name` (String) Name of the workflow node to wait on.
- `workflow_job_id` (Number) ID of the workflow job to monitor for node.
