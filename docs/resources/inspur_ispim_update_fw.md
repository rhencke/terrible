...
page_title: "terrible_inspur_ispim_update_fw Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_inspur_ispim_update_fw (Resource)
...
- `dual_image` (String) (M5)update dual image(default) or not. Only the M5 model supports this parameter.
...
- `has_me` (Number) (M5-BIOS)update me or not when update bios,only work in INTEL platform,0-no,1-yes. Only the M5 model supports this parameter.
...
- `over_ride` (Number) Reserve Configrations,0-reserve, 1-override.
