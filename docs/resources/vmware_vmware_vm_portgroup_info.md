...
page_title: "terrible_vmware_vmware_vm_portgroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_vmware_vmware_vm_portgroup_info (Resource)
...
- `vm_names` (String) VM names for retrieving the information about portgroup
...
- `vm_portgroup_info` (String) Dictionary of the requested VMs with the portgroup information
