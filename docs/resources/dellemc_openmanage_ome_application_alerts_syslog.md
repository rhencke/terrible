...
page_title: "terrible_dellemc_openmanage_ome_application_alerts_syslog Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_ome_application_alerts_syslog (Resource)
...
- `syslog_servers` (String) List of servers to forward syslog.
...
- `msg` (String) Overall status of the syslog forwarding operation.
- `syslog_details` (String) Syslog forwarding settings list applied.
