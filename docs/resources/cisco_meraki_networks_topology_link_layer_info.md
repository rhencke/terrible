...
page_title: "terrible_cisco_meraki_networks_topology_link_layer_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_topology_link_layer_info (Resource)
...
- `networkId` (String) Information module for Networks Topology Linklayer Info. NetworkId path parameter. Network ID.
