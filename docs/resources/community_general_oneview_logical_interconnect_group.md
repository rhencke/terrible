...
page_title: "terrible_community_general_oneview_logical_interconnect_group Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_oneview_logical_interconnect_group (Resource)
...
- `data` (String) List with the Logical Interconnect Group properties.
...
- `state` (String) Indicates the desired state for the Logical Interconnect Group resource. `absent` removes the resource from OneView, if it exists. `present` ensures data properties are compliant with OneView.
...
- `logical_interconnect_group` (String) Has the facts about the OneView Logical Interconnect Group.
