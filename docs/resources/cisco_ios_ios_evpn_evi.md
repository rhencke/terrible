...
page_title: "terrible_cisco_ios_ios_evpn_evi Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_ios_ios_evpn_evi (Resource)
...
- `config` (String) A dictionary of L2VPN Ethernet Virtual Private Network (EVPN) EVI configuration
