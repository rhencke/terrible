...
page_title: "terrible_cisco_meraki_meraki_ms_access_list Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_meraki_ms_access_list (Resource)
...
- `rules` (String) List of access control rules.
