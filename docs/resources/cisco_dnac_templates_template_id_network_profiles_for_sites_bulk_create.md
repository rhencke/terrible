...
page_title: "terrible_cisco_dnac_templates_template_id_network_profiles_for_sites_bulk_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_templates_template_id_network_profiles_for_sites_bulk_create (Resource)
...
- `items` (String) Templates Template Id Network Profiles For Sites Bulk Create's items.
