...
page_title: "terrible_cisco_dnac_feature_templates_wireless_dot11be_status_configurations Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_feature_templates_wireless_dot11be_status_configurations (Resource)
...
- `featureAttributes` (String) Feature Templates Wireless Dot11be Status Configurations's featureAttributes.
