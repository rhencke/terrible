...
page_title: "terrible_community_hrobot_storagebox_subaccount_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_hrobot_storagebox_subaccount_info (Resource)
...
- `subaccounts` (String) The storage box's info. All date and time parameters are in UTC.
