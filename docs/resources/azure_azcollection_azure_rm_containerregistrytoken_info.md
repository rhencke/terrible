...
page_title: "terrible_azure_azcollection_azure_rm_containerregistrytoken_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_containerregistrytoken_info (Resource)
...
- `registry_tokens` (String) A list of dictionaries containing facts for token.
