...
page_title: "terrible_awx_awx_controller_meta Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_awx_awx_controller_meta (Resource)
...
- `prefix` (String) Collection namespace and name in the namespace.name format
