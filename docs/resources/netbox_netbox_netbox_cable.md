...
page_title: "terrible_netbox_netbox_netbox_cable Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_cable (Resource)
...
- `data` (String) Defines the cable configuration
...
- `cable` (String) Serialized object as created or already existent within NetBox
