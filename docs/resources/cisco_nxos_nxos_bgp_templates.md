...
page_title: "terrible_cisco_nxos_nxos_bgp_templates Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_nxos_nxos_bgp_templates (Resource)
...
- `config` (String) A list of BGP templates.
