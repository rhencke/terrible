...
page_title: "terrible_cisco_intersight_intersight_lan_connectivity_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_intersight_intersight_lan_connectivity_policy_info (Resource)
...
- `name` (String) The name of the LAN Connectivity Policy to gather information from.
- `organization` (String) The name of the organization the LAN Connectivity Policy belongs to.
