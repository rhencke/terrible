...
page_title: "terrible_cisco_mso_mso_schema_template_anp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_schema_template_anp (Resource)
...
- `anp` (String) The name of the ANP to manage.
...
- `description` (String) The description of ANP is supported on versions of MSO that are 3.3 or greater.
