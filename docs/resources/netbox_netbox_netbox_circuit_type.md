...
page_title: "terrible_netbox_netbox_netbox_circuit_type Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_circuit_type (Resource)
...
- `data` (String) Defines the circuit type configuration
...
- `circuit_type` (String) Serialized object as created or already existent within NetBox
