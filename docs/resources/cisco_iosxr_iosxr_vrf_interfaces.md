...
page_title: "terrible_cisco_iosxr_iosxr_vrf_interfaces Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_iosxr_iosxr_vrf_interfaces (Resource)
...
- `config` (String) A list of VRF interfaces options.
...
- `running_config` (String) This option is used only with state *parsed*. The value of this option should be the output received from the IOS device by executing the command **sh running-config interface**. The state *parsed* reads the configuration from `running_config` option and transforms it into Ansible structured data as per the resource module's argspec and the value is then returned in the *parsed* key within the result.
