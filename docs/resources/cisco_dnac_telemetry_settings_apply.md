...
page_title: "terrible_cisco_dnac_telemetry_settings_apply Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_telemetry_settings_apply (Resource)
...
- `deviceIds` (String) The list of device Ids to perform the provisioning against.
