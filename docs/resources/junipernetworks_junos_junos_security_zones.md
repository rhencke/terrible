...
page_title: "terrible_junipernetworks_junos_junos_security_zones Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_security_zones (Resource)
...
- `config` (String) Dictionary of security zone parameters
