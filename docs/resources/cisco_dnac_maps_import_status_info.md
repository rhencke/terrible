...
page_title: "terrible_cisco_dnac_maps_import_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_maps_import_status_info (Resource)
...
- `importContextUuid` (String) ImportContextUuid path parameter. The unique import context UUID given by a previous and recent call to maps/import/start API.
