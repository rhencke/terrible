...
page_title: "terrible_azure_azcollection_azure_rm_mysqlflexiblefirewallrule_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mysqlflexiblefirewallrule_info (Resource)
...
- `name` (String) The name of the flexible server firewall rule.
...
- `rules` (String) A list of dictionaries containing facts for MySQL Flexible Firewall Rule.
