...
page_title: "terrible_cisco_meraki_networks_firmware_upgrades_staged_events_rollbacks Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_firmware_upgrades_staged_events_rollbacks (Resource)
...
- `reasons` (String) The reason for rolling back the staged upgrade.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `stages` (String) All completed or in-progress stages in the network with their new start times. All pending stages will be canceled.
