...
page_title: "terrible_azure_azcollection_azure_rm_sshpublickey_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_sshpublickey_info (Resource)
...
- `name` (String) Name of the SSH Public Key.
...
- `ssh_keys` (String) Current state of the SSH Public Key.
