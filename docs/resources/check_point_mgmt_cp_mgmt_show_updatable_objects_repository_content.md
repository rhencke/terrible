...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_updatable_objects_repository_content Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_updatable_objects_repository_content (Resource)
...
- `uid_in_updatable_objects_repository` (String) The object's unique identifier in the Updatable Objects repository.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `cp_mgmt_show_updatable_objects_repository_content` (String) The checkpoint show-updatable-objects-repository-content output.
