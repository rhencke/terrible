...
page_title: "terrible_hetzner_hcloud_storage_box_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_hetzner_hcloud_storage_box_info (Resource)
...
- `label_selector` (String) Label selector to filter the Storage Boxes to get.
- `name` (String) Name of the Storage Box to get.
...
- `hcloud_storage_box_info` (String) List of Storage Boxes.
