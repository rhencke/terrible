...
page_title: "terrible_containers_podman_podman_container_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_container_info (Resource)
...
- `name` (String) List of container names to gather facts about. If no name is given return facts about all containers.
...
- `containers` (String) Facts from all or specified containers
