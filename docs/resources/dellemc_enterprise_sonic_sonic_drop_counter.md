...
page_title: "terrible_dellemc_enterprise_sonic_sonic_drop_counter Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_drop_counter (Resource)
...
- `config` (String) List of drop counter configurations
