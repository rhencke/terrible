...
page_title: "terrible_azure_azcollection_azure_rm_gallery Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_gallery (Resource)
...
- `name` (String) The name of the Shared Image Gallery. Valid names consist of less than 80 alphanumeric characters, underscores and periods.
...
- `state` (String) Assert the state of the Gallery. Use `present` to create or update an Gallery and `absent` to delete it.
