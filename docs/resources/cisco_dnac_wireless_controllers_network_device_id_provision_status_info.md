...
page_title: "terrible_cisco_dnac_wireless_controllers_network_device_id_provision_status_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_controllers_network_device_id_provision_status_info (Resource)
...
- `networkDeviceId` (String) NetworkDeviceId path parameter. Obtain the networkDeviceId value by using the API call GET /dna/intent/api/v1/network-device/ip-address/${ipAddress}.
