...
page_title: "terrible_f5networks_f5_modules_bigip_firewall_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigip_firewall_policy (Resource)
...
- `state` (String) When `state` is `present`, ensures the policy exists. When `state` is `absent`, ensures the policy is removed.
