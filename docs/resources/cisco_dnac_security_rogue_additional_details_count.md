...
page_title: "terrible_cisco_dnac_security_rogue_additional_details_count Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_security_rogue_additional_details_count (Resource)
...
- `threatLevel` (String) This information can be fetched from "Get Threat Levels" API.
- `threatType` (String) This information can be fetched from "Get Threat Types" API.
