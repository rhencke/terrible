...
page_title: "terrible_cisco_dnac_network_device_images_id_activate Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_device_images_id_activate (Resource)
...
- `compatibleFeatures` (String) Network Device Images Id Activate's compatibleFeatures.
...
- `installedImages` (String) Network Device Images Id Activate's installedImages.
- `networkValidationIds` (String) List of unique identifiers of custom network device validations.
