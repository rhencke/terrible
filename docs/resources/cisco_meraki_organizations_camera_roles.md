...
page_title: "terrible_cisco_meraki_organizations_camera_roles Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_camera_roles (Resource)
...
- `appliedOnDevices` (String) Device tag on which this specified permission is applied.
- `appliedOnNetworks` (String) Network tag on which this specified permission is applied.
- `appliedOrgWide` (String) Permissions to be applied org wide.
