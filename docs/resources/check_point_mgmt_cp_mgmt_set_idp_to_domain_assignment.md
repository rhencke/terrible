...
page_title: "terrible_check_point_mgmt_cp_mgmt_set_idp_to_domain_assignment Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_set_idp_to_domain_assignment (Resource)
...
- `using_default` (Boolean) Is this assignment override by 'idp-default-assignment'.

### Read-Only

- `changed` (Boolean) Whether the task reported a change
- `cp_mgmt_set_idp_to_domain_assignment` (String) The checkpoint set-idp-to-domain-assignment output.
