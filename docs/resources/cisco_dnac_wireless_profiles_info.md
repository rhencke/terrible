...
page_title: "terrible_cisco_dnac_wireless_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_wireless_profiles_info (Resource)
...
- `wirelessProfileName` (String) WirelessProfileName query parameter. Wireless Profile Name.
