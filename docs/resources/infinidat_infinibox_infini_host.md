...
page_title: "terrible_infinidat_infinibox_infini_host Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infinidat_infinibox_infini_host (Resource)
...
- `state` (String) Creates/Modifies Host when present or removes when absent
