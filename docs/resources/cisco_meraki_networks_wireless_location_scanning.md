...
page_title: "terrible_cisco_meraki_networks_wireless_location_scanning Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_wireless_location_scanning (Resource)
...
- `api` (String) Enable push API for scanning events, analytics must be enabled.
