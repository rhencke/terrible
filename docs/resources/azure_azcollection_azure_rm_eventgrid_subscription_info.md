...
page_title: "terrible_azure_azcollection_azure_rm_eventgrid_subscription_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_eventgrid_subscription_info (Resource)
...
- `location` (String) List by region.
...
- `resource_group` (String) Name of a resource group to limit event subscriptions from.  If not specified the subscription will be searched.
- `skip_tags` (String) Skip tasks with these Ansible tags (list of strings).
- `source_resource_id` (String) Fully qualified identifier of the Azure resource whose event subscription needs to be listed.
...
- `eventgrid_subscriptions` (String) List of Eventgrid subscriptions.
