...
page_title: "terrible_community_windows_win_rabbitmq_plugin Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_windows_win_rabbitmq_plugin (Resource)
...
- `names` (String) Comma-separated list of plugin names.
