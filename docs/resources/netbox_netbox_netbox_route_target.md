...
page_title: "terrible_netbox_netbox_netbox_route_target Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_route_target (Resource)
...
- `data` (String) Defines the route target configuration
...
- `route_target` (String) Serialized object as created/existent/updated/deleted within NetBox
