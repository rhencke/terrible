...
page_title: "terrible_community_proxysql_proxysql_global_variables Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_proxysql_proxysql_global_variables (Resource)
...
- `variable` (String) Defines which variable should be returned, or if *value* is specified which variable should be updated.
...
- `stdout` (String) Returns the mysql variable supplied with it's associated value.
