...
page_title: "terrible_azure_azcollection_azure_rm_localnetworkgateway_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_localnetworkgateway_info (Resource)
...
- `state` (String) Current state of the Azure Local Network Gateway resource.
