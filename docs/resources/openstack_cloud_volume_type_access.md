...
page_title: "terrible_openstack_cloud_volume_type_access Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_openstack_cloud_volume_type_access (Resource)
...
- `name` (String) Name or ID of the block-storage volume type.
- `project` (String) ID or Name of project to grant. Allow *project* to access private volume type (name or ID).
...
- `state` (String) Indicate whether project should have access to volume type or not.
...
- `volume_type` (String) Dictionary describing the volume type.
