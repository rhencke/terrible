...
page_title: "terrible_ieisystem_inmanage_restore Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ieisystem_inmanage_restore (Resource)
...
- `bak_file` (String) Select backup file or bak folder.
...
- `item` (String) Select export item. Only the M5 model supports this parameter.
