...
page_title: "terrible_azure_azcollection_azure_rm_azurefirewall_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_azurefirewall_info (Resource)
...
- `firewalls` (String) A list of dict results where the key is the name of the AzureFirewall and the values are the facts for that AzureFirewall.
