...
page_title: "terrible_cisco_meraki_networks_switch_qos_rules_order_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_switch_qos_rules_order_info (Resource)
...
- `networkId` (String) Information module for Networks Switch Qosrules Order Info. NetworkId path parameter. Network ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `qosRuleId` (String) Information module for Networks Switch Qosrules Order Info. QosRuleId path parameter. Qos rule ID.
