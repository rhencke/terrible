...
page_title: "terrible_containers_podman_podman_export Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_export (Resource)
...
- `dest` (String) Path to export container to.
...
- `container` (String) Container to export.
...
- `volume` (String) Volume to export.
