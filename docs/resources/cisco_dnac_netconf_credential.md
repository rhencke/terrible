...
page_title: "terrible_cisco_dnac_netconf_credential Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_netconf_credential (Resource)
...
- `credentialType` (String) Credential type to identify the application that uses the netconf credential.
...
- `netconfPort` (String) Netconf port on the device. Valid port should be in the range of 1 to 65535.
