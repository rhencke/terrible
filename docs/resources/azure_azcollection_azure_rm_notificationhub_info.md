...
page_title: "terrible_azure_azcollection_azure_rm_notificationhub_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_notificationhub_info (Resource)
...
- `namespace_name` (String) The name of the namspace.
...
- `state` (String) Current state of the Notification Hub namesapce or Notification Hub.
