...
page_title: "terrible_cisco_mso_ndo_l3out_annotation Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_ndo_l3out_annotation (Resource)
...
- `template` (String) The name of the template. The template must be a L3Out template.
