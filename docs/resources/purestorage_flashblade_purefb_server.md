...
page_title: "terrible_purestorage_flashblade_purefb_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_purestorage_flashblade_purefb_server (Resource)
...
- `directory_service` (String) The directory service configuration to be used for this server
- `dns` (String) The DNS configuration to be used for this server
