...
page_title: "terrible_cisco_meraki_devices_wireless_zigbee_enrollments_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_wireless_zigbee_enrollments_info (Resource)
...
- `enrollmentId` (String) Information module for Devices Wireless Zigbee Enrollments Info. EnrollmentId path parameter. Enrollment ID.
...
- `serial` (String) Information module for Devices Wireless Zigbee Enrollments Info. Serial path parameter.
