...
page_title: "terrible_community_windows_win_psrepository_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_windows_win_psrepository_info (Resource)
...
- `name` (String) The name of the repository to retrieve. Supports any wildcard pattern supported by `Get-PSRepository`. If omitted then all repositories will returned.
...
- `repositories` (String) A list of repositories (or an empty list is there are none).
