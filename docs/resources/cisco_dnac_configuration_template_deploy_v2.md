...
page_title: "terrible_cisco_dnac_configuration_template_deploy_v2 Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_configuration_template_deploy_v2 (Resource)
...
- `forcePushTemplate` (Boolean) ForcePushTemplate flag.
- `ignore_errors` (Boolean) When true, a failed task does not raise a Terraform error.
- `isComposite` (Boolean) Composite template flag.
- `mainTemplateId` (String) Main template UUID of versioned template.
- `memberTemplateDeploymentInfo` (String) MemberTemplateDeploymentInfo.
...
- `targetInfo` (String) Configuration Template Deploy V2's targetInfo.
