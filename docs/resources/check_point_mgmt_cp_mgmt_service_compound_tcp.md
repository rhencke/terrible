...
page_title: "terrible_check_point_mgmt_cp_mgmt_service_compound_tcp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_service_compound_tcp (Resource)
...
- `compound_service` (String) Compound service type.
...
- `cp_mgmt_service_compound_tcp` (String) The checkpoint object created or updated.
