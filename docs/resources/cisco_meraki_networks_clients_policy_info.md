...
page_title: "terrible_cisco_meraki_networks_clients_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_clients_policy_info (Resource)
...
- `clientId` (String) Information module for Networks Clients Policy Info. ClientId path parameter. Client ID.
...
- `networkId` (String) Information module for Networks Clients Policy Info. NetworkId path parameter. Network ID.
