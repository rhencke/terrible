...
page_title: "terrible_azure_azcollection_azure_rm_firewallpolicy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_firewallpolicy_info (Resource)
...
- `firewallpolicies` (String) Gets a list of firewall policies.
