...
page_title: "terrible_cisco_meraki_devices_cellular_sims_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_cellular_sims_info (Resource)
...
- `serial` (String) Information module for Devices Cellular Sims Info. Serial path parameter.
