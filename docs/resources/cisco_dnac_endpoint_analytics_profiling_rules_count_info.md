...
page_title: "terrible_cisco_dnac_endpoint_analytics_profiling_rules_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_endpoint_analytics_profiling_rules_count_info (Resource)
...
- `includeDeleted` (Boolean) IncludeDeleted query parameter. Flag to indicate whether deleted rules should be part of the records fetched.
