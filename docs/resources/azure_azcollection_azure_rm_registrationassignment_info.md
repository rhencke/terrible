...
page_title: "terrible_azure_azcollection_azure_rm_registrationassignment_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_registrationassignment_info (Resource)
...
- `scope` (String) Scope of the registration assignment.
...
- `registration_assignment_id` (String) ID of the registration assignment.
...
- `registration_assignments` (String) A list of dict results where the key is the name of the RegistrationAssignment. The values are the facts for that RegistrationAssignment.
