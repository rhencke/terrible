...
page_title: "terrible_azure_azcollection_azure_rm_resourcegroup_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_resourcegroup_info (Resource)
...
- `list_resources` (Boolean) List all resources under the resource group. Note this will cost network overhead for each resource group. Suggest use this when *name* set.
...
- `resourcegroups` (String) List of resource group dicts.
