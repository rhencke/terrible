...
page_title: "terrible_check_point_mgmt_cp_mgmt_dns_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_dns_domain (Resource)
...
- `is_sub_domain` (Boolean) Whether to match sub-domains in addition to the domain itself.
...
- `cp_mgmt_dns_domain` (String) The checkpoint object created or updated.
