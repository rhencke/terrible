...
page_title: "terrible_cisco_dnac_device_configurations_export Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_device_configurations_export (Resource)
...
- `deviceId` (String) UUIDs of the devices for which configurations need to be exported.
...
- `password` (String) Password for the zip file to protect exported configurations. Must contain, at minimum 8 characters, one lowercase letter, one uppercase letter, one number, one special character(-=;,./~!@#$%^&*()_+{}| ?). It may not contain white space or the characters <>.
