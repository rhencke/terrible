...
page_title: "terrible_cisco_meraki_organizations_wireless_zigbee_disenrollments Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_wireless_zigbee_disenrollments (Resource)
...
- `doorLockIds` (String) A list of Meraki door lock ids to disenroll from the device.
