...
page_title: "terrible_check_point_mgmt_cp_mgmt_delete_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_delete_domain (Resource)
...
- `cp_mgmt_domain` (String) The checkpoint delete-domain output.
