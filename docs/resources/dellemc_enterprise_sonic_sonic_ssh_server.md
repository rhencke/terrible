...
page_title: "terrible_dellemc_enterprise_sonic_sonic_ssh_server Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_enterprise_sonic_sonic_ssh_server (Resource)
...
- `config` (String) SSH servers use the following configurations for SSH connections.
