...
page_title: "terrible_netbox_netbox_netbox_location Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_location (Resource)
...
- `data` (String) Defines the location configuration
...
- `location` (String) Serialized object as created or already existent within NetBox
