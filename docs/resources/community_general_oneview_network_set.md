...
page_title: "terrible_community_general_oneview_network_set Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_oneview_network_set (Resource)
...
- `data` (String) List with the Network Set properties.
...
- `state` (String) Indicates the desired state for the Network Set resource. `present` ensures data properties are compliant with OneView. `absent` removes the resource from OneView, if it exists.
...
- `network_set` (String) Has the facts about the Network Set.
