...
page_title: "terrible_f5networks_f5_modules_bigip_monitor_https Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_f5networks_f5_modules_bigip_monitor_https (Resource)
...
- `cipher_list` (String) Specifies the list of ciphers for this monitor. The items in the cipher list are separated with a colon `:`.
...
- `interval` (Number) The interval specifying how frequently the monitor instance of this template runs. If this parameter is not provided when creating a new monitor, the default value is 5. This value **must** be less than the `timeout` value.
