...
page_title: "terrible_azure_azcollection_azure_rm_deployment_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_deployment_info (Resource)
...
- `deployments` (String) A list of dictionaries containing facts for deployments.
