...
page_title: "terrible_azure_azcollection_azure_rm_trafficmanagerendpoint_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_trafficmanagerendpoint_info (Resource)
...
- `profile_name` (String) Name of Traffic Manager Profile.
...
- `endpoints` (String) List of Traffic Manager endpoints.
