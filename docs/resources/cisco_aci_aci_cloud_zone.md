...
page_title: "terrible_cisco_aci_aci_cloud_zone Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_aci_aci_cloud_zone (Resource)
...
- `state` (String) Use `query` for listing an object or multiple objects.
