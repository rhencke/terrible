...
page_title: "terrible_junipernetworks_junos_junos_static_routes Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_junipernetworks_junos_junos_static_routes (Resource)
...
- `config` (String) A dictionary of static routes options
