...
page_title: "terrible_check_point_mgmt_cp_mgmt_show_commands Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_show_commands (Resource)
...
- `prefix` (String) The prefix of the desired commands to show.
...
- `cp_mgmt_show_commands` (String) The checkpoint show-commands output.
