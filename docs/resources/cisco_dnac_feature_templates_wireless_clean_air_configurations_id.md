...
page_title: "terrible_cisco_dnac_feature_templates_wireless_clean_air_configurations_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_feature_templates_wireless_clean_air_configurations_id (Resource)
...
- `featureAttributes` (String) Feature Templates Wireless Clean Air Configurations Id's featureAttributes.
...
- `unlockedAttributes` (String) Attributes unlocked in design can be changed at device provision time. `Note ` unlockedAttributes can only contain the first level attributes defined under featureAttributes.
