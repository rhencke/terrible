...
page_title: "terrible_community_general_memset_memstore_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_memset_memstore_info (Resource)
...
- `name` (String) The Memstore product name (that is, `mstestyaa1`).
...
- `memset_api` (String) Info from the Memset API.
