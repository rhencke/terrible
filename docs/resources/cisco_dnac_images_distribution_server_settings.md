...
page_title: "terrible_cisco_dnac_images_distribution_server_settings Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_images_distribution_server_settings (Resource)
...
- `rootLocation` (String) Server root location.
- `serverAddress` (String) FQDN or IP address of the server.
