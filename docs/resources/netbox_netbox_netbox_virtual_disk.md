...
page_title: "terrible_netbox_netbox_netbox_virtual_disk Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_virtual_disk (Resource)
...
- `data` (String) Defines the vm disk configuration
...
- `virtual_disk` (String) Serialized object as created or already existent within NetBox
