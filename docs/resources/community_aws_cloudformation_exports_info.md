...
page_title: "terrible_community_aws_cloudformation_exports_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_cloudformation_exports_info (Resource)
...
- `export_items` (String) A dictionary of Exports items names and values.
