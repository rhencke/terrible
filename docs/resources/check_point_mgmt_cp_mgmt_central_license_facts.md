...
page_title: "terrible_check_point_mgmt_cp_mgmt_central_license_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_central_license_facts (Resource)
...
- `signature` (String) The license's signature. This parameter is relevant only for getting a specific object.
