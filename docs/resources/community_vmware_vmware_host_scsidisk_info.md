...
page_title: "terrible_community_vmware_vmware_host_scsidisk_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_scsidisk_info (Resource)
...
- `hosts_scsidisk_info` (String) metadata about host system SCSI disk information
