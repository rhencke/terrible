...
page_title: "terrible_cisco_mso_mso_dhcp_relay_policy Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_mso_mso_dhcp_relay_policy (Resource)
...
- `description` (String) Description of the DHCP Relay Policy
...
- `tenant` (String) Tenant where the DHCP Relay Policy is located.
