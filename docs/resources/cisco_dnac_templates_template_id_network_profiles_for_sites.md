...
page_title: "terrible_cisco_dnac_templates_template_id_network_profiles_for_sites Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_templates_template_id_network_profiles_for_sites (Resource)
...
- `profileId` (String) The id of the network profile, retrievable from `/intent/api/v1/networkProfilesForSites`.
