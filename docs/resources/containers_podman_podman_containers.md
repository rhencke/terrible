...
page_title: "terrible_containers_podman_podman_containers Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_containers_podman_podman_containers (Resource)
...
- `containers` (String) List of dictionaries with data for running containers for podman_container module.
