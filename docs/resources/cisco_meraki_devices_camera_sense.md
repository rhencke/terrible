...
page_title: "terrible_cisco_meraki_devices_camera_sense Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_devices_camera_sense (Resource)
...
- `audioDetection` (String) The details of the audio detection config.
