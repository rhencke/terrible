...
page_title: "terrible_cisco_dnac_templates_template_id_versions_version_id_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_templates_template_id_versions_version_id_info (Resource)
...
- `versionId` (String) VersionId path parameter. The id of the versioned template to get versions of, retrieveable from `GET /dna/intent/api/v1/templates/{id}/versions`.
