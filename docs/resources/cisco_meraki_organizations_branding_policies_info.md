...
page_title: "terrible_cisco_meraki_organizations_branding_policies_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_branding_policies_info (Resource)
...
- `brandingPolicyId` (String) Information module for Organizations Brandingpolicies Info. BrandingPolicyId path parameter. Branding policy ID.
...
- `organizationId` (String) Information module for Organizations Brandingpolicies Info. OrganizationId path parameter. Organization ID.
