...
page_title: "terrible_ansible_windows_win_tempfile Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_ansible_windows_win_tempfile (Resource)
...
- `path` (String) Location where temporary file or directory should be created. If path is not specified default system temporary directory (%TEMP%) will be used.
