...
page_title: "terrible_community_aws_networkfirewall_policy_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_aws_networkfirewall_policy_info (Resource)
...
- `policies` (String) The details of the policies
- `policy_list` (String) A list of ARNs of the matching policies.
