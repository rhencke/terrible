...
page_title: "terrible_cisco_meraki_organizations_devices_packet_capture_captures_bulk_create Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_devices_packet_capture_captures_bulk_create (Resource)
...
- `advanced` (String) Advanced capture options (optional).
...
- `devices` (String) Device details (maximum of 20 devices allowed).
