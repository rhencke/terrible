...
page_title: "terrible_community_vmware_vmware_host_capability_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_capability_info (Resource)
...
- `hosts_capability_info` (String) metadata about host's capability info
