...
page_title: "terrible_theforeman_foreman_domain Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_theforeman_foreman_domain (Resource)
...
- `dns_proxy` (String) DNS proxy to use within this domain for managing A records
...
- `parameters` (String) Domain specific host parameters
