...
page_title: "terrible_community_vmware_vmware_vsan_release_catalog Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_vsan_release_catalog (Resource)
...
- `source` (String) The path to the release catalog file
