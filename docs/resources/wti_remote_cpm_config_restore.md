...
page_title: "terrible_wti_remote_cpm_config_restore Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_wti_remote_cpm_config_restore (Resource)
...
- `cpm_filename` (String) This is the filename of the existing WTI device configuration file.
- `cpm_password` (String) This is the Password of the WTI device to get the parameters from.
- `cpm_url` (String) This is the URL of the WTI device to get the parameters from.
- `cpm_username` (String) This is the Username of the WTI device to get the parameters from.
...
- `cpm_path` (String) This is the directory path to the existing the WTI device configuration file.
...
- `data` (String) The output XML configuration of the WTI device queried
