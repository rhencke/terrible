...
page_title: "terrible_check_point_mgmt_cp_mgmt_reject_session Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_reject_session (Resource)
...
- `comments` (String) Reject justification.
...
- `cp_mgmt_reject_session` (String) The checkpoint reject-session output.
