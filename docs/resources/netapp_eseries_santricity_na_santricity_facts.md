...
page_title: "terrible_netapp_eseries_santricity_na_santricity_facts Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netapp_eseries_santricity_na_santricity_facts (Resource)
...
- `proxy_facts` (String) proxy storage system list
- `storage_array_facts` (String) provides details about the array, controllers, management interfaces, hostside interfaces, driveside interfaces, disks, storage pools, volumes, snapshots, and features.
