...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabenvironment Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabenvironment (Resource)
...
- `user_name` (String) The name of the user profile.
...
- `deployment_parameters` (String) The parameters of the Azure Resource Manager template.
- `deployment_template` (String) The Azure Resource Manager template's identifier.
...
- `state` (String) Assert the state of the Environment. Use `(present` to create or update an Environment and `absent` to delete it.
