...
page_title: "terrible_cisco_meraki_organizations_action_batches_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_organizations_action_batches_info (Resource)
...
- `actionBatchId` (String) Information module for Organizations Actionbatches Info. ActionBatchId path parameter. Action batch ID.
...
- `organizationId` (String) Information module for Organizations Actionbatches Info. OrganizationId path parameter. Organization ID.
...
- `status` (String) Information module for Organizations Actionbatches Info. Status query parameter. Filter batches by status. Valid types are pending, completed, and failed.
