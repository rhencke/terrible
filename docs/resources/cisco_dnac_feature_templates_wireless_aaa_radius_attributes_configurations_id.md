...
page_title: "terrible_cisco_dnac_feature_templates_wireless_aaa_radius_attributes_configurations_id Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_feature_templates_wireless_aaa_radius_attributes_configurations_id (Resource)
...
- `designName` (String) The feature template design name. `Note ` The following characters are not allowed % & < > ' /.
...
- `featureAttributes` (String) Feature Templates Wireless Aaa Radius Attributes Configurations Id's featureAttributes.
