...
page_title: "terrible_cisco_dnac_diagnostic_validation_workflows Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_diagnostic_validation_workflows (Resource)
...
- `validationSetIds` (String) List of validation set ids.
