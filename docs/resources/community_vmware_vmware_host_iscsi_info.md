...
page_title: "terrible_community_vmware_vmware_host_iscsi_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_host_iscsi_info (Resource)
...
- `esxi_hostname` (String) The ESXi hostname on which to gather iSCSI settings.
...
- `detected_iscsi_drives` (String) list of detected iSCSI drive
- `id` (String) Unique task resource ID
- `iscsi_properties` (String) dictionary of current iSCSI information
