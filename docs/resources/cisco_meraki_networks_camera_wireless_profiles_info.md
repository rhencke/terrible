...
page_title: "terrible_cisco_meraki_networks_camera_wireless_profiles_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_camera_wireless_profiles_info (Resource)
...
- `networkId` (String) Information module for Networks Camera Wirelessprofiles Info. NetworkId path parameter. Network ID.
...
- `wirelessProfileId` (String) Information module for Networks Camera Wirelessprofiles Info. WirelessProfileId path parameter. Wireless profile ID.
