...
page_title: "terrible_check_point_mgmt_cp_mgmt_user_template Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_check_point_mgmt_cp_mgmt_user_template (Resource)
...
- `expiration_by_global_properties` (Boolean) Expiration date according to global properties.
...
- `cp_mgmt_user_template` (String) The checkpoint object created or updated.
