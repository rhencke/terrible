...
page_title: "terrible_cisco_meraki_networks_pii_requests_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_pii_requests_info (Resource)
...
- `networkId` (String) Information module for Networks Pii Requests Info. NetworkId path parameter. Network ID.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `requestId` (String) Information module for Networks Pii Requests Info. RequestId path parameter. Request ID.
