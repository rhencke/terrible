...
page_title: "terrible_cisco_dnac_discovery_range_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_discovery_range_info (Resource)
...
- `recordsToReturn` (Number) RecordsToReturn path parameter. Number of records to fetch from the starting index.
