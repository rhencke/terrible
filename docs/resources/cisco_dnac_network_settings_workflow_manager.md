...
page_title: "terrible_cisco_dnac_network_settings_workflow_manager Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_network_settings_workflow_manager (Resource)
...
- `config` (String) List of details of global pool, reserved pool, network being managed.
