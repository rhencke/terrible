...
page_title: "terrible_azure_azcollection_azure_rm_devtestlabartifact_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_devtestlabartifact_info (Resource)
...
- `artifacts` (String) A list of dictionaries containing facts for DevTest Lab Artifact.
