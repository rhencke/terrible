...
page_title: "terrible_cisco_meraki_networks_sm_users_softwares_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_meraki_networks_sm_users_softwares_info (Resource)
...
- `networkId` (String) Information module for Networks Sm Users Softwares Info. NetworkId path parameter. Network ID.
...
- `userId` (String) Information module for Networks Sm Users Softwares Info. UserId path parameter. User ID.
