...
page_title: "terrible_cisco_dnac_event_subscription_count_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_event_subscription_count_info (Resource)
...
- `eventIds` (String) EventIds query parameter. List of subscriptions related to the respective eventIds.
