...
page_title: "terrible_azure_azcollection_azure_rm_mysqlflexibledatabase_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_mysqlflexibledatabase_info (Resource)
...
- `databases` (String) A list of dictionaries containing facts for MySQL Flexible Databases.
