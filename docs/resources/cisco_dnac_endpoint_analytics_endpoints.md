...
page_title: "terrible_cisco_dnac_endpoint_analytics_endpoints Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_endpoint_analytics_endpoints (Resource)
...
- `deviceType` (String) Type of the device represented by this endpoint.
...
- `hardwareManufacturer` (String) Hardware manufacturer for the endpoint.
- `hardwareModel` (String) Hardware model of the endpoint.
