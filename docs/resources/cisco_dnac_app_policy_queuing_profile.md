...
page_title: "terrible_cisco_dnac_app_policy_queuing_profile Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_app_policy_queuing_profile (Resource)
...
- `payload` (String) App Policy Queuing Profile's payload.
