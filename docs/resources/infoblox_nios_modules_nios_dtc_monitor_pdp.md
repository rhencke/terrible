...
page_title: "terrible_infoblox_nios_modules_nios_dtc_monitor_pdp Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_infoblox_nios_modules_nios_dtc_monitor_pdp (Resource)
...
- `interval` (Number) Configures the interval for PDP health check.
- `poll_interval` (Number) Polling interval in seconds when async_seconds > 0. Defaults to 15.
- `port` (Number) Configures the port value for PDP requests.
