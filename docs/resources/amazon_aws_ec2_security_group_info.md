...
page_title: "terrible_amazon_aws_ec2_security_group_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_ec2_security_group_info (Resource)
...
- `security_groups` (String) Security groups that match the provided filters. Each element consists of a dict with all the information related to that security group.
