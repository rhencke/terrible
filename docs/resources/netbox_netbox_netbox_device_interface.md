...
page_title: "terrible_netbox_netbox_netbox_device_interface Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_netbox_netbox_netbox_device_interface (Resource)
...
- `data` (String) Defines the interface configuration
...
- `update_vc_child` (Boolean) Use when master device is specified for `device` and the specified interface exists on a child device
and needs updated
...
- `interface` (String) Serialized object as created or already existent within NetBox
