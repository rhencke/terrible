...
page_title: "terrible_community_general_ilo_redfish_config Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_general_ilo_redfish_config (Resource)
...
- `attribute_name` (String) Name of the attribute to be configured.
- `baseuri` (String) Base URI of iLO.
- `category` (String) Command category to execute on iLO.
- `command` (String) List of commands to execute on iLO.
