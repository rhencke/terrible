...
page_title: "terrible_community_vmware_vmware_vsan_hcl_db Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_community_vmware_vmware_vsan_hcl_db (Resource)
...
- `source` (String) The path to the HCL db file
