...
page_title: "terrible_amazon_aws_elb_classic_lb_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_amazon_aws_elb_classic_lb_info (Resource)
...
- `names` (String) List of ELB names to gather information about. Pass this option to gather information about a set of ELBs, otherwise, all ELBs are returned.
...
- `elbs` (String) A list of load balancers.
