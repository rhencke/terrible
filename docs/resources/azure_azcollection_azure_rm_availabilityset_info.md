...
page_title: "terrible_azure_azcollection_azure_rm_availabilityset_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_azure_azcollection_azure_rm_availabilityset_info (Resource)
...
- `azure_availabilityset` (String) List of availability sets dicts.
