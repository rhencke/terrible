...
page_title: "terrible_cisco_dnac_sda_pending_fabric_events_info Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_cisco_dnac_sda_pending_fabric_events_info (Resource)
...
- `fabricId` (String) FabricId query parameter. ID of the fabric.
