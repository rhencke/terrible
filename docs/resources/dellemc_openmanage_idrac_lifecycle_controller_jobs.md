...
page_title: "terrible_dellemc_openmanage_idrac_lifecycle_controller_jobs Resource - terrible"
subcategory: ""
description: |-
  
---

# terrible_dellemc_openmanage_idrac_lifecycle_controller_jobs (Resource)
...
- `msg` (String) Status of the delete operation.
- `status` (String) Details of the delete operation.
